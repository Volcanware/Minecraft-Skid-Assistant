...
public class SVertexBuilder {
    ...
    public void calcNormal(WorldRenderer wrr, int baseIndex) {
        ...
        float v0x = floatBuffer.get(baseIndex * this.vertexSize);
        float v0y = floatBuffer.get(baseIndex * this.vertexSize + 1);
        float v0z = floatBuffer.get(baseIndex * this.vertexSize + 2);
        float v0u = floatBuffer.get(baseIndex * this.vertexSize + this.offsetUV);
        float v0v = floatBuffer.get(baseIndex * this.vertexSize + this.offsetUV + 1);
        float v1x = floatBuffer.get(baseIndex + this.vertexSize);
        float v1y = floatBuffer.get(baseIndex + this.vertexSize + 1);
        float v1z = floatBuffer.get(baseIndex + this.vertexSize + 2);
        float v1u = floatBuffer.get(baseIndex + this.vertexSize + this.offsetUV);
        float v1v = floatBuffer.get(baseIndex + this.vertexSize + this.offsetUV + 1);
        ...
        intBuffer.put(baseIndex * this.vertexSize + this.offsetNormal, packedNormal);
        intBuffer.put(baseIndex + this.vertexSize + this.offsetNormal, packedNormal);
        ...
        intBuffer.put(baseIndex * this.vertexSize + 10, packedTan1xy);
        intBuffer.put(baseIndex * this.vertexSize + 10 + 1, packedTan1zw);
        intBuffer.put(baseIndex + this.vertexSize + 10, packedTan1xy);
        intBuffer.put(baseIndex + this.vertexSize + 10 + 1, packedTan1zw);
        ...
        floatBuffer.put(baseIndex * this.vertexSize + 8, midU);
        floatBuffer.put(baseIndex * this.vertexSize + 8 + 1, midV);
        floatBuffer.put(baseIndex + this.vertexSize + 8, midU);
        floatBuffer.put(baseIndex + this.vertexSize + 8 + 1, midV);
