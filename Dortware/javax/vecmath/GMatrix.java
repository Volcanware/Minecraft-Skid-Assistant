...
public class GMatrix
    ...
    public final void add(GMatrix m1) {
        ...
        for (int i = 0; i < this.nRow * this.nCol; ++i) {
            ...
            elementData[i] = elementData[i] + m1.elementData[i];
        }
    }
    ...
    public final void setIdentity() {
        this.setZero();
        int min = Math.min(this.nRow, this.nCol);
        for (int i = 0; i < min; ++i) {
    ...
    public boolean equals(Object o1) {
        return o1 instanceof GMatrix && this.equals((GMatrix) o1);
    }
    ...
    public final void LUD(GMatrix LU, GVector permutation) {
        if (this.nRow != this.nCol) {
            throw new ArrayIndexOutOfBoundsException("not a square matrix");
        }
        int n = this.nRow;
