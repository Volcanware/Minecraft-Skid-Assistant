...
//        Display.setTitle("Dortware - Server List");
    ...
    public void createButtons() {
        ...
        try {
            ...
            this.buttonList.add(new GuiButton(69, 5, 5, 98, 20, String.valueOf(ReflectUtils.call(null, "com.github.creeper123123321.viafabric.util.ProtocolUtils", "getProtocolName", clientSideVer))));
        } catch (ClassNotFoundException | InvocationTargetException | IllegalAccessException | NullPointerException e) {
            e.printStackTrace();
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.title"), this.width / 2F, 20, 16777215);
