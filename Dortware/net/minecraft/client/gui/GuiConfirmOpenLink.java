...
public class GuiConfirmOpenLink extends GuiYesNo {
     ...
     */
    public void initGui() {
        this.buttonList.add(new GuiButton(0, this.width / 2F - 50 - 105, this.height / 6F + 96, 100, 20, this.confirmButtonText));
        this.buttonList.add(new GuiButton(2, this.width / 2F - 50, this.height / 6F + 96, 100, 20, this.copyLinkButtonText));
        this.buttonList.add(new GuiButton(1, this.width / 2F - 50 + 105, this.height / 6F + 96, 100, 20, this.cancelButtonText));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.showSecurityWarning) {
            this.drawCenteredString(this.fontRendererObj, this.openLinkWarning, this.width / 2F, 110, 16764108);
        }
    }
