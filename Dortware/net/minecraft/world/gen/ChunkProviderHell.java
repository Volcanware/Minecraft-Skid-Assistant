...
public class ChunkProviderHell implements IChunkProvider {
    ...
    public void func_180515_a(int p_180515_1_, int p_180515_2_, ChunkPrimer p_180515_3_) {
        ...
        byte var7 = 17;
        int var8 = var4 + 1;
        this.noiseField = this.initializeNoiseField(this.noiseField, p_180515_1_ * var4, p_180515_2_ * var4, var6, var7, var8);
    ...
    private double[] initializeNoiseField(double[] p_73164_1_, int p_73164_2_, int p_73164_4_, int p_73164_5_, int p_73164_6_, int p_73164_7_) {
        ...
        this.noiseData1 = this.netherNoiseGen3.generateNoiseOctaves(this.noiseData1, p_73164_2_, 0, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, var8 / 80.0D, var10 / 60.0D, var8 / 80.0D);
        this.noiseData2 = this.netherNoiseGen1.generateNoiseOctaves(this.noiseData2, p_73164_2_, 0, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, var8, var10, var8);
        this.noiseData3 = this.netherNoiseGen2.generateNoiseOctaves(this.noiseData3, p_73164_2_, 0, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, var8, var10, var8);
        int var12 = 0;
