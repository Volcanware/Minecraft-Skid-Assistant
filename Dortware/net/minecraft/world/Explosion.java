        ...
        if (this.isSmoking) {
            ...
            while (var2.hasNext()) {
                ...
                if (p_77279_1_) {
                    ...
                    var13 *= var19;
                    var15 *= var19;
                    this.worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_NORMAL, (var5 + this.explosionX) / 2.0D, (var7 + this.explosionY) / 2.0D, (var9 + this.explosionZ) / 2.0D, var11, var13, var15, new int[0]);
