...
public class ItemInWorldManager {
    ...
    public void updateBlockRemoving() {
        ...
        if (this.receivedFinishDiggingPacket) {
            ...
            if (var2.getMaterial() == Material.air) {
                ...
                var3 = var2.getPlayerRelativeBlockHardness(this.thisPlayerMP) * (float) (var1 + 1);
                var4 = (int) (var3 * 10.0F);
            ...
            if (var5.getMaterial() == Material.air) {
                ...
                var3 = var5.getPlayerRelativeBlockHardness(this.thisPlayerMP) * (float) (var6 + 1);
                var4 = (int) (var3 * 10.0F);
    ...
    public void func_180784_a(BlockPos p_180784_1_, EnumFacing p_180784_2_) {
        if (this.isCreative()) {
            ...
            if (var3.getMaterial() != Material.air) {
                ...
                var6 = var3.getPlayerRelativeBlockHardness(this.thisPlayerMP);
            }
    ...
    public void func_180785_a(BlockPos p_180785_1_) {
        if (p_180785_1_.equals(this.field_180240_f)) {
            ...
            if (var3.getMaterial() != Material.air) {
                float var4 = var3.getPlayerRelativeBlockHardness(this.thisPlayerMP) * (float) (var2 + 1);
