                    ...
                    if (var6.minY >= 0 && var6.maxY < 256 && var7.minY >= 0 && var7.maxY < 256) {
                        ...
                        if (var12.isAreaLoaded(var6) && var12.isAreaLoaded(var7)) {
                                    ...
                                    for (int var21 = var6.minX; var21 <= var6.maxX; ++var21) {
                                        ...
                                        if ((!var13 || var24.getBlock() != Blocks.air) && (var10 == null || var24.getBlock() == var10 && (var11 < 0 || var24.getBlock().getMetaFromState(var24) == var11))) {
                                            ...
                                            if (var25 != null) {
                                                ...
                                                var16.add(new CommandClone.StaticCloneData(var23, var24, null));
                                                var17.addFirst(var22);
                                            } else {
                                                var14.add(new CommandClone.StaticCloneData(var23, var24, null));
                                                var17.addLast(var22);
                                            }
                                        }
                                    }
                            ...
                            if (var33 != null) {
                                ...
                                for (Object o : var33) {
                                    NextTickListEntry var37 = (NextTickListEntry) o;
                            ...
                            if (var8 <= 0) {
                                ...
                                notifyOperators(sender, this, "commands.clone.success", var8);
                            }
                        } else {
