...
public class CommandEffect extends CommandBase {
        ...
        if (args.length < 2) {
            ...
            if (args[1].equals("clear")) {
                if (var3.getActivePotionEffects().isEmpty()) {
                    ...
                    notifyOperators(sender, this, "commands.effect.success.removed.all", var3.getName());
                }
            } else {
                int var4;
                ...
                if (var4 >= 0 && var4 < Potion.potionTypes.length && Potion.potionTypes[var4] != null) {
                    ...
                    if (var12 > 0) {
                        ...
                        notifyOperators(sender, this, "commands.effect.success", new ChatComponentTranslation(var10.getEffectName()), var4, var7, var3.getName(), var12);
                    } else if (var3.isPotionActive(var4)) {
                        var3.removePotionEffect(var4);
                        notifyOperators(sender, this, "commands.effect.success.removed", new ChatComponentTranslation(var8.getName()), var3.getName());
                    } else {
                        throw new CommandException("commands.effect.failure.notActive", new ChatComponentTranslation(var8.getName()), var3.getName());
                    }
                } else {
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return args.length == 1 ? getListOfStringsMatchingLastWord(args, this.getAllUsernames()) : (args.length == 2 ? getListOfStringsMatchingLastWord(args, Potion.func_180141_c()) : (args.length == 5 ? getListOfStringsMatchingLastWord(args, "true", "false") : null));
    }
