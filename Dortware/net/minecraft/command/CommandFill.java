...
public class CommandFill extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 7) {
            ...
            Block var5 = CommandBase.getBlockByText(args[6]);
            int var6 = 0;
            ...
            if (var9 > 32768) {
                            ...
                            if (args.length >= 9) {
                                if (!args[8].equals("outline") && !args[8].equals("hollow")) {
                                    if (args[8].equals("destroy")) {
                                        ...
                                        if (args.length > 9) {
                                            Block var18 = CommandBase.getBlockByText(args[9]);
                ...
                if (var9 <= 0) {
                    ...
                    notifyOperators(sender, this, "commands.fill.success", var9);
                }
            } else {
                throw new CommandException("commands.fill.outOfWorld");
            }
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return args.length > 0 && args.length <= 3 ? func_175771_a(args, 0, pos) : (args.length > 3 && args.length <= 6 ? func_175771_a(args, 3, pos) : (args.length == 7 ? func_175762_a(args, Block.blockRegistry.getKeys()) : (args.length == 9 ? getListOfStringsMatchingLastWord(args, "replace", "destroy", "keep", "hollow", "outline") : null)));
    }
}
