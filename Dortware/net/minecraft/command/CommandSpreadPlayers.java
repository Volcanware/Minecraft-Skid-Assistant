...
public class CommandSpreadPlayers extends CommandBase {
    ...
    private void func_110669_a(ICommandSender p_110669_1_, List p_110669_2_, CommandSpreadPlayers.Position p_110669_3_, double p_110669_4_, double p_110669_6_, World worldIn, boolean p_110669_9_) throws CommandException {
        ...
        notifyOperators(p_110669_1_, this, "commands.spreadplayers.success." + (p_110669_9_ ? "teams" : "players"), var19.length, p_110669_3_.field_111101_a, p_110669_3_.field_111100_b);
    ...
    private double func_110671_a(List p_110671_1_, World worldIn, CommandSpreadPlayers.Position[] p_110671_3_, boolean p_110671_4_) {
        ...
        for (Object o : p_110671_1_) {
            ...
            var10.setPositionAndUpdate((float) MathHelper.floor_double(var11.field_111101_a) + 0.5F, var11.func_111092_a(worldIn), (double) MathHelper.floor_double(var11.field_111100_b) + 0.5D);
            double var17 = Double.MAX_VALUE;

            for (Position position : p_110671_3_) {
                if (var11 != position) {
                    double var15 = var11.func_111099_a(position);
