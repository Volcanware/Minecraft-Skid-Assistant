...
public class CommandAchievement extends CommandBase {
                ...
                if (var5 || var6) {
                    if (var3 == null) {
                        ...
                        if (var5) {
                            ...
                            notifyOperators(sender, this, "commands.achievement.give.success.all", var4.getName());
                        } else {
                            ...
                            notifyOperators(sender, this, "commands.achievement.take.success.all", var4.getName());
                        }
                    } else {
                        ...
                        if (var5) {
                            ...
                            notifyOperators(sender, this, "commands.achievement.give.success.one", var4.getName(), var3.func_150955_j());
                        } else if (var6) {
                            var4.func_175145_a(var3);
                            notifyOperators(sender, this, "commands.achievement.take.success.one", var3.func_150955_j(), var4.getName());
                        }
                    }
                }
            }
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        if (args.length == 1) {
            ...
            for (Object o : StatList.allStats) {
                StatBase var6 = (StatBase) o;
