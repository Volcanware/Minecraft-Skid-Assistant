    ...
    public void onLivingUpdate() {
        ...
        if (this.getHealth() <= 0.0F) {
            ...
            if (this.worldObj.isRemote) {
                ...
                double var21 = Math.sqrt(this.motionX * this.motionX + this.motionZ * this.motionZ) + 1.0D;
            ...
            this.dragonPartHead.setLocationAndAngles(this.posX + (double) (var33 * 5.5F * var3), this.posY + (var9[1] - var31[1]) + (double) (var29 * 5.5F), this.posZ - (double) (var35 * 5.5F * var3), 0.0F, 0.0F);
            ...
            for (int var32 = 0; var32 < 3; ++var32) {
                ...
                float var37 = this.rotationYaw * (float) Math.PI / 180.0F + this.simplifyAngle(var36[0] - var31[0]) * (float) Math.PI / 180.0F;
                float var38 = MathHelper.sin(var37);
                float var39 = MathHelper.cos(var37);
                float var40 = 1.5F;
                float var41 = (float) (var32 + 1) * 2.0F;
                var34.onUpdate();
                var34.setLocationAndAngles(this.posX - (double) ((var30 * var40 + var38 * var41) * var3), this.posY + (var36[1] - var31[1]) - (double) ((var41 + var40) * var29) + 1.5D, this.posZ + (double) ((var7 * var40 + var39 * var41) * var3), 0.0F, 0.0F);
            }
