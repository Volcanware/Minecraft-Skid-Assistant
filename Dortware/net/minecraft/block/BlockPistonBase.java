...
public class BlockPistonBase extends Block {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        worldIn.setBlockState(pos, state.withProperty(FACING, func_180695_a(pos, placer)), 2);
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        return this.getDefaultState().withProperty(FACING, func_180695_a(pos, placer)).withProperty(EXTENDED, false);
    }
    ...
    public static EnumFacing func_180695_a(BlockPos p_180695_1_, EntityLivingBase p_180695_2_) {
        ...
        if (p_180696_0_ == Blocks.obsidian) {
            ...
            if (p_180696_2_.getY() <= worldIn.getHeight() - 1 && (p_180696_3_ != EnumFacing.UP || p_180696_2_.getY() != worldIn.getHeight() - 1)) {
                if (p_180696_0_ != Blocks.piston && p_180696_0_ != Blocks.sticky_piston) {
                    if (p_180696_0_.getBlockHardness() == -1.0F) {
                        return false;
                    }
