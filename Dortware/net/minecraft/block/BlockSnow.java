...
public class BlockSnow extends Block {
    ...
    public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
        ...
        return var4 != Blocks.ice && var4 != Blocks.packed_ice && (var4.getMaterial() == Material.leaves || (var4 == this && (Integer) var3.getValue(LAYERS_PROP) == 7 || var4.isOpaqueCube() && var4.blockMaterial.blocksMovement()));
    }
    ...
    private void checkAndDropBlock(World worldIn, BlockPos p_176314_2_, IBlockState p_176314_3_) {
