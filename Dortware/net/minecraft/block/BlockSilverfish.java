...
public class BlockSilverfish extends Block {
    ...
    public void dropBlockAsItemWithChance(World worldIn, BlockPos pos, IBlockState state, float chance, int fortune) {
        if (!worldIn.isRemote && worldIn.getGameRules().getGameRuleBooleanValue("doTileDrops")) {
            ...
            var6.setLocationAndAngles((double) pos.getX() + 0.5D, pos.getY(), (double) pos.getZ() + 0.5D, 0.0F, 0.0F);
    ...
    public enum EnumType implements IStringSerializable {
        ...
        COBBLESTONE(1, "cobblestone", "cobble", null) {
            // private static final String __OBFID = "CL_00002096";
            public IBlockState func_176883_d() {
                return Blocks.cobblestone.getDefaultState();
            }
        },
        STONEBRICK(2, "stone_brick", "brick", null) {
        ...
        MOSSY_STONEBRICK(3, "mossy_brick", "mossybrick", null) {
        ...
        CRACKED_STONEBRICK(4, "cracked_brick", "crackedbrick", null) {
        ...
        CHISELED_STONEBRICK(5, "chiseled_brick", "chiseledbrick", null) {
        ...
        EnumType(int p_i45704_3_, String p_i45704_4_) {
            this(p_i45704_3_, p_i45704_4_, p_i45704_4_);
        }

        EnumType(int p_i45705_3_, String p_i45705_4_, String p_i45705_5_) {
        ...
        EnumType(int p_i45706_3_, String p_i45706_4_, BlockSilverfish.SwitchEnumType p_i45706_5_) {
            this(p_i45706_3_, p_i45706_4_);
        }

        EnumType(int p_i45707_3_, String p_i45707_4_, String p_i45707_5_, BlockSilverfish.SwitchEnumType p_i45707_6_) {
            this(p_i45707_3_, p_i45707_4_, p_i45707_5_);
        }
