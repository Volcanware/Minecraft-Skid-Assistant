...
public class BlockDoublePlant extends BlockBush implements IGrowable {
    ...
    public enum EnumPlantType implements IStringSerializable {
        ...
        EnumPlantType(String p_i45722_1_, int p_i45722_2_, int p_i45722_3_, String p_i45722_4_) {
            this(p_i45722_3_, p_i45722_4_, p_i45722_4_);
        }

        EnumPlantType(int p_i45723_3_, String p_i45723_4_, String p_i45723_5_) {
