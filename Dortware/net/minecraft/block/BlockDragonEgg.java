                ...
                if (worldIn.getBlockState(var5).getBlock().blockMaterial == Material.air) {
                    if (worldIn.isRemote) {
                        for (int var6 = 0; var6 < 128; ++var6) {
                            ...
                            double var12 = (double) var5.getX() + (double) (p_180684_2_.getX() - var5.getX()) * var7 + (worldIn.rand.nextDouble() - 0.5D) + 0.5D;
                            double var14 = (double) var5.getY() + (double) (p_180684_2_.getY() - var5.getY()) * var7 + worldIn.rand.nextDouble() - 0.5D;
                            double var16 = (double) var5.getZ() + (double) (p_180684_2_.getZ() - var5.getZ()) * var7 + (worldIn.rand.nextDouble() - 0.5D) + 0.5D;
