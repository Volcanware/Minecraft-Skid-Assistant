...
public abstract class BlockRailBase extends Block {
    ...
    public enum EnumRailDirection implements IStringSerializable {
        ...
        EnumRailDirection(int p_i45738_3_, String p_i45738_4_) {
        ...
        static {
            ...
            for (EnumRailDirection var3 : var0) {
    ...
    public class Rail {
        ...
        private boolean func_180363_c(BlockPos p_180363_1_) {
            for (Object o : this.field_150657_g) {
                BlockPos var3 = (BlockPos) o;
        ...
        public BlockRailBase.Rail func_180364_a(boolean p_180364_1_, boolean p_180364_2_) {
            ...
            if (p_180364_2_ || this.field_150660_b.getBlockState(this.field_180367_c) != this.field_180366_e) {
                ...
                for (Object o : this.field_150657_g) {
                    Rail var13 = this.func_180697_b((BlockPos) o);
