...
public class CommandEffect extends CommandBase {
    ...
    public void processCommand(final ICommandSender sender, final String[] args) throws CommandException {
        if (args.length < 2) {
            ...
            final EntityLivingBase entitylivingbase = getEntity(sender, args[0], EntityLivingBase.class);
            ...
            if (args[1].equals("clear")) {
                ...
                if (i >= 0 && i < Potion.potionTypes.length && Potion.potionTypes[i] != null) {
                    final Potion potion1 = Potion.potionTypes[i];
                    ...
                    if (l > 0) {
                        ...
                        notifyOperators(sender, this, "commands.effect.success", new ChatComponentTranslation(potioneffect.getEffectName()), Integer.valueOf(i), Integer.valueOf(k), entitylivingbase.getCommandSenderName(), Integer.valueOf(l));
