...
public class CommandScoreboard extends CommandBase {
    ...
    private boolean func_175780_b(final ICommandSender p_175780_1_, final String[] p_175780_2_) throws CommandException {
        ...
        if (i < 0) {
            ...
            final List<String> list1 = Lists.newArrayList(this.getScoreboard().getObjectiveNames());
    ...
    protected void addObjective(final ICommandSender sender, final String[] args, int index) throws CommandException {
        ...
        final String s1 = args[index++];
        final Scoreboard scoreboard = this.getScoreboard();
        final IScoreObjectiveCriteria iscoreobjectivecriteria = IScoreObjectiveCriteria.INSTANCES.get(s1);
        ...
        if (iscoreobjectivecriteria == null) {
            ...
            if (args.length > index) {
                final String s2 = getChatComponentFromNthArg(sender, args, index).getUnformattedText();
    ...
    protected void addTeam(final ICommandSender sender, final String[] args, int index) throws CommandException {
        ...
        if (scoreboard.getTeam(s) != null) {
            ...
            if (args.length > index) {
                final String s1 = getChatComponentFromNthArg(sender, args, index).getUnformattedText();
    ...
    protected void setTeamOption(final ICommandSender sender, final String[] args, int index) throws CommandException {
        ...
        if (scoreplayerteam != null) {
            ...
            if (!s.equalsIgnoreCase("color") && !s.equalsIgnoreCase("friendlyfire") && !s.equalsIgnoreCase("seeFriendlyInvisibles") && !s.equalsIgnoreCase("nametagVisibility") && !s.equalsIgnoreCase("deathMessageVisibility")) {
                ...
                if (s.equalsIgnoreCase("color")) {
                    final EnumChatFormatting enumchatformatting = EnumChatFormatting.getValueByName(s1);
                    ...
                    final Team.EnumVisible team$enumvisible = Team.EnumVisible.func_178824_a(s1);
                    ...
                    final Team.EnumVisible team$enumvisible1 = Team.EnumVisible.func_178824_a(s1);
    ...
    protected void listTeams(final ICommandSender p_147186_1_, final String[] p_147186_2_, final int p_147186_3_) throws CommandException {
        ...
        if (p_147186_2_.length > p_147186_3_) {
            ...
            final ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("commands.scoreboard.teams.list.player.count", Integer.valueOf(collection.size()), scoreplayerteam.getRegisteredName());
            ...
            final Collection<ScorePlayerTeam> collection1 = scoreboard.getTeams();
            ...
            final ChatComponentTranslation chatcomponenttranslation1 = new ChatComponentTranslation("commands.scoreboard.teams.list.count", Integer.valueOf(collection1.size()));
            chatcomponenttranslation1.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
            p_147186_1_.addChatMessage(chatcomponenttranslation1);

            for (final ScorePlayerTeam scoreplayerteam1 : collection1) {
    ...
    protected void joinTeam(final ICommandSender p_147190_1_, final String[] p_147190_2_, int p_147190_3_) throws CommandException {
        ...
        if (p_147190_1_ instanceof EntityPlayer && p_147190_3_ == p_147190_2_.length) {
            final String s4 = getCommandSenderAsPlayer(p_147190_1_).getCommandSenderName();
            ...
            while (p_147190_3_ < p_147190_2_.length) {
                final String s1 = p_147190_2_[p_147190_3_++];

                if (s1.startsWith("@")) {
                    for (final Entity entity : func_175763_c(p_147190_1_, s1)) {
                        final String s3 = getEntityName(p_147190_1_, entity.getUniqueID().toString());
                    ...
                    final String s2 = getEntityName(p_147190_1_, s1);
    ...
    protected void leaveTeam(final ICommandSender p_147199_1_, final String[] p_147199_2_, int p_147199_3_) throws CommandException {
        ...
        if (p_147199_1_ instanceof EntityPlayer && p_147199_3_ == p_147199_2_.length) {
            final String s3 = getCommandSenderAsPlayer(p_147199_1_).getCommandSenderName();
            ...
            while (p_147199_3_ < p_147199_2_.length) {
                final String s = p_147199_2_[p_147199_3_++];

                if (s.startsWith("@")) {
                    for (final Entity entity : func_175763_c(p_147199_1_, s)) {
                        final String s2 = getEntityName(p_147199_1_, entity.getUniqueID().toString());
                    ...
                    final String s1 = getEntityName(p_147199_1_, s);
    ...
    protected void emptyTeam(final ICommandSender p_147188_1_, final String[] p_147188_2_, final int p_147188_3_) throws CommandException {
        ...
        if (scoreplayerteam != null) {
            final Collection<String> collection = Lists.newArrayList(scoreplayerteam.getMembershipCollection());
    ...
    protected void listObjectives(final ICommandSender p_147196_1_) throws CommandException {
        ...
        if (collection.size() <= 0) {
            ...
            final ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("commands.scoreboard.objectives.list.count", Integer.valueOf(collection.size()));
            chatcomponenttranslation.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
    ...
    protected void listPlayers(final ICommandSender p_147195_1_, final String[] p_147195_2_, final int p_147195_3_) throws CommandException {
        ...
        if (p_147195_2_.length > p_147195_3_) {
            final String s = getEntityName(p_147195_1_, p_147195_2_[p_147195_3_]);
            ...
            final ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("commands.scoreboard.players.list.player.count", Integer.valueOf(map.size()), s);
            chatcomponenttranslation.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
            ...
            final ChatComponentTranslation chatcomponenttranslation1 = new ChatComponentTranslation("commands.scoreboard.players.list.count", Integer.valueOf(collection.size()));
            chatcomponenttranslation1.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
    ...
    protected void setPlayer(final ICommandSender p_147197_1_, final String[] p_147197_2_, int p_147197_3_) throws CommandException {
        ...
        final String s1 = getEntityName(p_147197_1_, p_147197_2_[p_147197_3_++]);
        ...
        if (s1.length() > 40) {
            ...
            final int j = s.equalsIgnoreCase("set") ? parseInt(p_147197_2_[p_147197_3_++]) : parseInt(p_147197_2_[p_147197_3_++], 0);

            if (p_147197_2_.length > p_147197_3_) {
                final Entity entity = func_175768_b(p_147197_1_, p_147197_2_[i]);

                try {
                    final NBTTagCompound nbttagcompound = JsonToNBT.getTagFromJson(buildString(p_147197_2_, p_147197_3_));
    ...
    protected void resetPlayers(final ICommandSender p_147187_1_, final String[] p_147187_2_, int p_147187_3_) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard();
        final String s = getEntityName(p_147187_1_, p_147187_2_[p_147187_3_++]);
    ...
    protected void func_175779_n(final ICommandSender p_175779_1_, final String[] p_175779_2_, int p_175779_3_) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard();
        final String s = getPlayerName(p_175779_1_, p_175779_2_[p_175779_3_++]);
    ...
    protected void func_175781_o(final ICommandSender p_175781_1_, final String[] p_175781_2_, int p_175781_3_) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard();
        final String s = getEntityName(p_175781_1_, p_175781_2_[p_175781_3_++]);
        ...
        if (s.length() > 40) {
            ...
            if (!scoreboard.entityHasObjective(s, scoreobjective)) {
                ...
                final int i = p_175781_2_[p_175781_3_].equals("*") ? Integer.MIN_VALUE : parseInt(p_175781_2_[p_175781_3_]);
                ++p_175781_3_;
                final int j = p_175781_3_ < p_175781_2_.length && !p_175781_2_[p_175781_3_].equals("*") ? parseInt(p_175781_2_[p_175781_3_], i) : Integer.MAX_VALUE;
                final Score score = scoreboard.getValueFromObjective(s, scoreobjective);
    ...
    protected void func_175778_p(final ICommandSender p_175778_1_, final String[] p_175778_2_, int p_175778_3_) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard();
        final String s = getEntityName(p_175778_1_, p_175778_2_[p_175778_3_++]);
        final ScoreObjective scoreobjective = this.getObjective(p_175778_2_[p_175778_3_++], true);
        final String s1 = p_175778_2_[p_175778_3_++];
        final String s2 = getEntityName(p_175778_1_, p_175778_2_[p_175778_3_++]);
        final ScoreObjective scoreobjective1 = this.getObjective(p_175778_2_[p_175778_3_], false);
        ...
        if (s.length() > 40) {
            ...
            if (!scoreboard.entityHasObjective(s2, scoreobjective1)) {
                ...
                final Score score1 = scoreboard.getValueFromObjective(s2, scoreobjective1);
