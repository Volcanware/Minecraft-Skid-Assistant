    ...
    public void processCommand(final ICommandSender sender, final String[] args) throws CommandException {
        if (args.length < 1) {
            ...
            if (!world.isBlockLoaded(blockpos)) {
                ...
                if (args.length >= 5) {
                    final IChatComponent ichatcomponent = getChatComponentFromNthArg(sender, args, 4);
                ...
                if (entity2 == null) {
                    ...
                    for (NBTTagCompound nbttagcompound1 = nbttagcompound; entity != null && nbttagcompound1.hasKey("Riding", 10); nbttagcompound1 = nbttagcompound1.getCompoundTag("Riding")) {
                        final Entity entity1 = EntityList.createEntityFromNBT(nbttagcompound1.getCompoundTag("Riding"), world);
