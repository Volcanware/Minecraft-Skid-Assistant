...
public class BiomeDecorator {
    ...
    protected void genDecorations(final BiomeGenBase biomeGenBaseIn) {
        ...
        for (int i1 = 0; i1 < this.clayPerChunk; ++i1) {
            ...
            final int i6 = this.randomGenerator.nextInt(16) + 8;
        ...
        for (int j1 = 0; j1 < this.sandPerChunk; ++j1) {
            final int i2 = this.randomGenerator.nextInt(16) + 8;
        ...
        for (int j2 = 0; j2 < k1; ++j2) {
            final int k6 = this.randomGenerator.nextInt(16) + 8;
            final int l = this.randomGenerator.nextInt(16) + 8;
            final WorldGenAbstractTree worldgenabstracttree = biomeGenBaseIn.genBigTreeChance(this.randomGenerator);
            worldgenabstracttree.func_175904_e();
            final BlockPos blockpos = this.currentWorld.getHeight(this.field_180294_c.add(k6, 0, l));
        ...
        for (int k2 = 0; k2 < this.bigMushroomsPerChunk; ++k2) {
            final int l6 = this.randomGenerator.nextInt(16) + 8;
        ...
        for (int l2 = 0; l2 < this.flowersPerChunk; ++l2) {
            ...
            final int j14 = this.currentWorld.getHeight(this.field_180294_c.add(i7, 0, l10)).getY() + 32;

            if (j14 > 0) {
                final int k17 = this.randomGenerator.nextInt(j14);
                final BlockPos blockpos1 = this.field_180294_c.add(i7, k17, l10);
                final BlockFlower.EnumFlowerType blockflower$enumflowertype = biomeGenBaseIn.pickRandomFlower(this.randomGenerator, blockpos1);
        ...
        for (int i3 = 0; i3 < this.grassPerChunk; ++i3) {
            final int j7 = this.randomGenerator.nextInt(16) + 8;
            final int i11 = this.randomGenerator.nextInt(16) + 8;
            final int k14 = this.currentWorld.getHeight(this.field_180294_c.add(j7, 0, i11)).getY() * 2;

            if (k14 > 0) {
                final int l17 = this.randomGenerator.nextInt(k14);
        ...
        for (int j3 = 0; j3 < this.deadBushPerChunk; ++j3) {
            final int k7 = this.randomGenerator.nextInt(16) + 8;
            final int j11 = this.randomGenerator.nextInt(16) + 8;
            final int l14 = this.currentWorld.getHeight(this.field_180294_c.add(k7, 0, j11)).getY() * 2;

            if (l14 > 0) {
                final int i18 = this.randomGenerator.nextInt(l14);
        ...
        for (int k3 = 0; k3 < this.waterlilyPerChunk; ++k3) {
            ...
            final int k11 = this.randomGenerator.nextInt(16) + 8;
            final int i15 = this.currentWorld.getHeight(this.field_180294_c.add(l7, 0, k11)).getY() * 2;

            if (i15 > 0) {
                final int j18 = this.randomGenerator.nextInt(i15);
                BlockPos blockpos4;
                BlockPos blockpos7;
        ...
        for (int l3 = 0; l3 < this.mushroomsPerChunk; ++l3) {
            if (this.randomGenerator.nextInt(4) == 0) {
                final int i8 = this.randomGenerator.nextInt(16) + 8;
                final int l11 = this.randomGenerator.nextInt(16) + 8;
                final BlockPos blockpos2 = this.currentWorld.getHeight(this.field_180294_c.add(i8, 0, l11));
            ...
            if (this.randomGenerator.nextInt(8) == 0) {
                ...
                final int j15 = this.currentWorld.getHeight(this.field_180294_c.add(j8, 0, i12)).getY() * 2;

                if (j15 > 0) {
                    final int k18 = this.randomGenerator.nextInt(j15);
                    final BlockPos blockpos5 = this.field_180294_c.add(j8, k18, i12);
        ...
        if (this.randomGenerator.nextInt(4) == 0) {
            ...
            final int j12 = this.currentWorld.getHeight(this.field_180294_c.add(i4, 0, k8)).getY() * 2;

            if (j12 > 0) {
                final int k15 = this.randomGenerator.nextInt(j12);
                this.mushroomBrownGen.generate(this.currentWorld, this.randomGenerator, this.field_180294_c.add(i4, k15, k8));
            }
        }

        if (this.randomGenerator.nextInt(8) == 0) {
            final int j4 = this.randomGenerator.nextInt(16) + 8;
            final int l8 = this.randomGenerator.nextInt(16) + 8;
            final int k12 = this.currentWorld.getHeight(this.field_180294_c.add(j4, 0, l8)).getY() * 2;

            if (k12 > 0) {
                final int l15 = this.randomGenerator.nextInt(k12);
        ...
        for (int k4 = 0; k4 < this.reedsPerChunk; ++k4) {
            final int i9 = this.randomGenerator.nextInt(16) + 8;
            final int l12 = this.randomGenerator.nextInt(16) + 8;
            final int i16 = this.currentWorld.getHeight(this.field_180294_c.add(i9, 0, l12)).getY() * 2;

            if (i16 > 0) {
                final int l18 = this.randomGenerator.nextInt(i16);
                this.reedGen.generate(this.currentWorld, this.randomGenerator, this.field_180294_c.add(i9, l18, l12));
            }
        }

        for (int l4 = 0; l4 < 10; ++l4) {
            final int j9 = this.randomGenerator.nextInt(16) + 8;
            final int i13 = this.randomGenerator.nextInt(16) + 8;
            final int j16 = this.currentWorld.getHeight(this.field_180294_c.add(j9, 0, i13)).getY() * 2;

            if (j16 > 0) {
                final int i19 = this.randomGenerator.nextInt(j16);
        ...
        if (this.randomGenerator.nextInt(32) == 0) {
            ...
            final int k9 = this.randomGenerator.nextInt(16) + 8;
            final int j13 = this.currentWorld.getHeight(this.field_180294_c.add(i5, 0, k9)).getY() * 2;

            if (j13 > 0) {
                final int k16 = this.randomGenerator.nextInt(j13);
        ...
        for (int j5 = 0; j5 < this.cactiPerChunk; ++j5) {
            ...
            final int k13 = this.randomGenerator.nextInt(16) + 8;
            final int l16 = this.currentWorld.getHeight(this.field_180294_c.add(l9, 0, k13)).getY() * 2;

            if (l16 > 0) {
                final int j19 = this.randomGenerator.nextInt(l16);
        ...
        if (this.generateLakes) {
            for (int k5 = 0; k5 < 50; ++k5) {
                ...
                final int l13 = this.randomGenerator.nextInt(16) + 8;
                final int i17 = this.randomGenerator.nextInt(248) + 8;

                if (i17 > 0) {
                    final int k19 = this.randomGenerator.nextInt(i17);
                    final BlockPos blockpos6 = this.field_180294_c.add(i10, k19, l13);
            ...
            for (int l5 = 0; l5 < 20; ++l5) {
                ...
                final int i14 = this.randomGenerator.nextInt(16) + 8;
                final int j17 = this.randomGenerator.nextInt(this.randomGenerator.nextInt(this.randomGenerator.nextInt(240) + 8) + 8);
                final BlockPos blockpos3 = this.field_180294_c.add(j10, j17, i14);
