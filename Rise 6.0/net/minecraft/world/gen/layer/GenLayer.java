...
public abstract class GenLayer {
    ...
    public static GenLayer[] initializeAllBiomeGenerators(final long seed, final WorldType p_180781_2_, final String p_180781_3_) {
        ...
        final GenLayerRemoveTooMuchOcean genlayerremovetoomuchocean = new GenLayerRemoveTooMuchOcean(2L, genlayeraddisland1);
        final GenLayerAddSnow genlayeraddsnow = new GenLayerAddSnow(2L, genlayerremovetoomuchocean);
        final GenLayerAddIsland genlayeraddisland2 = new GenLayerAddIsland(3L, genlayeraddsnow);
        ...
        final GenLayerAddIsland genlayeraddisland3 = new GenLayerAddIsland(4L, genlayerzoom1);
        final GenLayerAddMushroomIsland genlayeraddmushroomisland = new GenLayerAddMushroomIsland(5L, genlayeraddisland3);
        final GenLayerDeepOcean genlayerdeepocean = new GenLayerDeepOcean(4L, genlayeraddmushroomisland);
        final GenLayer genlayer4 = GenLayerZoom.magnify(1000L, genlayerdeepocean, 0);
        ...
        final GenLayer lvt_8_1_ = GenLayerZoom.magnify(1000L, genlayer4, 0);
        final GenLayerRiverInit genlayerriverinit = new GenLayerRiverInit(100L, lvt_8_1_);
        final GenLayerBiome lvt_9_1_ = new GenLayerBiome(200L, genlayer4, p_180781_2_, p_180781_3_);
        final GenLayer genlayer6 = GenLayerZoom.magnify(1000L, lvt_9_1_, 2);
        final GenLayerBiomeEdge genlayerbiomeedge = new GenLayerBiomeEdge(1000L, genlayer6);
        ...
        final GenLayerRiver genlayerriver = new GenLayerRiver(1L, genlayer5);
        ...
        final GenLayerSmooth genlayersmooth1 = new GenLayerSmooth(1000L, genlayerhills);
        final GenLayerRiverMix genlayerrivermix = new GenLayerRiverMix(100L, genlayersmooth1, genlayersmooth);
        final GenLayer genlayer3 = new GenLayerVoronoiZoom(10L, genlayerrivermix);
