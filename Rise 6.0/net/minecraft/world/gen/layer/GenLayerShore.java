        ...
        for (int i = 0; i < areaHeight; ++i) {
            for (int j = 0; j < areaWidth; ++j) {
                ...
                if (k == BiomeGenBase.mushroomIsland.biomeID) {
                    ...
                    final int k4 = aint[j + 1 + (i + 1 + 1) * (areaWidth + 2)];
                    ...
                    final int i2 = aint[j + 1 + (i + 1 - 1) * (areaWidth + 2)];
                    final int l2 = aint[j + 1 + 1 + (i + 1) * (areaWidth + 2)];
                    final int k3 = aint[j + 1 - 1 + (i + 1) * (areaWidth + 2)];
                    final int j4 = aint[j + 1 + (i + 1 + 1) * (areaWidth + 2)];
                    ...
                    if (biomegenbase != null && biomegenbase.isSnowyBiome()) {
                        ...
                        if (k != BiomeGenBase.ocean.biomeID && k != BiomeGenBase.deepOcean.biomeID && k != BiomeGenBase.river.biomeID && k != BiomeGenBase.swampland.biomeID) {
                            ...
                            final int k2 = aint[j + 1 + 1 + (i + 1) * (areaWidth + 2)];
                        ...
                        final int l = aint[j + 1 + (i + 1 - 1) * (areaWidth + 2)];
                        final int i1 = aint[j + 1 + 1 + (i + 1) * (areaWidth + 2)];
                        final int j1 = aint[j + 1 - 1 + (i + 1) * (areaWidth + 2)];
                        final int k1 = aint[j + 1 + (i + 1 + 1) * (areaWidth + 2)];
