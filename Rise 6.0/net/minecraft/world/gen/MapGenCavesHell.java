...
public class MapGenCavesHell extends MapGenBase {
    ...
    protected void func_180704_a(final long p_180704_1_, final int p_180704_3_, final int p_180704_4_, final ChunkPrimer p_180704_5_, double p_180704_6_, double p_180704_8_, double p_180704_10_, final float p_180704_12_, float p_180704_13_, float p_180704_14_, int p_180704_15_, int p_180704_16_, final double p_180704_17_) {
        ...
        final double d1 = p_180704_4_ * 16 + 8;
        float f = 0.0F;
        float f1 = 0.0F;
        ...
        for (final boolean flag = random.nextInt(6) == 0; p_180704_15_ < p_180704_16_; ++p_180704_15_) {
            final double d2 = 1.5D + (double) (MathHelper.sin((float) p_180704_15_ * (float) Math.PI / (float) p_180704_16_) * p_180704_12_ * 1.0F);
            ...
            if (flag1 || random.nextInt(4) != 0) {
                ...
                final double d6 = p_180704_16_ - p_180704_15_;
                final double d7 = p_180704_12_ + 2.0F + 16.0F;
                    ...
                    for (int j1 = j2; !flag2 && j1 < k; ++j1) {
                        for (int k1 = l2; !flag2 && k1 < i1; ++k1) {
                            for (int l1 = l + 1; !flag2 && l1 >= k2 - 1; --l1) {
                                if (l1 >= 0 && l1 < 128) {
                                    final IBlockState iblockstate = p_180704_5_.getBlockState(j1, l1, k1);
    ...
    protected void recursiveGenerate(final World worldIn, final int chunkX, final int chunkZ, final int p_180701_4_, final int p_180701_5_, final ChunkPrimer chunkPrimerIn) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            final double d1 = this.rand.nextInt(128);
