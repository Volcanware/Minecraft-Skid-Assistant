...
public abstract class EntityAIDoorInteract extends EntityAIBase {
    ...
    public void updateTask() {
        final float f = (float) ((double) ((float) this.doorPosition.getX() + 0.5F) - this.theEntity.posX);
        final float f1 = (float) ((double) ((float) this.doorPosition.getZ() + 0.5F) - this.theEntity.posZ);
