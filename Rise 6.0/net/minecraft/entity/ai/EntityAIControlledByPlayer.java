...
public class EntityAIControlledByPlayer extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        final int l = MathHelper.floor_double(this.thisEntity.posX + (double) f9);
        final int i1 = MathHelper.floor_double(this.thisEntity.posZ + (double) f10);
        final int j1 = MathHelper.floor_float(this.thisEntity.width + 1.0F);
        final int k1 = MathHelper.floor_float(this.thisEntity.height + entityplayer.height + 1.0F);
        final int l1 = MathHelper.floor_float(this.thisEntity.width + 1.0F);
        ...
        if (!entityplayer.capabilities.isCreativeMode && this.currentSpeed >= this.maxSpeed * 0.5F && this.thisEntity.getRNG().nextFloat() < 0.006F && !this.speedBoosted) {
            ...
            if (itemstack != null && itemstack.getItem() == Items.carrot_on_a_stick) {
                ...
                if (itemstack.stackSize == 0) {
                    final ItemStack itemstack1 = new ItemStack(Items.fishing_rod);
