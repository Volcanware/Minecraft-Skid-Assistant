...
public class IteratorAxis implements Iterator<BlockPos> {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final BlockPos blockpos1 = new BlockPos(2, 12, 22);
        final double d0 = -0.5D;
        final double d1 = 0.5D;
        final IteratorAxis iteratoraxis = new IteratorAxis(blockpos, blockpos1, d0, d1);
        System.out.println("Start: " + blockpos + ", end: " + blockpos1 + ", yDelta: " + d0 + ", zDelta: " + d1);

        while (iteratoraxis.hasNext()) {
            final BlockPos blockpos2 = iteratoraxis.next();
