...
import com.alan.clients.notification.NotificationType;
...
public class RiseAPI {
    ...
    public void displayInfoNotification(final String title, final String message) {
        Client.INSTANCE.getNotificationManager().register(title, message, NotificationType.INFO);
    }

    public void displayWarnNotification(final String title, final String message) {
        Client.INSTANCE.getNotificationManager().register(title, message, NotificationType.WARNING);
    }

    public void displayErrorNotification(final String title, final String message) {
        Client.INSTANCE.getNotificationManager().register(title, message, NotificationType.ERROR);
    }
