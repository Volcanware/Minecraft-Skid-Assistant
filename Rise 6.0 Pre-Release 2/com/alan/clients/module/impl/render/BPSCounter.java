...
@ModuleInfo(name = "BPS Counter", description = "module.render.bpscounter.description", category = Category.RENDER)
public final class BPSCounter extends Module {
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        ...
        final String bpsString = MathUtil.round(MoveUtil.speed() * 20, 1) + "";
        ...
        NORMAL_POST_RENDER_RUNNABLES.add(() -> {
            ...
            nunitoNormal.drawString(bpsString, textX + titleWidth, textY, Color.WHITE.getRGB());
        });
