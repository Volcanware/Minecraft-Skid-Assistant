...
@ModuleInfo(name = "FPS Counter", description = "module.render.fpscounter.description", category = Category.RENDER)
public final class FPSCounter extends Module  {
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        ...
        NORMAL_POST_RENDER_RUNNABLES.add(() -> {
            ...
            nunitoNormal.drawString(fpsString, textX + titleWidth, textY, Color.WHITE.getRGB());
        });
