...
@Rise
@ModuleInfo(name = "Manager", description = "module.player.manager.description", category = Category.PLAYER)
public class Manager extends Module {

    private final BoundsNumberValue delay = new BoundsNumberValue("Delay", this, 100, 150, 50, 500, 25);
    ...
    private void throwItem(final int slot) {
        if (!this.moved && !SelectorDetectionComponent.selector(slot)) {
