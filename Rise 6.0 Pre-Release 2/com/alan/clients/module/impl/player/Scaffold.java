...
@Rise
@ModuleInfo(name = "Scaffold", description = "module.player.scaffold.description", category = Category.PLAYER)
public class Scaffold extends Module {
    ...
    private final BooleanValue downwards = new BooleanValue("Downwards", this, false);
    ...
    public final ModeValue yawOffset = new ModeValue("Yaw Offset", this, () -> !advanced.getValue())
            ...
            .add(new SubMode("-45"))
            .setDefault("0");
    private final BooleanValue autoF5 = new BooleanValue("Auto F5", this, true, () -> !advanced.getValue());
    ...
    protected void onEnable() {
        ...
        // Toggles third-person perspective automatically
    ...
    protected void onDisable() {
        ...
        // Toggles perspective back to first-person
        if (this.autoF5.getValue()) {
    ...
    public final Listener<PacketReceiveEvent> onPacketReceiveEvent = event -> {
        ...
        if (packet instanceof S2FPacketSetSlot) {
            ...
            if (wrapper.func_149174_e() == null) {
                ...
                try {
                    final ItemStack itemStack = mc.thePlayer.inventory.getStackInSlot(wrapper.func_149173_d() - 36);
    ...
    public void calculateSneaking() {
        ...
        if (PlayerUtil.blockRelativeToPlayer(mc.thePlayer.motionX * ahead, MoveUtil.HEAD_HITTER_MOTION, mc.thePlayer.motionZ * ahead) instanceof BlockAir) {
...
//        }
    ...
    public final Listener<PreUpdateEvent> onPreUpdate = event -> {
        ...
        // Gets block to place
        targetBlock = PlayerUtil.getPlacePossibility();
        ...
        if (downwards.getValue() && mc.gameSettings.keyBindSneak.isKeyDown() && mc.thePlayer.onGround) {
        ...
        if (!BadPacketsComponent.bad(false, true, false, false, true) &&
                ...
                (mc.thePlayer.inventory.alternativeCurrentItem == SlotComponent.getItemIndex())) {
            /* Correct HitVec */
        ...
        } else if (Math.random() > 0.85 && mc.rightClickDelayTimer <= 0) {
    ...
    public void getRotations(final float yawOffset) {
        ...
        if (!found) {
            ...
            if (ticksOnAir > 0) ChatUtil.display("Backup");
        }
    }
