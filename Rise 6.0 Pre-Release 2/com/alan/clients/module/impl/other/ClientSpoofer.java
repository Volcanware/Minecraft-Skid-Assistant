...
@Rise
@ModuleInfo(name = "Client Spoofer", description = "module.other.clientspoofer.description", category = Category.OTHER)
    ...
    public final Listener<PacketSendEvent> onPacketSend = event -> {
        ...
        if (packet instanceof C17PacketCustomPayload) {
            ...
            switch (mode.getValue().getName()) {
                ...
                case "Geyser": {
                    wrapper.setData(createPacketBuffer("Geyser", false));
                    break;
                }
            }
        }
