...
@Rise
@DevelopmentFeature
@ModuleInfo(name = "Debugger", category = Category.OTHER, description = "module.other.debugger.description")
public final class Debugger extends Module implements InstanceAccess {
    ...
    public final Listener<PacketReceiveEvent> onPacketReceiveEvent = event -> {
        ...
        // This shouldn't be possible (@DevelopmentFeature annotation present), but just in case
        if (!Client.DEVELOPMENT_SWITCH) this.toggle();
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        ...
        if (devPanel.getValue()) {
            double padding = 10;
            position.scale = new Vector2d(180, 177);
