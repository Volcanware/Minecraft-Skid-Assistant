...
public class PlayerSelector {
    ...
    public static IChatComponent matchEntitiesToChatComponent(final ICommandSender sender, final String token) {
        ...
        if (list.isEmpty()) {
            ...
            final List<IChatComponent> list1 = Lists.newArrayList();
    ...
    public static <T extends Entity> List<T> matchEntities(final ICommandSender sender, final String token, final Class<? extends T> targetClass) {
        final Matcher matcher = tokenPattern.matcher(token);
        ...
        if (matcher.matches() && sender.canCommandSenderUseCommand(1, "@")) {
            ...
            if (!isEntityTypeValid(sender, map)) {
                ...
                final List<T> list1 = Lists.newArrayList();

                for (final World world : list) {
                    if (world != null) {
                        final List<Predicate<Entity>> list2 = Lists.newArrayList();
    ...
    private static List<Predicate<Entity>> func_179663_a(final Map<String, String> p_179663_0_, final String p_179663_1_) {
        ...
        final boolean flag1 = !p_179663_1_.equals("e");
        final boolean flag2 = p_179663_1_.equals("r") && s != null;
            ...
            list.add(new Predicate<Entity>() {
                public boolean apply(final Entity p_apply_1_) {
                    ...
                    for (final Entry<String, Integer> entry : map.entrySet()) {
                        ...
                        final String s1 = p_apply_1_ instanceof EntityPlayerMP ? p_apply_1_.getCommandSenderName() : p_apply_1_.getUniqueID().toString();
    ...
    private static <T extends Entity> List<T> filterResults(final Map<String, String> params, final Class<? extends T> entityClass, final List<Predicate<Entity>> inputList, final String type, final World worldIn, final BlockPos position) {
        ...
        final boolean flag1 = type.equals("r") && s != null;
        ...
        final Predicate<Entity> predicate1 = Predicates.and(EntitySelectors.selectAnything, predicate);

        if (position != null) {
            final int i1 = worldIn.playerEntities.size();
            final int j1 = worldIn.loadedEntityList.size();
            final boolean flag2 = i1 < j1 / 16;
            ...
            if (!params.containsKey("dx") && !params.containsKey("dy") && !params.containsKey("dz")) {
                ...
                if (flag && flag2 && !flag1) {
                    final Predicate<Entity> predicate2 = new Predicate<Entity>() {
                        public boolean apply(final Entity p_apply_1_) {
    ...
    private static AxisAlignedBB func_179661_a(final BlockPos p_179661_0_, final int p_179661_1_, final int p_179661_2_, final int p_179661_3_) {
        ...
        final boolean flag1 = p_179661_2_ < 0;
        final boolean flag2 = p_179661_3_ < 0;
        final int i = p_179661_0_.getX() + (flag ? p_179661_1_ : 0);
        final int j = p_179661_0_.getY() + (flag1 ? p_179661_2_ : 0);
        final int k = p_179661_0_.getZ() + (flag2 ? p_179661_3_ : 0);
        final int l = p_179661_0_.getX() + (flag ? 0 : p_179661_1_) + 1;
        final int i1 = p_179661_0_.getY() + (flag1 ? 0 : p_179661_2_) + 1;
        final int j1 = p_179661_0_.getZ() + (flag2 ? 0 : p_179661_3_) + 1;
    ...
    private static boolean func_179665_h(final Map<String, String> p_179665_0_) {
        for (final String s : WORLD_BINDING_ARGS) {
    ...
    public static boolean matchesMultiplePlayers(final String p_82377_0_) {
        final Matcher matcher = tokenPattern.matcher(p_82377_0_);
    ...
    private static Map<String, String> getArgumentMap(final String argumentString) {
        ...
        if (argumentString == null) {
            ...
            for (final Matcher matcher = intListPattern.matcher(argumentString); matcher.find(); j = matcher.end()) {
                String s = null;
            ...
            if (j < argumentString.length()) {
                final Matcher matcher1 = keyValueListPattern.matcher(j == -1 ? argumentString : argumentString.substring(j));
