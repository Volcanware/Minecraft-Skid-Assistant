...
public class CommandSpreadPlayers extends CommandBase {
    ...
    public void processCommand(final ICommandSender sender, final String[] args) throws CommandException {
        if (args.length < 6) {
            ...
            final double d0 = parseDouble(blockpos.getX(), args[i++], true);
            final double d1 = parseDouble(blockpos.getZ(), args[i++], true);
            final double d2 = parseDouble(args[i++], 0.0D);
            final double d3 = parseDouble(args[i++], d2 + 1.0D);
            final boolean flag = parseBoolean(args[i++]);
            ...
            while (i < args.length) {
                ...
                if (PlayerSelector.hasArguments(s)) {
                    final List<Entity> list1 = PlayerSelector.matchEntities(sender, s, Entity.class);
    ...
    private void func_110669_a(final ICommandSender p_110669_1_, final List<Entity> p_110669_2_, final CommandSpreadPlayers.Position p_110669_3_, final double p_110669_4_, final double p_110669_6_, final World worldIn, final boolean p_110669_9_) throws CommandException {
        final Random random = new Random();
        final double d0 = p_110669_3_.field_111101_a - p_110669_6_;
        final double d1 = p_110669_3_.field_111100_b - p_110669_6_;
        final double d2 = p_110669_3_.field_111101_a + p_110669_6_;
        final double d3 = p_110669_3_.field_111100_b + p_110669_6_;
        final CommandSpreadPlayers.Position[] acommandspreadplayers$position = this.func_110670_a(random, p_110669_9_ ? this.func_110667_a(p_110669_2_) : p_110669_2_.size(), d0, d1, d2, d3);
        final int i = this.func_110668_a(p_110669_3_, p_110669_4_, worldIn, random, d0, d1, d2, d3, acommandspreadplayers$position, p_110669_9_);
        final double d4 = this.func_110671_a(p_110669_2_, worldIn, acommandspreadplayers$position, p_110669_9_);
    ...
    private int func_110668_a(final CommandSpreadPlayers.Position p_110668_1_, final double p_110668_2_, final World worldIn, final Random p_110668_5_, final double p_110668_6_, final double p_110668_8_, final double p_110668_10_, final double p_110668_12_, final CommandSpreadPlayers.Position[] p_110668_14_, final boolean p_110668_15_) throws CommandException {
        boolean flag = true;
        ...
        for (i = 0; i < 10000 && flag; ++i) {
            ...
            for (int j = 0; j < p_110668_14_.length; ++j) {
                final CommandSpreadPlayers.Position commandspreadplayers$position = p_110668_14_[j];
                int k = 0;
                final CommandSpreadPlayers.Position commandspreadplayers$position1 = new CommandSpreadPlayers.Position();

                for (int l = 0; l < p_110668_14_.length; ++l) {
                    if (j != l) {
                        final CommandSpreadPlayers.Position commandspreadplayers$position2 = p_110668_14_[l];
                        final double d1 = commandspreadplayers$position.func_111099_a(commandspreadplayers$position2);
                        d0 = Math.min(d1, d0);
                ...
                if (k > 0) {
                    ...
                    final double d2 = commandspreadplayers$position1.func_111096_b();
            ...
            if (!flag) {
                for (final CommandSpreadPlayers.Position commandspreadplayers$position3 : p_110668_14_) {
    ...
    private double func_110671_a(final List<Entity> p_110671_1_, final World worldIn, final CommandSpreadPlayers.Position[] p_110671_3_, final boolean p_110671_4_) {
        double d0 = 0.0D;
        int i = 0;
        final Map<Team, CommandSpreadPlayers.Position> map = Maps.newHashMap();

        for (int j = 0; j < p_110671_1_.size(); ++j) {
            final Entity entity = p_110671_1_.get(j);
            final CommandSpreadPlayers.Position commandspreadplayers$position;
            ...
            for (int k = 0; k < p_110671_3_.length; ++k) {
                if (commandspreadplayers$position != p_110671_3_[k]) {
                    final double d1 = commandspreadplayers$position.func_111099_a(p_110671_3_[k]);
                    d2 = Math.min(d1, d2);
                }
            }
    ...
    private CommandSpreadPlayers.Position[] func_110670_a(final Random p_110670_1_, final int p_110670_2_, final double p_110670_3_, final double p_110670_5_, final double p_110670_7_, final double p_110670_9_) {
        final CommandSpreadPlayers.Position[] acommandspreadplayers$position = new CommandSpreadPlayers.Position[p_110670_2_];

        for (int i = 0; i < acommandspreadplayers$position.length; ++i) {
            final CommandSpreadPlayers.Position commandspreadplayers$position = new CommandSpreadPlayers.Position();
    ...
    static class Position {
        ...
        double func_111099_a(final CommandSpreadPlayers.Position p_111099_1_) {
            ...
            final double d1 = this.field_111100_b - p_111099_1_.field_111100_b;
