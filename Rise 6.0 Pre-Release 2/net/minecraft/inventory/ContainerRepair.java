        ...
        if (itemstack == null) {
            ...
            if (itemstack2 != null) {
                ...
                if (itemstack1.isItemStackDamageable() && itemstack1.getItem().getIsRepairable(itemstack, itemstack2)) {
                    ...
                    final Iterator iterator1 = map1.keySet().iterator();

                    while (iterator1.hasNext()) {
                        final int i5 = ((Integer) iterator1.next()).intValue();
                        final Enchantment enchantment = Enchantment.getEnchantmentById(i5);

                        if (enchantment != null) {
                            final int k5 = map.containsKey(Integer.valueOf(i5)) ? map.get(Integer.valueOf(i5)).intValue() : 0;
                            ...
                            while (iterator.hasNext()) {
                                final int i4 = ((Integer) iterator.next()).intValue();
