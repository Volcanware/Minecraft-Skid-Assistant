...
public class InventoryBasic implements IInventory {
    ...
    public ItemStack decrStackSize(final int index, final int count) {
        if (this.inventoryContents[index] != null) {
            if (this.inventoryContents[index].stackSize <= count) {
                ...
                final ItemStack itemstack = this.inventoryContents[index].splitStack(count);
    ...
    public ItemStack func_174894_a(final ItemStack stack) {
        ...
        for (int i = 0; i < this.slotsCount; ++i) {
            final ItemStack itemstack1 = this.getStackInSlot(i);
            ...
            if (ItemStack.areItemsEqual(itemstack1, itemstack)) {
                ...
                final int k = Math.min(itemstack.stackSize, j - itemstack1.stackSize);
