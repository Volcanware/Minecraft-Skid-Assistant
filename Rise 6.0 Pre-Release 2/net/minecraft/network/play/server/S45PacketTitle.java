...
public class S45PacketTitle implements Packet<INetHandlerPlayClient> {
    ...
    public S45PacketTitle(final S45PacketTitle.Type type, final IChatComponent message) {
    ...
    public S45PacketTitle(final S45PacketTitle.Type type, final IChatComponent message, final int fadeInTime, final int displayTime, final int fadeOutTime) {
        this.type = type;
    ...
    public enum Type {
        ...
        public static S45PacketTitle.Type byName(final String name) {
            for (final S45PacketTitle.Type s45packettitle$type : values()) {
