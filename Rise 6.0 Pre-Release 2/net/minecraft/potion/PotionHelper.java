    ...
    private static int parsePotionEffects(final String p_77912_0_, final int p_77912_1_, final int p_77912_2_, final int p_77912_3_) {
        if (p_77912_1_ < p_77912_0_.length() && p_77912_2_ >= 0 && p_77912_1_ < p_77912_2_) {
            ...
            if (i >= 0 && i < p_77912_2_) {
                ...
                if (j >= 0 && j < p_77912_2_) {
                    final int i2 = parsePotionEffects(p_77912_0_, p_77912_1_, j - 1, p_77912_3_);

                    if (i2 <= 0) {
                        return 0;
                    } else {
                        final int k2 = parsePotionEffects(p_77912_0_, j + 1, p_77912_2_, p_77912_3_);
                    ...
                    for (int k1 = p_77912_1_; k1 < p_77912_2_; ++k1) {
                        final char c0 = p_77912_0_.charAt(k1);
    ...
    public static List<PotionEffect> getPotionEffects(final int p_77917_0_, final boolean p_77917_1_) {
        ...
        for (final Potion potion : Potion.potionTypes) {
            if (potion != null && (!potion.isUsable() || p_77917_1_)) {
                final String s = potionRequirements.get(Integer.valueOf(potion.getId()));
                ...
                if (s != null) {
                    ...
                    if (i > 0) {
                        int j = 0;
                        final String s1 = potionAmplifiers.get(Integer.valueOf(potion.getId()));
