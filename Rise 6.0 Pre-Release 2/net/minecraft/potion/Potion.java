...
public class Potion {
    ...
    public void affectEntity(final Entity p_180793_1_, final Entity p_180793_2_, final EntityLivingBase entityLivingBaseIn, final int p_180793_4_, final double p_180793_5_) {
        if ((this.id != heal.id || entityLivingBaseIn.isEntityUndead()) && (this.id != harm.id || !entityLivingBaseIn.isEntityUndead())) {
            if (this.id == harm.id && !entityLivingBaseIn.isEntityUndead() || this.id == heal.id && entityLivingBaseIn.isEntityUndead()) {
                final int j = (int) (p_180793_5_ * (double) (6 << p_180793_4_) + 0.5D);
            ...
            final int i = (int) (p_180793_5_ * (double) (4 << p_180793_4_) + 0.5D);
    ...
    public void removeAttributesModifiersFromEntity(final EntityLivingBase entityLivingBaseIn, final BaseAttributeMap p_111187_2_, final int amplifier) {
        for (final Entry<IAttribute, AttributeModifier> entry : this.attributeModifierMap.entrySet()) {
