...
public class ChunkLoader {
    public static ChunkLoader.AnvilConverterData load(final NBTTagCompound nbt) {
        ...
        final ChunkLoader.AnvilConverterData chunkloader$anvilconverterdata = new ChunkLoader.AnvilConverterData(i, j);
    ...
    public static void convertToAnvilFormat(final ChunkLoader.AnvilConverterData p_76690_0_, final NBTTagCompound p_76690_1_, final WorldChunkManager p_76690_2_) {
        ...
        for (int j = 0; j < 8; ++j) {
            ...
            for (int k = 0; k < 16 && flag; ++k) {
                for (int l = 0; l < 16 && flag; ++l) {
                    for (int i1 = 0; i1 < 16; ++i1) {
                        final int j1 = k << 11 | i1 << 7 | l + (j << 4);
                        final int k1 = p_76690_0_.blocks[j1];
            ...
            if (!flag) {
                ...
                final NibbleArray nibblearray1 = new NibbleArray();
                final NibbleArray nibblearray2 = new NibbleArray();

                for (int j3 = 0; j3 < 16; ++j3) {
                    for (int l1 = 0; l1 < 16; ++l1) {
                        for (int i2 = 0; i2 < 16; ++i2) {
                            final int j2 = j3 << 11 | i2 << 7 | l1 + (j << 4);
