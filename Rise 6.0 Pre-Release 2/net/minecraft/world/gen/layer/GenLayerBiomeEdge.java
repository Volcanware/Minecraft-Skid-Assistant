...
public class GenLayerBiomeEdge extends GenLayer {
    ...
    private boolean canBiomesBeNeighbors(final int p_151634_1_, final int p_151634_2_) {
        if (biomesEqualOrMesaPlateau(p_151634_1_, p_151634_2_)) {
            ...
            final BiomeGenBase biomegenbase1 = BiomeGenBase.getBiome(p_151634_2_);
            ...
            if (biomegenbase != null && biomegenbase1 != null) {
                ...
                final BiomeGenBase.TempCategory biomegenbase$tempcategory1 = biomegenbase1.getTempCategory();
