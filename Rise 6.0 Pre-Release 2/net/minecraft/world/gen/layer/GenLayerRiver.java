    ...
    public int[] getInts(final int areaX, final int areaY, final int areaWidth, final int areaHeight) {
        ...
        for (int i1 = 0; i1 < areaHeight; ++i1) {
            for (int j1 = 0; j1 < areaWidth; ++j1) {
                final int k1 = this.func_151630_c(aint[j1 + 0 + (i1 + 1) * k]);
                final int l1 = this.func_151630_c(aint[j1 + 2 + (i1 + 1) * k]);
                final int i2 = this.func_151630_c(aint[j1 + 1 + (i1 + 0) * k]);
                final int j2 = this.func_151630_c(aint[j1 + 1 + (i1 + 2) * k]);
                final int k2 = this.func_151630_c(aint[j1 + 1 + (i1 + 1) * k]);
