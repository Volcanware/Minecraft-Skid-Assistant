...
public class NoiseGeneratorSimplex {
    ...
    public double func_151605_a(final double p_151605_1_, final double p_151605_3_) {
        final double d3 = 0.5D * (field_151614_a - 1.0D);
        ...
        final double d5 = (3.0D - field_151614_a) / 6.0D;
        ...
        final int i1 = i & 255;
        final int j1 = j & 255;
        final int k1 = this.field_151608_f[i1 + this.field_151608_f[j1]] % 12;
        final int l1 = this.field_151608_f[i1 + k + this.field_151608_f[j1 + l]] % 12;
        final int i2 = this.field_151608_f[i1 + 1 + this.field_151608_f[j1 + 1]] % 12;
    ...
    public void func_151606_a(final double[] p_151606_1_, final double p_151606_2_, final double p_151606_4_, final int p_151606_6_, final int p_151606_7_, final double p_151606_8_, final double p_151606_10_, final double p_151606_12_) {
        ...
        for (int j = 0; j < p_151606_7_; ++j) {
            final double d0 = (p_151606_4_ + (double) j) * p_151606_10_ + this.field_151613_c;

            for (int k = 0; k < p_151606_6_; ++k) {
                final double d1 = (p_151606_2_ + (double) k) * p_151606_8_ + this.field_151612_b;
                final double d5 = (d1 + d0) * field_151609_g;
                final int l = func_151607_a(d1 + d5);
                final int i1 = func_151607_a(d0 + d5);
                final double d6 = (double) (l + i1) * field_151615_h;
                ...
                final double d11 = d9 - (double) j1 + field_151615_h;
                final double d12 = d10 - (double) k1 + field_151615_h;
                final double d13 = d9 - 1.0D + 2.0D * field_151615_h;
                final double d14 = d10 - 1.0D + 2.0D * field_151615_h;
                final int l1 = l & 255;
                final int i2 = i1 & 255;
                final int j2 = this.field_151608_f[l1 + this.field_151608_f[i2]] % 12;
                final int k2 = this.field_151608_f[l1 + j1 + this.field_151608_f[i2 + k1]] % 12;
                final int l2 = this.field_151608_f[l1 + 1 + this.field_151608_f[i2 + 1]] % 12;
                double d15 = 0.5D - d9 * d9 - d10 * d10;
                final double d2;
