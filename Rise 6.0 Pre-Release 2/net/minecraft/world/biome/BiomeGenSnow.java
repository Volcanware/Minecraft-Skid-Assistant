...
public class BiomeGenSnow extends BiomeGenBase {
    ...
    public void decorate(final World worldIn, final Random rand, final BlockPos pos) {
        if (this.field_150615_aC) {
            ...
            for (int l = 0; l < 2; ++l) {
                final int i1 = rand.nextInt(16) + 8;
    ...
    protected BiomeGenBase createMutatedBiome(final int p_180277_1_) {
        final BiomeGenBase biomegenbase = (new BiomeGenSnow(p_180277_1_, true)).func_150557_a(13828095, true).setBiomeName(this.biomeName + " Spikes").setEnableSnow().setTemperatureRainfall(0.0F, 0.5F).setHeight(new BiomeGenBase.Height(this.minHeight + 0.1F, this.maxHeight + 0.1F));
