...
public enum EnumFacing implements IStringSerializable {
    ...
    EnumFacing(final int indexIn, final int oppositeIn, final int horizontalIndexIn, final String nameIn, final EnumFacing.AxisDirection axisDirectionIn, final EnumFacing.Axis axisIn, final Vec3i directionVecIn) {
        this.index = indexIn;
    ...
    public static EnumFacing getFacingFromVector(final float p_176737_0_, final float p_176737_1_, final float p_176737_2_) {
        ...
        for (final EnumFacing enumfacing1 : values()) {
            final float f1 = p_176737_0_ * (float) enumfacing1.directionVec.getX() + p_176737_1_ * (float) enumfacing1.directionVec.getY() + p_176737_2_ * (float) enumfacing1.directionVec.getZ();
    ...
    public static EnumFacing func_181076_a(final EnumFacing.AxisDirection p_181076_0_, final EnumFacing.Axis p_181076_1_) {
    ...
    public enum Axis implements Predicate<EnumFacing>, IStringSerializable {
        ...
        Axis(final String name, final EnumFacing.Plane plane) {
            this.name = name;
            this.plane = plane;
        }
        ...
        static {
            for (final EnumFacing.Axis enumfacing$axis : values()) {
