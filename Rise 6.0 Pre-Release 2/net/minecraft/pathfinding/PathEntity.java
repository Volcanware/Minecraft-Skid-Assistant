...
public class PathEntity {
    ...
    public Vec3 getVectorFromIndex(final Entity entityIn, final int index) {
        final double d0 = (double) this.points[index].xCoord + (double) ((int) (entityIn.width + 1.0F)) * 0.5D;
        final double d1 = this.points[index].yCoord;
        final double d2 = (double) this.points[index].zCoord + (double) ((int) (entityIn.width + 1.0F)) * 0.5D;
