...
public class EntityAIFollowGolem extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        if (this.theVillager.getGrowingAge() >= 0) {
            ...
            final List<EntityIronGolem> list = this.theVillager.worldObj.getEntitiesWithinAABB(EntityIronGolem.class, this.theVillager.getEntityBoundingBox().expand(6.0D, 2.0D, 6.0D));
