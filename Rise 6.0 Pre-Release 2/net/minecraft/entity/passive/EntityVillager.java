...
public class EntityVillager extends EntityAgeable implements IMerchant, INpc {
    ...
    private void populateBuyingList() {
        final EntityVillager.ITradeList[][][] aentityvillager$itradelist = DEFAULT_TRADE_LIST_MAP[this.getProfession()];
        ...
        final EntityVillager.ITradeList[][] aentityvillager$itradelist1 = aentityvillager$itradelist[i];

        if (j >= 0 && j < aentityvillager$itradelist1.length) {
            final EntityVillager.ITradeList[] aentityvillager$itradelist2 = aentityvillager$itradelist1[j];

            for (final EntityVillager.ITradeList entityvillager$itradelist : aentityvillager$itradelist2) {
    ...
    static class EmeraldForItems implements EntityVillager.ITradeList {
        ...
        public EmeraldForItems(final Item itemIn, final EntityVillager.PriceInfo priceIn) {
    ...
    static class ItemAndEmeraldToItem implements EntityVillager.ITradeList {
        ...
        public ItemAndEmeraldToItem(final Item p_i45813_1_, final EntityVillager.PriceInfo p_i45813_2_, final Item p_i45813_3_, final EntityVillager.PriceInfo p_i45813_4_) {
    ...
    static class ListItemForEmeralds implements EntityVillager.ITradeList {
        ...
        public ListItemForEmeralds(final Item par1Item, final EntityVillager.PriceInfo priceInfo) {
            this.field_179403_a = new ItemStack(par1Item);
            this.field_179402_b = priceInfo;
        }

        public ListItemForEmeralds(final ItemStack stack, final EntityVillager.PriceInfo priceInfo) {
