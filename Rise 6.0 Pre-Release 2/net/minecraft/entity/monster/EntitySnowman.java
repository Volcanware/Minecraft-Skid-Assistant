...
public class EntitySnowman extends EntityGolem implements IRangedAttackMob {
    ...
    protected void dropFewItems(final boolean p_70628_1_, final int p_70628_2_) {
        final int i = this.rand.nextInt(16);
    ...
    public void attackEntityWithRangedAttack(final EntityLivingBase p_82196_1_, final float p_82196_2_) {
        ...
        final double d1 = p_82196_1_.posX - this.posX;
        final double d2 = d0 - entitysnowball.posY;
        final double d3 = p_82196_1_.posZ - this.posZ;
        final float f = MathHelper.sqrt_double(d1 * d1 + d3 * d3) * 0.2F;
