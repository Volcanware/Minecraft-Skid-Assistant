...
public class Radar extends Module {
    ...
    private final EventListener<Render2DEvent> render2DEvent = e -> {
        ...
        GLUtil.rotate(middleX, middleY, mc.player.rotationYaw, () -> {
            for (EntityLivingBase entity : entities) {
                double xDiff = MathUtils.interpolate(entity.prevPosX, entity.posX, mc.timer.renderPartialTicks) - MathUtils.interpolate(mc.player.prevPosX, mc.player.posX, mc.timer.renderPartialTicks);
                double zDiff = MathUtils.interpolate(entity.prevPosZ, entity.posZ, mc.timer.renderPartialTicks) - MathUtils.interpolate(mc.player.prevPosZ, mc.player.posZ, mc.timer.renderPartialTicks);
    ...
    public void getEntities() {
        ...
        for (Entity entity : mc.world.loadedEntityList) {
            if (entity instanceof EntityLivingBase) {
                if (entity instanceof EntityPlayer && entity != mc.player && !entity.isInvisible()) {
