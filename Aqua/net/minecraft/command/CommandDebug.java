...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args[0].equals((Object)"start")) {
            if (args.length != 1) {
                throw new WrongUsageException("commands.debug.usage", new Object[0]);
            }
            CommandDebug.notifyOperators((ICommandSender)sender, (ICommand)this, (String)"commands.debug.start", (Object[])new Object[0]);
            ...
            CommandDebug.notifyOperators((ICommandSender)sender, (ICommand)this, (String)"commands.debug.stop", (Object[])new Object[]{Float.valueOf((float)((float)k / 1000.0f)), l});
        }
    }
    ...
    private String getProfileResults(long timeSpan, int tickSpan) {
        ...
        stringbuilder.append("// This is approximately ").append(String.format((String)"%.2f", (Object[])new Object[]{Float.valueOf((float)((float)tickSpan / ((float)timeSpan / 1000.0f)))})).append(" ticks per second. It should be ").append(20).append(" ticks per second\n\n");
    ...
    private void func_147202_a(int p_147202_1_, String p_147202_2_, StringBuilder stringBuilder) {
        ...
        if (list != null && list.size() >= 3) {
            for (int i = 1; i < list.size(); ++i) {
                ...
                stringBuilder.append(String.format((String)"[%02d] ", (Object[])new Object[]{p_147202_1_}));
                for (int j = 0; j < p_147202_1_; ++j) {
                    stringBuilder.append(" ");
                }
                stringBuilder.append(profiler$result.field_76331_c).append(" - ").append(String.format((String)"%.2f", (Object[])new Object[]{profiler$result.field_76332_a})).append("%/").append(String.format((String)"%.2f", (Object[])new Object[]{profiler$result.field_76330_b})).append("%\n");
                if (profiler$result.field_76331_c.equals((Object)"unspecified")) continue;
                try {
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return args.length == 1 ? CommandDebug.getListOfStringsMatchingLastWord((String[])args, (String[])new String[]{"start", "stop"}) : null;
    }
}
