...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        try {
            ...
            if (args.length > 0 && "flush".equals((Object)args[0])) {
            ...
            CommandSaveAll.notifyOperators((ICommandSender)sender, (ICommand)this, (String)"commands.save.failed", (Object[])new Object[]{minecraftexception.getMessage()});
            return;
        }
        CommandSaveAll.notifyOperators((ICommandSender)sender, (ICommand)this, (String)"commands.save.success", (Object[])new Object[0]);
    }
}
