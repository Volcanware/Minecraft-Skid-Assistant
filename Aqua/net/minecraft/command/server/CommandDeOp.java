...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        CommandDeOp.notifyOperators((ICommandSender)sender, (ICommand)this, (String)"commands.deop.success", (Object[])new Object[]{args[0]});
    }

    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return args.length == 1 ? CommandDeOp.getListOfStringsMatchingLastWord((String[])args, (String[])MinecraftServer.getServer().getConfigurationManager().getOppedPlayerNames()) : null;
    }
}
