...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length >= 1 && args[0].length() > 0) {
            ...
            String s = null;
            if (args.length >= 2) {
                s = CommandBanPlayer.getChatComponentFromNthArg((ICommandSender)sender, (String[])args, (int)1).getUnformattedText();
            }
        ...
        CommandBanPlayer.notifyOperators((ICommandSender)sender, (ICommand)this, (String)"commands.ban.success", (Object[])new Object[]{args[0]});
    }

    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return args.length >= 1 ? CommandBanPlayer.getListOfStringsMatchingLastWord((String[])args, (String[])MinecraftServer.getServer().getAllUsernames()) : null;
    }
}
