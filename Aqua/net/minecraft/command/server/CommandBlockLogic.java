...
implements ICommandSender {
    ...
    public void writeDataToNBT(NBTTagCompound tagCompound) {
        ...
        if (this.lastOutput != null && this.trackOutput) {
            tagCompound.setString("LastOutput", IChatComponent.Serializer.componentToJson((IChatComponent)this.lastOutput));
        }
    ...
    public void readDataFromNBT(NBTTagCompound nbt) {
        ...
        if (nbt.hasKey("LastOutput", 8) && this.trackOutput) {
            this.lastOutput = IChatComponent.Serializer.jsonToComponent((String)nbt.getString("LastOutput"));
        }
    ...
    public void trigger(World worldIn) {
        ...
        if ((minecraftserver = MinecraftServer.getServer()) != null && minecraftserver.isAnvilFileSet() && minecraftserver.isCommandBlockEnabled()) {
            ...
            try {
                ...
                this.successCount = icommandmanager.executeCommand((ICommandSender)this, this.commandStored);
            }
            catch (Throwable throwable) {
                CrashReport crashreport = CrashReport.makeCrashReport((Throwable)throwable, (String)"Executing command block");
                CrashReportCategory crashreportcategory = crashreport.makeCategory("Command to be executed");
                crashreportcategory.addCrashSectionCallable("Command", (Callable)new /* Unavailable Anonymous Inner Class!! */);
                crashreportcategory.addCrashSectionCallable("Name", (Callable)new /* Unavailable Anonymous Inner Class!! */);
    ...
    public void setCommandStat(CommandResultStats.Type type, int amount) {
        this.resultStats.setCommandStatScore((ICommandSender)this, type, amount);
    }
