...
public final class NBTUtil {
    public static GameProfile readGameProfileFromNBT(NBTTagCompound compound) {
        ...
        if (StringUtils.isNullOrEmpty((String)s) && StringUtils.isNullOrEmpty((String)s1)) {
            return null;
        }
        try {
            uuid = UUID.fromString((String)s1);
        }
    ...
    public static NBTTagCompound writeGameProfile(NBTTagCompound tagCompound, GameProfile profile) {
        ...
        if (!profile.getProperties().isEmpty()) {
            ...
            for (String s : profile.getProperties().keySet()) {
                ...
                nbttagcompound.setTag(s, (NBTBase)nbttaglist);
            }
            tagCompound.setTag("Properties", (NBTBase)nbttagcompound);
        }
        return tagCompound;
    }
    ...
    public static boolean func_181123_a(NBTBase p_181123_0_, NBTBase p_181123_1_, boolean p_181123_2_) {
        ...
        if (!p_181123_0_.getClass().equals((Object)p_181123_1_.getClass())) {
            return false;
        }
        ...
        return p_181123_0_.equals((Object)p_181123_1_);
    }
}
