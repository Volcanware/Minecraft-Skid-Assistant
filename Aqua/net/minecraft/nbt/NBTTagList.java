...
extends NBTBase {
    ...
    void write(DataOutput output) throws IOException {
        ...
        output.writeByte((int)this.tagType);
    ...
    void read(DataInput input, int depth, NBTSizeTracker sizeTracker) throws IOException {
        ...
        for (int j = 0; j < i; ++j) {
            NBTBase nbtbase = NBTBase.createNewByType((byte)this.tagType);
            nbtbase.read(input, depth + 1, sizeTracker);
            this.tagList.add((Object)nbtbase);
        }
    }
    ...
    public void set(int idx, NBTBase nbt) {
        if (nbt.getId() == 0) {
            ...
            this.tagList.set(idx, (Object)nbt);
        } else {
    ...
    public NBTBase copy() {
        ...
        for (NBTBase nbtbase : this.tagList) {
            ...
            nbttaglist.tagList.add((Object)nbtbase1);
        }
        return nbttaglist;
    }
    ...
    public boolean equals(Object p_equals_1_) {
        if (super.equals(p_equals_1_)) {
            NBTTagList nbttaglist = (NBTTagList)((Object)p_equals_1_);
