...
extends Block {
    ...
    public static final PropertyBool FLIP = PropertyBool.create((String)"flip");
    public static final PropertyBool ALT = PropertyBool.create((String)"alt");
    ...
    public static final PropertyInteger UPPER = PropertyInteger.create((String)"upper", (int)0, (int)2);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        ...
        int j = pos.getY();
        int k = pos.getZ();
        if (!World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, (BlockPos)pos.down()) && !Blocks.fire.canCatchFire(worldIn, pos.down())) {
            ...
            return state.withProperty((IProperty)NORTH, (Comparable)Boolean.valueOf((boolean)this.canCatchFire(worldIn, pos.north()))).withProperty((IProperty)EAST, (Comparable)Boolean.valueOf((boolean)this.canCatchFire(worldIn, pos.east()))).withProperty((IProperty)SOUTH, (Comparable)Boolean.valueOf((boolean)this.canCatchFire(worldIn, pos.south()))).withProperty((IProperty)WEST, (Comparable)Boolean.valueOf((boolean)this.canCatchFire(worldIn, pos.west()))).withProperty((IProperty)UPPER, (Comparable)Integer.valueOf((int)l)).withProperty((IProperty)FLIP, (Comparable)Boolean.valueOf((boolean)flag1)).withProperty((IProperty)ALT, (Comparable)Boolean.valueOf((boolean)flag));
        }
    ...
    protected BlockFire() {
        super(Material.fire);
        this.setDefaultState(this.blockState.getBaseState().withProperty((IProperty)AGE, (Comparable)Integer.valueOf((int)0)).withProperty((IProperty)FLIP, (Comparable)Boolean.valueOf((boolean)false)).withProperty((IProperty)ALT, (Comparable)Boolean.valueOf((boolean)false)).withProperty((IProperty)NORTH, (Comparable)Boolean.valueOf((boolean)false)).withProperty((IProperty)EAST, (Comparable)Boolean.valueOf((boolean)false)).withProperty((IProperty)SOUTH, (Comparable)Boolean.valueOf((boolean)false)).withProperty((IProperty)WEST, (Comparable)Boolean.valueOf((boolean)false)).withProperty((IProperty)UPPER, (Comparable)Integer.valueOf((int)0)));
        this.setTickRandomly(true);
    }

    public static void init() {
        Blocks.fire.setFireInfo(Blocks.planks, 5, 20);
        Blocks.fire.setFireInfo((Block)Blocks.double_wooden_slab, 5, 20);
        Blocks.fire.setFireInfo((Block)Blocks.wooden_slab, 5, 20);
        ...
        Blocks.fire.setFireInfo((Block)Blocks.leaves, 30, 60);
        Blocks.fire.setFireInfo((Block)Blocks.leaves2, 30, 60);
        Blocks.fire.setFireInfo(Blocks.bookshelf, 30, 20);
        Blocks.fire.setFireInfo(Blocks.tnt, 15, 100);
        Blocks.fire.setFireInfo((Block)Blocks.tallgrass, 60, 100);
        Blocks.fire.setFireInfo((Block)Blocks.double_plant, 60, 100);
        Blocks.fire.setFireInfo((Block)Blocks.yellow_flower, 60, 100);
        Blocks.fire.setFireInfo((Block)Blocks.red_flower, 60, 100);
        Blocks.fire.setFireInfo((Block)Blocks.deadbush, 60, 100);
    ...
    public void setFireInfo(Block blockIn, int encouragement, int flammability) {
        this.encouragements.put((Object)blockIn, (Object)encouragement);
        this.flammabilities.put((Object)blockIn, (Object)flammability);
    }
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (worldIn.getGameRules().getBoolean("doFireTick")) {
            ...
            if (!flag && worldIn.isRaining() && this.canDie(worldIn, pos)) {
                ...
                if (i < 15) {
                    state = state.withProperty((IProperty)AGE, (Comparable)Integer.valueOf((int)(i + rand.nextInt(3) / 2)));
                    worldIn.setBlockState(pos, state, 4);
                }
                worldIn.scheduleUpdate(pos, (Block)this, this.tickRate(worldIn) + rand.nextInt(10));
                if (!flag) {
                    if (!this.canNeighborCatchFire(worldIn, pos)) {
                        if (!World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, (BlockPos)pos.down()) || i > 3) {
                            worldIn.setBlockToAir(pos);
                        }
                        return;
                    }
                    if (!this.canCatchFire((IBlockAccess)worldIn, pos.down()) && i == 15 && rand.nextInt(4) == 0) {
                        worldIn.setBlockToAir(pos);
                        return;
                    }
                }
                ...
                for (int k = -1; k <= 1; ++k) {
                    for (int l = -1; l <= 1; ++l) {
                        for (int i1 = -1; i1 <= 4; ++i1) {
                            ...
                            worldIn.setBlockState(blockpos, state.withProperty((IProperty)AGE, (Comparable)Integer.valueOf((int)i2)), 3);
                        }
                    }
                }
            }
    ...
    private int getFlammability(Block blockIn) {
        Integer integer = (Integer)this.flammabilities.get((Object)blockIn);
        return integer == null ? 0 : integer;
    }

    private int getEncouragement(Block blockIn) {
        Integer integer = (Integer)this.encouragements.get((Object)blockIn);
        return integer == null ? 0 : integer;
    }
    ...
    private void catchOnFire(World worldIn, BlockPos pos, int chance, Random random, int age) {
        ...
        if (random.nextInt(chance) < i) {
            ...
            if (random.nextInt(age + 10) < 5 && !worldIn.isRainingAt(pos)) {
                ...
                worldIn.setBlockState(pos, this.getDefaultState().withProperty((IProperty)AGE, (Comparable)Integer.valueOf((int)j)), 3);
            } else {
                worldIn.setBlockToAir(pos);
            }
            if (iblockstate.getBlock() == Blocks.tnt) {
                Blocks.tnt.onBlockDestroyedByPlayer(worldIn, pos, iblockstate.withProperty((IProperty)BlockTNT.EXPLODE, (Comparable)Boolean.valueOf((boolean)true)));
            }
        }
    }
    ...
    private boolean canNeighborCatchFire(World worldIn, BlockPos pos) {
        for (EnumFacing enumfacing : EnumFacing.values()) {
            if (!this.canCatchFire((IBlockAccess)worldIn, pos.offset(enumfacing))) continue;
            return true;
        }
        return false;
    }
    ...
    private int getNeighborEncouragement(World worldIn, BlockPos pos) {
        ...
        int i = 0;
        for (EnumFacing enumfacing : EnumFacing.values()) {
            i = Math.max((int)this.getEncouragement(worldIn.getBlockState(pos.offset(enumfacing)).getBlock()), (int)i);
        }
        return i;
    }
    ...
    public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
        return World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, (BlockPos)pos.down()) || this.canNeighborCatchFire(worldIn, pos);
    }

    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock) {
        if (!World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, (BlockPos)pos.down()) && !this.canNeighborCatchFire(worldIn, pos)) {
            worldIn.setBlockToAir(pos);
        }
    }
    ...
    public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
        if (worldIn.provider.getDimensionId() > 0 || !Blocks.portal.func_176548_d(worldIn, pos)) {
            if (!World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, (BlockPos)pos.down()) && !this.canNeighborCatchFire(worldIn, pos)) {
                ...
                worldIn.scheduleUpdate(pos, (Block)this, this.tickRate(worldIn) + worldIn.rand.nextInt(10));
            }
        }
    }
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        block12: {
            block11: {
                ...
                if (World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, (BlockPos)pos.down()) || Blocks.fire.canCatchFire((IBlockAccess)worldIn, pos.down())) break block11;
                ...
                if (!Blocks.fire.canCatchFire((IBlockAccess)worldIn, pos.up())) break block12;
    ...
    protected BlockState createBlockState() {
        return new BlockState((Block)this, new IProperty[]{AGE, NORTH, EAST, SOUTH, WEST, UPPER, FLIP, ALT});
    }
}
