...
extends BlockLiquid {
    ...
    private void updateLiquid(World worldIn, BlockPos pos, IBlockState state) {
        BlockDynamicLiquid blockdynamicliquid = BlockStaticLiquid.getFlowingBlock((Material)this.blockMaterial);
        ...
        worldIn.scheduleUpdate(pos, (Block)blockdynamicliquid, this.tickRate(worldIn));
    }
