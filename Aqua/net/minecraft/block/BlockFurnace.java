...
extends BlockContainer {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        if (tileentity instanceof TileEntityFurnace) {
            playerIn.displayGUIChest((IInventory)((TileEntityFurnace)tileentity));
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (!keepInventory && (tileentity = worldIn.getTileEntity(pos)) instanceof TileEntityFurnace) {
            InventoryHelper.dropInventoryItems((World)worldIn, (BlockPos)pos, (IInventory)((TileEntityFurnace)tileentity));
