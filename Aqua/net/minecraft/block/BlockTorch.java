...
extends Block {
    ...
    protected BlockTorch() {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty((IProperty)FACING, (Comparable)EnumFacing.UP));
    ...
    private boolean canPlaceOn(World worldIn, BlockPos pos) {
        if (World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, (BlockPos)pos)) {
            return true;
        }
    ...
    private boolean canPlaceAt(World worldIn, BlockPos pos, EnumFacing facing) {
        ...
        return flag && worldIn.isBlockNormalCube(blockpos, true) || facing.equals((Object)EnumFacing.UP) && this.canPlaceOn(worldIn, blockpos);
    }
    ...
    protected boolean checkForDrop(World worldIn, BlockPos pos, IBlockState state) {
        if (state.getBlock() == this && this.canPlaceAt(worldIn, pos, (EnumFacing)state.getValue((IProperty)FACING))) {
            return true;
        }
    ...
    public int getMetaFromState(IBlockState state) {
        int i = 0;
        switch (2.$SwitchMap$net$minecraft$util$EnumFacing[((EnumFacing)state.getValue((IProperty)FACING)).ordinal()]) {
            case 1: {
                i |= 1;
                break;
            }
