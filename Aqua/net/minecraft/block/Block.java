...
public class Block {
    ...
    public static final RegistryNamespacedDefaultedByKey<ResourceLocation, Block> blockRegistry = new RegistryNamespacedDefaultedByKey((Object)AIR_ID);
    ...
    public static final SoundType soundTypeGlass = new /* Unavailable Anonymous Inner Class!! */;
    ...
    public static final SoundType soundTypeLadder = new /* Unavailable Anonymous Inner Class!! */;
    public static final SoundType soundTypeAnvil = new /* Unavailable Anonymous Inner Class!! */;
    public static final SoundType SLIME_SOUND = new /* Unavailable Anonymous Inner Class!! */;
    ...
    public static int getIdFromBlock(Block blockIn) {
        return blockRegistry.getIDForObject((Object)blockIn);
    }
    ...
    public static Block getBlockFromName(String name) {
        ...
        if (blockRegistry.containsKey((Object)resourcelocation)) {
            return (Block)blockRegistry.getObject((Object)resourcelocation);
        }
        try {
            return (Block)blockRegistry.getObjectById(Integer.parseInt((String)name));
        }
    ...
    protected void dropXpOnBlockBreak(World worldIn, BlockPos pos, int amount) {
        if (!worldIn.isRemote) {
            while (amount > 0) {
                int i = EntityXPOrb.getXPSplit((int)amount);
                amount -= i;
                worldIn.spawnEntityInWorld((Entity)new EntityXPOrb(worldIn, (double)pos.getX() + 0.5, (double)pos.getY() + 0.5, (double)pos.getZ() + 0.5, i));
            }
        }
    }
    ...
    public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, TileEntity te) {
        ...
        if (this.canSilkHarvest() && EnchantmentHelper.getSilkTouchModifier((EntityLivingBase)player)) {
    ...
    public String getLocalizedName() {
        return StatCollector.translateToLocal((String)(this.getUnlocalizedName() + ".name"));
    }
    ...
    public String toString() {
        return "Block{" + blockRegistry.getNameForObject((Object)this) + "}";
    }
    ...
    public static void registerBlocks() {
        ...
        Block.registerBlock(53, "oak_stairs", new BlockStairs(block1.getDefaultState().withProperty((IProperty)BlockPlanks.VARIANT, (Comparable)BlockPlanks.EnumType.OAK)).setUnlocalizedName("stairsWood"));
        ...
        Block.registerBlock(109, "stone_brick_stairs", new BlockStairs(block8.getDefaultState().withProperty((IProperty)BlockStoneBrick.VARIANT, (Comparable)BlockStoneBrick.EnumType.DEFAULT)).setUnlocalizedName("stairsStoneBrickSmooth"));
        ...
        Block.registerBlock(128, "sandstone_stairs", new BlockStairs(block2.getDefaultState().withProperty((IProperty)BlockSandStone.TYPE, (Comparable)BlockSandStone.EnumType.SMOOTH)).setUnlocalizedName("stairsSandStone"));
        ...
        Block.registerBlock(134, "spruce_stairs", new BlockStairs(block1.getDefaultState().withProperty((IProperty)BlockPlanks.VARIANT, (Comparable)BlockPlanks.EnumType.SPRUCE)).setUnlocalizedName("stairsWoodSpruce"));
        Block.registerBlock(135, "birch_stairs", new BlockStairs(block1.getDefaultState().withProperty((IProperty)BlockPlanks.VARIANT, (Comparable)BlockPlanks.EnumType.BIRCH)).setUnlocalizedName("stairsWoodBirch"));
        Block.registerBlock(136, "jungle_stairs", new BlockStairs(block1.getDefaultState().withProperty((IProperty)BlockPlanks.VARIANT, (Comparable)BlockPlanks.EnumType.JUNGLE)).setUnlocalizedName("stairsWoodJungle"));
        ...
        Block.registerBlock(156, "quartz_stairs", new BlockStairs(block11.getDefaultState().withProperty((IProperty)BlockQuartz.VARIANT, (Comparable)BlockQuartz.EnumType.DEFAULT)).setUnlocalizedName("stairsQuartz"));
        ...
        Block.registerBlock(163, "acacia_stairs", new BlockStairs(block1.getDefaultState().withProperty((IProperty)BlockPlanks.VARIANT, (Comparable)BlockPlanks.EnumType.ACACIA)).setUnlocalizedName("stairsWoodAcacia"));
        Block.registerBlock(164, "dark_oak_stairs", new BlockStairs(block1.getDefaultState().withProperty((IProperty)BlockPlanks.VARIANT, (Comparable)BlockPlanks.EnumType.DARK_OAK)).setUnlocalizedName("stairsWoodDarkOak"));
        ...
        Block.registerBlock(180, "red_sandstone_stairs", new BlockStairs(block12.getDefaultState().withProperty((IProperty)BlockRedSandstone.TYPE, (Comparable)BlockRedSandstone.EnumType.SMOOTH)).setUnlocalizedName("stairsRedSandStone"));
        ...
        for (Block block14 : blockRegistry) {
            for (IBlockState iblockstate : block14.getBlockState().getValidStates()) {
                int i = blockRegistry.getIDForObject((Object)block14) << 4 | block14.getMetaFromState(iblockstate);
                BLOCK_STATE_IDS.put((Object)iblockstate, i);
            }
        }
    }

    private static void registerBlock(int id, ResourceLocation textualID, Block block_) {
        blockRegistry.register(id, (Object)textualID, (Object)block_);
    }
