...
extends BlockContainer {
    ...
    public BlockCommandBlock() {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty((IProperty)TRIGGERED, (Comparable)Boolean.valueOf((boolean)false)));
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty((IProperty)TRIGGERED, (Comparable)Boolean.valueOf(((meta & 1) > 0 ? 1 : 0) != 0));
    }
    ...
    protected BlockState createBlockState() {
        return new BlockState((Block)this, new IProperty[]{TRIGGERED});
    }

    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        return this.getDefaultState().withProperty((IProperty)TRIGGERED, (Comparable)Boolean.valueOf((boolean)false));
    }
}
