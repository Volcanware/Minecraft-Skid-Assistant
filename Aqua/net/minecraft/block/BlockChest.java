...
extends BlockContainer {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        boolean flag3;
        EnumFacing enumfacing = EnumFacing.getHorizontal((int)(MathHelper.floor_double((double)((double)(placer.rotationYaw * 4.0f / 360.0f) + 0.5)) & 3)).getOpposite();
    ...
    public IBlockState checkForSurroundingChests(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (block != this && block1 != this) {
            ...
            if (block2 == this || block3 == this) {
                ...
                EnumFacing enumfacing2 = block2 == this ? (EnumFacing)iblockstate2.getValue((IProperty)FACING) : (EnumFacing)iblockstate3.getValue((IProperty)FACING);
            ...
            EnumFacing enumfacing1 = block == this ? (EnumFacing)iblockstate.getValue((IProperty)FACING) : (EnumFacing)iblockstate1.getValue((IProperty)FACING);
    ...
    public ILockableContainer getLockableContainer(World worldIn, BlockPos pos) {
        ...
        for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
            ...
            if (enumfacing != EnumFacing.WEST && enumfacing != EnumFacing.NORTH) {
                ilockablecontainer = new InventoryLargeChest("container.chestDouble", (ILockableContainer)ilockablecontainer, (ILockableContainer)((TileEntityChest)tileentity1));
                continue;
            }
            ilockablecontainer = new InventoryLargeChest("container.chestDouble", (ILockableContainer)((TileEntityChest)tileentity1), (ILockableContainer)ilockablecontainer);
        }
    ...
    public int getWeakPower(IBlockAccess worldIn, BlockPos pos, IBlockState state, EnumFacing side) {
        ...
        return MathHelper.clamp_int((int)i, (int)0, (int)15);
    }
