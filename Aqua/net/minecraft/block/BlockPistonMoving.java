...
extends BlockContainer {
    ...
    public BlockPistonMoving() {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty((IProperty)FACING, (Comparable)EnumFacing.NORTH).withProperty(TYPE, (Comparable)BlockPistonExtension.EnumPistonType.DEFAULT));
    ...
    public void dropBlockAsItemWithChance(World worldIn, BlockPos pos, IBlockState state, float chance, int fortune) {
        ...
        if (!worldIn.isRemote && (tileentitypiston = this.getTileEntity((IBlockAccess)worldIn, pos)) != null) {
    ...
    public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state) {
        TileEntityPiston tileentitypiston = this.getTileEntity((IBlockAccess)worldIn, pos);
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty((IProperty)FACING, (Comparable)BlockPistonExtension.getFacing((int)meta)).withProperty(TYPE, (Comparable)((meta & 8) > 0 ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT));
    }
