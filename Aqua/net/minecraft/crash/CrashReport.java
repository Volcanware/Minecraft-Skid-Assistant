...
public class CrashReport {
    ...
    private void populateEnvironment() {
        this.theReportCategory.addCrashSectionCallable("Minecraft Version", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        this.theReportCategory.addCrashSectionCallable("Operating System", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        this.theReportCategory.addCrashSectionCallable("Java Version", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        this.theReportCategory.addCrashSectionCallable("Java VM Version", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        this.theReportCategory.addCrashSectionCallable("Memory", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        this.theReportCategory.addCrashSectionCallable("JVM Flags", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        this.theReportCategory.addCrashSectionCallable("IntCache", (Callable)new /* Unavailable Anonymous Inner Class!! */);
