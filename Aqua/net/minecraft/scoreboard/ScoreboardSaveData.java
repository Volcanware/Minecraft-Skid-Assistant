...
extends WorldSavedData {
    ...
    protected void readTeams(NBTTagList p_96498_1_) {
        for (int i = 0; i < p_96498_1_.tagCount(); ++i) {
            ...
            if (nbttagcompound.hasKey("TeamColor", 8)) {
                scoreplayerteam.setChatFormat(EnumChatFormatting.getValueByName((String)nbttagcompound.getString("TeamColor")));
            }
            ...
            if (nbttagcompound.hasKey("NameTagVisibility", 8) && (team$enumvisible = Team.EnumVisible.func_178824_a((String)nbttagcompound.getString("NameTagVisibility"))) != null) {
                scoreplayerteam.setNameTagVisibility(team$enumvisible);
            }
            if (nbttagcompound.hasKey("DeathMessageVisibility", 8) && (team$enumvisible1 = Team.EnumVisible.func_178824_a((String)nbttagcompound.getString("DeathMessageVisibility"))) != null) {
    ...
    protected void readObjectives(NBTTagList nbt) {
        for (int i = 0; i < nbt.tagCount(); ++i) {
            ...
            IScoreObjectiveCriteria iscoreobjectivecriteria = (IScoreObjectiveCriteria)IScoreObjectiveCriteria.INSTANCES.get((Object)nbttagcompound.getString("CriteriaName"));
            ...
            scoreobjective.setRenderType(IScoreObjectiveCriteria.EnumRenderType.func_178795_a((String)nbttagcompound.getString("RenderType")));
        }
    }
    ...
    public void writeToNBT(NBTTagCompound nbt) {
        if (this.theScoreboard == null) {
            ...
            nbt.setTag("Objectives", (NBTBase)this.objectivesToNbt());
            nbt.setTag("PlayerScores", (NBTBase)this.scoresToNbt());
            nbt.setTag("Teams", (NBTBase)this.func_96496_a());
