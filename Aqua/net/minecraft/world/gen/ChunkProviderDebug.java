...
implements IChunkProvider {
    ...
    public static IBlockState func_177461_b(int p_177461_0_, int p_177461_1_) {
        ...
        if (p_177461_0_ > 0 && p_177461_1_ > 0 && p_177461_0_ % 2 != 0 && p_177461_1_ % 2 != 0 && (p_177461_0_ /= 2) <= field_177462_b && (p_177461_1_ /= 2) <= field_181039_c && (i = MathHelper.abs_int((int)(p_177461_0_ * field_177462_b + p_177461_1_))) < field_177464_a.size()) {
    ...
    static {
        for (Block block : Block.blockRegistry) {
            field_177464_a.addAll((Collection)block.getBlockState().getValidStates());
        }
        field_177462_b = MathHelper.ceiling_float_int((float)MathHelper.sqrt_float((float)field_177464_a.size()));
        field_181039_c = MathHelper.ceiling_float_int((float)((float)field_177464_a.size() / (float)field_177462_b));
    }
}
