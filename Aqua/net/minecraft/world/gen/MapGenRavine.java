...
extends MapGenBase {
    ...
    protected void func_180707_a(long p_180707_1_, int p_180707_3_, int p_180707_4_, ChunkPrimer p_180707_5_, double p_180707_6_, double p_180707_8_, double p_180707_10_, float p_180707_12_, float p_180707_13_, float p_180707_14_, int p_180707_15_, int p_180707_16_, double p_180707_17_) {
        ...
        while (p_180707_15_ < p_180707_16_) {
            double d9 = 1.5 + (double)(MathHelper.sin((float)((float)p_180707_15_ * (float)Math.PI / (float)p_180707_16_)) * p_180707_12_ * 1.0f);
            double d2 = d9 * p_180707_17_;
            d9 *= (double)random.nextFloat() * 0.25 + 0.75;
            d2 *= (double)random.nextFloat() * 0.25 + 0.75;
            float f3 = MathHelper.cos((float)p_180707_14_);
            float f4 = MathHelper.sin((float)p_180707_14_);
            p_180707_6_ += (double)(MathHelper.cos((float)p_180707_13_) * f3);
            p_180707_8_ += (double)f4;
            p_180707_10_ += (double)(MathHelper.sin((float)p_180707_13_) * f3);
            p_180707_14_ *= 0.7f;
            ...
            if (flag1 || random.nextInt(4) != 0) {
                ...
                if (p_180707_6_ >= d0 - 16.0 - d9 * 2.0 && p_180707_10_ >= d1 - 16.0 - d9 * 2.0 && p_180707_6_ <= d0 + 16.0 + d9 * 2.0 && p_180707_10_ <= d1 + 16.0 + d9 * 2.0) {
                    int k2 = MathHelper.floor_double((double)(p_180707_6_ - d9)) - p_180707_3_ * 16 - 1;
                    int k = MathHelper.floor_double((double)(p_180707_6_ + d9)) - p_180707_3_ * 16 + 1;
                    int l2 = MathHelper.floor_double((double)(p_180707_8_ - d2)) - 1;
                    int l = MathHelper.floor_double((double)(p_180707_8_ + d2)) + 1;
                    int i3 = MathHelper.floor_double((double)(p_180707_10_ - d9)) - p_180707_4_ * 16 - 1;
                    int i1 = MathHelper.floor_double((double)(p_180707_10_ + d9)) - p_180707_4_ * 16 + 1;
                    if (k2 < 0) {
                        k2 = 0;
                    }
                    if (k > 16) {
