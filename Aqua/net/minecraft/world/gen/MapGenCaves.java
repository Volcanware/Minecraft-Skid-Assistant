...
extends MapGenBase {
    ...
    protected void func_180702_a(long p_180702_1_, int p_180702_3_, int p_180702_4_, ChunkPrimer p_180702_5_, double p_180702_6_, double p_180702_8_, double p_180702_10_, float p_180702_12_, float p_180702_13_, float p_180702_14_, int p_180702_15_, int p_180702_16_, double p_180702_17_) {
        ...
        while (p_180702_15_ < p_180702_16_) {
            double d2 = 1.5 + (double)(MathHelper.sin((float)((float)p_180702_15_ * (float)Math.PI / (float)p_180702_16_)) * p_180702_12_ * 1.0f);
            double d3 = d2 * p_180702_17_;
            float f2 = MathHelper.cos((float)p_180702_14_);
            float f3 = MathHelper.sin((float)p_180702_14_);
            p_180702_6_ += (double)(MathHelper.cos((float)p_180702_13_) * f2);
            p_180702_8_ += (double)f3;
            p_180702_10_ += (double)(MathHelper.sin((float)p_180702_13_) * f2);
            ...
            if (flag2 || random.nextInt(4) != 0) {
                ...
                if (p_180702_6_ >= d0 - 16.0 - d2 * 2.0 && p_180702_10_ >= d1 - 16.0 - d2 * 2.0 && p_180702_6_ <= d0 + 16.0 + d2 * 2.0 && p_180702_10_ <= d1 + 16.0 + d2 * 2.0) {
                    int k2 = MathHelper.floor_double((double)(p_180702_6_ - d2)) - p_180702_3_ * 16 - 1;
                    int k = MathHelper.floor_double((double)(p_180702_6_ + d2)) - p_180702_3_ * 16 + 1;
                    int l2 = MathHelper.floor_double((double)(p_180702_8_ - d3)) - 1;
                    int l = MathHelper.floor_double((double)(p_180702_8_ + d3)) + 1;
                    int i3 = MathHelper.floor_double((double)(p_180702_10_ - d2)) - p_180702_4_ * 16 - 1;
                    int i1 = MathHelper.floor_double((double)(p_180702_10_ + d2)) - p_180702_4_ * 16 + 1;
                    if (k2 < 0) {
                        k2 = 0;
                    }
                    if (k > 16) {
