...
extends GenLayer {
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight) {
        ...
        int[] aint1 = IntCache.getIntCache((int)(areaWidth * areaHeight));
        for (int i = 0; i < areaHeight; ++i) {
            for (int j = 0; j < areaWidth; ++j) {
                this.initChunkSeed(j + areaX, i + areaY);
                int k = aint[j + 1 + (i + 1) * (areaWidth + 2)];
                BiomeGenBase biomegenbase = BiomeGenBase.getBiome((int)k);
                ...
                if (biomegenbase != null && biomegenbase.getBiomeClass() == BiomeGenJungle.class) {
                    ...
                    if (this.func_151631_c(i2) && this.func_151631_c(l2) && this.func_151631_c(k3) && this.func_151631_c(j4)) {
                        if (!(GenLayerShore.isBiomeOceanic((int)i2) || GenLayerShore.isBiomeOceanic((int)l2) || GenLayerShore.isBiomeOceanic((int)k3) || GenLayerShore.isBiomeOceanic((int)j4))) {
                            aint1[j + i * areaWidth] = k;
                            continue;
                        }
                ...
                if (k != BiomeGenBase.extremeHills.biomeID && k != BiomeGenBase.extremeHillsPlus.biomeID && k != BiomeGenBase.extremeHillsEdge.biomeID) {
                    ...
                    if (k != BiomeGenBase.mesa.biomeID && k != BiomeGenBase.mesaPlateau_F.biomeID) {
                        if (k != BiomeGenBase.ocean.biomeID && k != BiomeGenBase.deepOcean.biomeID && k != BiomeGenBase.river.biomeID && k != BiomeGenBase.swampland.biomeID) {
                            ...
                            if (!(GenLayerShore.isBiomeOceanic((int)l1) || GenLayerShore.isBiomeOceanic((int)k2) || GenLayerShore.isBiomeOceanic((int)j3) || GenLayerShore.isBiomeOceanic((int)i4))) {
                                aint1[j + i * areaWidth] = k;
                                continue;
                            }
                            aint1[j + i * areaWidth] = BiomeGenBase.beach.biomeID;
                    ...
                    if (!(GenLayerShore.isBiomeOceanic((int)l) || GenLayerShore.isBiomeOceanic((int)i1) || GenLayerShore.isBiomeOceanic((int)j1) || GenLayerShore.isBiomeOceanic((int)k1))) {
    ...
    private void func_151632_a(int[] p_151632_1_, int[] p_151632_2_, int p_151632_3_, int p_151632_4_, int p_151632_5_, int p_151632_6_, int p_151632_7_) {
        if (GenLayerShore.isBiomeOceanic((int)p_151632_6_)) {
            ...
            p_151632_2_[p_151632_3_ + p_151632_4_ * p_151632_5_] = !GenLayerShore.isBiomeOceanic((int)i) && !GenLayerShore.isBiomeOceanic((int)j) && !GenLayerShore.isBiomeOceanic((int)k) && !GenLayerShore.isBiomeOceanic((int)l) ? p_151632_6_ : p_151632_7_;
        }
    }

    private boolean func_151631_c(int p_151631_1_) {
        return BiomeGenBase.getBiome((int)p_151631_1_) != null && BiomeGenBase.getBiome((int)p_151631_1_).getBiomeClass() == BiomeGenJungle.class ? true : p_151631_1_ == BiomeGenBase.jungleEdge.biomeID || p_151631_1_ == BiomeGenBase.jungle.biomeID || p_151631_1_ == BiomeGenBase.jungleHills.biomeID || p_151631_1_ == BiomeGenBase.forest.biomeID || p_151631_1_ == BiomeGenBase.taiga.biomeID || GenLayerShore.isBiomeOceanic((int)p_151631_1_);
    }

    private boolean func_151633_d(int p_151633_1_) {
        return BiomeGenBase.getBiome((int)p_151633_1_) instanceof BiomeGenMesa;
    }
}
