...
extends GenLayer {
    ...
    public GenLayerBiome(long p_i45560_1_, GenLayer p_i45560_3_, WorldType p_i45560_4_, String p_i45560_5_) {
        ...
        if (p_i45560_4_ == WorldType.DEFAULT_1_1) {
            ...
            this.field_175973_g = p_i45560_4_ == WorldType.CUSTOMIZED ? ChunkProviderSettings.Factory.jsonToFactory((String)p_i45560_5_).func_177864_b() : null;
        }
    }
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight) {
        ...
        for (int i = 0; i < areaHeight; ++i) {
            for (int j = 0; j < areaWidth; ++j) {
                ...
                if (GenLayerBiome.isBiomeOceanic((int)k)) {
