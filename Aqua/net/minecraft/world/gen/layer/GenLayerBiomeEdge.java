...
extends GenLayer {
    ...
    private boolean replaceBiomeEdgeIfNecessary(int[] p_151636_1_, int[] p_151636_2_, int p_151636_3_, int p_151636_4_, int p_151636_5_, int p_151636_6_, int p_151636_7_, int p_151636_8_) {
        if (!GenLayerBiomeEdge.biomesEqualOrMesaPlateau((int)p_151636_6_, (int)p_151636_7_)) {
            return false;
        }
    ...
    private boolean replaceBiomeEdge(int[] p_151635_1_, int[] p_151635_2_, int p_151635_3_, int p_151635_4_, int p_151635_5_, int p_151635_6_, int p_151635_7_, int p_151635_8_) {
        ...
        p_151635_2_[p_151635_3_ + p_151635_4_ * p_151635_5_] = GenLayerBiomeEdge.biomesEqualOrMesaPlateau((int)i, (int)p_151635_7_) && GenLayerBiomeEdge.biomesEqualOrMesaPlateau((int)j, (int)p_151635_7_) && GenLayerBiomeEdge.biomesEqualOrMesaPlateau((int)k, (int)p_151635_7_) && GenLayerBiomeEdge.biomesEqualOrMesaPlateau((int)l, (int)p_151635_7_) ? p_151635_6_ : p_151635_8_;
        return true;
    }

    private boolean canBiomesBeNeighbors(int p_151634_1_, int p_151634_2_) {
        if (GenLayerBiomeEdge.biomesEqualOrMesaPlateau((int)p_151634_1_, (int)p_151634_2_)) {
            return true;
        }
        BiomeGenBase biomegenbase = BiomeGenBase.getBiome((int)p_151634_1_);
        BiomeGenBase biomegenbase1 = BiomeGenBase.getBiome((int)p_151634_2_);
