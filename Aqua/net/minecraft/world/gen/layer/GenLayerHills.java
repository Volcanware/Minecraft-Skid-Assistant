        ...
        for (int i = 0; i < areaHeight; ++i) {
            for (int j = 0; j < areaWidth; ++j) {
                ...
                if (k != 0 && l >= 2 && (l - 2) % 29 == 1 && k < 128) {
                    if (BiomeGenBase.getBiome((int)(k + 128)) != null) {
                ...
                } else if (GenLayerHills.biomesEqualOrMesaPlateau((int)k, (int)BiomeGenBase.mesaPlateau_F.biomeID)) {
                ...
                if (flag && i1 != k) {
                    i1 = BiomeGenBase.getBiome((int)(i1 + 128)) != null ? (i1 += 128) : k;
                }
                if (i1 == k) {
                    aint2[j + i * areaWidth] = k;
                    continue;
                ...
                int j2 = 0;
                if (GenLayerHills.biomesEqualOrMesaPlateau((int)k2, (int)k)) {
                    ++j2;
                }
                if (GenLayerHills.biomesEqualOrMesaPlateau((int)k1, (int)k)) {
                    ++j2;
                }
                if (GenLayerHills.biomesEqualOrMesaPlateau((int)l1, (int)k)) {
                    ++j2;
                }
                if (GenLayerHills.biomesEqualOrMesaPlateau((int)i2, (int)k)) {
                    ++j2;
                }
