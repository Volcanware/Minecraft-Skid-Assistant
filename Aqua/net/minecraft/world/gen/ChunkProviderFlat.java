...
implements IChunkProvider {
    ...
    public ChunkProviderFlat(World worldIn, long seed, boolean generateStructures, String flatGeneratorSettings) {
        ...
        this.flatWorldGenInfo = FlatGeneratorInfo.createFlatGeneratorFromString((String)flatGeneratorSettings);
        if (generateStructures) {
            Map map = this.flatWorldGenInfo.getWorldFeatures();
            if (map.containsKey((Object)"village")) {
                Map map1 = (Map)map.get((Object)"village");
                if (!map1.containsKey((Object)"size")) {
                    map1.put((Object)"size", (Object)"1");
                }
                this.structureGenerators.add((Object)new MapGenVillage(map1));
            }
            if (map.containsKey((Object)"biome_1")) {
                this.structureGenerators.add((Object)new MapGenScatteredFeature((Map)map.get((Object)"biome_1")));
            }
            if (map.containsKey((Object)"mineshaft")) {
                this.structureGenerators.add((Object)new MapGenMineshaft((Map)map.get((Object)"mineshaft")));
            }
            if (map.containsKey((Object)"stronghold")) {
                this.structureGenerators.add((Object)new MapGenStronghold((Map)map.get((Object)"stronghold")));
            }
            if (map.containsKey((Object)"oceanmonument")) {
                this.structureGenerators.add((Object)new StructureOceanMonument((Map)map.get((Object)"oceanmonument")));
            }
        }
        if (this.flatWorldGenInfo.getWorldFeatures().containsKey((Object)"lake")) {
            this.waterLakeGenerator = new WorldGenLakes((Block)Blocks.water);
        }
        if (this.flatWorldGenInfo.getWorldFeatures().containsKey((Object)"lava_lake")) {
            this.lavaLakeGenerator = new WorldGenLakes((Block)Blocks.lava);
        }
        this.hasDungeons = this.flatWorldGenInfo.getWorldFeatures().containsKey((Object)"dungeon");
        int j = 0;
        int k = 0;
        boolean flag = true;
        ...
        this.hasDecoration = flag ? false : this.flatWorldGenInfo.getWorldFeatures().containsKey((Object)"decoration");
    }
    ...
    public Chunk provideChunk(int x, int z) {
        ...
        for (MapGenBase mapgenbase : this.structureGenerators) {
            mapgenbase.generate((IChunkProvider)this, this.worldObj, x, z, chunkprimer);
        }
    ...
    public BlockPos getStrongholdGen(World worldIn, String structureName, BlockPos position) {
        if ("Stronghold".equals((Object)structureName)) {
            for (MapGenStructure mapgenstructure : this.structureGenerators) {
    ...
    public void recreateStructures(Chunk chunkIn, int x, int z) {
        for (MapGenStructure mapgenstructure : this.structureGenerators) {
            mapgenstructure.generate((IChunkProvider)this, this.worldObj, x, z, (ChunkPrimer)null);
        }
    }
