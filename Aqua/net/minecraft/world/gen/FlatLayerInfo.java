...
public class FlatLayerInfo {
    ...
    public String toString() {
        ...
        if (this.field_175902_a >= 3) {
            ResourceLocation resourcelocation = (ResourceLocation)Block.blockRegistry.getNameForObject((Object)this.getLayerMaterialBlock());
            String string = s = resourcelocation == null ? "null" : resourcelocation.toString();
            if (this.layerCount > 1) {
                s = this.layerCount + "*" + s;
            }
        } else {
            s = Integer.toString((int)Block.getIdFromBlock((Block)this.getLayerMaterialBlock()));
            if (this.layerCount > 1) {
