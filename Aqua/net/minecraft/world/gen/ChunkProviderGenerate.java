...
implements IChunkProvider {
    ...
    public ChunkProviderGenerate(World worldIn, long seed, boolean generateStructures, String structuresJson) {
        ...
        for (int i = -2; i <= 2; ++i) {
            for (int j = -2; j <= 2; ++j) {
                float f;
                this.parabolicField[i + 2 + (j + 2) * 5] = f = 10.0f / MathHelper.sqrt_float((float)((float)(i * i + j * j) + 0.2f));
            }
        }
        if (structuresJson != null) {
            this.settings = ChunkProviderSettings.Factory.jsonToFactory((String)structuresJson).func_177864_b();
    ...
    public Chunk provideChunk(int x, int z) {
        ...
        if (this.settings.useCaves) {
            this.caveGenerator.generate((IChunkProvider)this, this.worldObj, x, z, chunkprimer);
        }
        if (this.settings.useRavines) {
            this.ravineGenerator.generate((IChunkProvider)this, this.worldObj, x, z, chunkprimer);
        }
        if (this.settings.useMineShafts && this.mapFeaturesEnabled) {
            this.mineshaftGenerator.generate((IChunkProvider)this, this.worldObj, x, z, chunkprimer);
        }
        if (this.settings.useVillages && this.mapFeaturesEnabled) {
            this.villageGenerator.generate((IChunkProvider)this, this.worldObj, x, z, chunkprimer);
        }
        if (this.settings.useStrongholds && this.mapFeaturesEnabled) {
            this.strongholdGenerator.generate((IChunkProvider)this, this.worldObj, x, z, chunkprimer);
        }
        if (this.settings.useTemples && this.mapFeaturesEnabled) {
            this.scatteredFeatureGenerator.generate((IChunkProvider)this, this.worldObj, x, z, chunkprimer);
        }
        if (this.settings.useMonuments && this.mapFeaturesEnabled) {
            this.oceanMonumentGenerator.generate((IChunkProvider)this, this.worldObj, x, z, chunkprimer);
        }
        ...
        for (int k = 0; k < 5; ++k) {
            for (int l = 0; l < 5; ++l) {
                ...
                for (int l1 = 0; l1 < 33; ++l1) {
                    ...
                    double d5 = MathHelper.denormalizeClamp((double)d2, (double)d3, (double)d4) - d1;
                    if (l1 > 29) {
    ...
    public void populate(IChunkProvider chunkProvider, int x, int z) {
        ...
        SpawnerAnimals.performWorldGenSpawning((World)this.worldObj, (BiomeGenBase)biomegenbase, (int)(i + 8), (int)(j + 8), (int)16, (int)16, (Random)this.rand);
    ...
    public BlockPos getStrongholdGen(World worldIn, String structureName, BlockPos position) {
        return "Stronghold".equals((Object)structureName) && this.strongholdGenerator != null ? this.strongholdGenerator.getClosestStrongholdPos(worldIn, position) : null;
    }
    ...
    public void recreateStructures(Chunk chunkIn, int x, int z) {
        if (this.settings.useMineShafts && this.mapFeaturesEnabled) {
            this.mineshaftGenerator.generate((IChunkProvider)this, this.worldObj, x, z, (ChunkPrimer)null);
        }
        if (this.settings.useVillages && this.mapFeaturesEnabled) {
            this.villageGenerator.generate((IChunkProvider)this, this.worldObj, x, z, (ChunkPrimer)null);
        }
        if (this.settings.useStrongholds && this.mapFeaturesEnabled) {
            this.strongholdGenerator.generate((IChunkProvider)this, this.worldObj, x, z, (ChunkPrimer)null);
        }
        if (this.settings.useTemples && this.mapFeaturesEnabled) {
            this.scatteredFeatureGenerator.generate((IChunkProvider)this, this.worldObj, x, z, (ChunkPrimer)null);
        }
        if (this.settings.useMonuments && this.mapFeaturesEnabled) {
            this.oceanMonumentGenerator.generate((IChunkProvider)this, this.worldObj, x, z, (ChunkPrimer)null);
        }
    }
