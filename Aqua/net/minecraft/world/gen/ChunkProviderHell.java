...
implements IChunkProvider {
    ...
    private final WorldGenerator field_177467_w = new WorldGenMinable(Blocks.quartz_ore.getDefaultState(), 14, (Predicate)BlockHelper.forBlock((Block)Blocks.netherrack));
    ...
    public Chunk provideChunk(int x, int z) {
        ...
        this.netherCaveGenerator.generate((IChunkProvider)this, this.worldObj, x, z, chunkprimer);
        if (this.field_177466_i) {
            this.genNetherBridge.generate((IChunkProvider)this, this.worldObj, x, z, chunkprimer);
        }
    ...
    private double[] initializeNoiseField(double[] p_73164_1_, int p_73164_2_, int p_73164_3_, int p_73164_4_, int p_73164_5_, int p_73164_6_, int p_73164_7_) {
        ...
        for (int j = 0; j < p_73164_6_; ++j) {
            adouble[j] = Math.cos((double)((double)j * Math.PI * 6.0 / (double)p_73164_6_)) * 2.0;
            double d2 = j;
            if (j > p_73164_6_ / 2) {
                d2 = p_73164_6_ - 1 - j;
            }
            ...
            for (int i1 = 0; i1 < p_73164_7_; ++i1) {
                ...
                for (int k = 0; k < p_73164_6_; ++k) {
                    ...
                    if ((double)k < d3) {
                        ...
                        d10 = MathHelper.clamp_double((double)d10, (double)0.0, (double)1.0);
    ...
    public void recreateStructures(Chunk chunkIn, int x, int z) {
        this.genNetherBridge.generate((IChunkProvider)this, this.worldObj, x, z, (ChunkPrimer)null);
    }
