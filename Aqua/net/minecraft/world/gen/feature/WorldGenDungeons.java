        ...
        if (j2 >= 1 && j2 <= 5) {
            ...
            block6: for (int l3 = 0; l3 < 2; ++l3) {
                for (int j4 = 0; j4 < 3; ++j4) {
                    ...
                    List list = WeightedRandomChestContent.func_177629_a(CHESTCONTENT, (WeightedRandomChestContent[])new WeightedRandomChestContent[]{Items.enchanted_book.getRandom(rand)});
                    TileEntity tileentity1 = worldIn.getTileEntity(blockpos2);
                    if (!(tileentity1 instanceof TileEntityChest)) continue block6;
                    WeightedRandomChestContent.generateChestContents((Random)rand, (List)list, (IInventory)((TileEntityChest)tileentity1), (int)8);
                    continue block6;
                }
            }
