...
extends WorldGenAbstractTree {
    ...
    private static final IBlockState field_181641_b = Blocks.leaves2.getDefaultState().withProperty((IProperty)BlockNewLeaf.VARIANT, (Comparable)BlockPlanks.EnumType.DARK_OAK).withProperty((IProperty)BlockLeaves.CHECK_DECAY, (Comparable)Boolean.valueOf((boolean)false));
        ...
        if (k >= 1 && k + i + 1 < 256) {
            ...
            for (int j3 = -3; j3 <= 4; ++j3) {
                for (int i4 = -3; i4 <= 4; ++i4) {
                    if (j3 == -3 && i4 == -3 || j3 == -3 && i4 == 4 || j3 == 4 && i4 == -3 || j3 == 4 && i4 == 4 || Math.abs((int)j3) >= 3 && Math.abs((int)i4) >= 3) continue;
                ...
                for (int j4 = -1; j4 <= 2; ++j4) {
                    ...
                    for (int k5 = -2; k5 <= 2; ++k5) {
                        for (int l5 = -2; l5 <= 2; ++l5) {
                            if (Math.abs((int)k5) == 2 && Math.abs((int)l5) == 2) continue;
        ...
        for (int l = 0; l <= p_181638_3_ + 1; ++l) {
            ...
            for (int j1 = -i1; j1 <= i1; ++j1) {
                for (int k1 = -i1; k1 <= i1; ++k1) {
                    if (this.func_150523_a(p_181638_1_.getBlockState((BlockPos)blockpos$mutableblockpos.set(i + j1, j + l, k + k1)).getBlock())) continue;
                    return false;
                }
            }
        }
