...
extends WorldGenAbstractTree {
    ...
    private static final IBlockState field_181644_b = Blocks.leaves2.getDefaultState().withProperty((IProperty)BlockNewLeaf.VARIANT, (Comparable)BlockPlanks.EnumType.ACACIA).withProperty((IProperty)BlockLeaves.CHECK_DECAY, (Comparable)Boolean.valueOf((boolean)false));
            ...
            if ((block == Blocks.grass || block == Blocks.dirt) && position.getY() < 256 - i - 1) {
                ...
                for (int j3 = -3; j3 <= 3; ++j3) {
                    for (int i4 = -3; i4 <= 3; ++i4) {
                        if (Math.abs((int)j3) == 3 && Math.abs((int)i4) == 3) continue;
                    ...
                    if (k1 > 0) {
                        ...
                        for (int i5 = -2; i5 <= 2; ++i5) {
                            for (int k5 = -2; k5 <= 2; ++k5) {
                                if (Math.abs((int)i5) == 2 && Math.abs((int)k5) == 2) continue;
