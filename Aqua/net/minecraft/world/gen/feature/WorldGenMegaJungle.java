...
extends WorldGenHugeTrees {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        for (int j = position.getY() + i - 2 - rand.nextInt(4); j > position.getY() + i / 2; j -= 2 + rand.nextInt(4)) {
            ...
            int k = position.getX() + (int)(0.5f + MathHelper.cos((float)f) * 4.0f);
            int l = position.getZ() + (int)(0.5f + MathHelper.sin((float)f) * 4.0f);
            for (int i1 = 0; i1 < 5; ++i1) {
                k = position.getX() + (int)(1.5f + MathHelper.cos((float)f) * (float)i1);
                l = position.getZ() + (int)(1.5f + MathHelper.sin((float)f) * (float)i1);
    ...
    private void func_181632_a(World p_181632_1_, Random p_181632_2_, BlockPos p_181632_3_, PropertyBool p_181632_4_) {
        if (p_181632_2_.nextInt(3) > 0 && p_181632_1_.isAirBlock(p_181632_3_)) {
            this.setBlockAndNotifyAdequately(p_181632_1_, p_181632_3_, Blocks.vine.getDefaultState().withProperty((IProperty)p_181632_4_, (Comparable)Boolean.valueOf((boolean)true)));
        }
    }
