...
extends BiomeGenBase {
    ...
    public BiomeGenForest(int id, int p_i45377_2_) {
        ...
        if (this.field_150632_aF == 0) {
            this.spawnableCreatureList.add((Object)new BiomeGenBase.SpawnListEntry(EntityWolf.class, 5, 4, 4));
        }
    ...
    public BlockFlower.EnumFlowerType pickRandomFlower(Random rand, BlockPos pos) {
        if (this.field_150632_aF == 1) {
            double d0 = MathHelper.clamp_double((double)((1.0 + GRASS_COLOR_NOISE.func_151601_a((double)pos.getX() / 48.0, (double)pos.getZ() / 48.0)) / 2.0), (double)0.0, (double)0.9999);
    ...
    protected BiomeGenBase createMutatedBiome(int p_180277_1_) {
        ...
        return this.biomeID != BiomeGenBase.birchForest.biomeID && this.biomeID != BiomeGenBase.birchForestHills.biomeID ? new /* Unavailable Anonymous Inner Class!! */ : new /* Unavailable Anonymous Inner Class!! */;
    }
}
