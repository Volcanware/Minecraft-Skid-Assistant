...
extends WorldChunkManager {
    ...
    public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] biomes, int x, int z, int width, int height) {
        ...
        Arrays.fill((Object[])biomes, (int)0, (int)(width * height), (Object)this.biomeGenerator);
        return biomes;
    }
    ...
    public float[] getRainfall(float[] listToReuse, int x, int z, int width, int length) {
        ...
        Arrays.fill((float[])listToReuse, (int)0, (int)(width * length), (float)this.rainfall);
        return listToReuse;
    }
    ...
    public BiomeGenBase[] loadBlockGeneratorData(BiomeGenBase[] oldBiomeList, int x, int z, int width, int depth) {
        ...
        Arrays.fill((Object[])oldBiomeList, (int)0, (int)(width * depth), (Object)this.biomeGenerator);
        return oldBiomeList;
    }
    ...
    public BlockPos findBiomePosition(int x, int z, int range, List<BiomeGenBase> biomes, Random random) {
        return biomes.contains((Object)this.biomeGenerator) ? new BlockPos(x - range + random.nextInt(range * 2 + 1), 0, z - range + random.nextInt(range * 2 + 1)) : null;
    }

    public boolean areBiomesViable(int p_76940_1_, int p_76940_2_, int p_76940_3_, List<BiomeGenBase> p_76940_4_) {
        return p_76940_4_.contains((Object)this.biomeGenerator);
    }
}
