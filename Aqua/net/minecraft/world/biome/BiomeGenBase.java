...
public abstract class BiomeGenBase {
    ...
    protected BiomeGenBase(int id) {
        ...
        this.spawnableCreatureList.add((Object)new SpawnListEntry(EntitySheep.class, 12, 4, 4));
        this.spawnableCreatureList.add((Object)new SpawnListEntry(EntityRabbit.class, 10, 3, 3));
        this.spawnableCreatureList.add((Object)new SpawnListEntry(EntityPig.class, 10, 4, 4));
        this.spawnableCreatureList.add((Object)new SpawnListEntry(EntityChicken.class, 10, 4, 4));
        this.spawnableCreatureList.add((Object)new SpawnListEntry(EntityCow.class, 8, 4, 4));
        this.spawnableMonsterList.add((Object)new SpawnListEntry(EntitySpider.class, 100, 4, 4));
        this.spawnableMonsterList.add((Object)new SpawnListEntry(EntityZombie.class, 100, 4, 4));
        this.spawnableMonsterList.add((Object)new SpawnListEntry(EntitySkeleton.class, 100, 4, 4));
        this.spawnableMonsterList.add((Object)new SpawnListEntry(EntityCreeper.class, 100, 4, 4));
        this.spawnableMonsterList.add((Object)new SpawnListEntry(EntitySlime.class, 100, 4, 4));
        this.spawnableMonsterList.add((Object)new SpawnListEntry(EntityEnderman.class, 10, 1, 4));
        this.spawnableMonsterList.add((Object)new SpawnListEntry(EntityWitch.class, 5, 1, 1));
        this.spawnableWaterCreatureList.add((Object)new SpawnListEntry(EntitySquid.class, 10, 4, 4));
        this.spawnableCaveCreatureList.add((Object)new SpawnListEntry(EntityBat.class, 10, 8, 8));
    }
    ...
    public int getSkyColorByTemp(float p_76731_1_) {
        p_76731_1_ /= 3.0f;
        p_76731_1_ = MathHelper.clamp_float((float)p_76731_1_, (float)-1.0f, (float)1.0f);
        return MathHelper.func_181758_c((float)(0.62222224f - p_76731_1_ * 0.05f), (float)(0.5f + p_76731_1_ * 0.1f), (float)1.0f);
    }
    ...
    public int getGrassColorAtPos(BlockPos pos) {
        double d0 = MathHelper.clamp_float((float)this.getFloatTemperature(pos), (float)0.0f, (float)1.0f);
        ...
        for (int j1 = 255; j1 >= 0; --j1) {
            ...
            if (j == -1) {
                ...
                if (j1 < i && (iblockstate == null || iblockstate.getBlock().getMaterial() == Material.air)) {
                    iblockstate = this.getFloatTemperature((BlockPos)blockpos$mutableblockpos.set(p_180628_4_, j1, p_180628_5_)) < 0.15f ? Blocks.ice.getDefaultState() : Blocks.water.getDefaultState();
                }
                j = k;
                if (j1 >= i - 1) {
            ...
            j = rand.nextInt(4) + Math.max((int)0, (int)(j1 - 63));
    ...
    static {
        ...
        for (BiomeGenBase biomegenbase : biomeList) {
            ...
            if (BIOME_ID_MAP.containsKey((Object)biomegenbase.biomeName)) {
                throw new Error("Biome \"" + biomegenbase.biomeName + "\" is defined as both ID " + ((BiomeGenBase)BiomeGenBase.BIOME_ID_MAP.get((Object)biomegenbase.biomeName)).biomeID + " and " + biomegenbase.biomeID);
            }
            BIOME_ID_MAP.put((Object)biomegenbase.biomeName, (Object)biomegenbase);
            if (biomegenbase.biomeID >= 128) continue;
            explorationBiomesList.add((Object)biomegenbase);
        }
        explorationBiomesList.remove((Object)hell);
        explorationBiomesList.remove((Object)sky);
        explorationBiomesList.remove((Object)frozenOcean);
        explorationBiomesList.remove((Object)extremeHillsEdge);
