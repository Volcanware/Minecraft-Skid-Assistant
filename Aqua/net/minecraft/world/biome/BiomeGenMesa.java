...
extends BiomeGenBase {
    ...
    public void genTerrainBlocks(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z, double noiseVal) {
        ...
        if (this.field_150626_aH) {
            ...
            double d0 = Math.min((double)Math.abs((double)noiseVal), (double)this.field_150623_aE.func_151601_a((double)i * 0.25, (double)j * 0.25));
            if (d0 > 0.0) {
                d4 = d0 * d0 * 2.5;
                double d1 = 0.001953125;
                double d2 = Math.abs((double)this.field_150624_aF.func_151601_a((double)i * d1, (double)j * d1));
                double d3 = Math.ceil((double)(d2 * 50.0)) + 14.0;
                if (d4 > d3) {
                    d4 = d3;
                }
                d4 += 64.0;
        ...
        boolean flag = Math.cos((double)(noiseVal / 3.0 * Math.PI)) > 0.0;
        int l = -1;
        boolean flag1 = false;
        for (int i1 = 255; i1 >= 0; --i1) {
            ...
            if (l == -1) {
                ...
                IBlockState iblockstate4 = i1 >= 64 && i1 <= 127 ? (flag ? Blocks.hardened_clay.getDefaultState() : this.func_180629_a(x, i1, z)) : Blocks.stained_hardened_clay.getDefaultState().withProperty((IProperty)BlockColored.COLOR, (Comparable)EnumDyeColor.ORANGE);
    ...
    private void func_150619_a(long p_150619_1_) {
        ...
        Arrays.fill((Object[])this.field_150621_aC, (Object)Blocks.hardened_clay.getDefaultState());
    ...
    private IBlockState func_180629_a(int p_180629_1_, int p_180629_2_, int p_180629_3_) {
        int i = (int)Math.round((double)(this.field_150625_aG.func_151601_a((double)p_180629_1_ * 1.0 / 512.0, (double)p_180629_1_ * 1.0 / 512.0) * 2.0));
