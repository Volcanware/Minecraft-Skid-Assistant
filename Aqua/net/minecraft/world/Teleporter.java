...
public class Teleporter {
    ...
    public void placeInPortal(Entity entityIn, float rotationYaw) {
        if (this.worldServerInstance.provider.getDimensionId() != 1) {
            ...
            int j = MathHelper.floor_double((double)entityIn.posY) - 1;
    ...
    public boolean placeInExistingPortal(Entity entityIn, float rotationYaw) {
        int i = 128;
        double d0 = -1.0;
        int j = MathHelper.floor_double((double)entityIn.posX);
        int k = MathHelper.floor_double((double)entityIn.posZ);
        boolean flag = true;
        BlockPos blockpos = BlockPos.ORIGIN;
        long l = ChunkCoordIntPair.chunkXZ2Int((int)j, (int)k);
        ...
        if (d0 >= 0.0) {
            if (flag) {
                this.destinationCoordinateCache.add(l, (Object)new PortalPosition(this, blockpos, this.worldServerInstance.getTotalWorldTime()));
                this.destinationCoordinateKeys.add((Object)l);
            }
            double d5 = (double)blockpos.getX() + 0.5;
            double d6 = (double)blockpos.getY() + 0.5;
            double d7 = (double)blockpos.getZ() + 0.5;
            BlockPattern.PatternHelper blockpattern$patternhelper = Blocks.portal.func_181089_f((World)this.worldServerInstance, blockpos);
    ...
    public boolean makePortal(Entity entityIn) {
        ...
        double d0 = -1.0;
        int j = MathHelper.floor_double((double)entityIn.posX);
        int k = MathHelper.floor_double((double)entityIn.posY);
        int l = MathHelper.floor_double((double)entityIn.posZ);
        int i1 = j;
        int j1 = k;
        int k1 = l;
        int l1 = 0;
        ...
        for (int j2 = j - i; j2 <= j + i; ++j2) {
            ...
            for (int l2 = l - i; l2 <= l + i; ++l2) {
                ...
                block2: for (int j3 = this.worldServerInstance.getActualHeight() - 1; j3 >= 0; --j3) {
                    if (!this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.set(j2, j3, l2))) continue;
                    while (j3 > 0 && this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.set(j2, j3 - 1, l2))) {
                        --j3;
                    }
                        ...
                        for (int j4 = 0; j4 < 3; ++j4) {
                            for (int k4 = 0; k4 < 4; ++k4) {
                                for (int l4 = -1; l4 < 4; ++l4) {
                                    ...
                                    if (l4 < 0 && !this.worldServerInstance.getBlockState((BlockPos)blockpos$mutableblockpos).getBlock().getMaterial().isSolid() || l4 >= 0 && !this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos)) continue block2;
                                }
                            }
                        }
            ...
            for (int l5 = j - i; l5 <= j + i; ++l5) {
                ...
                for (int j6 = l - i; j6 <= l + i; ++j6) {
                    ...
                    block10: for (int i7 = this.worldServerInstance.getActualHeight() - 1; i7 >= 0; --i7) {
                        if (!this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.set(l5, i7, j6))) continue;
                        while (i7 > 0 && this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.set(l5, i7 - 1, j6))) {
                            --i7;
                        }
                        for (int k7 = i2; k7 < i2 + 2; ++k7) {
                            ...
                            for (int j10 = 0; j10 < 4; ++j10) {
                                for (int j11 = -1; j11 < 4; ++j11) {
                                    ...
                                    if (j11 < 0 && !this.worldServerInstance.getBlockState((BlockPos)blockpos$mutableblockpos).getBlock().getMaterial().isSolid() || j11 >= 0 && !this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos)) continue block10;
                                }
                            }
        ...
        if (d0 < 0.0) {
            k2 = j1 = MathHelper.clamp_int((int)j1, (int)70, (int)(this.worldServerInstance.getActualHeight() - 10));
        ...
        IBlockState iblockstate = Blocks.portal.getDefaultState().withProperty((IProperty)BlockPortal.AXIS, (Comparable)(l6 != 0 ? EnumFacing.Axis.X : EnumFacing.Axis.Z));
