...
public class Chunk {
    ...
    public Chunk(World worldIn, int x, int z) {
        ...
        Arrays.fill((byte[])this.blockBiomeArray, (byte)-1);
    }
            ...
            for (int i = 0; i < 16; ++i) {
                for (int j = 0; j < 16; ++j) {
                    ...
                    for (Object enumfacing : EnumFacing.Plane.HORIZONTAL) {
                        j1 = Math.min((int)j1, (int)this.worldObj.getChunksLowestHorizon(l + ((EnumFacing)enumfacing).getFrontOffsetX(), i1 + ((EnumFacing)enumfacing).getFrontOffsetZ()));
                    }
    ...
    private Block getBlock0(int x, int y, int z) {
        ...
        if (y >= 0 && y >> 4 < this.storageArrays.length && (extendedblockstorage = this.storageArrays[y >> 4]) != null) {
            try {
                ...
                CrashReport crashreport = CrashReport.makeCrashReport((Throwable)throwable, (String)"Getting block");
    ...
    public IBlockState getBlockState(BlockPos pos) {
        if (this.worldObj.getWorldType() == WorldType.DEBUG_WORLD) {
            ...
            if (pos.getY() == 70) {
                iblockstate = ChunkProviderDebug.func_177461_b((int)pos.getX(), (int)pos.getZ());
            }
        ...
        try {
            ...
            CrashReport crashreport = CrashReport.makeCrashReport((Throwable)throwable, (String)"Getting block state");
    ...
    public void addEntity(Entity entityIn) {
        ...
        if ((k = MathHelper.floor_double((double)(entityIn.posY / 16.0))) < 0) {
            k = 0;
        }
        ...
        this.entityLists[k].add((Object)entityIn);
    }
    ...
    public void removeEntityAtIndex(Entity entityIn, int p_76608_2_) {
        ...
        this.entityLists[p_76608_2_].remove((Object)entityIn);
    }
    ...
    public TileEntity getTileEntity(BlockPos pos, EnumCreateEntityType p_177424_2_) {
        TileEntity tileentity = (TileEntity)this.chunkTileEntityMap.get((Object)pos);
        if (tileentity == null) {
            if (p_177424_2_ == EnumCreateEntityType.IMMEDIATE) {
                ...
                this.tileEntityPosQueue.add((Object)pos);
            }
        } else if (tileentity.isInvalid()) {
            this.chunkTileEntityMap.remove((Object)pos);
            return null;
        }
        return tileentity;
    }
    ...
    public void addTileEntity(BlockPos pos, TileEntity tileEntityIn) {
        ...
        if (this.getBlock(pos) instanceof ITileEntityProvider) {
            if (this.chunkTileEntityMap.containsKey((Object)pos)) {
                ((TileEntity)this.chunkTileEntityMap.get((Object)pos)).invalidate();
            }
            tileEntityIn.validate();
            this.chunkTileEntityMap.put((Object)pos, (Object)tileEntityIn);
        }
    }

    public void removeTileEntity(BlockPos pos) {
        TileEntity tileentity;
        if (this.isChunkLoaded && (tileentity = (TileEntity)this.chunkTileEntityMap.remove((Object)pos)) != null) {
    ...
    public void getEntitiesWithinAABBForEntity(Entity entityIn, AxisAlignedBB aabb, List<Entity> listToFill, Predicate<? super Entity> p_177414_4_) {
        int i = MathHelper.floor_double((double)((aabb.minY - 2.0) / 16.0));
        int j = MathHelper.floor_double((double)((aabb.maxY + 2.0) / 16.0));
        i = MathHelper.clamp_int((int)i, (int)0, (int)(this.entityLists.length - 1));
        j = MathHelper.clamp_int((int)j, (int)0, (int)(this.entityLists.length - 1));
        for (int k = i; k <= j; ++k) {
    ...
    public void fillChunk(byte[] p_177439_1_, int p_177439_2_, boolean p_177439_3_) {
        ...
        for (int l = 0; l < this.storageArrays.length; ++l) {
            ...
            System.arraycopy((Object)p_177439_1_, (int)i, (Object)nibblearray.getData(), (int)0, (int)nibblearray.getData().length);
        ...
        if (flag) {
            for (i1 = 0; i1 < this.storageArrays.length; ++i1) {
                ...
                System.arraycopy((Object)p_177439_1_, (int)i, (Object)nibblearray1.getData(), (int)0, (int)nibblearray1.getData().length);
                i += nibblearray1.getData().length;
            }
        }
        if (p_177439_3_) {
            System.arraycopy((Object)p_177439_1_, (int)i, (Object)this.blockBiomeArray, (int)0, (int)this.blockBiomeArray.length);
    ...
    public BiomeGenBase getBiome(BlockPos pos, WorldChunkManager chunkManager) {
        ...
        return (biomegenbase1 = BiomeGenBase.getBiome((int)k)) == null ? BiomeGenBase.plains : biomegenbase1;
    }
    ...
    private boolean func_150811_f(int x, int z) {
        ...
        for (int j = i + 16 - 1; j > this.worldObj.getSeaLevel() || j > 0 && !flag1; --j) {
            ...
            int k = this.getBlockLightOpacity((BlockPos)blockpos$mutableblockpos);
            ...
            if (!flag || k != 0 || this.worldObj.checkLight((BlockPos)blockpos$mutableblockpos)) continue;
            return false;
        }
        for (int l = blockpos$mutableblockpos.getY(); l > 0; --l) {
            ...
            if (this.getBlock((BlockPos)blockpos$mutableblockpos).getLightValue() <= 0) continue;
