...
public class ExtendedBlockStorage {
    ...
    public IBlockState get(int x, int y, int z) {
        IBlockState iblockstate = (IBlockState)Block.BLOCK_STATE_IDS.getByValue((int)this.data[y << 8 | z << 4 | x]);
    ...
    public void set(int x, int y, int z, IBlockState state) {
        ...
        this.data[y << 8 | z << 4 | x] = (char)Block.BLOCK_STATE_IDS.get((Object)state);
    }
