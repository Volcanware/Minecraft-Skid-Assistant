...
public class ChunkLoader {
    ...
    public static void convertToAnvilFormat(AnvilConverterData p_76690_0_, NBTTagCompound compound, WorldChunkManager p_76690_2_) {
        ...
        compound.setTag("Sections", (NBTBase)nbttaglist);
        ...
        compound.setTag("Entities", (NBTBase)p_76690_0_.entities);
        compound.setTag("TileEntities", (NBTBase)p_76690_0_.tileEntities);
        if (p_76690_0_.tileTicks != null) {
            compound.setTag("TileTicks", (NBTBase)p_76690_0_.tileTicks);
        }
    }
}
