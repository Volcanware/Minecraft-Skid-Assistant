...
public class WorldInfo {
    ...
    public WorldInfo(NBTTagCompound nbt) {
        ...
        if (nbt.hasKey("generatorName", 8)) {
            ...
            this.terrainType = WorldType.parseWorldType((String)s);
        ...
        this.theGameType = WorldSettings.GameType.getByID((int)nbt.getInteger("GameType"));
        ...
        if (nbt.hasKey("Difficulty", 99)) {
            this.difficulty = EnumDifficulty.getDifficultyEnum((int)nbt.getByte("Difficulty"));
        }
    ...
    public void addToCrashReport(CrashReportCategory category) {
        category.addCrashSectionCallable("Level seed", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        category.addCrashSectionCallable("Level generator", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        category.addCrashSectionCallable("Level generator options", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        category.addCrashSectionCallable("Level spawn location", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        category.addCrashSectionCallable("Level time", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        category.addCrashSectionCallable("Level dimension", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        category.addCrashSectionCallable("Level storage version", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        category.addCrashSectionCallable("Level weather", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        category.addCrashSectionCallable("Level game mode", (Callable)new /* Unavailable Anonymous Inner Class!! */);
    }

    static /* synthetic */ WorldType access$000(WorldInfo x0) {
        return x0.terrainType;
    }

    static /* synthetic */ boolean access$100(WorldInfo x0) {
        return x0.mapFeaturesEnabled;
    }

    static /* synthetic */ String access$200(WorldInfo x0) {
        return x0.generatorOptions;
    }

    static /* synthetic */ int access$300(WorldInfo x0) {
        return x0.spawnX;
    }

    static /* synthetic */ int access$400(WorldInfo x0) {
        return x0.spawnY;
    }

    static /* synthetic */ int access$500(WorldInfo x0) {
        return x0.spawnZ;
    }

    static /* synthetic */ long access$600(WorldInfo x0) {
        return x0.totalTime;
    }

    static /* synthetic */ long access$700(WorldInfo x0) {
        return x0.worldTime;
    }

    static /* synthetic */ int access$800(WorldInfo x0) {
        return x0.dimension;
    }

    static /* synthetic */ int access$900(WorldInfo x0) {
        return x0.saveVersion;
    }

    static /* synthetic */ int access$1000(WorldInfo x0) {
        return x0.rainTime;
    }

    static /* synthetic */ boolean access$1100(WorldInfo x0) {
        return x0.raining;
    }

    static /* synthetic */ int access$1200(WorldInfo x0) {
        return x0.thunderTime;
    }

    static /* synthetic */ boolean access$1300(WorldInfo x0) {
        return x0.thundering;
    }

    static /* synthetic */ WorldSettings.GameType access$1400(WorldInfo x0) {
        return x0.theGameType;
    }

    static /* synthetic */ boolean access$1500(WorldInfo x0) {
        return x0.hardcore;
    }

    static /* synthetic */ boolean access$1600(WorldInfo x0) {
