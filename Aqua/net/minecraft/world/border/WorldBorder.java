...
public class WorldBorder {
    ...
    public double getClosestDistance(double x, double z) {
        ...
        double d4 = Math.min((double)d2, (double)d3);
        d4 = Math.min((double)d4, (double)d0);
        return Math.min((double)d4, (double)d1);
    }
    ...
    public double getResizeSpeed() {
        return this.endTime == this.startTime ? 0.0 : Math.abs((double)(this.startDiameter - this.endDiameter)) / (double)(this.endTime - this.startTime);
    }
