...
public final class SpawnerAnimals {
    ...
    public int findChunksForSpawning(WorldServer worldServerIn, boolean spawnHostileMobs, boolean spawnPeacefulMobs, boolean p_77192_4_) {
        ...
        if (flag) {
            ...
            for (EntityPlayer entityplayer1 : worldServerIn.playerEntities) {
                ...
                int j = MathHelper.floor_double((double)(entityplayer1.posX / 16.0));
                int k = MathHelper.floor_double((double)(entityplayer1.posZ / 16.0));
                int l = 8;
        ...
        for (EnumCreatureType enumcreaturetype : EnumCreatureType.values()) {
            ...
            block6: for (ChunkCoordIntPair chunkcoordintpair1 : collection) {
                BlockPosM blockpos = SpawnerAnimals.getRandomChunkPosition((World)worldServerIn, chunkcoordintpair1.chunkXPos, chunkcoordintpair1.chunkZPos, blockposm);
                int k1 = blockpos.getX();
                int l1 = blockpos.getY();
                int i2 = blockpos.getZ();
                Block block = worldServerIn.getBlockState((BlockPos)blockpos).getBlock();
                ...
                block7: for (int k2 = 0; k2 < 3; ++k2) {
                    ...
                    for (int l3 = 0; l3 < 4; ++l3) {
                        ...
                        if (worldServerIn.isAnyPlayerWithinRangeAt((double)f, (double)i3, (double)f1, 24.0) || !(blockpos2.distanceSq((double)f, (double)i3, (double)f1) >= 576.0)) continue;
                        ...
                        if (!worldServerIn.canCreatureTypeSpawnHere(enumcreaturetype, biomegenbase$spawnlistentry, blockpos1) || !SpawnerAnimals.canCreatureTypeSpawnAtLocation(EntitySpawnPlacementRegistry.getPlacementForEntity((Class)biomegenbase$spawnlistentry.entityClass), (World)worldServerIn, blockpos1)) continue;
                        try {
                            entityliving = (EntityLiving)this.mapSampleEntitiesByClass.get((Object)biomegenbase$spawnlistentry.entityClass);
                            if (entityliving == null) {
                                ...
                                this.mapSampleEntitiesByClass.put((Object)biomegenbase$spawnlistentry.entityClass, (Object)entityliving);
                            }
                        }
                        ...
                        boolean bl = Reflector.ForgeEventFactory_canEntitySpawn.exists() ? ReflectorForge.canEntitySpawn((EntityLiving)entityliving, (World)worldServerIn, (float)f, (float)i3, (float)f1) : (flag2 = entityliving.getCanSpawnHere() && entityliving.isNotColliding());
                        if (flag2) {
                            int i4;
                            this.mapSampleEntitiesByClass.remove((Object)biomegenbase$spawnlistentry.entityClass);
                            ...
                            if (entityliving.isNotColliding()) {
                                ++j2;
                                worldServerIn.spawnEntityInWorld((Entity)entityliving);
                            }
                            int n = i4 = Reflector.ForgeEventFactory_getMaxSpawnPackSize.exists() ? Reflector.callInt((ReflectorMethod)Reflector.ForgeEventFactory_getMaxSpawnPackSize, (Object[])new Object[]{entityliving}) : entityliving.getMaxSpawnedInChunk();
    ...
    private static BlockPosM getRandomChunkPosition(World p_getRandomChunkPosition_0_, int p_getRandomChunkPosition_1_, int p_getRandomChunkPosition_2_, BlockPosM p_getRandomChunkPosition_3_) {
        ...
        int k = MathHelper.roundUp((int)(chunk.getHeightValue(i & 0xF, j & 0xF) + 1), (int)16);
    ...
    public static boolean canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType spawnPlacementTypeIn, World worldIn, BlockPos pos) {
        ...
        boolean bl = flag = Reflector.ForgeBlock_canCreatureSpawn.exists() ? Reflector.callBoolean((Object)iblockstate.getBlock(), (ReflectorMethod)Reflector.ForgeBlock_canCreatureSpawn, (Object[])new Object[]{worldIn, blockpos, spawnPlacementTypeIn}) : World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, (BlockPos)blockpos);
        if (!flag) {
            return false;
        }
    ...
    public static void performWorldGenSpawning(World worldIn, BiomeGenBase biomeIn, int p_77191_2_, int p_77191_3_, int p_77191_4_, int p_77191_5_, Random randomIn) {
        ...
        if (!list.isEmpty()) {
            while (randomIn.nextFloat() < biomeIn.getSpawningChance()) {
                BiomeGenBase.SpawnListEntry biomegenbase$spawnlistentry = (BiomeGenBase.SpawnListEntry)WeightedRandom.getRandomItem((Random)worldIn.rand, (Collection)list);
                ...
                for (int j1 = 0; j1 < i; ++j1) {
                    ...
                    for (int k1 = 0; !flag && k1 < 4; ++k1) {
                        ...
                        if (SpawnerAnimals.canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType.ON_GROUND, worldIn, blockpos)) {
                            ...
                            if (Reflector.ForgeEventFactory_canEntitySpawn.exists() && (object = Reflector.call((ReflectorMethod)Reflector.ForgeEventFactory_canEntitySpawn, (Object[])new Object[]{entityliving, worldIn, Float.valueOf((float)((float)j + 0.5f)), blockpos.getY(), Float.valueOf((float)((float)k + 0.5f))})) == ReflectorForge.EVENT_RESULT_DENY) continue;
