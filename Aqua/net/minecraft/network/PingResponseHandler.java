            ...
            if (bytebuf.readUnsignedByte() == 254) {
                ...
                switch (i) {
                    case 0: {
                        ...
                        String s2 = String.format((String)"%s\u00a7%d\u00a7%d", (Object[])new Object[]{minecraftserver.getMOTD(), minecraftserver.getCurrentPlayerCount(), minecraftserver.getMaxPlayers()});
                    ...
                    case 1: {
                        ...
                        String s = String.format((String)"\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", (Object[])new Object[]{127, minecraftserver.getMinecraftVersion(), minecraftserver.getMOTD(), minecraftserver.getCurrentPlayerCount(), minecraftserver.getMaxPlayers()});
                    ...
                    default: {
                        ...
                        flag1 &= "MC|PingHost".equals((Object)new String(bytebuf.readBytes(bytebuf.readShort() * 2).array(), Charsets.UTF_16BE));
                        ...
                        String s1 = String.format((String)"\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", (Object[])new Object[]{127, minecraftserver.getMinecraftVersion(), minecraftserver.getMOTD(), minecraftserver.getCurrentPlayerCount(), minecraftserver.getMaxPlayers()});
