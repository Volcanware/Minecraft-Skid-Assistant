...
ITickable {
    ...
    public void update() {
        ...
        if ((long)this.networkTickCount - this.lastSentPingPacket > 40L) {
            ...
            this.sendPacket((Packet)new S00PacketKeepAlive(this.field_147378_h));
        }
    ...
    public void kickPlayerFromServer(String reason) {
        ...
        this.netManager.sendPacket((Packet)new S40PacketDisconnect((IChatComponent)chatcomponenttext), (GenericFutureListener)new /* Unavailable Anonymous Inner Class!! */, new GenericFutureListener[0]);
        this.netManager.disableAutoRead();
        Futures.getUnchecked((Future)this.serverController.addScheduledTask((Runnable)new /* Unavailable Anonymous Inner Class!! */));
    }

    public void processInput(C0CPacketInput packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue((Packet)packetIn, (INetHandler)this, (IThreadListener)this.playerEntity.getServerForPlayer());
            ...
            if (!this.playerEntity.playerConqueredTheEnd) {
                ...
                if (this.hasMoved) {
                    ...
                    if (packetIn.isMoving()) {
                        ...
                        if (Math.abs((double)packetIn.getPositionX()) > 3.0E7 || Math.abs((double)packetIn.getPositionZ()) > 3.0E7) {
                    ...
                    if (!(!(d15 - d14 > 100.0) || this.serverController.isSinglePlayer() && this.serverController.getServerOwner().equals((Object)this.playerEntity.getName()))) {
                        logger.warn(this.playerEntity.getName() + " moved too quickly! " + d11 + "," + d12 + "," + d13 + " (" + d11 + ", " + d12 + ", " + d13 + ")");
                        this.setPlayerLocation(this.lastPosX, this.lastPosY, this.lastPosZ, this.playerEntity.rotationYaw, this.playerEntity.rotationPitch);
                        return;
                    }
                    float f3 = 0.0625f;
                    boolean flag = worldserver.getCollidingBoundingBoxes((Entity)this.playerEntity, this.playerEntity.getEntityBoundingBox().contract((double)f3, (double)f3, (double)f3)).isEmpty();
                    ...
                    if (!this.playerEntity.noClip) {
                        boolean flag2 = worldserver.getCollidingBoundingBoxes((Entity)this.playerEntity, this.playerEntity.getEntityBoundingBox().contract((double)f3, (double)f3, (double)f3)).isEmpty();
    ...
    public void setPlayerLocation(double x, double y, double z, float yaw, float pitch) {
        this.setPlayerLocation(x, y, z, yaw, pitch, (Set<S08PacketPlayerPosLook.EnumFlags>)Collections.emptySet());
    }
    ...
    public void processPlayerBlockPlacement(C08PacketPlayerBlockPlacement packetIn) {
        ...
        boolean flag = false;
        BlockPos blockpos = packetIn.getPosition();
        EnumFacing enumfacing = EnumFacing.getFront((int)packetIn.getPlacedBlockDirection());
        this.playerEntity.markPlayerActive();
        if (packetIn.getPlacedBlockDirection() == 255) {
            ...
            if (this.hasMoved && this.playerEntity.getDistanceSq((double)blockpos.getX() + 0.5, (double)blockpos.getY() + 0.5, (double)blockpos.getZ() + 0.5) < 64.0 && !this.serverController.isBlockProtected((World)worldserver, blockpos, (EntityPlayer)this.playerEntity) && worldserver.getWorldBorder().contains(blockpos)) {
        ...
        if (itemstack == null || itemstack.getMaxItemUseDuration() == 0) {
            ...
            this.playerEntity.inventory.mainInventory[this.playerEntity.inventory.currentItem] = ItemStack.copyItemStack((ItemStack)this.playerEntity.inventory.mainInventory[this.playerEntity.inventory.currentItem]);
            ...
            if (!ItemStack.areItemStacksEqual((ItemStack)this.playerEntity.inventory.getCurrentItem(), (ItemStack)packetIn.getStack())) {
                this.sendPacket((Packet)new S2FPacketSetSlot(this.playerEntity.openContainer.windowId, slot.slotNumber, this.playerEntity.inventory.getCurrentItem()));
            }
        }
    }
        ...
        if (this.playerEntity.isSpectator()) {
            ...
            if (entity != null) {
                ...
                if (entity.worldObj != this.playerEntity.worldObj) {
                    ...
                    this.sendPacket((Packet)new S07PacketRespawn(this.playerEntity.dimension, worldserver1.getDifficulty(), worldserver1.getWorldInfo().getTerrainType(), this.playerEntity.theItemInWorldManager.getGameType()));
    ...
    public void onDisconnect(IChatComponent reason) {
        ...
        if (this.serverController.isSinglePlayer() && this.playerEntity.getName().equals((Object)this.serverController.getServerOwner())) {
    ...
    public void sendPacket(Packet packetIn) {
        ...
        try {
            ...
            CrashReport crashreport = CrashReport.makeCrashReport((Throwable)throwable, (String)"Sending packet");
            CrashReportCategory crashreportcategory = crashreport.makeCategory("Packet being sent");
            crashreportcategory.addCrashSectionCallable("Packet class", (Callable)new /* Unavailable Anonymous Inner Class!! */);
    ...
    public void processChatMessage(C01PacketChatMessage packetIn) {
        ...
        if (this.playerEntity.getChatVisibility() == EntityPlayer.EnumChatVisibility.HIDDEN) {
            ...
            chatcomponenttranslation.getChatStyle().setColor(EnumChatFormatting.RED);
            this.sendPacket((Packet)new S02PacketChat((IChatComponent)chatcomponenttranslation));
        } else {
            this.playerEntity.markPlayerActive();
            String s = packetIn.getMessage();
            s = StringUtils.normalizeSpace((String)s);
            for (int i = 0; i < s.length(); ++i) {
                if (ChatAllowedCharacters.isAllowedCharacter((char)s.charAt(i))) continue;
            ...
            if (s.startsWith("/")) {
                ...
                ChatComponentTranslation ichatcomponent = new ChatComponentTranslation("chat.type.text", new Object[]{this.playerEntity.getDisplayName(), s});
                this.serverController.getConfigurationManager().sendChatMsgImpl((IChatComponent)ichatcomponent, false);
            }
    ...
    public void processEntityAction(C0BPacketEntityAction packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue((Packet)packetIn, (INetHandler)this, (IThreadListener)this.playerEntity.getServerForPlayer());
        this.playerEntity.markPlayerActive();
        switch (4.$SwitchMap$net$minecraft$network$play$client$C0BPacketEntityAction$Action[packetIn.getAction().ordinal()]) {
            case 1: {
    ...
    public void processClientStatus(C16PacketClientStatus packetIn) {
        ...
        switch (4.$SwitchMap$net$minecraft$network$play$client$C16PacketClientStatus$EnumState[c16packetclientstatus$enumstate.ordinal()]) {
            case 1: {
                if (this.playerEntity.playerConqueredTheEnd) {
        ...
        if (this.playerEntity.openContainer.windowId == packetIn.getWindowId() && this.playerEntity.openContainer.getCanCraft((EntityPlayer)this.playerEntity)) {
            if (this.playerEntity.isSpectator()) {
                ...
                for (int i = 0; i < this.playerEntity.openContainer.inventorySlots.size(); ++i) {
                    list.add((Object)((Slot)this.playerEntity.openContainer.inventorySlots.get(i)).getStack());
                }
                this.playerEntity.updateCraftingInventory(this.playerEntity.openContainer, (List)list);
            } else {
                ...
                if (ItemStack.areItemStacksEqual((ItemStack)packetIn.getClickedItem(), (ItemStack)itemstack)) {
                    ...
                    this.field_147372_n.addKey(this.playerEntity.openContainer.windowId, (Object)packetIn.getActionNumber());
                    ...
                    for (int j = 0; j < this.playerEntity.openContainer.inventorySlots.size(); ++j) {
                        list1.add((Object)((Slot)this.playerEntity.openContainer.inventorySlots.get(j)).getStack());
                    }
                    this.playerEntity.updateCraftingInventory(this.playerEntity.openContainer, (List)list1);
                }
            }
        }
    }
    ...
    public void processUpdateSign(C12PacketUpdateSign packetIn) {
        ...
        if (worldserver.isBlockLoaded(blockpos)) {
            ...
            for (int i = 0; i < aichatcomponent.length; ++i) {
                tileentitysign.signText[i] = new ChatComponentText(EnumChatFormatting.getTextWithoutFormattingCodes((String)aichatcomponent[i].getUnformattedText()));
            }
    ...
    public void processTabComplete(C14PacketTabComplete packetIn) {
        ...
        this.playerEntity.playerNetServerHandler.sendPacket((Packet)new S3APacketTabComplete((String[])list.toArray((Object[])new String[list.size()])));
    }
    ...
    public void processVanilla250Packet(C17PacketCustomPayload packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue((Packet)packetIn, (INetHandler)this, (IThreadListener)this.playerEntity.getServerForPlayer());
        if ("MC|BEdit".equals((Object)packetIn.getChannelName())) {
            ...
            try {
                ...
                if (!ItemWritableBook.isNBTValid((NBTTagCompound)itemstack1.getTagCompound())) {
        ...
        if ("MC|BSign".equals((Object)packetIn.getChannelName())) {
            ...
            try {
                ...
                if (!ItemEditableBook.validBookTagContents((NBTTagCompound)itemstack.getTagCompound())) {
                    throw new IOException("Invalid book tag!");
                }
        ...
        if ("MC|TrSel".equals((Object)packetIn.getChannelName())) {
            try {
            ...
            return;
        } else if ("MC|AdvCdm".equals((Object)packetIn.getChannelName())) {
            ...
            return;
        } else if ("MC|Beacon".equals((Object)packetIn.getChannelName())) {
            ...
            if (!"MC|ItemName".equals((Object)packetIn.getChannelName()) || !(this.playerEntity.openContainer instanceof ContainerRepair)) return;
            ...
            if (packetIn.getBufferData() != null && packetIn.getBufferData().readableBytes() >= 1) {
                String s = ChatAllowedCharacters.filterAllowedCharacters((String)packetIn.getBufferData().readStringFromBuffer(Short.MAX_VALUE));
