...
extends ByteBuf {
    ...
    public BlockPos readBlockPos() {
        return BlockPos.fromLong((long)this.readLong());
    }
    ...
    public IChatComponent readChatComponent() throws IOException {
        return IChatComponent.Serializer.jsonToComponent((String)this.readStringFromBuffer(Short.MAX_VALUE));
    }

    public void writeChatComponent(IChatComponent component) throws IOException {
        this.writeString(IChatComponent.Serializer.componentToJson((IChatComponent)component));
    }
    ...
    public void writeNBTTagCompoundToBuffer(NBTTagCompound nbt) {
        if (nbt == null) {
            ...
            try {
                CompressedStreamTools.write((NBTTagCompound)nbt, (DataOutput)new ByteBufOutputStream((ByteBuf)this));
            }
    ...
    public NBTTagCompound readNBTTagCompoundFromBuffer() throws IOException {
        ...
        this.readerIndex(i);
        return CompressedStreamTools.read((DataInput)new ByteBufInputStream((ByteBuf)this), (NBTSizeTracker)new NBTSizeTracker(0x200000L));
    }
    ...
    public void writeItemStackToBuffer(ItemStack stack) {
        if (stack == null) {
            ...
            this.writeShort(Item.getIdFromItem((Item)stack.getItem()));
    ...
    public ItemStack readItemStackFromBuffer() throws IOException {
        ...
        if (i >= 0) {
            ...
            itemstack = new ItemStack(Item.getItemById((int)i), (int)j, (int)k);
