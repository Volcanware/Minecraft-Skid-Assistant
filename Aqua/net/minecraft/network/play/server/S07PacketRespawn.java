...
implements Packet<INetHandlerPlayClient> {
    ...
    public void readPacketData(PacketBuffer buf) throws IOException {
        ...
        this.difficulty = EnumDifficulty.getDifficultyEnum((int)buf.readUnsignedByte());
        this.gameType = WorldSettings.GameType.getByID((int)buf.readUnsignedByte());
        this.worldType = WorldType.parseWorldType((String)buf.readStringFromBuffer(16));
