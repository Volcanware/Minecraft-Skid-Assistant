...
implements Packet<INetHandlerPlayClient> {
    ...
    public S11PacketSpawnExperienceOrb(EntityXPOrb xpOrb) {
        ...
        this.posX = MathHelper.floor_double((double)(xpOrb.posX * 32.0));
        this.posY = MathHelper.floor_double((double)(xpOrb.posY * 32.0));
        this.posZ = MathHelper.floor_double((double)(xpOrb.posZ * 32.0));
