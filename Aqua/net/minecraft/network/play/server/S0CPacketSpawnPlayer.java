...
implements Packet<INetHandlerPlayClient> {
    ...
    public S0CPacketSpawnPlayer(EntityPlayer player) {
        ...
        this.x = MathHelper.floor_double((double)(player.posX * 32.0));
        this.y = MathHelper.floor_double((double)(player.posY * 32.0));
        this.z = MathHelper.floor_double((double)(player.posZ * 32.0));
        this.yaw = (byte)(player.rotationYaw * 256.0f / 360.0f);
        this.pitch = (byte)(player.rotationPitch * 256.0f / 360.0f);
        ItemStack itemstack = player.inventory.getCurrentItem();
        this.currentItem = itemstack == null ? 0 : Item.getIdFromItem((Item)itemstack.getItem());
    ...
    public void readPacketData(PacketBuffer buf) throws IOException {
        ...
        this.field_148958_j = DataWatcher.readWatchedListFromPacketBuffer((PacketBuffer)buf);
    }
