...
implements Packet<INetHandlerPlayClient> {
    ...
    public void writePacketData(PacketBuffer buf) throws IOException {
        ...
        buf.writeShort((int)((short)(this.extractedData.dataSize & 0xFFFF)));
    ...
    public static Extracted getExtractedData(Chunk p_179756_0_, boolean p_179756_1_, boolean p_179756_2_, int p_179756_3_) {
        ...
        for (int i = 0; i < aextendedblockstorage.length; ++i) {
            ...
            list.add((Object)extendedblockstorage);
        }
        s21packetchunkdata$extracted.data = new byte[S21PacketChunkData.func_180737_a(Integer.bitCount((int)s21packetchunkdata$extracted.dataSize), p_179756_2_, p_179756_1_)];
        int j = 0;
    ...
    private static int func_179757_a(byte[] p_179757_0_, byte[] p_179757_1_, int p_179757_2_) {
        System.arraycopy((Object)p_179757_0_, (int)0, (Object)p_179757_1_, (int)p_179757_2_, (int)p_179757_0_.length);
