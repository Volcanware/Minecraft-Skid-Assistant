...
implements Packet<INetHandlerPlayClient> {
    ...
    public S34PacketMaps(int mapIdIn, byte scale, Collection<Vec4b> visiblePlayers, byte[] colors, int minX, int minY, int maxX, int maxY) {
        this.mapId = mapIdIn;
        this.mapScale = scale;
        this.mapVisiblePlayersVec4b = (Vec4b[])visiblePlayers.toArray((Object[])new Vec4b[visiblePlayers.size()]);
        this.mapMinX = minX;
        this.mapMinY = minY;
        this.mapMaxX = maxX;
        this.mapMaxY = maxY;
    ...
    public void writePacketData(PacketBuffer buf) throws IOException {
        ...
        buf.writeByte((int)this.mapScale);
        ...
        for (Vec4b vec4b : this.mapVisiblePlayersVec4b) {
            ...
            buf.writeByte((int)vec4b.func_176112_b());
            buf.writeByte((int)vec4b.func_176113_c());
        }
    ...
    public void setMapdataTo(MapData mapdataIn) {
        ...
        for (int i = 0; i < this.mapVisiblePlayersVec4b.length; ++i) {
            ...
            mapdataIn.mapDecorations.put((Object)("icon-" + i), (Object)vec4b);
        }
