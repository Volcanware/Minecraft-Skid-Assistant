...
implements Packet<INetHandlerPlayClient> {
    ...
    public S18PacketEntityTeleport(Entity entityIn) {
        ...
        this.posX = MathHelper.floor_double((double)(entityIn.posX * 32.0));
        this.posY = MathHelper.floor_double((double)(entityIn.posY * 32.0));
        this.posZ = MathHelper.floor_double((double)(entityIn.posZ * 32.0));
