...
implements Packet<INetHandlerPlayClient> {
    ...
    public S0EPacketSpawnObject(Entity entityIn, int typeIn, int p_i45166_3_) {
        ...
        this.x = MathHelper.floor_double((double)(entityIn.posX * 32.0));
        this.y = MathHelper.floor_double((double)(entityIn.posY * 32.0));
        this.z = MathHelper.floor_double((double)(entityIn.posZ * 32.0));
        this.pitch = MathHelper.floor_float((float)(entityIn.rotationPitch * 256.0f / 360.0f));
        this.yaw = MathHelper.floor_float((float)(entityIn.rotationYaw * 256.0f / 360.0f));
        this.type = typeIn;
