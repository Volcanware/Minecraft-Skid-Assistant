...
public class ViewFrustum {
    ...
    public void updateChunkPositions(double viewEntityX, double viewEntityZ) {
        int i = MathHelper.floor_double((double)viewEntityX) - 8;
        int j = MathHelper.floor_double((double)viewEntityZ) - 8;
        ...
        for (int l = 0; l < this.countChunksX; ++l) {
            ...
            for (int j1 = 0; j1 < this.countChunksZ; ++j1) {
                ...
                for (int l1 = 0; l1 < this.countChunksY; ++l1) {
                    ...
                    if (blockpos.getX() == i1 && blockpos.getY() == i2 && blockpos.getZ() == k1 || (blockpos1 = new BlockPos(i1, i2, k1)).equals((Object)renderchunk.getPosition())) continue;
    ...
    public void markBlocksForUpdate(int fromX, int fromY, int fromZ, int toX, int toY, int toZ) {
        int i = MathHelper.bucketInt((int)fromX, (int)16);
        int j = MathHelper.bucketInt((int)fromY, (int)16);
        int k = MathHelper.bucketInt((int)fromZ, (int)16);
        int l = MathHelper.bucketInt((int)toX, (int)16);
        int i1 = MathHelper.bucketInt((int)toY, (int)16);
        int j1 = MathHelper.bucketInt((int)toZ, (int)16);
    ...
    private void updateVboRegion(RenderChunk p_updateVboRegion_1_) {
        ...
        VboRegion[] avboregion = (VboRegion[])this.mapVboRegions.get((Object)chunkcoordintpair);
        if (avboregion == null) {
            ...
            this.mapVboRegions.put((Object)chunkcoordintpair, (Object)avboregion);
        }
