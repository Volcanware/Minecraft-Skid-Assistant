...
public class TextureUtil {
    ...
    private static final IntBuffer dataBuffer = GLAllocation.createDirectIntBuffer((int)0x400000);
    ...
    private static int blendColorComponent(int p_147944_0_, int p_147944_1_, int p_147944_2_, int p_147944_3_, int p_147944_4_) {
        float f = (float)Math.pow((double)((float)(p_147944_0_ >> p_147944_4_ & 0xFF) / 255.0f), (double)2.2);
        float f1 = (float)Math.pow((double)((float)(p_147944_1_ >> p_147944_4_ & 0xFF) / 255.0f), (double)2.2);
        float f2 = (float)Math.pow((double)((float)(p_147944_2_ >> p_147944_4_ & 0xFF) / 255.0f), (double)2.2);
        float f3 = (float)Math.pow((double)((float)(p_147944_3_ >> p_147944_4_ & 0xFF) / 255.0f), (double)2.2);
        float f4 = (float)Math.pow((double)((double)(f + f1 + f2 + f3) * 0.25), (double)0.45454545454545453);
    ...
    private static void uploadTextureSub(int p_147947_0_, int[] p_147947_1_, int p_147947_2_, int p_147947_3_, int p_147947_4_, int p_147947_5_, boolean p_147947_6_, boolean p_147947_7_, boolean p_147947_8_) {
        ...
        for (int k = 0; k < p_147947_2_ * p_147947_3_; k += p_147947_2_ * j) {
            int l = k / p_147947_2_;
            j = Math.min((int)i, (int)(p_147947_3_ - l));
    ...
    static {
        ...
        int k = aint.length;
        for (int l = 0; l < 16; ++l) {
            System.arraycopy((Object)(l < k ? aint : aint1), (int)0, (Object)missingTextureData, (int)(16 * l), (int)k);
            System.arraycopy((Object)(l < k ? aint1 : aint), (int)0, (Object)missingTextureData, (int)(16 * l + k), (int)k);
        }
