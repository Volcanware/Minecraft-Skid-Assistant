...
extends ClippingHelper {
    ...
    private FloatBuffer projectionMatrixBuffer = GLAllocation.createDirectFloatBuffer((int)16);
    private FloatBuffer modelviewMatrixBuffer = GLAllocation.createDirectFloatBuffer((int)16);
    private FloatBuffer field_78564_h = GLAllocation.createDirectFloatBuffer((int)16);
    ...
    private void normalize(float[] p_180547_1_) {
        float f = MathHelper.sqrt_float((float)(p_180547_1_[0] * p_180547_1_[0] + p_180547_1_[1] * p_180547_1_[1] + p_180547_1_[2] * p_180547_1_[2]));
    ...
    public void init() {
        ...
        GlStateManager.getFloat((int)2983, (FloatBuffer)this.projectionMatrixBuffer);
        GlStateManager.getFloat((int)2982, (FloatBuffer)this.modelviewMatrixBuffer);
