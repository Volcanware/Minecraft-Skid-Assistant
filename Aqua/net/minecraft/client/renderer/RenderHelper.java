...
public class RenderHelper {
    ...
    private static final Vec3 LIGHT0_POS = new Vec3((double)0.2f, 1.0, (double)-0.7f).normalize();
    private static final Vec3 LIGHT1_POS = new Vec3((double)-0.2f, 1.0, (double)0.7f).normalize();
