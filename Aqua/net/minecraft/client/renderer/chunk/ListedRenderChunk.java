...
extends RenderChunk {
    private final int baseDisplayList = GLAllocation.generateDisplayLists((int)EnumWorldBlockLayer.values().length);
    ...
    public void deleteGlResources() {
        ...
        GLAllocation.deleteDisplayLists((int)this.baseDisplayList, (int)EnumWorldBlockLayer.values().length);
    }
}
