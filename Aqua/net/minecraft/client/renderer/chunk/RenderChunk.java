...
public class RenderChunk {
    ...
    public RenderChunk(World worldIn, RenderGlobal renderGlobalIn, BlockPos blockPosIn, int indexIn) {
        ...
        this.index = indexIn;
        if (!blockPosIn.equals((Object)this.getPosition())) {
    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
        ...
        if (!this.isChunkRegionEmpty(blockpos)) {
            ...
            for (BlockPosM blockposm : BlockPosM.getAllInBoxMutable((BlockPos)blockpos, (BlockPos)blockpos1)) {
                ...
                if (ReflectorForge.blockHasTileEntity((IBlockState)iblockstate)) {
                    ...
                    if (tileentity != null && tileentityspecialrenderer != null) {
                        ...
                        if (tileentityspecialrenderer.forceTileEntityRender()) {
                            lvt_11_1_.add((Object)tileentity);
                        }
                    }
                }
                if (flag) {
                ...
                for (int j = 0; j < aenumworldblocklayer.length; ++j) {
                    ...
                    if (flag && !(flag2 = Reflector.callBoolean((Object)block, (ReflectorMethod)Reflector.ForgeBlock_canRenderInLayer, (Object[])new Object[]{enumworldblocklayer}))) continue;
                    if (flag1) {
                    ...
                    int n = k;
                    aboolean[n] = aboolean[n] | blockrendererdispatcher.renderBlock(iblockstate, (BlockPos)blockposm, (IBlockAccess)chunkcacheof, worldrenderer);
        ...
        try {
            ...
            set1.removeAll((Collection)lvt_11_1_);
            this.setTileEntities.clear();
            this.setTileEntities.addAll((Collection)lvt_11_1_);
    ...
    private EnumWorldBlockLayer fixBlockLayer(IBlockState p_fixBlockLayer_1_, EnumWorldBlockLayer p_fixBlockLayer_2_) {
        ...
        if (CustomBlockLayers.isActive() && (enumworldblocklayer = CustomBlockLayers.getRenderLayer((IBlockState)p_fixBlockLayer_1_)) != null) {
    ...
    private ChunkCacheOF makeChunkCacheOF(BlockPos p_makeChunkCacheOF_1_) {
        ...
        if (Reflector.MinecraftForgeClient_onRebuildChunk.exists()) {
            Reflector.call((ReflectorMethod)Reflector.MinecraftForgeClient_onRebuildChunk, (Object[])new Object[]{this.world, p_makeChunkCacheOF_1_, chunkcache});
        }
        ChunkCacheOF chunkcacheof = new ChunkCacheOF((ChunkCache)chunkcache, blockpos, blockpos1, 1);
        return chunkcacheof;
    }
