...
implements LayerRenderer<AbstractClientPlayer> {
    ...
    public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
        if (entitylivingbaseIn.getName().equals((Object)"deadmau5") && entitylivingbaseIn.hasSkin() && !entitylivingbaseIn.isInvisible()) {
            ...
            for (int i = 0; i < 2; ++i) {
                ...
                GlStateManager.translate((float)(0.375f * (float)(i * 2 - 1)), (float)0.0f, (float)0.0f);
                GlStateManager.translate((float)0.0f, (float)-0.375f, (float)0.0f);
                GlStateManager.rotate((float)(-f1), (float)1.0f, (float)0.0f, (float)0.0f);
                GlStateManager.rotate((float)(-f), (float)0.0f, (float)1.0f, (float)0.0f);
                float f2 = 1.3333334f;
