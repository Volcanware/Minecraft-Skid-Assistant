...
implements IResourceManagerReloadListener {
    ...
    private void renderModel(IBakedModel model, int color, ItemStack stack) {
        ...
        for (EnumFacing enumfacing : EnumFacing.VALUES) {
            this.renderQuads(worldrenderer, (List<BakedQuad>)model.getFaceQuads(enumfacing), color, stack);
        }
        this.renderQuads(worldrenderer, (List<BakedQuad>)model.getGeneralQuads(), color, stack);
        tessellator.draw();
        if (flag1) {
        ...
        if (stack != null) {
            ...
            if (model.isBuiltInRenderer()) {
                ...
                if (this.renderModelHasEmissive) {
                    ...
                    OpenGlHelper.setLightmapTextureCoords((int)OpenGlHelper.lightmapTexUnit, (float)240.0f, (float)f1);
    ...
    private void setupGuiTransform(int xPosition, int yPosition, boolean isGui3d) {
        ...
        if (isGui3d) {
            ...
            GlStateManager.scale((float)64.0f, (float)64.0f, (float)64.0f);
    ...
    public void renderItemAndEffectIntoGUI(ItemStack stack, int xPosition, int yPosition) {
        if (stack != null && stack.getItem() != null) {
            ...
            try {
                ...
                crashreportcategory.addCrashSectionCallable("Item Type", (Callable)new /* Unavailable Anonymous Inner Class!! */);
                crashreportcategory.addCrashSectionCallable("Item Aux", (Callable)new /* Unavailable Anonymous Inner Class!! */);
                crashreportcategory.addCrashSectionCallable("Item NBT", (Callable)new /* Unavailable Anonymous Inner Class!! */);
                crashreportcategory.addCrashSectionCallable("Item Foil", (Callable)new /* Unavailable Anonymous Inner Class!! */);
    ...
    public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text) {
        if (stack != null) {
            if (stack.stackSize != 1 || text != null) {
                String s;
                String string = s = text == null ? String.valueOf((int)stack.stackSize) : text;
                if (text == null && stack.stackSize < 1) {
                    s = EnumChatFormatting.RED + String.valueOf((int)stack.stackSize);
                }
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                GlStateManager.disableBlend();
                Aqua.INSTANCE.comfortaa4.drawStringWithShadow(s, (float)(xPosition + 22 - 2 - fr.getStringWidth(s)), (float)(yPosition + 6 + 3), 0xFFFFFF);
                GlStateManager.enableDepth();
                GlStateManager.enableBlend();
            }
            if (ReflectorForge.isItemDamaged((ItemStack)stack)) {
                int i1;
                int j1 = (int)Math.round((double)(13.0 - (double)stack.getItemDamage() * 13.0 / (double)stack.getMaxDamage()));
                int i = (int)Math.round((double)(255.0 - (double)stack.getItemDamage() * 255.0 / (double)stack.getMaxDamage()));
                if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
                    ...
                    j1 = (int)Math.round((double)(13.0 - d0 * 13.0));
                    i = (int)Math.round((double)(255.0 - d0 * 255.0));
                }
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                ...
                int k = i;
                int l = 0;
                if (Config.isCustomColors() && (i1 = CustomColors.getDurabilityColor((int)i)) >= 0) {
                    j = i1 >> 16 & 0xFF;
                    k = i1 >> 8 & 0xFF;
                    l = i1 >> 0 & 0xFF;
                }
    ...
    private void registerItems() {
        ...
        this.registerItem((Item)Items.bow, 0, "bow");
        this.registerItem((Item)Items.bow, 1, "bow_pulling_0");
        this.registerItem((Item)Items.bow, 2, "bow_pulling_1");
        this.registerItem((Item)Items.bow, 3, "bow_pulling_2");
        ...
        this.registerItem((Item)Items.fishing_rod, 1, "fishing_rod_cast");
        ...
        this.itemModelMesher.register((Item)Items.potionitem, (ItemMeshDefinition)new /* Unavailable Anonymous Inner Class!! */);
        ...
        this.itemModelMesher.register((Item)Items.enchanted_book, (ItemMeshDefinition)new /* Unavailable Anonymous Inner Class!! */);
    ...
    public static void forgeHooksClient_putQuadColor(WorldRenderer p_forgeHooksClient_putQuadColor_0_, BakedQuad p_forgeHooksClient_putQuadColor_1_, int p_forgeHooksClient_putQuadColor_2_) {
        ...
        for (int j = 0; j < 4; ++j) {
            ...
            float f6 = k >>> 16 & 0xFF;
            float f7 = k >>> 24 & 0xFF;
            int l = Math.min((int)255, (int)((int)(f * f4 / 255.0f)));
            int i1 = Math.min((int)255, (int)((int)(f1 * f5 / 255.0f)));
            int j1 = Math.min((int)255, (int)((int)(f2 * f6 / 255.0f)));
            int k1 = Math.min((int)255, (int)((int)(f3 * f7 / 255.0f)));
