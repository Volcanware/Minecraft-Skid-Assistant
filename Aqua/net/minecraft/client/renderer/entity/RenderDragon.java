...
extends RenderLiving<EntityDragon> {
    ...
    public RenderDragon(RenderManager renderManagerIn) {
        ...
        this.addLayer((LayerRenderer)new LayerEnderDragonEyes(this));
        this.addLayer((LayerRenderer)new LayerEnderDragonDeath());
    }
    ...
    protected void rotateCorpse(EntityDragon bat, float p_77043_2_, float p_77043_3_, float partialTicks) {
        ...
        GlStateManager.rotate((float)(f1 * 10.0f), (float)1.0f, (float)0.0f, (float)0.0f);
        GlStateManager.translate((float)0.0f, (float)0.0f, (float)1.0f);
        if (bat.deathTime > 0) {
            float f2 = ((float)bat.deathTime + partialTicks - 1.0f) / 20.0f * 1.6f;
            if ((f2 = MathHelper.sqrt_float((float)f2)) > 1.0f) {
                f2 = 1.0f;
            }
            GlStateManager.rotate((float)(f2 * this.getDeathMaxRotation((EntityLivingBase)bat)), (float)0.0f, (float)0.0f, (float)1.0f);
        }
    }
    ...
    protected void renderModel(EntityDragon entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor) {
        if (entitylivingbaseIn.deathTicks > 0) {
            ...
            GlStateManager.alphaFunc((int)516, (float)f);
        ...
        this.bindEntityTexture((Entity)entitylivingbaseIn);
        this.mainModel.render((Entity)entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, scaleFactor);
    ...
    public void doRender(EntityDragon entity, double x, double y, double z, float entityYaw, float partialTicks) {
        BossStatus.setBossStatus((IBossDisplayData)entity, (boolean)false);
    ...
    protected void drawRechargeRay(EntityDragon dragon, double p_180574_2_, double p_180574_4_, double p_180574_6_, float p_180574_8_) {
        ...
        float f5 = MathHelper.sqrt_float((float)(f2 * f2 + f4 * f4));
        float f6 = MathHelper.sqrt_float((float)(f2 * f2 + f3 * f3 + f4 * f4));
        GlStateManager.pushMatrix();
        GlStateManager.translate((float)((float)p_180574_2_), (float)((float)p_180574_4_ + 2.0f), (float)((float)p_180574_6_));
        GlStateManager.rotate((float)((float)(-Math.atan2((double)f4, (double)f2)) * 180.0f / (float)Math.PI - 90.0f), (float)0.0f, (float)1.0f, (float)0.0f);
        GlStateManager.rotate((float)((float)(-Math.atan2((double)f5, (double)f3)) * 180.0f / (float)Math.PI - 90.0f), (float)1.0f, (float)0.0f, (float)0.0f);
        ...
        float f8 = MathHelper.sqrt_float((float)(f2 * f2 + f3 * f3 + f4 * f4)) / 32.0f - ((float)dragon.ticksExisted + p_180574_8_) * 0.01f;
        worldrenderer.begin(5, DefaultVertexFormats.POSITION_TEX_COLOR);
        int i = 8;
        for (int j = 0; j <= 8; ++j) {
            float f9 = MathHelper.sin((float)((float)(j % 8) * (float)Math.PI * 2.0f / 8.0f)) * 0.75f;
            float f10 = MathHelper.cos((float)((float)(j % 8) * (float)Math.PI * 2.0f / 8.0f)) * 0.75f;
