        ...
        if ((double)f > 0.0) {
            ...
            if (f > 0.0f) {
                ...
                for (int j = 0; j < list.size(); ++j) {
                    ...
                    double d1 = MathHelper.func_181162_h((double)(-d0 * 0.2 - (double)MathHelper.floor_double((double)(-d0 * 0.1))));
                    ...
                    double d3 = 0.2;
                    double d4 = 0.5 + Math.cos((double)(d2 + 2.356194490192345)) * 0.2;
                    double d5 = 0.5 + Math.sin((double)(d2 + 2.356194490192345)) * 0.2;
                    double d6 = 0.5 + Math.cos((double)(d2 + 0.7853981633974483)) * 0.2;
                    double d7 = 0.5 + Math.sin((double)(d2 + 0.7853981633974483)) * 0.2;
                    double d8 = 0.5 + Math.cos((double)(d2 + 3.9269908169872414)) * 0.2;
                    double d9 = 0.5 + Math.sin((double)(d2 + 3.9269908169872414)) * 0.2;
                    double d10 = 0.5 + Math.cos((double)(d2 + 5.497787143782138)) * 0.2;
                    double d11 = 0.5 + Math.sin((double)(d2 + 5.497787143782138)) * 0.2;
                    double d12 = 0.0;
                    double d13 = 1.0;
                    double d14 = -1.0 + d1;
