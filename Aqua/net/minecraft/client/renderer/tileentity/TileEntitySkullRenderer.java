...
extends TileEntitySpecialRenderer<TileEntitySkull> {
    ...
    public void renderTileEntityAt(TileEntitySkull te, double x, double y, double z, float partialTicks, int destroyStage) {
        EnumFacing enumfacing = EnumFacing.getFront((int)(te.getBlockMetadata() & 7));
    ...
    public void renderSkull(float p_180543_1_, float p_180543_2_, float p_180543_3_, EnumFacing p_180543_4_, float p_180543_5_, int p_180543_6_, GameProfile p_180543_7_, int p_180543_8_) {
                ...
                case 3: {
                    ...
                    if (p_180543_7_ != null) {
                        ...
                        if (map.containsKey((Object)MinecraftProfileTexture.Type.SKIN)) {
                            resourcelocation = minecraft.getSkinManager().loadSkin((MinecraftProfileTexture)map.get((Object)MinecraftProfileTexture.Type.SKIN), MinecraftProfileTexture.Type.SKIN);
                        } else {
                            UUID uuid = EntityPlayer.getUUID((GameProfile)p_180543_7_);
                            resourcelocation = DefaultPlayerSkin.getDefaultSkin((UUID)uuid);
                        }
                    }
        ...
        if (p_180543_4_ != EnumFacing.UP) {
            switch (1.$SwitchMap$net$minecraft$util$EnumFacing[p_180543_4_.ordinal()]) {
                case 1: {
                    GlStateManager.translate((float)(p_180543_1_ + 0.5f), (float)(p_180543_2_ + 0.25f), (float)(p_180543_3_ + 0.74f));
                    break;
                }
                case 2: {
                    GlStateManager.translate((float)(p_180543_1_ + 0.5f), (float)(p_180543_2_ + 0.25f), (float)(p_180543_3_ + 0.26f));
                    p_180543_5_ = 180.0f;
                    break;
                }
                case 3: {
                    GlStateManager.translate((float)(p_180543_1_ + 0.74f), (float)(p_180543_2_ + 0.25f), (float)(p_180543_3_ + 0.5f));
                    p_180543_5_ = 270.0f;
                    break;
                }
                default: {
                    GlStateManager.translate((float)(p_180543_1_ + 0.26f), (float)(p_180543_2_ + 0.25f), (float)(p_180543_3_ + 0.5f));
                    p_180543_5_ = 90.0f;
                    break;
                }
            }
        } else {
            GlStateManager.translate((float)(p_180543_1_ + 0.5f), (float)p_180543_2_, (float)(p_180543_3_ + 0.5f));
        }
        float f = 0.0625f;
