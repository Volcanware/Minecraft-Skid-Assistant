...
extends TileEntitySpecialRenderer<TileEntityEnchantmentTable> {
    ...
    public void renderTileEntityAt(TileEntityEnchantmentTable te, double x, double y, double z, float partialTicks, int destroyStage) {
        ...
        GlStateManager.translate((float)((float)x + 0.5f), (float)((float)y + 0.75f), (float)((float)z + 0.5f));
        float f = (float)te.tickCount + partialTicks;
        GlStateManager.translate((float)0.0f, (float)(0.1f + MathHelper.sin((float)(f * 0.1f)) * 0.01f), (float)0.0f);
        ...
        GlStateManager.rotate((float)(-f2 * 180.0f / (float)Math.PI), (float)0.0f, (float)1.0f, (float)0.0f);
        GlStateManager.rotate((float)80.0f, (float)0.0f, (float)0.0f, (float)1.0f);
