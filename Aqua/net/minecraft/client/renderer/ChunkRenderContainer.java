...
public abstract class ChunkRenderContainer {
    ...
    public void preRenderChunk(RenderChunk renderChunkIn) {
        ...
        GlStateManager.translate((float)((float)((double)blockpos.getX() - this.viewEntityX)), (float)((float)((double)blockpos.getY() - this.viewEntityY)), (float)((float)((double)blockpos.getZ() - this.viewEntityZ)));
    }
