...
public class VertexFormat {
    ...
    public VertexFormat addElement(VertexFormatElement element) {
        ...
        this.offsets.add((Object)this.nextOffset);
        switch (1.$SwitchMap$net$minecraft$client$renderer$vertex$VertexFormatElement$EnumUsage[element.getUsage().ordinal()]) {
            case 1: {
            ...
            case 3: {
                this.uvOffsetsById.add(element.getIndex(), (Object)this.nextOffset);
            }
        }
