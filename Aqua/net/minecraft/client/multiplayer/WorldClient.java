...
extends World {
    ...
    public WorldClient(NetHandlerPlayClient netHandler, WorldSettings settings, int dimension, EnumDifficulty difficulty, Profiler profilerIn) {
        super((ISaveHandler)new SaveHandlerMP(), new WorldInfo(settings, "MpServer"), WorldProvider.getProviderForDimension((int)dimension), profilerIn, true);
    ...
    public void doVoidFogParticles(int posX, int posY, int posZ) {
        ...
        boolean flag = this.mc.playerController.getCurrentGameType() == WorldSettings.GameType.CREATIVE && itemstack != null && Block.getBlockFromItem((Item)itemstack.getItem()) == Blocks.barrier;
        ...
        for (int j = 0; j < 1000; ++j) {
            ...
            iblockstate.getBlock().randomDisplayTick((World)this, (BlockPos)blockpos$mutableblockpos, iblockstate, random);
            if (!flag || iblockstate.getBlock() != Blocks.barrier) continue;
            this.spawnParticle(EnumParticleTypes.BARRIER, (float)k + 0.5f, (float)l + 0.5f, (float)i1 + 0.5f, 0.0, 0.0, 0.0, new int[0]);
        }
    }
    ...
    public CrashReportCategory addWorldInfoToCrashReport(CrashReport report) {
        ...
        crashreportcategory.addCrashSectionCallable("Forced entities", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        crashreportcategory.addCrashSectionCallable("Retry entities", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        crashreportcategory.addCrashSectionCallable("Server brand", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        crashreportcategory.addCrashSectionCallable("Server type", (Callable)new /* Unavailable Anonymous Inner Class!! */);
    ...
    public void makeFireworks(double x, double y, double z, double motionX, double motionY, double motionZ, NBTTagCompound compund) {
        this.mc.effectRenderer.addEffect((EntityFX)new EntityFirework.StarterFX((World)this, x, y, z, motionX, motionY, motionZ, this.mc.effectRenderer, compund));
    }
