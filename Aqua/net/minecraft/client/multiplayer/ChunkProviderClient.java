...
implements IChunkProvider {
    ...
    public void unloadChunk(int x, int z) {
        ...
        this.chunkMapping.remove(ChunkCoordIntPair.chunkXZ2Int((int)x, (int)z));
        this.chunkListing.remove((Object)chunk);
    }

    public Chunk loadChunk(int chunkX, int chunkZ) {
        Chunk chunk = new Chunk(this.worldObj, chunkX, chunkZ);
        this.chunkMapping.add(ChunkCoordIntPair.chunkXZ2Int((int)chunkX, (int)chunkZ), (Object)chunk);
        this.chunkListing.add((Object)chunk);
        chunk.setChunkLoaded(true);
        return chunk;
    }

    public Chunk provideChunk(int x, int z) {
        Chunk chunk = (Chunk)this.chunkMapping.getValueByKey(ChunkCoordIntPair.chunkXZ2Int((int)x, (int)z));
