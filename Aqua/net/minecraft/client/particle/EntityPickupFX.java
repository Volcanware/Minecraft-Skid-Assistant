...
extends EntityFX {
    ...
    public void renderParticle(WorldRenderer worldRendererIn, Entity entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ) {
        ...
        if (Config.isShaders()) {
            ...
            Shaders.nextEntity((Entity)this.field_174840_a);
        }
        ...
        this.field_174842_aB.renderEntityWithPosYaw(this.field_174840_a, (double)((float)(d6 -= interpPosX)), (double)((float)(d7 -= interpPosY)), (double)((float)(d8 -= interpPosZ)), this.field_174840_a.rotationYaw, partialTicks);
        if (Config.isShaders()) {
