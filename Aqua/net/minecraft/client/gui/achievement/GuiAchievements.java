...
implements IProgressMeter {
    ...
    public void initGui() {
        ...
        this.buttonList.add((Object)new GuiOptionButton(1, width / 2 + 24, height / 2 + 74, 80, 20, I18n.format((String)"gui.done", (Object[])new Object[0])));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.loadingAchievements) {
            ...
            this.field_146570_r = MathHelper.clamp_float((float)this.field_146570_r, (float)1.0f, (float)2.0f);
    ...
    protected void drawTitle() {
        int i = (width - this.field_146555_f) / 2;
        int j = (height - this.field_146557_g) / 2;
        this.fontRendererObj.drawString(I18n.format((String)"gui.achievements", (Object[])new Object[0]), i + 15, j + 5, 0x404040);
    }

    protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
        int i = MathHelper.floor_double((double)(this.field_146569_s + (this.field_146567_u - this.field_146569_s) * (double)p_146552_3_));
        int j = MathHelper.floor_double((double)(this.field_146568_t + (this.field_146566_v - this.field_146568_t) * (double)p_146552_3_));
        if (i < field_146572_y) {
            i = field_146572_y;
        }
        if (j < field_146571_z) {
        ...
        GlStateManager.translate((float)i1, (float)j1, (float)-200.0f);
        GlStateManager.scale((float)(1.0f / this.field_146570_r), (float)(1.0f / this.field_146570_r), (float)0.0f);
        ...
        while ((float)l3 * f - (float)j2 < 155.0f) {
            ...
            GlStateManager.color((float)f2, (float)f2, (float)f2, (float)1.0f);
            int i4 = 0;
            while ((float)i4 * f1 - (float)i2 < 224.0f) {
                ...
                TextureAtlasSprite textureatlassprite = this.func_175371_a((Block)Blocks.sand);
                if (j4 <= 37 && l1 + l3 != 35) {
                    if (j4 == 22) {
        ...
        for (int i6 = 0; i6 < AchievementList.achievementList.size(); ++i6) {
            ...
            if (this.statFileWriter.hasAchievementUnlocked(achievement2)) {
                float f5 = 0.75f;
                GlStateManager.color((float)f5, (float)f5, (float)f5, (float)1.0f);
            } else if (this.statFileWriter.canUnlockAchievement(achievement2)) {
                float f6 = 1.0f;
                GlStateManager.color((float)f6, (float)f6, (float)f6, (float)1.0f);
            } else if (l7 < 3) {
                float f7 = 0.3f;
                GlStateManager.color((float)f7, (float)f7, (float)f7, (float)1.0f);
            } else if (l7 == 3) {
                float f8 = 0.2f;
                GlStateManager.color((float)f8, (float)f8, (float)f8, (float)1.0f);
            } else {
                if (l7 != 4) continue;
                float f9 = 0.1f;
                GlStateManager.color((float)f9, (float)f9, (float)f9, (float)1.0f);
            }
            this.mc.getTextureManager().bindTexture(ACHIEVEMENT_BACKGROUND);
        ...
        if (achievement != null) {
            ...
            if (this.statFileWriter.canUnlockAchievement(achievement)) {
                int j8 = Math.max((int)this.fontRendererObj.getStringWidth(s), (int)120);
                ...
                if (this.statFileWriter.hasAchievementUnlocked(achievement)) {
                    this.fontRendererObj.drawStringWithShadow(I18n.format((String)"achievement.taken", (Object[])new Object[0]), (float)i7, (float)(k7 + i9 + 4), -7302913);
                }
            } else if (i8 == 3) {
                s = I18n.format((String)"achievement.unknown", (Object[])new Object[0]);
                int k8 = Math.max((int)this.fontRendererObj.getStringWidth(s), (int)120);
                ...
                int l8 = Math.max((int)this.fontRendererObj.getStringWidth(s), (int)120);
