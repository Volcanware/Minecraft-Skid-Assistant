...
extends Gui {
    ...
    public void displayAchievement(Achievement ach) {
        this.achievementTitle = I18n.format((String)"achievement.get", (Object[])new Object[0]);
    ...
    private void updateAchievementWindowScale() {
        ...
        GlStateManager.matrixMode((int)5889);
        GlStateManager.loadIdentity();
        GlStateManager.ortho((double)0.0, (double)this.width, (double)this.height, (double)0.0, (double)1000.0, (double)3000.0);
        GlStateManager.matrixMode((int)5888);
        GlStateManager.loadIdentity();
