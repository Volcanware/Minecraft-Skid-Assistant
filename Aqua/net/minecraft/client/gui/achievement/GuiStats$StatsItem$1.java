...
implements Comparator<StatCrafting> {
    ...
    GuiStats.StatsItem.1(GuiStats guiStats) {
    ...
    public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
        ...
        if (statbase != null || statbase1 != null) {
            ...
            int l = GuiStats.access$100((GuiStats)StatsItem.this.this$0).readStat(statbase);
            if (l != (i1 = GuiStats.access$100((GuiStats)StatsItem.this.this$0).readStat(statbase1))) {
