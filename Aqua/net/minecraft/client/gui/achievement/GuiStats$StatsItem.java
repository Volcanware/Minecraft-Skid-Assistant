...
extends GuiStats.Stats {
    public GuiStats.StatsItem(Minecraft mcIn) {
        ...
        for (StatCrafting statcrafting : StatList.itemStats) {
            ...
            if (GuiStats.access$100((GuiStats)GuiStats.this).readStat((StatBase)statcrafting) > 0) {
                flag = true;
            } else if (StatList.objectBreakStats[i] != null && GuiStats.access$100((GuiStats)GuiStats.this).readStat(StatList.objectBreakStats[i]) > 0) {
                flag = true;
    ...
    protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_) {
        ...
        if (this.field_148218_l == 0) {
            GuiStats.access$000((GuiStats)GuiStats.this, (int)(p_148129_1_ + 115 - 18 + 1), (int)(p_148129_2_ + 1 + 1), (int)72, (int)18);
        } else {
            GuiStats.access$000((GuiStats)GuiStats.this, (int)(p_148129_1_ + 115 - 18), (int)(p_148129_2_ + 1), (int)72, (int)18);
        }
        if (this.field_148218_l == 1) {
            GuiStats.access$000((GuiStats)GuiStats.this, (int)(p_148129_1_ + 165 - 18 + 1), (int)(p_148129_2_ + 1 + 1), (int)18, (int)18);
        } else {
            GuiStats.access$000((GuiStats)GuiStats.this, (int)(p_148129_1_ + 165 - 18), (int)(p_148129_2_ + 1), (int)18, (int)18);
        }
        if (this.field_148218_l == 2) {
            GuiStats.access$000((GuiStats)GuiStats.this, (int)(p_148129_1_ + 215 - 18 + 1), (int)(p_148129_2_ + 1 + 1), (int)36, (int)18);
        } else {
            GuiStats.access$000((GuiStats)GuiStats.this, (int)(p_148129_1_ + 215 - 18), (int)(p_148129_2_ + 1), (int)36, (int)18);
        }
    }
