...
extends Gui {
    ...
    public void func_175202_a(String p_175202_1_) {
        this.field_146173_k.add((Object)I18n.format((String)p_175202_1_, (Object[])new Object[0]));
    }
    ...
    protected void drawLabelBackground(Minecraft mcIn, int p_146160_2_, int p_146160_3_) {
        if (this.labelBgEnabled) {
            ...
            GuiLabel.drawRect((int)k, (int)l, (int)(k + i), (int)(l + j), (int)this.field_146169_o);
