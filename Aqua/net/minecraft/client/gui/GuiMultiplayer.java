...
implements GuiYesNoCallback {
    ...
    public void createButtons() {
        this.btnEditServer = new GuiButton(7, width / 2 - 154, height - 28, 70, 20, I18n.format((String)"selectServer.edit", (Object[])new Object[0]));
        this.buttonList.add((Object)this.btnEditServer);
        this.btnDeleteServer = new GuiButton(2, width / 2 - 74, height - 28, 70, 20, I18n.format((String)"selectServer.delete", (Object[])new Object[0]));
        this.buttonList.add((Object)this.btnDeleteServer);
        this.btnSelectServer = new GuiButton(1, width / 2 - 154, height - 52, 100, 20, I18n.format((String)"selectServer.select", (Object[])new Object[0]));
        this.buttonList.add((Object)this.btnSelectServer);
        this.buttonList.add((Object)new GuiButton(4, width / 2 - 50, height - 52, 100, 20, I18n.format((String)"selectServer.direct", (Object[])new Object[0])));
        this.buttonList.add((Object)new GuiButton(3, width / 2 + 4 + 50, height - 52, 100, 20, I18n.format((String)"selectServer.add", (Object[])new Object[0])));
        this.buttonList.add((Object)new GuiButton(8, width / 2 + 4, height - 28, 70, 20, I18n.format((String)"selectServer.refresh", (Object[])new Object[0])));
        this.buttonList.add((Object)new GuiButton(0, width / 2 + 4 + 76, height - 28, 75, 20, I18n.format((String)"gui.cancel", (Object[])new Object[0])));
        ...
        if (button.enabled) {
            ...
            if (button.id == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
                ...
                if (s4 != null) {
                    ...
                    String s = I18n.format((String)"selectServer.deleteQuestion", (Object[])new Object[0]);
                    String s1 = "'" + s4 + "' " + I18n.format((String)"selectServer.deleteWarning", (Object[])new Object[0]);
                    String s2 = I18n.format((String)"selectServer.deleteButton", (Object[])new Object[0]);
                ...
                this.selectedServer = new ServerData(I18n.format((String)"selectServer.defaultName", (Object[])new Object[0]), "", false);
                this.mc.displayGuiScreen((GuiScreen)new GuiScreenServerList((GuiScreen)this, this.selectedServer));
            } else if (button.id == 3) {
                this.addingServer = true;
                this.selectedServer = new ServerData(I18n.format((String)"selectServer.defaultName", (Object[])new Object[0]), "", false);
                this.mc.displayGuiScreen((GuiScreen)new GuiScreenAddServer((GuiScreen)this, this.selectedServer));
    ...
    private void refreshServerList() {
        this.mc.displayGuiScreen((GuiScreen)new GuiMultiplayer(this.parentScreen));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Aqua.INSTANCE.comfortaa3.drawCenteredString(I18n.format((String)"multiplayer.title", (Object[])new Object[0]), (float)(width / 2), 20.0f, 0xFFFFFF);
        super.drawScreen(mouseX, mouseY, partialTicks);
        if (this.hoveringText != null) {
            this.drawHoveringText((List)Lists.newArrayList((Iterable)Splitter.on((String)"\n").split((CharSequence)this.hoveringText)), mouseX, mouseY);
        }
    }
    ...
    private void connectToServer(ServerData server) {
        this.mc.displayGuiScreen((GuiScreen)new GuiConnecting((GuiScreen)this, this.mc, server));
    }
