...
extends GuiListExtended {
    ...
    public GuiResourcePackList(Minecraft mcIn, int p_i45055_2_, int p_i45055_3_, List<ResourcePackListEntry> p_i45055_4_) {
        ...
        FontRenderer cfr_ignored_0 = mcIn.fontRendererObj;
    ...
    protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_) {
        ...
        this.mc.fontRendererObj.drawString(s, p_148129_1_ + this.width / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2, Math.min((int)(this.top + 3), (int)p_148129_2_), 0xFFFFFF);
    }
