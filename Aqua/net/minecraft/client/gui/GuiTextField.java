...
extends Gui {
    ...
    public int func_146197_a(int p_146197_1_, int p_146197_2_, boolean p_146197_3_) {
        ...
        int j = Math.abs((int)p_146197_1_);
        for (int k = 0; k < j; ++k) {
            if (!flag) {
    ...
    public boolean textboxKeyTyped(char p_146201_1_, int p_146201_2_) {
        ...
        if (ChatAllowedCharacters.isAllowedCharacter((char)p_146201_1_)) {
            if (this.isEnabled) {
                this.writeText(Character.toString((char)p_146201_1_));
            }
            return true;
        }
        return false;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtil.drawRoundedRect2Alpha((double)(this.xPosition - 1), (double)(this.yPosition - 1), (double)(this.width + 1), (double)(this.height + 1), (double)3.0, (Color)new Color(20, 20, 20, 120));
            }
