...
public class GuiUtilRenderComponents {
    public static String func_178909_a(String p_178909_0_, boolean p_178909_1_) {
        return !p_178909_1_ && !Minecraft.getMinecraft().gameSettings.chatColours ? EnumChatFormatting.getTextWithoutFormattingCodes((String)p_178909_0_) : p_178909_0_;
    }
    ...
    public static List<IChatComponent> splitText(IChatComponent p_178908_0_, int p_178908_1_, FontRenderer p_178908_2_, boolean p_178908_3_, boolean p_178908_4_) {
        ...
        for (int j = 0; j < list1.size(); ++j) {
            ...
            if (s.contains((CharSequence)"\n")) {
                ...
                list1.add(j + 1, (Object)chatcomponenttext);
                flag = true;
            }
            ...
            if (i + i1 > p_178908_1_) {
                ...
                if (s3 != null && s3.length() > 0) {
                    ...
                    if (l >= 0 && p_178908_2_.getStringWidth(s4.substring(0, l)) > 0) {
                        ...
                        s3 = s4.substring(l);
                    } else if (i > 0 && !s4.contains((CharSequence)" ")) {
                        s2 = "";
                        s3 = s4;
                    }
                    ...
                    list1.add(j + 1, (Object)chatcomponenttext2);
                }
            ...
            if (i + i1 <= p_178908_1_) {
                i += i1;
                ichatcomponent.appendSibling((IChatComponent)chatcomponenttext1);
            } else {
                flag = true;
            }
            if (!flag) continue;
            list.add((Object)ichatcomponent);
            i = 0;
