...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GlStateManager.translate((float)i, (float)j, (float)0.0f);
        ...
        if (itemstack != null) {
            ...
            if (this.draggedStack != null && this.isRightMouseClick) {
                ...
                itemstack.stackSize = MathHelper.ceiling_float_int((float)((float)itemstack.stackSize / 2.0f));
    ...
    private void drawSlot(Slot slotIn) {
        ...
        } else if (this.dragSplitting && this.dragSplittingSlots.contains((Object)slotIn) && itemstack1 != null) {
            if (this.dragSplittingSlots.size() == 1) {
                return;
            }
            if (Container.canAddItemToSlot((Slot)slotIn, (ItemStack)itemstack1, (boolean)true) && this.inventorySlots.canDragIntoSlot(slotIn)) {
                itemstack = itemstack1.copy();
                flag = true;
                Container.computeStackSize(this.dragSplittingSlots, (int)this.dragSplittingLimit, (ItemStack)itemstack, (int)(slotIn.getStack() == null ? 0 : slotIn.getStack().stackSize));
                ...
                this.dragSplittingSlots.remove((Object)slotIn);
        ...
        if (!flag1) {
            if (flag) {
                GuiContainer.drawRect((int)i, (int)j, (int)(i + 16), (int)(j + 16), (int)-2130706433);
            }
            GlStateManager.enableDepth();
    ...
    private void updateDragSplitting() {
        ...
        if (itemstack != null && this.dragSplitting) {
            ...
            for (Slot slot : this.dragSplittingSlots) {
                ...
                Container.computeStackSize(this.dragSplittingSlots, (int)this.dragSplittingLimit, (ItemStack)itemstack1, (int)i);
    ...
    protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick) {
        ...
        if (this.clickedSlot != null && this.mc.gameSettings.touchscreen) {
            if (clickedMouseButton == 0 || clickedMouseButton == 1) {
                ...
                } else if (this.draggedStack.stackSize > 1 && slot != null && Container.canAddItemToSlot((Slot)slot, (ItemStack)this.draggedStack, (boolean)false)) {
                    long i = Minecraft.getSystemTime();
        ...
        } else if (this.dragSplitting && slot != null && itemstack != null && itemstack.stackSize > this.dragSplittingSlots.size() && Container.canAddItemToSlot((Slot)slot, (ItemStack)itemstack, (boolean)true) && slot.isItemValid(itemstack) && this.inventorySlots.canDragIntoSlot(slot)) {
            this.dragSplittingSlots.add((Object)slot);
            this.updateDragSplitting();
        }
    }
        ...
        if (this.doubleClick && slot != null && state == 0 && this.inventorySlots.canMergeSlot((ItemStack)null, slot)) {
            if (GuiContainer.isShiftKeyDown()) {
                if (slot != null && slot.inventory != null && this.shiftClickedSlot != null) {
                    for (Slot slot2 : this.inventorySlots.inventorySlots) {
                        if (slot2 == null || !slot2.canTakeStack((EntityPlayer)this.mc.thePlayer) || !slot2.getHasStack() || slot2.inventory != slot.inventory || !Container.canAddItemToSlot((Slot)slot2, (ItemStack)this.shiftClickedSlot, (boolean)true)) continue;
            ...
            if (this.clickedSlot != null && this.mc.gameSettings.touchscreen) {
                if (state == 0 || state == 1) {
                    ...
                    boolean flag2 = Container.canAddItemToSlot((Slot)slot, (ItemStack)this.draggedStack, (boolean)false);
                ...
                this.handleMouseClick(null, -999, Container.func_94534_d((int)0, (int)this.dragSplittingLimit), 5);
                for (Slot slot1 : this.dragSplittingSlots) {
                    this.handleMouseClick(slot1, slot1.slotNumber, Container.func_94534_d((int)1, (int)this.dragSplittingLimit), 5);
                }
                this.handleMouseClick(null, -999, Container.func_94534_d((int)2, (int)this.dragSplittingLimit), 5);
