...
extends GuiScreen {
    ...
    public GuiScreenRealmsProxy(RealmsScreen p_i1087_1_) {
        ...
        this.buttonList = Collections.synchronizedList((List)Lists.newArrayList());
    }
