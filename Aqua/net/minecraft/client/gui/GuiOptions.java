...
implements GuiYesNoCallback {
    ...
    public void initGui() {
        int i = 0;
        this.field_146442_a = I18n.format((String)"options.title", (Object[])new Object[0]);
        for (GameSettings.Options gamesettings$options : field_146440_f) {
            if (gamesettings$options.getEnumFloat()) {
                this.buttonList.add((Object)new GuiOptionSlider(gamesettings$options.returnEnumOrdinal(), width / 2 - 155 + i % 2 * 160, height / 6 - 12 + 24 * (i >> 1), gamesettings$options));
            } else {
                ...
                this.buttonList.add((Object)guioptionbutton);
            }
            ++i;
        }
        if (this.mc.theWorld != null) {
            ...
            this.buttonList.add((Object)this.field_175357_i);
            if (this.mc.isSingleplayer() && !this.mc.theWorld.getWorldInfo().isHardcoreModeEnabled()) {
                ...
                this.buttonList.add((Object)this.field_175356_r);
            ...
            this.buttonList.add((Object)guioptionbutton1);
        }
        this.buttonList.add((Object)new GuiButton(110, width / 2 - 155, height / 6 + 48 - 6, 150, 20, I18n.format((String)"options.skinCustomisation", (Object[])new Object[0])));
        this.buttonList.add((Object)new /* Unavailable Anonymous Inner Class!! */);
        this.buttonList.add((Object)new GuiButton(106, width / 2 - 155, height / 6 + 72 - 6, 150, 20, I18n.format((String)"options.sounds", (Object[])new Object[0])));
        this.buttonList.add((Object)new GuiButton(107, width / 2 + 5, height / 6 + 72 - 6, 150, 20, I18n.format((String)"options.stream", (Object[])new Object[0])));
        this.buttonList.add((Object)new GuiButton(101, width / 2 - 155, height / 6 + 96 - 6, 150, 20, I18n.format((String)"options.video", (Object[])new Object[0])));
        this.buttonList.add((Object)new GuiButton(100, width / 2 + 5, height / 6 + 96 - 6, 150, 20, I18n.format((String)"options.controls", (Object[])new Object[0])));
        this.buttonList.add((Object)new GuiButton(102, width / 2 - 155, height / 6 + 120 - 6, 150, 20, I18n.format((String)"options.language", (Object[])new Object[0])));
        this.buttonList.add((Object)new GuiButton(103, width / 2 + 5, height / 6 + 120 - 6, 150, 20, I18n.format((String)"options.chat.title", (Object[])new Object[0])));
        this.buttonList.add((Object)new GuiButton(105, width / 2 - 155, height / 6 + 144 - 6, 150, 20, I18n.format((String)"options.resourcepack", (Object[])new Object[0])));
        this.buttonList.add((Object)new GuiButton(104, width / 2 + 5, height / 6 + 144 - 6, 150, 20, I18n.format((String)"options.snooper.view", (Object[])new Object[0])));
    ...
    public String func_175355_a(EnumDifficulty p_175355_1_) {
        ...
        ichatcomponent.appendSibling((IChatComponent)new ChatComponentTranslation("options.difficulty", new Object[0]));
        ichatcomponent.appendText(": ");
        ichatcomponent.appendSibling((IChatComponent)new ChatComponentTranslation(p_175355_1_.getDifficultyResourceKey(), new Object[0]));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id < 100 && button instanceof GuiOptionButton) {
                ...
                button.displayString = this.game_settings_1.getKeyBinding(GameSettings.Options.getEnumOptions((int)button.id));
            }
            if (button.id == 108) {
