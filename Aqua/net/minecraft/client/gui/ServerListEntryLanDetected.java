...
implements GuiListExtended.IGuiListEntry {
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
        this.mc.fontRendererObj.drawString(I18n.format((String)"lanServer.title", (Object[])new Object[0]), x + 32 + 3, y + 1, 0xFFFFFF);
        ...
        if (this.mc.gameSettings.hideServerAddress) {
            this.mc.fontRendererObj.drawString(I18n.format((String)"selectServer.hiddenAddress", (Object[])new Object[0]), x + 32 + 3, y + 12 + 11, 0x303030);
        } else {
