...
extends GuiListExtended {
    ...
    public void func_148195_a(ServerList p_148195_1_) {
        ...
        for (int i = 0; i < p_148195_1_.countServers(); ++i) {
            this.serverListInternet.add((Object)new ServerListEntryNormal(this.owner, p_148195_1_.getServerData(i)));
        }
    }
    ...
    public void func_148194_a(List<LanServerDetector.LanServer> p_148194_1_) {
        ...
        for (LanServerDetector.LanServer lanserverdetector$lanserver : p_148194_1_) {
            this.serverListLan.add((Object)new ServerListEntryLanDetected(this.owner, lanserverdetector$lanserver));
        }
    }
