...
public class ShaderUniform {
    ...
    public static int parseType(String p_148085_0_) {
        int i = -1;
        if (p_148085_0_.equals((Object)"int")) {
            i = 0;
        } else if (p_148085_0_.equals((Object)"float")) {
            i = 4;
    ...
    private void uploadInt() {
        switch (this.uniformType) {
            case 0: {
                OpenGlHelper.glUniform1((int)this.uniformLocation, (IntBuffer)this.uniformIntBuffer);
                break;
            }
            case 1: {
                OpenGlHelper.glUniform2((int)this.uniformLocation, (IntBuffer)this.uniformIntBuffer);
                break;
            }
            case 2: {
                OpenGlHelper.glUniform3((int)this.uniformLocation, (IntBuffer)this.uniformIntBuffer);
                break;
            }
            case 3: {
                OpenGlHelper.glUniform4((int)this.uniformLocation, (IntBuffer)this.uniformIntBuffer);
                break;
            }
            default: {
    ...
    private void uploadFloat() {
        switch (this.uniformType) {
            case 4: {
                OpenGlHelper.glUniform1((int)this.uniformLocation, (FloatBuffer)this.uniformFloatBuffer);
                break;
            }
            case 5: {
                OpenGlHelper.glUniform2((int)this.uniformLocation, (FloatBuffer)this.uniformFloatBuffer);
                break;
            }
            case 6: {
                OpenGlHelper.glUniform3((int)this.uniformLocation, (FloatBuffer)this.uniformFloatBuffer);
                break;
            }
            case 7: {
                OpenGlHelper.glUniform4((int)this.uniformLocation, (FloatBuffer)this.uniformFloatBuffer);
                break;
            }
            default: {
                logger.warn("Uniform.upload called, but count value (" + this.uniformCount + ") is not in the range of 1 to 4. Ignoring.");
    ...
    private void uploadFloatMatrix() {
        switch (this.uniformType) {
            case 8: {
                OpenGlHelper.glUniformMatrix2((int)this.uniformLocation, (boolean)true, (FloatBuffer)this.uniformFloatBuffer);
                break;
            }
            case 9: {
                OpenGlHelper.glUniformMatrix3((int)this.uniformLocation, (boolean)true, (FloatBuffer)this.uniformFloatBuffer);
                break;
            }
            case 10: {
                OpenGlHelper.glUniformMatrix4((int)this.uniformLocation, (boolean)true, (FloatBuffer)this.uniformFloatBuffer);
            }
        }
    }
}
