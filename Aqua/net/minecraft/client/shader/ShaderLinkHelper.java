...
public class ShaderLinkHelper {
    ...
    public void deleteShader(ShaderManager p_148077_1_) {
        ...
        OpenGlHelper.glDeleteProgram((int)p_148077_1_.getProgram());
    }
    ...
    public void linkProgram(ShaderManager manager) throws IOException {
        ...
        OpenGlHelper.glLinkProgram((int)manager.getProgram());
        int i = OpenGlHelper.glGetProgrami((int)manager.getProgram(), (int)OpenGlHelper.GL_LINK_STATUS);
        if (i == 0) {
            ...
            logger.warn(OpenGlHelper.glGetProgramInfoLog((int)manager.getProgram(), (int)32768));
        }
    }
}
