...
implements JsonSerializer<AnimationMetadataSection> {
    public AnimationMetadataSection deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
        ...
        JsonObject jsonobject = JsonUtils.getJsonObject((JsonElement)p_deserialize_1_, (String)"metadata section");
        int i = JsonUtils.getInt((JsonObject)jsonobject, (String)"frametime", (int)1);
        if (i != 1) {
            Validate.inclusiveBetween((long)1L, (long)Integer.MAX_VALUE, (long)i, (String)"Invalid default frame time");
        }
        if (jsonobject.has("frames")) {
            try {
                JsonArray jsonarray = JsonUtils.getJsonArray((JsonObject)jsonobject, (String)"frames");
                for (int j = 0; j < jsonarray.size(); ++j) {
                    JsonElement jsonelement = jsonarray.get(j);
                    AnimationFrame animationframe = this.parseAnimationFrame(j, jsonelement);
                    if (animationframe == null) continue;
                    list.add((Object)animationframe);
                }
            }
        ...
        int k = JsonUtils.getInt((JsonObject)jsonobject, (String)"width", (int)-1);
        int l = JsonUtils.getInt((JsonObject)jsonobject, (String)"height", (int)-1);
        if (k != -1) {
        ...
        boolean flag = JsonUtils.getBoolean((JsonObject)jsonobject, (String)"interpolate", (boolean)false);
        return new AnimationMetadataSection((List)list, k, l, i, flag);
    }

    private AnimationFrame parseAnimationFrame(int p_110492_1_, JsonElement p_110492_2_) {
        if (p_110492_2_.isJsonPrimitive()) {
            return new AnimationFrame(JsonUtils.getInt((JsonElement)p_110492_2_, (String)("frames[" + p_110492_1_ + "]")));
        }
        if (p_110492_2_.isJsonObject()) {
            JsonObject jsonobject = JsonUtils.getJsonObject((JsonElement)p_110492_2_, (String)("frames[" + p_110492_1_ + "]"));
            int i = JsonUtils.getInt((JsonObject)jsonobject, (String)"time", (int)-1);
            if (jsonobject.has("time")) {
                Validate.inclusiveBetween((long)1L, (long)Integer.MAX_VALUE, (long)i, (String)"Invalid frame time");
            }
            int j = JsonUtils.getInt((JsonObject)jsonobject, (String)"index");
    ...
    public JsonElement serialize(AnimationMetadataSection p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_) {
        ...
        jsonobject.addProperty("frametime", (Number)Integer.valueOf((int)p_serialize_1_.getFrameTime()));
        if (p_serialize_1_.getFrameWidth() != -1) {
            jsonobject.addProperty("width", (Number)Integer.valueOf((int)p_serialize_1_.getFrameWidth()));
        }
        if (p_serialize_1_.getFrameHeight() != -1) {
            jsonobject.addProperty("height", (Number)Integer.valueOf((int)p_serialize_1_.getFrameHeight()));
        }
        if (p_serialize_1_.getFrameCount() > 0) {
            ...
            for (int i = 0; i < p_serialize_1_.getFrameCount(); ++i) {
                if (p_serialize_1_.frameHasTime(i)) {
                    ...
                    jsonobject1.addProperty("index", (Number)Integer.valueOf((int)p_serialize_1_.getFrameIndex(i)));
                    jsonobject1.addProperty("time", (Number)Integer.valueOf((int)p_serialize_1_.getFrameTimeSingle(i)));
                    jsonarray.add((JsonElement)jsonobject1);
                    continue;
                }
                jsonarray.add((JsonElement)new JsonPrimitive((Number)Integer.valueOf((int)p_serialize_1_.getFrameIndex(i))));
            }
