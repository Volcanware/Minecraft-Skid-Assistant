...
implements Comparable<Language> {
    ...
    public String toString() {
        return String.format((String)"%s (%s)", (Object[])new Object[]{this.name, this.region});
    }

    public boolean equals(Object p_equals_1_) {
        return this == p_equals_1_ ? true : (!(p_equals_1_ instanceof Language) ? false : this.languageCode.equals((Object)((Language)p_equals_1_).languageCode));
    }
