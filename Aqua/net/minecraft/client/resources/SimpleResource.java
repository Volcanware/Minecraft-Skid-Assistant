...
implements IResource {
    ...
    public <T extends IMetadataSection> T getMetadata(String p_110526_1_) {
        ...
        if (this.mcmetaJson == null && !this.mcmetaJsonChecked) {
            ...
            try {
                bufferedreader = new BufferedReader((Reader)new InputStreamReader(this.mcmetaInputStream));
        ...
        if ((t = (IMetadataSection)this.mapMetadataSections.get((Object)p_110526_1_)) == null) {
    ...
    public boolean equals(Object p_equals_1_) {
        ...
        if (this.srResourceLocation != null ? !this.srResourceLocation.equals((Object)simpleresource.srResourceLocation) : simpleresource.srResourceLocation != null) {
            return false;
        }
        return !(this.resourcePackName != null ? !this.resourcePackName.equals((Object)simpleresource.resourcePackName) : simpleresource.resourcePackName != null);
    }
