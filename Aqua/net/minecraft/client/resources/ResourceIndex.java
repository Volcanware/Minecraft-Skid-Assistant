    ...
    public ResourceIndex(File p_i1047_1_, String p_i1047_2_) {
        if (p_i1047_2_ != null) {
            ...
            try {
                ...
                JsonObject jsonobject1 = JsonUtils.getJsonObject((JsonObject)jsonobject, (String)"objects", (JsonObject)null);
                if (jsonobject1 != null) {
                    for (Map.Entry entry : jsonobject1.entrySet()) {
                        ...
                        String s2 = JsonUtils.getString((JsonObject)jsonobject2, (String)"hash");
