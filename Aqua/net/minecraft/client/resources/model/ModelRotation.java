...
ITransformation
{
    ...
    private ModelRotation(int p_i46087_3_, int p_i46087_4_) {
        ...
        this.quartersX = MathHelper.abs_int((int)(p_i46087_3_ / 90));
        ...
        this.quartersY = MathHelper.abs_int((int)(p_i46087_4_ / 90));
    ...
    public static ModelRotation getModelRotation(int p_177524_0_, int p_177524_1_) {
        return (ModelRotation)((Object)mapRotations.get((Object)ModelRotation.combineXY(MathHelper.normalizeAngle((int)p_177524_0_, (int)360), MathHelper.normalizeAngle((int)p_177524_1_, (int)360))));
    }
    ...
    public Matrix4f getMatrix() {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (Matrix4f)Reflector.call((ReflectorMethod)Reflector.ForgeHooksClient_getMatrix, (Object[])new Object[]{this}) : new Matrix4f(this.getMatrix4d());
    }
    ...
    static {
        ...
        for (ModelRotation modelrotation : ModelRotation.values()) {
            mapRotations.put((Object)modelrotation.combinedXY, (Object)modelrotation);
        }
    }
}
