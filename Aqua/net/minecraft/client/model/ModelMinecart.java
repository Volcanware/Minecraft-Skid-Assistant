...
extends ModelBase {
    ...
    public ModelMinecart() {
        this.sideModels[0] = new ModelRenderer((ModelBase)this, 0, 10);
        this.sideModels[1] = new ModelRenderer((ModelBase)this, 0, 0);
        this.sideModels[2] = new ModelRenderer((ModelBase)this, 0, 0);
        this.sideModels[3] = new ModelRenderer((ModelBase)this, 0, 0);
        this.sideModels[4] = new ModelRenderer((ModelBase)this, 0, 0);
        this.sideModels[5] = new ModelRenderer((ModelBase)this, 44, 10);
        int i = 20;
        int j = 8;
        int k = 16;
        int l = 4;
