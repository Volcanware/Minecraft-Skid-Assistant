...
extends ModelBase {
    ...
    public ModelHorse() {
        ...
        this.field_178711_b = new ModelRenderer((ModelBase)this, 24, 18);
        ...
        this.field_178712_c = new ModelRenderer((ModelBase)this, 24, 27);
        ...
        this.muleLeftEar = new ModelRenderer((ModelBase)this, 0, 12);
        ...
        this.muleRightEar = new ModelRenderer((ModelBase)this, 0, 12);
        ...
        this.neck = new ModelRenderer((ModelBase)this, 0, 12);
        ...
        this.muleLeftChest = new ModelRenderer((ModelBase)this, 0, 34);
        ...
        this.muleRightChest = new ModelRenderer((ModelBase)this, 0, 47);
        ...
        this.horseRightFaceMetal = new ModelRenderer((ModelBase)this, 74, 13);
        ...
        this.horseLeftRein = new ModelRenderer((ModelBase)this, 44, 10);
        this.horseLeftRein.addBox(2.6f, -6.0f, -6.0f, 0, 3, 16);
        this.horseLeftRein.setRotationPoint(0.0f, 4.0f, -10.0f);
        this.horseRightRein = new ModelRenderer((ModelBase)this, 44, 5);
        ...
        this.horseFaceRopes = new ModelRenderer((ModelBase)this, 80, 12);
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        if (!flag) {
            ...
            GlStateManager.scale((float)f1, (float)(0.5f + f1 * 0.5f), (float)f1);
            GlStateManager.translate((float)0.0f, (float)(0.95f * (1.0f - f1)), (float)0.0f);
        }
        ...
        if (!flag) {
            ...
            GlStateManager.translate((float)0.0f, (float)(1.35f * (1.0f - f1)), (float)0.0f);
        }
        ...
        if (!flag) {
            ...
            if (f <= 0.0f) {
                ...
                GlStateManager.translate((float)0.0f, (float)(0.9f * (1.0f - f1) * f + 1.35f * (1.0f - f1) * (1.0f - f)), (float)(0.15f * (1.0f - f1) * f));
            }
        }
        if (flag3) {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
        ...
        if (p_78086_3_ > 0.2f) {
            f4 += MathHelper.cos((float)(p_78086_2_ * 0.4f)) * 0.15f * p_78086_3_;
        }
        ...
        float f10 = MathHelper.cos((float)(p_78086_2_ * 0.6662f + (float)Math.PI));
        ...
        this.head.rotateAngleX = f6 * (0.2617994f + f4) + f5 * 2.18166f + (1.0f - Math.max((float)f6, (float)f5)) * this.head.rotateAngleX;
        this.head.rotateAngleY = f6 * f3 / 57.295776f + (1.0f - Math.max((float)f6, (float)f5)) * this.head.rotateAngleY;
        this.head.rotationPointY = f6 * -6.0f + f5 * 11.0f + (1.0f - Math.max((float)f6, (float)f5)) * this.head.rotationPointY;
        this.head.rotationPointZ = f6 * -1.0f + f5 * -10.0f + (1.0f - Math.max((float)f6, (float)f5)) * this.head.rotationPointZ;
        ...
        float f16 = MathHelper.cos((float)(f9 * 0.6f + (float)Math.PI));
        ...
        this.backLeftShin.rotationPointY = this.backLeftLeg.rotationPointY + MathHelper.sin((float)(1.5707964f + f15 + f7 * -f10 * 0.5f * p_78086_3_)) * 7.0f;
        this.backLeftShin.rotationPointZ = this.backLeftLeg.rotationPointZ + MathHelper.cos((float)(4.712389f + f15 + f7 * -f10 * 0.5f * p_78086_3_)) * 7.0f;
        this.backRightShin.rotationPointY = this.backRightLeg.rotationPointY + MathHelper.sin((float)(1.5707964f + f15 + f7 * f10 * 0.5f * p_78086_3_)) * 7.0f;
        this.backRightShin.rotationPointZ = this.backRightLeg.rotationPointZ + MathHelper.cos((float)(4.712389f + f15 + f7 * f10 * 0.5f * p_78086_3_)) * 7.0f;
        float f17 = (-1.0471976f + f16) * f6 + f11 * f7;
        float f18 = (-1.0471976f + -f16) * f6 + -f11 * f7;
        this.frontLeftShin.rotationPointY = this.frontLeftLeg.rotationPointY + MathHelper.sin((float)(1.5707964f + f17)) * 7.0f;
        this.frontLeftShin.rotationPointZ = this.frontLeftLeg.rotationPointZ + MathHelper.cos((float)(4.712389f + f17)) * 7.0f;
        this.frontRightShin.rotationPointY = this.frontRightLeg.rotationPointY + MathHelper.sin((float)(1.5707964f + f18)) * 7.0f;
        this.frontRightShin.rotationPointZ = this.frontRightLeg.rotationPointZ + MathHelper.cos((float)(4.712389f + f18)) * 7.0f;
        this.backLeftLeg.rotateAngleX = f15 + -f10 * 0.5f * p_78086_3_ * f7;
        this.backLeftHoof.rotateAngleX = this.backLeftShin.rotateAngleX = -0.08726646f * f6 + (-f10 * 0.5f * p_78086_3_ - Math.max((float)0.0f, (float)(f10 * 0.5f * p_78086_3_))) * f7;
        this.backRightLeg.rotateAngleX = f15 + f10 * 0.5f * p_78086_3_ * f7;
        this.backRightHoof.rotateAngleX = this.backRightShin.rotateAngleX = -0.08726646f * f6 + (f10 * 0.5f * p_78086_3_ - Math.max((float)0.0f, (float)(-f10 * 0.5f * p_78086_3_))) * f7;
        this.frontLeftLeg.rotateAngleX = f17;
        this.frontLeftHoof.rotateAngleX = this.frontLeftShin.rotateAngleX = (this.frontLeftLeg.rotateAngleX + (float)Math.PI * Math.max((float)0.0f, (float)(0.2f + f16 * 0.2f))) * f6 + (f11 + Math.max((float)0.0f, (float)(f10 * 0.5f * p_78086_3_))) * f7;
        this.frontRightLeg.rotateAngleX = f18;
        this.frontRightHoof.rotateAngleX = this.frontRightShin.rotateAngleX = (this.frontRightLeg.rotateAngleX + (float)Math.PI * Math.max((float)0.0f, (float)(0.2f - f16 * 0.2f))) * f6 + (-f11 + Math.max((float)0.0f, (float)(-f10 * 0.5f * p_78086_3_))) * f7;
        ...
        if (flag) {
            this.tailBase.rotateAngleY = MathHelper.cos((float)(f9 * 0.7f));
            f12 = 0.0f;
        } else {
