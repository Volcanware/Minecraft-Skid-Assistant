...
extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        float f3 = -(MathHelper.cos((float)(limbSwing * 0.6662f * 2.0f + 0.0f)) * 0.4f) * limbSwingAmount;
        float f4 = -(MathHelper.cos((float)(limbSwing * 0.6662f * 2.0f + (float)Math.PI)) * 0.4f) * limbSwingAmount;
        float f5 = -(MathHelper.cos((float)(limbSwing * 0.6662f * 2.0f + 1.5707964f)) * 0.4f) * limbSwingAmount;
        float f6 = -(MathHelper.cos((float)(limbSwing * 0.6662f * 2.0f + 4.712389f)) * 0.4f) * limbSwingAmount;
        float f7 = Math.abs((float)(MathHelper.sin((float)(limbSwing * 0.6662f + 0.0f)) * 0.4f)) * limbSwingAmount;
        float f8 = Math.abs((float)(MathHelper.sin((float)(limbSwing * 0.6662f + (float)Math.PI)) * 0.4f)) * limbSwingAmount;
        float f9 = Math.abs((float)(MathHelper.sin((float)(limbSwing * 0.6662f + 1.5707964f)) * 0.4f)) * limbSwingAmount;
        float f10 = Math.abs((float)(MathHelper.sin((float)(limbSwing * 0.6662f + 4.712389f)) * 0.4f)) * limbSwingAmount;
