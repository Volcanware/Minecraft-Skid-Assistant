...
public class ModelRenderer {
    ...
    public ModelRenderer addBox(float p_178769_1_, float p_178769_2_, float p_178769_3_, int p_178769_4_, int p_178769_5_, int p_178769_6_, boolean p_178769_7_) {
        this.cubeList.add((Object)new ModelBox(this, this.textureOffsetX, this.textureOffsetY, p_178769_1_, p_178769_2_, p_178769_3_, p_178769_4_, p_178769_5_, p_178769_6_, 0.0f, p_178769_7_));
        return this;
    }

    public void addBox(float p_78790_1_, float p_78790_2_, float p_78790_3_, int width, int height, int depth, float scaleFactor) {
        this.cubeList.add((Object)new ModelBox(this, this.textureOffsetX, this.textureOffsetY, p_78790_1_, p_78790_2_, p_78790_3_, width, height, depth, scaleFactor));
    }
        ...
        if (!this.isHidden && this.showModel) {
            ...
            if (this.rotateAngleX == 0.0f && this.rotateAngleY == 0.0f && this.rotateAngleZ == 0.0f) {
                if (this.rotationPointX == 0.0f && this.rotationPointY == 0.0f && this.rotationPointZ == 0.0f) {
                    ...
                    GlStateManager.translate((float)(this.rotationPointX * p_78785_1_), (float)(this.rotationPointY * p_78785_1_), (float)(this.rotationPointZ * p_78785_1_));
                    if (flag) {
                        GlStateManager.scale((float)this.scaleX, (float)this.scaleY, (float)this.scaleZ);
                    }
                    GlStateManager.callList((int)this.displayList);
    ...
    public void renderWithRotation(float p_78791_1_) {
        if (!this.isHidden && this.showModel) {
            ...
            boolean flag = this.scaleX != 1.0f || this.scaleY != 1.0f || this.scaleZ != 1.0f;
            GlStateManager.pushMatrix();
            GlStateManager.translate((float)(this.rotationPointX * p_78791_1_), (float)(this.rotationPointY * p_78791_1_), (float)(this.rotationPointZ * p_78791_1_));
            if (this.rotateAngleY != 0.0f) {
                GlStateManager.rotate((float)(this.rotateAngleY * 57.295776f), (float)0.0f, (float)1.0f, (float)0.0f);
            }
            if (this.rotateAngleX != 0.0f) {
    ...
    public void addSprite(float p_addSprite_1_, float p_addSprite_2_, float p_addSprite_3_, int p_addSprite_4_, int p_addSprite_5_, int p_addSprite_6_, float p_addSprite_7_) {
        this.spriteList.add((Object)new ModelSprite(this, this.textureOffsetX, this.textureOffsetY, p_addSprite_1_, p_addSprite_2_, p_addSprite_3_, p_addSprite_4_, p_addSprite_5_, p_addSprite_6_, p_addSprite_7_));
    }
    ...
    public void addBox(int[][] p_addBox_1_, float p_addBox_2_, float p_addBox_3_, float p_addBox_4_, float p_addBox_5_, float p_addBox_6_, float p_addBox_7_, float p_addBox_8_) {
        this.cubeList.add((Object)new ModelBox(this, p_addBox_1_, p_addBox_2_, p_addBox_3_, p_addBox_4_, p_addBox_5_, p_addBox_6_, p_addBox_7_, p_addBox_8_, this.mirror));
    }
    ...
    public ModelRenderer getChild(String p_getChild_1_) {
        ...
        if (this.childModels != null) {
            for (int i = 0; i < this.childModels.size(); ++i) {
                ...
                if (!p_getChild_1_.equals((Object)modelrenderer.getId())) continue;
    ...
    public String toString() {
        ...
        stringbuffer.append("id: " + this.id + ", boxes: " + (this.cubeList != null ? Integer.valueOf((int)this.cubeList.size()) : null) + ", submodels: " + (this.childModels != null ? Integer.valueOf((int)this.childModels.size()) : null));
