...
extends ModelBase {
    ...
    public ModelBanner() {
        ...
        this.bannerSlate = new ModelRenderer((ModelBase)this, 0, 0);
        this.bannerSlate.addBox(-10.0f, 0.0f, -2.0f, 20, 40, 1, 0.0f);
        this.bannerStand = new ModelRenderer((ModelBase)this, 44, 0);
        this.bannerStand.addBox(-1.0f, -30.0f, -1.0f, 2, 42, 2, 0.0f);
        this.bannerTop = new ModelRenderer((ModelBase)this, 0, 42);
