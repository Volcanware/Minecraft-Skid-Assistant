...
extends ModelBiped {
    ...
    public void renderDeadmau5Head(float p_178727_1_) {
        ModelPlayer.copyModelAngles((ModelRenderer)this.bipedHead, (ModelRenderer)this.bipedDeadmau5Head);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        ModelPlayer.copyModelAngles((ModelRenderer)this.bipedLeftLeg, (ModelRenderer)this.bipedLeftLegwear);
        ModelPlayer.copyModelAngles((ModelRenderer)this.bipedRightLeg, (ModelRenderer)this.bipedRightLegwear);
        ModelPlayer.copyModelAngles((ModelRenderer)this.bipedLeftArm, (ModelRenderer)this.bipedLeftArmwear);
        ModelPlayer.copyModelAngles((ModelRenderer)this.bipedRightArm, (ModelRenderer)this.bipedRightArmwear);
        ModelPlayer.copyModelAngles((ModelRenderer)this.bipedBody, (ModelRenderer)this.bipedBodyWear);
    }
