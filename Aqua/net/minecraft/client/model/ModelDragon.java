...
extends ModelBase {
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        GlStateManager.translate((float)0.0f, (float)(f1 - 2.0f), (float)-3.0f);
        GlStateManager.rotate((float)(f1 * 2.0f), (float)1.0f, (float)0.0f, (float)0.0f);
        float f2 = -30.0f;
        float f4 = 0.0f;
        float f5 = 1.5f;
        ...
        GlStateManager.rotate((float)(-f6 * f5 * 1.0f), (float)0.0f, (float)0.0f, (float)1.0f);
        GlStateManager.translate((float)0.0f, (float)-1.0f, (float)0.0f);
