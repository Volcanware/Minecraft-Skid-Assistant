...
public class JsonBlendingMode {
    ...
    public void func_148109_a() {
        if (!this.equals(field_148118_a)) {
            ...
            if (this.field_148113_g) {
                GlStateManager.tryBlendFuncSeparate((int)this.field_148116_b, (int)this.field_148114_d, (int)this.field_148117_c, (int)this.field_148115_e);
            } else {
                GlStateManager.blendFunc((int)this.field_148116_b, (int)this.field_148114_d);
            }
        }
    }
    ...
    public static JsonBlendingMode func_148110_a(JsonObject p_148110_0_) {
        ...
        boolean flag = true;
        boolean flag1 = false;
        if (JsonUtils.isString((JsonObject)p_148110_0_, (String)"func") && (i = JsonBlendingMode.func_148108_a(p_148110_0_.get("func").getAsString())) != 32774) {
            flag = false;
        }
        if (JsonUtils.isString((JsonObject)p_148110_0_, (String)"srcrgb") && (j = JsonBlendingMode.func_148107_b(p_148110_0_.get("srcrgb").getAsString())) != 1) {
            flag = false;
        }
        if (JsonUtils.isString((JsonObject)p_148110_0_, (String)"dstrgb") && (k = JsonBlendingMode.func_148107_b(p_148110_0_.get("dstrgb").getAsString())) != 0) {
            flag = false;
        }
        if (JsonUtils.isString((JsonObject)p_148110_0_, (String)"srcalpha")) {
        ...
        if (JsonUtils.isString((JsonObject)p_148110_0_, (String)"dstalpha")) {
    ...
    private static int func_148108_a(String p_148108_0_) {
        ...
        return s.equals((Object)"add") ? 32774 : (s.equals((Object)"subtract") ? 32778 : (s.equals((Object)"reversesubtract") ? 32779 : (s.equals((Object)"reverse_subtract") ? 32779 : (s.equals((Object)"min") ? 32775 : (s.equals((Object)"max") ? 32776 : 32774)))));
    }
    ...
    private static int func_148107_b(String p_148107_0_) {
        ...
        return (s = s.replaceAll("minus", "-")).equals((Object)"0") ? 0 : (s.equals((Object)"1") ? 1 : (s.equals((Object)"srccolor") ? 768 : (s.equals((Object)"1-srccolor") ? 769 : (s.equals((Object)"dstcolor") ? 774 : (s.equals((Object)"1-dstcolor") ? 775 : (s.equals((Object)"srcalpha") ? 770 : (s.equals((Object)"1-srcalpha") ? 771 : (s.equals((Object)"dstalpha") ? 772 : (s.equals((Object)"1-dstalpha") ? 773 : -1)))))))));
    }
}
