...
public class Main {
    public static void main(String[] p_main_0_) {
        ...
        if (s != null) {
            try {
                proxy = new Proxy(Proxy.Type.SOCKS, (SocketAddress)new InetSocketAddress(s, ((Integer)optionset.valueOf((OptionSpec)optionspec6)).intValue()));
            }
            catch (Exception exception) {
                // empty catch block
            }
        }
        String s1 = (String)optionset.valueOf((OptionSpec)optionspec7);
        String s2 = (String)optionset.valueOf((OptionSpec)optionspec8);
        if (!proxy.equals((Object)Proxy.NO_PROXY) && Main.isNullOrEmpty(s1) && Main.isNullOrEmpty(s2)) {
