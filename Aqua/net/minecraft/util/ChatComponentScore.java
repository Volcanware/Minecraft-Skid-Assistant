...
extends ChatComponentStyle {
    ...
    public String getUnformattedTextForChat() {
        ...
        if (minecraftserver != null && minecraftserver.isAnvilFileSet() && StringUtils.isNullOrEmpty((String)this.value)) {
            ...
            if (scoreboard.entityHasObjective(this.name, scoreobjective = scoreboard.getObjective(this.objective))) {
                ...
                this.setValue(String.format((String)"%d", (Object[])new Object[]{score.getScorePoints()}));
            } else {
                this.value = "";
            }
        }
    ...
    public boolean equals(Object p_equals_1_) {
        ...
        ChatComponentScore chatcomponentscore = (ChatComponentScore)((Object)p_equals_1_);
        return this.name.equals((Object)chatcomponentscore.name) && this.objective.equals((Object)chatcomponentscore.objective) && super.equals(p_equals_1_);
    }
