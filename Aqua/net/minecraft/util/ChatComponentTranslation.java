...
extends ChatComponentStyle {
    ...
    public static final Pattern stringVariablePattern = Pattern.compile((String)"%(?:(\\d+)\\$)?([A-Za-z%]|$)");
    ...
    synchronized void ensureInitialized() {
        ...
        try {
            this.initializeFromFormat(StatCollector.translateToLocal((String)this.key));
        }
        catch (ChatComponentTranslationFormatException chatcomponenttranslationformatexception) {
            this.children.clear();
            try {
                this.initializeFromFormat(StatCollector.translateToFallback((String)this.key));
            }
    ...
    protected void initializeFromFormat(String format) {
        boolean flag = false;
        Matcher matcher = stringVariablePattern.matcher((CharSequence)format);
        int i = 0;
        int j = 0;
        try {
            while (matcher.find(j)) {
                ...
                int l = matcher.end();
                if (k > j) {
                    ChatComponentText chatcomponenttext = new ChatComponentText(String.format((String)format.substring(j, k), (Object[])new Object[0]));
                    chatcomponenttext.getChatStyle().setParentStyle(this.getChatStyle());
                    this.children.add((Object)chatcomponenttext);
                }
                String s2 = matcher.group(2);
                String s = format.substring(k, l);
                if ("%".equals((Object)s2) && "%%".equals((Object)s)) {
                    ...
                    this.children.add((Object)chatcomponenttext2);
                } else {
                    int i1;
                    ...
                    int n = i1 = s1 != null ? Integer.parseInt((String)s1) - 1 : i++;
                    if (i1 < this.formatArgs.length) {
                        this.children.add((Object)this.getFormatArgumentAsComponent(i1));
                    }
                }
                j = l;
            }
            if (j < format.length()) {
                ChatComponentText chatcomponenttext1 = new ChatComponentText(String.format((String)format.substring(j), (Object[])new Object[0]));
                chatcomponenttext1.getChatStyle().setParentStyle(this.getChatStyle());
                this.children.add((Object)chatcomponenttext1);
            }
        }
    ...
    public Iterator<IChatComponent> iterator() {
        ...
        return Iterators.concat((Iterator)ChatComponentTranslation.createDeepCopyIterator(this.children), (Iterator)ChatComponentTranslation.createDeepCopyIterator((Iterable)this.siblings));
    }
    ...
    public boolean equals(Object p_equals_1_) {
        ...
        ChatComponentTranslation chatcomponenttranslation = (ChatComponentTranslation)((Object)p_equals_1_);
        return Arrays.equals((Object[])this.formatArgs, (Object[])chatcomponenttranslation.formatArgs) && this.key.equals((Object)chatcomponenttranslation.key) && super.equals(p_equals_1_);
    }

    public int hashCode() {
        int i = super.hashCode();
        i = 31 * i + this.key.hashCode();
        i = 31 * i + Arrays.hashCode((Object[])this.formatArgs);
        return i;
    }

    public String toString() {
        return "TranslatableComponent{key='" + this.key + '\'' + ", args=" + Arrays.toString((Object[])this.formatArgs) + ", siblings=" + this.siblings + ", style=" + this.getChatStyle() + '}';
    }
