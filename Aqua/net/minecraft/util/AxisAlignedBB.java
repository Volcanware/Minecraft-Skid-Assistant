...
public class AxisAlignedBB {
    ...
    public AxisAlignedBB(double x1, double y1, double z1, double x2, double y2, double z2) {
        this.minX = Math.min((double)x1, (double)x2);
        this.minY = Math.min((double)y1, (double)y2);
        this.minZ = Math.min((double)z1, (double)z2);
        this.maxX = Math.max((double)x1, (double)x2);
        this.maxY = Math.max((double)y1, (double)y2);
        this.maxZ = Math.max((double)z1, (double)z2);
    }
    ...
    public AxisAlignedBB union(AxisAlignedBB other) {
        double d0 = Math.min((double)this.minX, (double)other.minX);
        double d1 = Math.min((double)this.minY, (double)other.minY);
        double d2 = Math.min((double)this.minZ, (double)other.minZ);
        double d3 = Math.max((double)this.maxX, (double)other.maxX);
        double d4 = Math.max((double)this.maxY, (double)other.maxY);
        double d5 = Math.max((double)this.maxZ, (double)other.maxZ);
        return new AxisAlignedBB(d0, d1, d2, d3, d4, d5);
    }

    public static AxisAlignedBB fromBounds(double x1, double y1, double z1, double x2, double y2, double z2) {
        double d0 = Math.min((double)x1, (double)x2);
        double d1 = Math.min((double)y1, (double)y2);
        double d2 = Math.min((double)z1, (double)z2);
        double d3 = Math.max((double)x1, (double)x2);
        double d4 = Math.max((double)y1, (double)y2);
        double d5 = Math.max((double)z1, (double)z2);
        return new AxisAlignedBB(d0, d1, d2, d3, d4, d5);
    }
