...
JsonSerializer<IChatComponent> {
    ...
    public IChatComponent deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
        ...
        if (!p_deserialize_1_.isJsonObject()) {
            if (p_deserialize_1_.isJsonArray()) {
                ...
                for (JsonElement jsonelement : jsonarray1) {
                    IChatComponent ichatcomponent2 = this.deserialize(jsonelement, (Type)jsonelement.getClass(), p_deserialize_3_);
        ...
        if (jsonobject.has("text")) {
            ...
            ichatcomponent = new ChatComponentScore(JsonUtils.getString((JsonObject)jsonobject1, (String)"name"), JsonUtils.getString((JsonObject)jsonobject1, (String)"objective"));
            if (jsonobject1.has("value")) {
                ((ChatComponentScore)ichatcomponent).setValue(JsonUtils.getString((JsonObject)jsonobject1, (String)"value"));
            }
        } else {
            if (!jsonobject.has("selector")) {
                throw new JsonParseException("Don't know how to turn " + p_deserialize_1_.toString() + " into a Component");
            }
            ichatcomponent = new ChatComponentSelector(JsonUtils.getString((JsonObject)jsonobject, (String)"selector"));
        }
        ...
        if (p_serialize_1_ instanceof ChatComponentText) {
            ...
            if (chatcomponenttranslation.getFormatArgs() != null && chatcomponenttranslation.getFormatArgs().length > 0) {
                ...
                for (Object object : chatcomponenttranslation.getFormatArgs()) {
                    ...
                    jsonarray1.add((JsonElement)new JsonPrimitive(String.valueOf((Object)object)));
                }
    ...
    static {
        ...
        gsonbuilder.registerTypeHierarchyAdapter(IChatComponent.class, (Object)new IChatComponent.Serializer());
