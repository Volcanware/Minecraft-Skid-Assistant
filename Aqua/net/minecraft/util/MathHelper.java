...
public class MathHelper {
    ...
    public static int parseIntWithDefault(String p_82715_0_, int p_82715_1_) {
        try {
            return Integer.parseInt((String)p_82715_0_);
        }
    ...
    public static int parseIntWithDefaultAndMax(String p_82714_0_, int p_82714_1_, int p_82714_2_) {
        return Math.max((int)p_82714_2_, (int)MathHelper.parseIntWithDefault(p_82714_0_, p_82714_1_));
    }

    public static double parseDoubleWithDefault(String p_82712_0_, double p_82712_1_) {
        try {
            return Double.parseDouble((String)p_82712_0_);
        }
    ...
    public static double parseDoubleWithDefaultAndMax(String p_82713_0_, double p_82713_1_, double p_82713_3_) {
        return Math.max((double)p_82713_3_, (double)MathHelper.parseDoubleWithDefault(p_82713_0_, p_82713_1_));
    }
    ...
    public static double func_181162_h(double p_181162_0_) {
        return p_181162_0_ - Math.floor((double)p_181162_0_);
    }
    ...
    static {
        ...
        for (int j = 0; j < SIN_TABLE_FAST.length; ++j) {
            MathHelper.SIN_TABLE_FAST[j] = MathUtils.roundToFloat((double)Math.sin((double)((double)j * Math.PI * 2.0 / 4096.0)));
        }
        multiplyDeBruijnBitPosition = new int[]{0, 1, 28, 2, 29, 14, 24, 3, 30, 22, 20, 15, 25, 17, 4, 8, 31, 27, 13, 23, 21, 19, 16, 7, 26, 12, 18, 6, 11, 5, 10, 9};
        field_181163_d = Double.longBitsToDouble((long)4805340802404319232L);
        field_181164_e = new double[257];
        field_181165_f = new double[257];
        for (int k = 0; k < 257; ++k) {
            double d0 = (double)k / 256.0;
            double d1 = Math.asin((double)d0);
            MathHelper.field_181165_f[k] = Math.cos((double)d1);
