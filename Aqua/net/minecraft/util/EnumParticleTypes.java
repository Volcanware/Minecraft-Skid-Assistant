...
public enum EnumParticleTypes {
    ...
    public static EnumParticleTypes getParticleFromId(int particleId) {
        return (EnumParticleTypes)((Object)PARTICLES.get((Object)particleId));
    }
    ...
    static {
        ...
        for (EnumParticleTypes enumparticletypes : EnumParticleTypes.values()) {
            PARTICLES.put((Object)enumparticletypes.getParticleID(), (Object)enumparticletypes);
            if (enumparticletypes.getParticleName().endsWith("_")) continue;
            list.add((Object)enumparticletypes.getParticleName());
        }
        PARTICLE_NAMES = (String[])list.toArray((Object[])new String[list.size()]);
    }
}
