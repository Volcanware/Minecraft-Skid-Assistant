...
public enum EnumChatFormatting {
    ...
    public static String getTextWithoutFormattingCodes(String text) {
        return text == null ? null : formattingCodePattern.matcher((CharSequence)text).replaceAll("");
    }

    public static EnumChatFormatting getValueByName(String friendlyName) {
        return friendlyName == null ? null : (EnumChatFormatting)((Object)nameMapping.get((Object)EnumChatFormatting.func_175745_c(friendlyName)));
    }
    ...
    public static Collection<String> getValidValues(boolean p_96296_0_, boolean p_96296_1_) {
        ...
        for (EnumChatFormatting enumchatformatting : EnumChatFormatting.values()) {
            ...
            list.add((Object)enumchatformatting.getFriendlyName());
        }
        return list;
    }
    ...
    static {
        ...
        formattingCodePattern = Pattern.compile((String)("(?i)" + String.valueOf((char)'\u00a7') + "[0-9A-FK-OR]"));
        for (EnumChatFormatting enumchatformatting : EnumChatFormatting.values()) {
            nameMapping.put((Object)EnumChatFormatting.func_175745_c(enumchatformatting.name), (Object)enumchatformatting);
        }
    }
}
