...
public class FoodStats {
    ...
    public void addStats(int foodLevelIn, float foodSaturationModifier) {
        this.foodLevel = Math.min((int)(foodLevelIn + this.foodLevel), (int)20);
        this.foodSaturationLevel = Math.min((float)(this.foodSaturationLevel + (float)foodLevelIn * foodSaturationModifier * 2.0f), (float)this.foodLevel);
    }
    ...
    public void onUpdate(EntityPlayer player) {
        ...
        if (this.foodExhaustionLevel > 4.0f) {
            ...
            if (this.foodSaturationLevel > 0.0f) {
                this.foodSaturationLevel = Math.max((float)(this.foodSaturationLevel - 1.0f), (float)0.0f);
    ...
    public void addExhaustion(float p_75113_1_) {
        this.foodExhaustionLevel = Math.min((float)(this.foodExhaustionLevel + p_75113_1_), (float)40.0f);
    }
