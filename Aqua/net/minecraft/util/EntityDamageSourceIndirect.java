...
extends EntityDamageSource {
    ...
    public IChatComponent getDeathMessage(EntityLivingBase entityLivingBaseIn) {
        ...
        String s1 = s + ".item";
        return itemstack != null && itemstack.hasDisplayName() && StatCollector.canTranslate((String)s1) ? new ChatComponentTranslation(s1, new Object[]{entityLivingBaseIn.getDisplayName(), ichatcomponent, itemstack.getChatComponent()}) : new ChatComponentTranslation(s, new Object[]{entityLivingBaseIn.getDisplayName(), ichatcomponent});
    }
}
