...
public class CombatTracker {
    ...
    public void trackDamage(DamageSource damageSrc, float healthIn, float damageAmount) {
        ...
        this.combatEntries.add((Object)combatentry);
    ...
    public IChatComponent getDeathMessage() {
        ...
        if (combatentry != null && combatentry1.getDamageSrc() == DamageSource.fall) {
            ...
            if (combatentry.getDamageSrc() != DamageSource.fall && combatentry.getDamageSrc() != DamageSource.outOfWorld) {
                if (!(ichatcomponent2 == null || ichatcomponent1 != null && ichatcomponent2.equals((Object)ichatcomponent1))) {
                    ...
                    ichatcomponent = itemstack1 != null && itemstack1.hasDisplayName() ? new ChatComponentTranslation("death.fell.assist.item", new Object[]{this.fighter.getDisplayName(), ichatcomponent2, itemstack1.getChatComponent()}) : new ChatComponentTranslation("death.fell.assist", new Object[]{this.fighter.getDisplayName(), ichatcomponent2});
                    ...
                    ichatcomponent = itemstack != null && itemstack.hasDisplayName() ? new ChatComponentTranslation("death.fell.finish.item", new Object[]{this.fighter.getDisplayName(), ichatcomponent1, itemstack.getChatComponent()}) : new ChatComponentTranslation("death.fell.finish", new Object[]{this.fighter.getDisplayName(), ichatcomponent1});
                } else {
    ...
    private CombatEntry func_94544_f() {
        ...
        for (int j = 0; j < this.combatEntries.size(); ++j) {
            ...
            CombatEntry combatEntry = combatentry3 = j > 0 ? (CombatEntry)this.combatEntries.get(j - 1) : null;
