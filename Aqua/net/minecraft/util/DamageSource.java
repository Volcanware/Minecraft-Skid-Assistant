...
public class DamageSource {
    ...
    public IChatComponent getDeathMessage(EntityLivingBase entityLivingBaseIn) {
        ...
        String s1 = s + ".player";
        return entitylivingbase != null && StatCollector.canTranslate((String)s1) ? new ChatComponentTranslation(s1, new Object[]{entityLivingBaseIn.getDisplayName(), entitylivingbase.getDisplayName()}) : new ChatComponentTranslation(s, new Object[]{entityLivingBaseIn.getDisplayName()});
    }
