...
IRangedAttackMob {
    ...
    private static final Predicate<Entity> attackEntitySelector = new /* Unavailable Anonymous Inner Class!! */;
    ...
    public void onLivingUpdate() {
        ...
        if (this.motionX * this.motionX + this.motionZ * this.motionZ > (double)0.05f) {
            this.rotationYaw = (float)MathHelper.atan2((double)this.motionZ, (double)this.motionX) * 57.295776f - 90.0f;
        }
        ...
        for (int j = 0; j < 2; ++j) {
            ...
            if (entity1 != null) {
                ...
                float f = (float)(MathHelper.atan2((double)d8, (double)d6) * 180.0 / Math.PI) - 90.0f;
                float f1 = (float)(-(MathHelper.atan2((double)d7, (double)d9) * 180.0 / Math.PI));
    ...
    protected void updateAITasks() {
        if (this.getInvulTime() > 0) {
            ...
            if (j1 <= 0) {
                this.worldObj.newExplosion((Entity)this, this.posX, this.posY + (double)this.getEyeHeight(), this.posZ, 7.0f, false, this.worldObj.getGameRules().getBoolean("mobGriefing"));
            ...
            block0: for (int i = 1; i < 3; ++i) {
                ...
                List list = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expand(20.0, 8.0, 20.0), Predicates.and(attackEntitySelector, (Predicate)EntitySelectors.NOT_SPECTATING));
            ...
            if (this.blockBreakCounter > 0) {
                ...
                if (this.blockBreakCounter == 0 && this.worldObj.getGameRules().getBoolean("mobGriefing")) {
                    int i1 = MathHelper.floor_double((double)this.posY);
                    int l1 = MathHelper.floor_double((double)this.posX);
                    int i2 = MathHelper.floor_double((double)this.posZ);
                    boolean flag = false;
    ...
    private float func_82204_b(float p_82204_1_, float p_82204_2_, float p_82204_3_) {
        float f = MathHelper.wrapAngleTo180_float((float)(p_82204_2_ - p_82204_1_));
        if (f > p_82204_3_) {
            f = p_82204_3_;
        }
        if (f < -p_82204_3_) {
    ...
    public void updateWatchedTargetId(int targetOffset, int newId) {
        this.dataWatcher.updateObject(17 + targetOffset, (Object)newId);
    }
