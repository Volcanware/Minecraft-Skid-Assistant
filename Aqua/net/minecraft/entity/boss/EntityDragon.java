...
IMob {
    ...
    public EntityDragonPart dragonPartHead = new EntityDragonPart((IEntityMultiPart)this, "head", 6.0f, 6.0f);
    public EntityDragonPart dragonPartBody = new EntityDragonPart((IEntityMultiPart)this, "body", 8.0f, 8.0f);
    public EntityDragonPart dragonPartTail1 = new EntityDragonPart((IEntityMultiPart)this, "tail", 4.0f, 4.0f);
    public EntityDragonPart dragonPartTail2 = new EntityDragonPart((IEntityMultiPart)this, "tail", 4.0f, 4.0f);
    public EntityDragonPart dragonPartTail3 = new EntityDragonPart((IEntityMultiPart)this, "tail", 4.0f, 4.0f);
    public EntityDragonPart dragonPartWing1 = new EntityDragonPart((IEntityMultiPart)this, "wing", 4.0f, 4.0f);
    public EntityDragonPart dragonPartWing2 = new EntityDragonPart((IEntityMultiPart)this, "wing", 4.0f, 4.0f);
    ...
    public void onLivingUpdate() {
        if (this.worldObj.isRemote) {
            float f = MathHelper.cos((float)(this.animTime * (float)Math.PI * 2.0f));
            float f1 = MathHelper.cos((float)(this.prevAnimTime * (float)Math.PI * 2.0f));
        ...
        if (this.getHealth() <= 0.0f) {
            ...
            float f10 = 0.2f / (MathHelper.sqrt_double((double)(this.motionX * this.motionX + this.motionZ * this.motionZ)) * 10.0f + 1.0f);
            this.animTime = this.slowed ? (this.animTime += f10 * 0.5f) : (this.animTime += (f10 *= (float)Math.pow((double)2.0, (double)this.motionY)));
            ...
            if (this.isAIDisabled()) {
                ...
                if (this.worldObj.isRemote) {
                    if (this.newPosRotationIncrements > 0) {
                        ...
                        double d2 = MathHelper.wrapAngleTo180_double((double)(this.newRotationYaw - (double)this.rotationYaw));
                    ...
                    if (this.target != null) {
                        ...
                        double d7 = Math.sqrt((double)(d3 * d3 + d5 * d5));
                    ...
                    d12 /= (double)MathHelper.sqrt_double((double)(d11 * d11 + d13 * d13));
                    float f17 = 0.6f;
                    d12 = MathHelper.clamp_double((double)d12, (double)(-f17), (double)f17);
                    this.motionY += d12 * (double)0.1f;
                    this.rotationYaw = MathHelper.wrapAngleTo180_float((float)this.rotationYaw);
                    double d4 = 180.0 - MathHelper.atan2((double)d11, (double)d13) * 180.0 / Math.PI;
                    ...
                    double d15 = -MathHelper.cos((float)(this.rotationYaw * (float)Math.PI / 180.0f));
                    Vec3 vec31 = new Vec3((double)MathHelper.sin((float)(this.rotationYaw * (float)Math.PI / 180.0f)), this.motionY, d15).normalize();
                    ...
                    double d9 = Math.sqrt((double)(this.motionX * this.motionX + this.motionZ * this.motionZ)) * 1.0 + 1.0;
                    if (d9 > 40.0) {
                        d9 = 40.0;
                    }
                ...
                float f2 = MathHelper.cos((float)f12);
                float f15 = -MathHelper.sin((float)f12);
                float f3 = this.rotationYaw * (float)Math.PI / 180.0f;
                float f16 = MathHelper.sin((float)f3);
                ...
                if (!this.worldObj.isRemote && this.hurtTime == 0) {
                    this.collideWithEntities((List<Entity>)this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.dragonPartWing1.getEntityBoundingBox().expand(4.0, 2.0, 4.0).offset(0.0, -2.0, 0.0)));
                    this.collideWithEntities((List<Entity>)this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.dragonPartWing2.getEntityBoundingBox().expand(4.0, 2.0, 4.0).offset(0.0, -2.0, 0.0)));
                    this.attackEntitiesInList((List<Entity>)this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.dragonPartHead.getEntityBoundingBox().expand(1.0, 1.0, 1.0)));
                }
                double[] adouble1 = this.getMovementOffsets(5, 1.0f);
                double[] adouble = this.getMovementOffsets(0, 1.0f);
                float f18 = MathHelper.sin((float)(this.rotationYaw * (float)Math.PI / 180.0f - this.randomYawVelocity * 0.01f));
                float f19 = MathHelper.cos((float)(this.rotationYaw * (float)Math.PI / 180.0f - this.randomYawVelocity * 0.01f));
                ...
                for (int j = 0; j < 3; ++j) {
                    ...
                    float f21 = MathHelper.sin((float)f20);
                    float f22 = MathHelper.cos((float)f20);
                    float f23 = 1.5f;
    ...
    private void collideWithEntities(List<Entity> p_70970_1_) {
        ...
        for (Entity entity : p_70970_1_) {
            ...
            entity.addVelocity(d2 / d4 * 4.0, (double)0.2f, d3 / d4 * 4.0);
        }
    }
    ...
    private void setNewTarget() {
        ...
        ArrayList list = Lists.newArrayList((Iterable)this.worldObj.playerEntities);
        ...
        if (!this.worldObj.isRemote) {
            if (this.deathTicks > 150 && this.deathTicks % 5 == 0 && flag) {
                ...
                for (int i = 1000; i > 0; i -= k) {
                    k = EntityXPOrb.getXPSplit((int)i);
        ...
        if (this.deathTicks == 200 && !this.worldObj.isRemote) {
            if (flag) {
                ...
                for (int j = 2000; j > 0; j -= l) {
                    l = EntityXPOrb.getXPSplit((int)j);
