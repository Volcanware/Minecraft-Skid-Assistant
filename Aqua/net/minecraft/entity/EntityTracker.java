...
public class EntityTracker {
    ...
    public void addEntityToTracker(Entity entityIn, int trackingRange, int updateFrequency, boolean sendVelocityUpdates) {
        ...
        try {
            ...
            this.trackedEntities.add((Object)entitytrackerentry);
            this.trackedEntityHashTable.addKey(entityIn.getEntityId(), (Object)entitytrackerentry);
            entitytrackerentry.updatePlayerEntities(this.theWorld.playerEntities);
        }
        catch (Throwable throwable) {
            CrashReport crashreport = CrashReport.makeCrashReport((Throwable)throwable, (String)"Adding entity to track");
            CrashReportCategory crashreportcategory = crashreport.makeCategory("Entity To Track");
            crashreportcategory.addCrashSection("Tracking range", (Object)(trackingRange + " blocks"));
            crashreportcategory.addCrashSectionCallable("Update interval", (Callable)new /* Unavailable Anonymous Inner Class!! */);
            entityIn.addEntityCrashInfo(crashreportcategory);
            CrashReportCategory crashreportcategory1 = crashreport.makeCategory("Entity That Is Already Tracked");
            ((EntityTrackerEntry)this.trackedEntityHashTable.lookup((int)entityIn.getEntityId())).trackedEntity.addEntityCrashInfo(crashreportcategory1);
            try {
    ...
    public void untrackEntity(Entity entityIn) {
        ...
        if ((entitytrackerentry1 = (EntityTrackerEntry)this.trackedEntityHashTable.removeObject(entityIn.getEntityId())) != null) {
            this.trackedEntities.remove((Object)entitytrackerentry1);
    ...
    public void updateTrackedEntities() {
        ...
        for (EntityTrackerEntry entitytrackerentry : this.trackedEntities) {
            ...
            list.add((Object)((EntityPlayerMP)entitytrackerentry.trackedEntity));
        }
