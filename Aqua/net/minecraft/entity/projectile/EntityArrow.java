...
implements IProjectile {
    ...
    public void setThrowableHeading(double x, double y, double z, float velocity, float inaccuracy) {
        float f = MathHelper.sqrt_double((double)(x * x + y * y + z * z));
        x /= (double)f;
        y /= (double)f;
        z /= (double)f;
        ...
        float f1 = MathHelper.sqrt_double((double)(x * x + z * z));
        this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.atan2((double)x, (double)z) * 180.0 / Math.PI);
        this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.atan2((double)y, (double)f1) * 180.0 / Math.PI);
    ...
    public void onUpdate() {
        ...
        if (this.prevRotationPitch == 0.0f && this.prevRotationYaw == 0.0f) {
            ...
            this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.atan2((double)this.motionX, (double)this.motionZ) * 180.0 / Math.PI);
            this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.atan2((double)this.motionY, (double)f) * 180.0 / Math.PI);
        }
        ...
        if (this.inGround) {
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    int l = MathHelper.ceiling_double_int((double)((double)f2 * this.damage));
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)l)) {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase) {
                            ...
                            if (this.knockbackStrength > 0 && (f7 = MathHelper.sqrt_double((double)(this.motionX * this.motionX + this.motionZ * this.motionZ))) > 0.0f) {
                            ...
                            if (this.shootingEntity instanceof EntityLivingBase) {
                                EnchantmentHelper.applyThornEnchantments((EntityLivingBase)entitylivingbase, (Entity)this.shootingEntity);
                                EnchantmentHelper.applyArthropodEnchantments((EntityLivingBase)((EntityLivingBase)this.shootingEntity), (Entity)entitylivingbase);
                            }
                    ...
                    float f5 = MathHelper.sqrt_double((double)(this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ));
                    ...
                    if (this.inTile.getMaterial() != Material.air) {
                        this.inTile.onEntityCollidedWithBlock(this.worldObj, blockpos1, iblockstate1, (Entity)this);
                    }
                }
            }
            if (this.getIsCritical()) {
            ...
            this.rotationPitch = (float)(MathHelper.atan2((double)this.motionY, (double)f3) * 180.0 / Math.PI);
