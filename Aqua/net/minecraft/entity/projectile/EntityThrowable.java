...
implements IProjectile {
    ...
    public EntityThrowable(World worldIn, EntityLivingBase throwerIn) {
        ...
        this.motionY = -MathHelper.sin((float)((this.rotationPitch + this.getInaccuracy()) / 180.0f * (float)Math.PI)) * f;
    ...
    public void onUpdate() {
        ...
        this.rotationPitch = (float)(MathHelper.atan2((double)this.motionY, (double)f1) * 180.0 / Math.PI);
    ...
    public EntityLivingBase getThrower() {
        if (this.thrower == null && this.throwerName != null && this.throwerName.length() > 0) {
            ...
            if (this.thrower == null && this.worldObj instanceof WorldServer) {
                try {
                    Entity entity = ((WorldServer)this.worldObj).getEntityFromUuid(UUID.fromString((String)this.throwerName));
