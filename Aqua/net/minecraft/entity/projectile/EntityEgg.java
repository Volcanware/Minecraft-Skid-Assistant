...
extends EntityThrowable {
    ...
    protected void onImpact(MovingObjectPosition p_70184_1_) {
        ...
        double d0 = 0.08;
        for (int k = 0; k < 8; ++k) {
            this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, this.posX, this.posY, this.posZ, ((double)this.rand.nextFloat() - 0.5) * 0.08, ((double)this.rand.nextFloat() - 0.5) * 0.08, ((double)this.rand.nextFloat() - 0.5) * 0.08, new int[]{Item.getIdFromItem((Item)Items.egg)});
        }
