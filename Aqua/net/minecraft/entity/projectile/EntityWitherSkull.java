...
extends EntityFireball {
    ...
    public float getExplosionResistance(Explosion explosionIn, World worldIn, BlockPos pos, IBlockState blockStateIn) {
        ...
        if (this.isInvulnerable() && EntityWither.canDestroyBlock((Block)block)) {
            f = Math.min((float)0.8f, (float)f);
        }
        return f;
    }
        ...
        if (!this.worldObj.isRemote) {
            if (movingObject.entityHit != null) {
                if (this.shootingEntity != null) {
                    if (movingObject.entityHit.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this.shootingEntity), 8.0f)) {
            ...
            this.worldObj.newExplosion((Entity)this, this.posX, this.posY, this.posZ, 1.0f, false, this.worldObj.getGameRules().getBoolean("mobGriefing"));
            this.setDead();
        }
    }
    ...
    public void setInvulnerable(boolean invulnerable) {
        this.dataWatcher.updateObject(10, (Object)((byte)(invulnerable ? 1 : 0)));
    }
}
