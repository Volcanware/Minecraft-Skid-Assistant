...
extends EntityZombie {
    private static final UUID ATTACK_SPEED_BOOST_MODIFIER_UUID = UUID.fromString((String)"49455A49-7EC5-45BA-B886-3B90B23A1718");
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        if (s.length() > 0) {
            this.angerTargetUUID = UUID.fromString((String)s);
            EntityPlayer entityplayer = this.worldObj.getPlayerEntityByUUID(this.angerTargetUUID);
            this.setRevengeTarget((EntityLivingBase)entityplayer);
    ...
    static /* synthetic */ void access$000(EntityPigZombie x0, Entity x1) {
        x0.becomeAngryAt(x1);
    }
}
