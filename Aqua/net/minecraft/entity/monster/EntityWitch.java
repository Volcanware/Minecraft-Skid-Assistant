...
implements IRangedAttackMob {
    private static final UUID MODIFIER_UUID = UUID.fromString((String)"5CD17E52-A79A-43D3-A529-90FDE04B181E");
    ...
    public void setAggressive(boolean aggressive) {
        this.getDataWatcher().updateObject(21, (Object)((byte)(aggressive ? 1 : 0)));
    }
    ...
    public void onLivingUpdate() {
        if (!this.worldObj.isRemote) {
            if (this.getAggressive()) {
                ...
                if (i > -1) {
                    this.setCurrentItemOrArmor(0, new ItemStack((Item)Items.potionitem, 1, i));
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase target, float p_82196_2_) {
        if (!this.getAggressive()) {
            ...
            float f = MathHelper.sqrt_double((double)(d1 * d1 + d3 * d3));
