...
implements ICommandSender {
    ...
    protected UUID entityUniqueID = MathHelper.getRandomUuid((Random)this.rand);
    ...
    public Entity(World worldIn) {
        ...
        this.dataWatcher.addObject(0, (Object)0);
        this.dataWatcher.addObject(1, (Object)300);
        this.dataWatcher.addObject(3, (Object)0);
        this.dataWatcher.addObject(2, (Object)"");
        this.dataWatcher.addObject(4, (Object)0);
        this.entityInit();
    }
    ...
    public void setAngles(float yaw, float pitch) {
        ...
        this.rotationPitch = MathHelper.clamp_float((float)this.rotationPitch, (float)-90.0f, (float)90.0f);
    ...
    public void setFire(int seconds) {
        int i = seconds * 20;
        if (this.fire < (i = EnchantmentProtection.getFireTimeForEntity((Entity)this, (int)i))) {
            this.fire = i;
        }
    }
                ...
                for (int j = blockpos.getY(); j <= blockpos1.getY(); ++j) {
                    for (int k = blockpos.getZ(); k <= blockpos1.getZ(); ++k) {
                        ...
                        try {
                            ...
                            CrashReportCategory.addBlockInfo((CrashReportCategory)crashreportcategory, (BlockPos)blockpos2, (IBlockState)iblockstate);
                            throw new ReportedException(crashreport);
                        }
                    }
                }
    ...
    public void setSilent(boolean isSilent) {
        this.dataWatcher.updateObject(4, (Object)((byte)(isSilent ? 1 : 0)));
    }
    ...
    public boolean handleWaterMovement() {
        if (this.worldObj.handleMaterialAcceleration(this.getEntityBoundingBox().expand(0.0, (double)-0.4f, 0.0).contract(0.001, 0.001, 0.001), Material.water, this)) {
    ...
    protected void resetHeight() {
        float f = MathHelper.sqrt_double((double)(this.motionX * this.motionX * (double)0.2f + this.motionY * this.motionY + this.motionZ * this.motionZ * (double)0.2f)) * 0.2f;
        if (f > 1.0f) {
            f = 1.0f;
        }
        this.playSound(this.getSplashSound(), f, 1.0f + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4f);
        float f1 = MathHelper.floor_double((double)this.getEntityBoundingBox().minY);
        int i = 0;
    ...
    protected void createRunningParticles() {
        ...
        int j;
        int i = MathHelper.floor_double((double)this.posX);
        BlockPos blockpos = new BlockPos(i, j = MathHelper.floor_double((double)(this.posY - (double)0.2f)), k = MathHelper.floor_double((double)this.posZ));
        IBlockState iblockstate = this.worldObj.getBlockState(blockpos);
        Block block = iblockstate.getBlock();
        if (block.getRenderType() != -1) {
            this.worldObj.spawnParticle(EnumParticleTypes.BLOCK_CRACK, this.posX + ((double)this.rand.nextFloat() - 0.5) * (double)this.width, this.getEntityBoundingBox().minY + 0.1, this.posZ + ((double)this.rand.nextFloat() - 0.5) * (double)this.width, -this.motionX * 4.0, 1.5, -this.motionZ * 4.0, new int[]{Block.getStateId((IBlockState)iblockstate)});
        }
    }
    ...
    public boolean isInsideOfMaterial(Material materialIn) {
        ...
        if (block.getMaterial() == materialIn) {
            float f = BlockLiquid.getLiquidHeightPercent((int)iblockstate.getBlock().getMetaFromState(iblockstate)) - 0.11111111f;
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        ...
        if (f >= 1.0E-4f) {
            ...
            try {
                boolean killaura;
                boolean bl = killaura = Aqua.moduleManager.getModuleByName("Killaura").isToggled() && Killaura.target != null && Aqua.setmgr.getSetting("KillauraCorrectMovement").isState();
                if (killaura) {
                    float f1 = MathHelper.sin((float)(RotationUtil.yaw * (float)Math.PI / 180.0f));
                    float f2 = MathHelper.cos((float)(RotationUtil.yaw * (float)Math.PI / 180.0f));
                    this.motionX += (double)(strafe * f2 - forward * f1);
                    this.motionZ += (double)(forward * f2 + strafe * f1);
                } else {
                    float f1 = MathHelper.sin((float)(this.rotationYaw * (float)Math.PI / 180.0f));
                    float f2 = MathHelper.cos((float)(this.rotationYaw * (float)Math.PI / 180.0f));
                    this.motionX += (double)(strafe * f2 - forward * f1);
                    this.motionZ += (double)(forward * f2 + strafe * f1);
                }
            }
    ...
    public double getDistance(double x, double y, double z) {
        ...
        double d1 = this.posY - y;
        double d2 = this.posZ - z;
        return MathHelper.sqrt_double((double)(d0 * d0 + d1 * d1 + d2 * d2));
    }
    ...
    public void applyEntityCollision(Entity entityIn) {
        ...
        double d0;
        double d2;
        if (entityIn.riddenByEntity != this && entityIn.ridingEntity != this && !entityIn.noClip && !this.noClip && (d2 = MathHelper.abs_max((double)(d0 = entityIn.posX - this.posX), (double)(d1 = entityIn.posZ - this.posZ))) >= (double)0.01f) {
    ...
    protected final Vec3 getVectorForRotation(float pitch, float yaw) {
        boolean build = Aqua.moduleManager.getModuleByName("Scaffold").isToggled() || Aqua.moduleManager.getModuleByName("Longjump").isToggled() || Aqua.moduleManager.getModuleByName("Killaura").isToggled() && Killaura.target != null && Aqua.setmgr.getSetting("KillauraLegitAttack").isState();
        float f = MathHelper.cos((float)(build ? -this.getRotationYawHead() * ((float)Math.PI / 180) - (float)Math.PI : -yaw * ((float)Math.PI / 180) - (float)Math.PI));
        float f1 = MathHelper.sin((float)(build ? -this.getRotationYawHead() * ((float)Math.PI / 180) - (float)Math.PI : -yaw * ((float)Math.PI / 180) - (float)Math.PI));
        float f2 = -MathHelper.cos((float)(build ? -this.rotationPitchHead * ((float)Math.PI / 180) : -pitch * ((float)Math.PI / 180)));
        float f3 = MathHelper.sin((float)(build ? -this.rotationPitchHead * ((float)Math.PI / 180) : -pitch * ((float)Math.PI / 180)));
    ...
    public void writeToNBT(NBTTagCompound tagCompund) {
        try {
            ...
            tagCompund.setTag("Pos", (NBTBase)this.newDoubleNBTList(this.posX, this.posY, this.posZ));
            tagCompund.setTag("Motion", (NBTBase)this.newDoubleNBTList(this.motionX, this.motionY, this.motionZ));
            tagCompund.setTag("Rotation", (NBTBase)this.newFloatNBTList(this.rotationYaw, this.rotationPitch));
            ...
            CrashReport crashreport = CrashReport.makeCrashReport((Throwable)throwable, (String)"Saving entity NBT");
    ...
    public void readFromNBT(NBTTagCompound tagCompund) {
        try {
            ...
            if (Math.abs((double)this.motionX) > 10.0) {
                this.motionX = 0.0;
            }
            if (Math.abs((double)this.motionY) > 10.0) {
                this.motionY = 0.0;
            }
            if (Math.abs((double)this.motionZ) > 10.0) {
                this.motionZ = 0.0;
            }
            ...
            if (tagCompund.hasKey("UUIDMost", 4) && tagCompund.hasKey("UUIDLeast", 4)) {
                ...
                this.entityUniqueID = UUID.fromString((String)tagCompund.getString("UUID"));
            }
            this.setPosition(this.posX, this.posY, this.posZ);
            ...
            CrashReport crashreport = CrashReport.makeCrashReport((Throwable)throwable, (String)"Loading entity NBT");
    ...
    public boolean isEntityInsideOpaqueBlock() {
        ...
        for (int i = 0; i < 8; ++i) {
            int j = MathHelper.floor_double((double)(this.posY + (double)(((float)((i >> 0) % 2) - 0.5f) * 0.1f) + (double)this.getEyeHeight()));
            int k = MathHelper.floor_double((double)(this.posX + (double)(((float)((i >> 1) % 2) - 0.5f) * this.width * 0.8f)));
            int l = MathHelper.floor_double((double)(this.posZ + (double)(((float)((i >> 2) % 2) - 0.5f) * this.width * 0.8f)));
            ...
            if (!this.worldObj.getBlockState((BlockPos)blockpos$mutableblockpos).getBlock().isVisuallyOpaque()) continue;
            return true;
        }
        return false;
    }
    ...
    public void setPositionAndRotation2(double x, double y, double z, float yaw, float pitch, int posRotationIncrements, boolean p_180426_10_) {
        ...
        this.setRotation(yaw, pitch);
        List list = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().contract(0.03125, 0.0, 0.03125));
        if (!list.isEmpty()) {
            double d0 = 0.0;
    ...
    public void setPortal(BlockPos pos) {
        if (this.timeUntilPortal > 0) {
            ...
            if (!this.worldObj.isRemote && !pos.equals((Object)this.lastPortalPos)) {
                ...
                d1 = Math.abs((double)MathHelper.func_181160_c((double)(d1 - (double)(blockpattern$patternhelper.getFinger().rotateY().getAxisDirection() == EnumFacing.AxisDirection.NEGATIVE ? 1 : 0)), (double)d0, (double)(d0 - (double)blockpattern$patternhelper.func_181118_d())));
                double d2 = MathHelper.func_181160_c((double)(this.posY - 1.0), (double)blockpattern$patternhelper.getPos().getY(), (double)(blockpattern$patternhelper.getPos().getY() - blockpattern$patternhelper.func_181119_e()));
    ...
    protected void setFlag(int flag, boolean set) {
        ...
        if (set) {
            this.dataWatcher.updateObject(0, (Object)((byte)(b0 | 1 << flag)));
        } else {
            this.dataWatcher.updateObject(0, (Object)((byte)(b0 & ~(1 << flag))));
        }
    }
    ...
    public void setAir(int air) {
        this.dataWatcher.updateObject(1, (Object)((short)air));
    }
    ...
    public String toString() {
        return String.format((String)"%s['%s'/%d, l='%s', x=%.2f, y=%.2f, z=%.2f]", (Object[])new Object[]{this.getClass().getSimpleName(), this.getName(), this.entityId, this.worldObj == null ? "~NULL~" : this.worldObj.getWorldInfo().getWorldName(), this.posX, this.posY, this.posZ});
    }
    ...
    public void addEntityCrashInfo(CrashReportCategory category) {
        category.addCrashSectionCallable("Entity Type", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        category.addCrashSection("Entity ID", (Object)this.entityId);
        category.addCrashSectionCallable("Entity Name", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        category.addCrashSection("Entity's Exact location", (Object)String.format((String)"%.2f, %.2f, %.2f", (Object[])new Object[]{this.posX, this.posY, this.posZ}));
        category.addCrashSection("Entity's Block location", (Object)CrashReportCategory.getCoordinateInfo((double)MathHelper.floor_double((double)this.posX), (double)MathHelper.floor_double((double)this.posY), (double)MathHelper.floor_double((double)this.posZ)));
        category.addCrashSection("Entity's Momentum", (Object)String.format((String)"%.2f, %.2f, %.2f", (Object[])new Object[]{this.motionX, this.motionY, this.motionZ}));
        category.addCrashSectionCallable("Entity's Rider", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        category.addCrashSectionCallable("Entity's Vehicle", (Callable)new /* Unavailable Anonymous Inner Class!! */);
    }
    ...
    public void setCustomNameTag(String name) {
        this.dataWatcher.updateObject(2, (Object)name);
    }
    ...
    public void setAlwaysRenderNameTag(boolean alwaysRenderNameTag) {
        this.dataWatcher.updateObject(3, (Object)((byte)(alwaysRenderNameTag ? 1 : 0)));
    }
    ...
    public EnumFacing getHorizontalFacing() {
        return EnumFacing.getHorizontal((int)(MathHelper.floor_double((double)((double)(this.rotationYaw * 4.0f / 360.0f) + 0.5)) & 3));
    }
    ...
    public void setCommandStat(CommandResultStats.Type type, int amount) {
        this.cmdResultStats.setCommandStatScore((ICommandSender)this, type, amount);
    }
    ...
    protected void applyEnchantments(EntityLivingBase entityLivingBaseIn, Entity entityIn) {
        if (entityIn instanceof EntityLivingBase) {
            EnchantmentHelper.applyThornEnchantments((EntityLivingBase)((EntityLivingBase)entityIn), (Entity)entityLivingBaseIn);
        }
        EnchantmentHelper.applyArthropodEnchantments((EntityLivingBase)entityLivingBaseIn, (Entity)entityIn);
    }
