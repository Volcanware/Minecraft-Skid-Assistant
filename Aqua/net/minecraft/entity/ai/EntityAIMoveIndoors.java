...
extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        if ((!this.entityObj.worldObj.isDaytime() || this.entityObj.worldObj.isRaining() && !this.entityObj.worldObj.getBiomeGenForCoords(blockpos).canRain()) && !this.entityObj.worldObj.provider.getHasNoSky()) {
            ...
            if (this.insidePosX != -1 && this.entityObj.getDistanceSq((double)this.insidePosX, this.entityObj.posY, (double)this.insidePosZ) < 4.0) {
                return false;
            }
    ...
    public void startExecuting() {
        ...
        if (this.entityObj.getDistanceSq(blockpos) > 256.0) {
            Vec3 vec3 = RandomPositionGenerator.findRandomTargetBlockTowards((EntityCreature)this.entityObj, (int)14, (int)3, (Vec3)new Vec3((double)i + 0.5, (double)j, (double)k + 0.5));
            if (vec3 != null) {
