...
extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        if (this.checkSufficientDoorsPresentForNewVillager() && this.villagerObj.getIsWillingToMate(true)) {
            Entity entity = this.worldObj.findNearestEntityWithinAABB(EntityVillager.class, this.villagerObj.getEntityBoundingBox().expand(8.0, 3.0, 8.0), (Entity)this.villagerObj);
            if (entity == null) {
                return false;
            }
