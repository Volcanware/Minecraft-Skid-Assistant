...
public class EntityLookHelper {
    ...
    public void onUpdateLook() {
        ...
        float f2 = MathHelper.wrapAngleTo180_float((float)(this.entity.rotationYawHead - this.entity.renderYawOffset));
    ...
    private float updateRotation(float p_75652_1_, float p_75652_2_, float p_75652_3_) {
        float f = MathHelper.wrapAngleTo180_float((float)(p_75652_2_ - p_75652_1_));
        if (f > p_75652_3_) {
            f = p_75652_3_;
        }
        if (f < -p_75652_3_) {
