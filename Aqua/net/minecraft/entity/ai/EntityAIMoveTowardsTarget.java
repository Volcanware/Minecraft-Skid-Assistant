...
extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        if (this.targetEntity.getDistanceSqToEntity((Entity)this.theEntity) > (double)(this.maxTargetDistance * this.maxTargetDistance)) {
            return false;
        }
        Vec3 vec3 = RandomPositionGenerator.findRandomTargetBlockTowards((EntityCreature)this.theEntity, (int)16, (int)7, (Vec3)new Vec3(this.targetEntity.posX, this.targetEntity.posY, this.targetEntity.posZ));
        if (vec3 == null) {
            return false;
        }
