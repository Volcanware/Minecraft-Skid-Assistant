...
public class EntitySenses {
    ...
    public boolean canSee(Entity entityIn) {
        if (this.seenEntities.contains((Object)entityIn)) {
            return true;
        }
        if (this.unseenEntities.contains((Object)entityIn)) {
            return false;
        }
        ...
        if (flag) {
            this.seenEntities.add((Object)entityIn);
        } else {
            this.unseenEntities.add((Object)entityIn);
        }
        return flag;
    }
}
