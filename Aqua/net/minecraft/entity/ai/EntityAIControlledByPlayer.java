...
extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        float f = MathHelper.wrapAngleTo180_float((float)(entityplayer.rotationYaw - this.thisEntity.rotationYaw)) * 0.5f;
        if (f > 5.0f) {
            f = 5.0f;
        }
        if (f < -5.0f) {
        ...
        this.thisEntity.rotationYaw = MathHelper.wrapAngleTo180_float((float)(this.thisEntity.rotationYaw + f));
        ...
        int i = MathHelper.floor_double((double)this.thisEntity.posX);
        int j = MathHelper.floor_double((double)this.thisEntity.posY);
        int k = MathHelper.floor_double((double)this.thisEntity.posZ);
        float f1 = this.currentSpeed;
        if (this.speedBoosted) {
            if (this.speedBoostTime++ > this.maxSpeedBoostTime) {
                this.speedBoosted = false;
            }
            f1 += f1 * 1.15f * MathHelper.sin((float)((float)this.speedBoostTime / (float)this.maxSpeedBoostTime * (float)Math.PI));
        }
        float f2 = 0.91f;
        ...
        float f4 = MathHelper.sin((float)(entitycreature.rotationYaw * (float)Math.PI / 180.0f));
        float f5 = MathHelper.cos((float)(entitycreature.rotationYaw * (float)Math.PI / 180.0f));
        float f6 = entitycreature.getAIMoveSpeed() * f3;
        float f7 = Math.max((float)f1, (float)1.0f);
        f7 = f6 / f7;
        float f8 = f1 * f7;
        float f9 = -(f8 * f4);
        float f10 = f8 * f5;
        if (MathHelper.abs((float)f9) > MathHelper.abs((float)f10)) {
            if (f9 < 0.0f) {
        ...
        int l = MathHelper.floor_double((double)(this.thisEntity.posX + (double)f9));
        int i1 = MathHelper.floor_double((double)(this.thisEntity.posZ + (double)f10));
        int j1 = MathHelper.floor_float((float)(this.thisEntity.width + 1.0f));
        int k1 = MathHelper.floor_float((float)(this.thisEntity.height + entityplayer.height + 1.0f));
        int l1 = MathHelper.floor_float((float)(this.thisEntity.width + 1.0f));
        if (i != l || k != i1) {
            boolean flag;
            ...
            if (flag && 0 == WalkNodeProcessor.func_176170_a((IBlockAccess)this.thisEntity.worldObj, (Entity)this.thisEntity, (int)l, (int)j, (int)i1, (int)j1, (int)k1, (int)l1, (boolean)false, (boolean)false, (boolean)true) && 1 == WalkNodeProcessor.func_176170_a((IBlockAccess)this.thisEntity.worldObj, (Entity)this.thisEntity, (int)i, (int)(j + 1), (int)k, (int)j1, (int)k1, (int)l1, (boolean)false, (boolean)false, (boolean)true) && 1 == WalkNodeProcessor.func_176170_a((IBlockAccess)this.thisEntity.worldObj, (Entity)this.thisEntity, (int)l, (int)(j + 1), (int)i1, (int)j1, (int)k1, (int)l1, (boolean)false, (boolean)false, (boolean)true)) {
