...
extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        ++this.spawnBabyDelay;
        if (this.spawnBabyDelay >= 60 && this.theAnimal.getDistanceSqToEntity((Entity)this.targetMate) < 9.0) {
            this.spawnBaby();
        }
    }
    ...
    private EntityAnimal getNearbyMate() {
        ...
        for (EntityAnimal entityanimal1 : list) {
            if (!this.theAnimal.canMateWith(entityanimal1) || !(this.theAnimal.getDistanceSqToEntity((Entity)entityanimal1) < d0)) continue;
