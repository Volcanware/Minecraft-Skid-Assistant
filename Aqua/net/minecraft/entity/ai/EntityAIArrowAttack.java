...
extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        if (--this.rangedAttackTime == 0) {
            ...
            float lvt_5_1_ = MathHelper.clamp_float((float)f, (float)0.1f, (float)1.0f);
            ...
            float f2 = MathHelper.sqrt_double((double)d0) / this.field_96562_i;
            this.rangedAttackTime = MathHelper.floor_float((float)(f2 * (float)(this.maxRangedAttackTime - this.field_96561_g) + (float)this.field_96561_g));
        }
    }
}
