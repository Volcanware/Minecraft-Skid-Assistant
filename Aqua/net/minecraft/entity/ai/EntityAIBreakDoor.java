...
extends EntityAIDoorInteract {
    ...
    public boolean shouldExecute() {
        ...
        return !BlockDoor.isOpen((IBlockAccess)this.theEntity.worldObj, (BlockPos)this.doorPosition);
    }
    ...
    public boolean continueExecuting() {
        ...
        if (this.breakingTime <= 240) {
            BlockDoor blockdoor = this.doorBlock;
            if (!BlockDoor.isOpen((IBlockAccess)this.theEntity.worldObj, (BlockPos)this.doorPosition) && d0 < 4.0) {
                boolean flag = true;
                return flag;
            }
        }
