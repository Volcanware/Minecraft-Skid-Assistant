...
public class SharedMonsterAttributes {
    ...
    public static final IAttribute maxHealth = new RangedAttribute((IAttribute)null, "generic.maxHealth", 20.0, 0.0, 1024.0).setDescription("Max Health").setShouldWatch(true);
    ...
    public static final IAttribute knockbackResistance = new RangedAttribute((IAttribute)null, "generic.knockbackResistance", 0.0, 0.0, 1.0).setDescription("Knockback Resistance");
    public static final IAttribute movementSpeed = new RangedAttribute((IAttribute)null, "generic.movementSpeed", (double)0.7f, 0.0, 1024.0).setDescription("Movement Speed").setShouldWatch(true);
    ...
    public static NBTTagList writeBaseAttributeMapToNBT(BaseAttributeMap map) {
        ...
        for (IAttributeInstance iattributeinstance : map.getAllAttributes()) {
            nbttaglist.appendTag((NBTBase)SharedMonsterAttributes.writeAttributeInstanceToNBT(iattributeinstance));
        }
        return nbttaglist;
    }
    ...
    private static NBTTagCompound writeAttributeInstanceToNBT(IAttributeInstance instance) {
        ...
        if (collection != null && !collection.isEmpty()) {
            ...
            for (AttributeModifier attributemodifier : collection) {
                ...
                nbttaglist.appendTag((NBTBase)SharedMonsterAttributes.writeAttributeModifierToNBT(attributemodifier));
            }
