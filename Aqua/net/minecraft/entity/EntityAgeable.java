...
extends EntityCreature {
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (itemstack != null && itemstack.getItem() == Items.spawn_egg) {
            ...
            Class oclass;
            if (!this.worldObj.isRemote && (oclass = EntityList.getClassFromID((int)itemstack.getMetadata())) != null && this.getClass() == oclass && (entityageable = this.createChild(this)) != null) {
                entityageable.setGrowingAge(-24000);
                entityageable.setLocationAndAngles(this.posX, this.posY, this.posZ, 0.0f, 0.0f);
                this.worldObj.spawnEntityInWorld((Entity)entityageable);
    ...
    public void setGrowingAge(int age) {
        this.dataWatcher.updateObject(12, (Object)((byte)MathHelper.clamp_int((int)age, (int)-1, (int)1)));
        this.growingAge = age;
