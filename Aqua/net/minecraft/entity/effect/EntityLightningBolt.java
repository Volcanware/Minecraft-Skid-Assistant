    ...
    public void onUpdate() {
        ...
        if (this.lightningState >= 0) {
            if (this.worldObj.isRemote) {
                ...
                double d0 = 3.0;
                List list = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, new AxisAlignedBB(this.posX - d0, this.posY - d0, this.posZ - d0, this.posX + d0, this.posY + 6.0 + d0, this.posZ + d0));
