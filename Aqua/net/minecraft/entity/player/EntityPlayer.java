...
extends EntityLivingBase {
    ...
    protected void entityInit() {
        ...
        this.dataWatcher.addObject(17, (Object)Float.valueOf((float)0.0f));
    ...
    public void onUpdate() {
        ...
        int i = 29999999;
        double d3 = MathHelper.clamp_double((double)this.posX, (double)-2.9999999E7, (double)2.9999999E7);
        double d4 = MathHelper.clamp_double((double)this.posZ, (double)-2.9999999E7, (double)2.9999999E7);
        ...
        if (itemStackIn.getItemUseAction() == EnumAction.EAT) {
            for (int i = 0; i < p_71010_2_; ++i) {
                ...
                if (itemStackIn.getHasSubtypes()) {
                    this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, vec31.xCoord, vec31.yCoord, vec31.zCoord, vec3.xCoord, vec3.yCoord + 0.05, vec3.zCoord, new int[]{Item.getIdFromItem((Item)itemStackIn.getItem()), itemStackIn.getMetadata()});
                    continue;
                }
                this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, vec31.xCoord, vec31.yCoord, vec31.zCoord, vec3.xCoord, vec3.yCoord + 0.05, vec3.zCoord, new int[]{Item.getIdFromItem((Item)itemStackIn.getItem())});
            }
    ...
    public void onLivingUpdate() {
        ...
        float f1 = (float)(Math.atan((double)(-this.motionY * (double)0.2f)) * 15.0);
        if (f > 0.1f) {
            f = 0.1f;
        }
        ...
        if (this.getHealth() > 0.0f && !this.isSpectator()) {
            ...
            List list = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, axisalignedbb);
    ...
    public void setScore(int p_85040_1_) {
        this.dataWatcher.updateObject(18, (Object)p_85040_1_);
    }

    public void addScore(int p_85039_1_) {
        int i = this.getScore();
        this.dataWatcher.updateObject(18, (Object)(i + p_85039_1_));
    }
    ...
    public void onDeath(DamageSource cause) {
        ...
        this.motionY = 0.1f;
        if (this.getName().equals((Object)"Notch")) {
        ...
        if (cause != null) {
            this.motionX = -MathHelper.cos((float)((this.attackedAtYaw + this.rotationYaw) * (float)Math.PI / 180.0f)) * 0.1f;
            this.motionZ = -MathHelper.sin((float)((this.attackedAtYaw + this.rotationYaw) * (float)Math.PI / 180.0f)) * 0.1f;
        } else {
            this.motionZ = 0.0;
            this.motionX = 0.0;
        }
    ...
    public EntityItem dropItem(ItemStack droppedItem, boolean dropAround, boolean traceItem) {
        ...
        if (dropAround) {
            ...
            entityitem.motionX = -MathHelper.sin((float)f1) * f;
            entityitem.motionZ = MathHelper.cos((float)f1) * f;
            entityitem.motionY = 0.2f;
        } else {
            float f2 = 0.3f;
            entityitem.motionX = -MathHelper.sin((float)(this.rotationYaw / 180.0f * (float)Math.PI)) * MathHelper.cos((float)(this.rotationPitch / 180.0f * (float)Math.PI)) * f2;
            entityitem.motionZ = MathHelper.cos((float)(this.rotationYaw / 180.0f * (float)Math.PI)) * MathHelper.cos((float)(this.rotationPitch / 180.0f * (float)Math.PI)) * f2;
            entityitem.motionY = -MathHelper.sin((float)(this.rotationPitch / 180.0f * (float)Math.PI)) * f2 + 0.1f;
    ...
    public float getToolDigEfficiency(Block p_180471_1_) {
        ...
        if (f > 1.0f) {
            int i = EnchantmentHelper.getEfficiencyModifier((EntityLivingBase)this);
            ItemStack itemstack = this.inventory.getCurrentItem();
        ...
        if (this.isInsideOfMaterial(Material.water) && !EnchantmentHelper.getAquaAffinityModifier((EntityLivingBase)this)) {
            f /= 5.0f;
        }
        if (!this.onGround) {
            f /= 5.0f;
        ...
        if (!this.isEntityInvulnerable(damageSrc)) {
            ...
            if (damageAmount != 0.0f) {
                ...
                if (damageAmount < 3.4028235E37f) {
                    this.addStat(StatList.damageTakenStat, Math.round((float)(damageAmount * 10.0f)));
                }
            }
        }
    }
    ...
    public void attackTargetEntityWithCurrentItem(Entity targetEntity) {
        if (targetEntity.canAttackWithItem() && !targetEntity.hitByEntity((Entity)this)) {
            ...
            int i = 0;
            float f1 = 0.0f;
            f1 = targetEntity instanceof EntityLivingBase ? EnchantmentHelper.getModifierForCreature((ItemStack)this.getHeldItem(), (EnumCreatureAttribute)((EntityLivingBase)targetEntity).getCreatureAttribute()) : EnchantmentHelper.getModifierForCreature((ItemStack)this.getHeldItem(), (EnumCreatureAttribute)EnumCreatureAttribute.UNDEFINED);
            ...
            if (f > 0.0f || f1 > 0.0f) {
                ...
                boolean flag2 = targetEntity.attackEntityFrom(DamageSource.causePlayerDamage((EntityPlayer)this), f);
                if (flag2) {
                    ...
                    if (targetEntity instanceof EntityLivingBase) {
                        this.addStat(StatList.damageDealtStat, Math.round((float)(f * 10.0f)));
                        if (j > 0) {
    ...
    public EnumStatus trySleep(BlockPos bedLocation) {
        if (!this.worldObj.isRemote) {
            ...
            if (Math.abs((double)(this.posX - (double)bedLocation.getX())) > 3.0 || Math.abs((double)(this.posY - (double)bedLocation.getY())) > 2.0 || Math.abs((double)(this.posZ - (double)bedLocation.getZ())) > 3.0) {
    ...
    public void wakeUpPlayer(boolean immediately, boolean updateWorldFlag, boolean setSpawn) {
        ...
        if (this.playerLocation != null && iblockstate.getBlock() == Blocks.bed) {
            this.worldObj.setBlockState(this.playerLocation, iblockstate.withProperty((IProperty)BlockBed.OCCUPIED, (Comparable)Boolean.valueOf((boolean)false)), 4);
            BlockPos blockpos = BlockBed.getSafeExitLocation((World)this.worldObj, (BlockPos)this.playerLocation, (int)0);
            if (blockpos == null) {
    ...
    public static BlockPos getBedSpawnLocation(World worldIn, BlockPos bedLocation, boolean forceSpawn) {
        ...
        return BlockBed.getSafeExitLocation((World)worldIn, (BlockPos)bedLocation, (int)0);
    }
    ...
    public void addMovementStat(double p_71000_1_, double p_71000_3_, double p_71000_5_) {
        if (this.ridingEntity == null) {
            if (this.isInsideOfMaterial(Material.water)) {
                int i = Math.round((float)(MathHelper.sqrt_double((double)(p_71000_1_ * p_71000_1_ + p_71000_3_ * p_71000_3_ + p_71000_5_ * p_71000_5_)) * 100.0f));
                if (i > 0) {
                    this.addStat(StatList.distanceDoveStat, i);
                    this.addExhaustion(0.015f * (float)i * 0.01f);
                }
            } else if (this.isInWater()) {
                int j = Math.round((float)(MathHelper.sqrt_double((double)(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_)) * 100.0f));
                if (j > 0) {
                ...
                if (p_71000_3_ > 0.0) {
                    this.addStat(StatList.distanceClimbedStat, (int)Math.round((double)(p_71000_3_ * 100.0)));
                }
            } else if (this.onGround) {
                int k = Math.round((float)(MathHelper.sqrt_double((double)(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_)) * 100.0f));
                if (k > 0) {
                ...
                int l = Math.round((float)(MathHelper.sqrt_double((double)(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_)) * 100.0f));
                if (l > 25) {
    ...
    private void addMountedMovementStat(double p_71015_1_, double p_71015_3_, double p_71015_5_) {
        int i;
        if (this.ridingEntity != null && (i = Math.round((float)(MathHelper.sqrt_double((double)(p_71015_1_ * p_71015_1_ + p_71015_3_ * p_71015_3_ + p_71015_5_ * p_71015_5_)) * 100.0f))) > 0) {
            if (this.ridingEntity instanceof EntityMinecart) {
                ...
                } else if (this.startMinecartRidingCoordinate.distanceSq((double)MathHelper.floor_double((double)this.posX), (double)MathHelper.floor_double((double)this.posY), (double)MathHelper.floor_double((double)this.posZ)) >= 1000000.0) {
                    this.triggerAchievement((StatBase)AchievementList.onARail);
                }
    ...
    public void fall(float distance, float damageMultiplier) {
        if (!this.capabilities.allowFlying) {
            if (distance >= 2.0f) {
                this.addStat(StatList.distanceFallenStat, (int)Math.round((double)((double)distance * 100.0)));
            }
    ...
    public void onKillEntity(EntityLivingBase entityLivingIn) {
        ...
        if (entityLivingIn instanceof IMob) {
            this.triggerAchievement((StatBase)AchievementList.killEnemy);
        }
        if ((entitylist$entityegginfo = (EntityList.EntityEggInfo)EntityList.entityEggs.get((Object)EntityList.getEntityID((Entity)entityLivingIn))) != null) {
    ...
    public void clonePlayer(EntityPlayer oldPlayer, boolean respawnFromEnd) {
        ...
        this.getDataWatcher().updateObject(10, (Object)oldPlayer.getDataWatcher().getWatchableObjectByte(10));
    }
    ...
    public IChatComponent getDisplayName() {
        ChatComponentText ichatcomponent = new ChatComponentText(ScorePlayerTeam.formatPlayerName((Team)this.getTeam(), (String)this.getName()));
    ...
    public void setAbsorptionAmount(float amount) {
        ...
        this.getDataWatcher().updateObject(17, (Object)Float.valueOf((float)amount));
    }
    ...
    public static UUID getOfflineUUID(String username) {
        return UUID.nameUUIDFromBytes((byte[])("OfflinePlayer:" + username).getBytes(Charsets.UTF_8));
    }
    ...
    public boolean canOpen(LockCode code) {
        ...
        ItemStack itemstack = this.getCurrentEquippedItem();
        return itemstack != null && itemstack.hasDisplayName() ? itemstack.getDisplayName().equals((Object)code.getLock()) : false;
    }
    ...
    public boolean replaceItemInInventory(int inventorySlot, ItemStack itemStackIn) {
        ...
        if (i >= 0 && i < this.inventory.armorInventory.length) {
            int k = i + 1;
            if (itemStackIn != null && itemStackIn.getItem() != null && (itemStackIn.getItem() instanceof ItemArmor ? EntityLiving.getArmorPosition((ItemStack)itemStackIn) != k : k != 4 || itemStackIn.getItem() != Items.skull && !(itemStackIn.getItem() instanceof ItemBlock))) {
                return false;
            }
