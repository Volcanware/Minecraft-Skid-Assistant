...
extends Entity {
    private static final UUID sprintingSpeedBoostModifierUUID = UUID.fromString((String)"662A6B8D-DA3E-4C1C-8813-96EA6097278D");
    ...
    protected void entityInit() {
        this.dataWatcher.addObject(7, (Object)0);
        this.dataWatcher.addObject(8, (Object)0);
        this.dataWatcher.addObject(9, (Object)0);
        this.dataWatcher.addObject(6, (Object)Float.valueOf((float)1.0f));
    }
    ...
    protected void updateFallState(double y, boolean onGroundIn, Block blockIn, BlockPos pos) {
        ...
        if (!this.worldObj.isRemote && this.fallDistance > 3.0f && onGroundIn) {
            ...
            float f = MathHelper.ceiling_float_int((float)(this.fallDistance - 3.0f));
            if (block.getMaterial() != Material.air) {
                double d0 = Math.min((float)(0.2f + f / 15.0f), (float)10.0f);
                if (d0 > 2.5) {
                    d0 = 2.5;
                }
                int i = (int)(150.0 * d0);
                ((WorldServer)this.worldObj).spawnParticle(EnumParticleTypes.BLOCK_DUST, this.posX, this.posY, this.posZ, i, 0.0, 0.0, 0.0, (double)0.15f, new int[]{Block.getStateId((IBlockState)iblockstate)});
            }
        }
    ...
    public void onEntityUpdate() {
        ...
        if (this.isEntityAlive()) {
            ...
            } else if (flag && !this.worldObj.getWorldBorder().contains(this.getEntityBoundingBox()) && (d0 = this.worldObj.getWorldBorder().getClosestDistance((Entity)this) + this.worldObj.getWorldBorder().getDamageBuffer()) < 0.0) {
                this.attackEntityFrom(DamageSource.inWall, Math.max((int)1, (int)MathHelper.floor_double((double)(-d0 * this.worldObj.getWorldBorder().getDamageAmount()))));
            }
        }
    ...
    protected int decreaseAirSupply(int p_70682_1_) {
        int i = EnchantmentHelper.getRespiration((Entity)this);
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        tagCompound.setShort("Health", (short)Math.ceil((double)this.getHealth()));
        ...
        tagCompound.setTag("Attributes", (NBTBase)SharedMonsterAttributes.writeBaseAttributeMapToNBT((BaseAttributeMap)this.getAttributeMap()));
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        if (tagCompund.hasKey("Attributes", 9) && this.worldObj != null && !this.worldObj.isRemote) {
            SharedMonsterAttributes.setAttributeModifiers((BaseAttributeMap)this.getAttributeMap(), (NBTTagList)tagCompund.getTagList("Attributes", 10));
        }
        if (tagCompund.hasKey("ActiveEffects", 9)) {
            ...
            for (int i = 0; i < nbttaglist.tagCount(); ++i) {
                ...
                this.activePotionsMap.put((Object)potioneffect.getPotionID(), (Object)potioneffect);
            }
        }
    ...
    protected void updatePotionEffects() {
        ...
        while (iterator.hasNext()) {
            ...
            PotionEffect potioneffect = (PotionEffect)this.activePotionsMap.get((Object)integer);
    ...
    protected void updatePotionMetadata() {
        if (this.activePotionsMap.isEmpty()) {
            ...
            int i = PotionHelper.calcPotionLiquidColor((Collection)this.activePotionsMap.values());
            this.dataWatcher.updateObject(8, (Object)((byte)(PotionHelper.getAreAmbient((Collection)this.activePotionsMap.values()) ? 1 : 0)));
            this.dataWatcher.updateObject(7, (Object)i);
    ...
    public boolean isPotionActive(int potionId) {
        return this.activePotionsMap.containsKey((Object)potionId);
    }

    public boolean isPotionActive(Potion potionIn) {
        return this.activePotionsMap.containsKey((Object)potionIn.id);
    }

    public PotionEffect getActivePotionEffect(Potion potionIn) {
        return (PotionEffect)this.activePotionsMap.get((Object)potionIn.id);
    }

    public void addPotionEffect(PotionEffect potioneffectIn) {
        if (this.isPotionApplicable(potioneffectIn)) {
            if (this.activePotionsMap.containsKey((Object)potioneffectIn.getPotionID())) {
                ((PotionEffect)this.activePotionsMap.get((Object)potioneffectIn.getPotionID())).combine(potioneffectIn);
                this.onChangedPotionEffect((PotionEffect)this.activePotionsMap.get((Object)potioneffectIn.getPotionID()), true);
            } else {
                this.activePotionsMap.put((Object)potioneffectIn.getPotionID(), (Object)potioneffectIn);
    ...
    public void removePotionEffectClient(int potionId) {
        this.activePotionsMap.remove((Object)potionId);
    }

    public void removePotionEffect(int potionId) {
        PotionEffect potioneffect = (PotionEffect)this.activePotionsMap.remove((Object)potionId);
    ...
    public void setHealth(float health) {
        this.dataWatcher.updateObject(6, (Object)Float.valueOf((float)MathHelper.clamp_float((float)health, (float)0.0f, (float)this.getMaxHealth())));
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        if (flag) {
            ...
            if (entity != null) {
                ...
                this.attackedAtYaw = (float)(MathHelper.atan2((double)d0, (double)d1) * 180.0 / Math.PI - (double)this.rotationYaw);
    ...
    public void renderBrokenItemStack(ItemStack stack) {
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, vec31.xCoord, vec31.yCoord, vec31.zCoord, vec3.xCoord, vec3.yCoord + 0.05, vec3.zCoord, new int[]{Item.getIdFromItem((Item)stack.getItem())});
        }
    }
    ...
    public void knockBack(Entity entityIn, float p_70653_2_, double p_70653_3_, double p_70653_5_) {
        if (this.rand.nextDouble() >= this.getEntityAttribute(SharedMonsterAttributes.knockbackResistance).getAttributeValue()) {
            ...
            float f = MathHelper.sqrt_double((double)(p_70653_3_ * p_70653_3_ + p_70653_5_ * p_70653_5_));
            float f1 = 0.4f;
            this.motionX /= 2.0;
            this.motionY /= 2.0;
            this.motionZ /= 2.0;
    ...
    public boolean isOnLadder() {
        ...
        Block block = this.worldObj.getBlockState(new BlockPos(i, j = MathHelper.floor_double((double)this.getEntityBoundingBox().minY), k = MathHelper.floor_double((double)this.posZ))).getBlock();
    ...
    public void fall(float distance, float damageMultiplier) {
        ...
        int i = MathHelper.ceiling_float_int((float)((distance - 3.0f - f) * damageMultiplier));
        if (i > 0) {
            this.playSound(this.getFallSoundString(i), 1.0f, 1.0f);
            this.attackEntityFrom(DamageSource.fall, i);
            int j = MathHelper.floor_double((double)this.posX);
            int k = MathHelper.floor_double((double)(this.posY - (double)0.2f));
    ...
    protected float applyPotionDamageCalculations(DamageSource source, float damage) {
        ...
        int k = EnchantmentHelper.getEnchantmentModifierDamage((ItemStack[])this.getInventory(), (DamageSource)source);
        if (k > 20) {
            k = 20;
        }
        if (k > 0 && k <= 20) {
    ...
    protected void damageEntity(DamageSource damageSrc, float damageAmount) {
        if (!this.isEntityInvulnerable(damageSrc)) {
            ...
            damageAmount = Math.max((float)(damageAmount - this.getAbsorptionAmount()), (float)0.0f);
    ...
    public final void setArrowCountInEntity(int count) {
        this.dataWatcher.updateObject(9, (Object)((byte)count));
    }
    ...
    public void swingItem() {
        if (!this.isSwingInProgress || this.swingProgressInt >= this.getArmSwingAnimationEnd() / 2 || this.swingProgressInt < 0) {
            ...
            if (this.worldObj instanceof WorldServer) {
                ((WorldServer)this.worldObj).getEntityTracker().sendToAllTrackingEntity((Entity)this, (Packet)new S0BPacketAnimation((Entity)this, 0));
            }
        }
    }
    ...
    public void dismountEntity(Entity entityIn) {
        ...
        for (int j = -i; j <= i; ++j) {
            for (int k = -i; k < i; ++k) {
                ...
                if (World.doesBlockHaveSolidTopSurface((IBlockAccess)this.worldObj, (BlockPos)new BlockPos(l, (int)this.posY, i1))) {
                    this.setPositionAndUpdate(this.posX + (double)j, this.posY + 1.0, this.posZ + (double)k);
                    return;
                }
                if (!World.doesBlockHaveSolidTopSurface((IBlockAccess)this.worldObj, (BlockPos)new BlockPos(l, (int)this.posY - 1, i1)) && this.worldObj.getBlockState(new BlockPos(l, (int)this.posY - 1, i1)).getBlock().getMaterial() != Material.water) continue;
    ...
    protected void jump() {
        ...
        if (this.isSprinting()) {
            if (Aqua.setmgr.getSetting("KillauraJumpFix").isState() && Killaura.target != null) {
                float f = EventPreMotion.getYaw() * ((float)Math.PI / 180);
    ...
    public void moveEntityWithHeading(float strafe, float forward) {
            ...
            if (!this.isInWater() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying) {
                if (!this.isInLava() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying) {
                    ...
                    if (this.isOnLadder()) {
                        boolean flag;
                        float f6 = 0.15f;
                        this.motionX = MathHelper.clamp_double((double)this.motionX, (double)(-f6), (double)f6);
                        this.motionZ = MathHelper.clamp_double((double)this.motionZ, (double)(-f6), (double)f6);
                ...
                float f1 = 0.8f;
                float f2 = 0.02f;
                float f3 = EnchantmentHelper.getDepthStriderModifier((Entity)this);
                if (f3 > 3.0f) {
                    f3 = 3.0f;
                }
                if (!this.onGround) {
        ...
        float f7 = MathHelper.sqrt_double((double)(d2 * d2 + d3 * d3)) * 4.0f;
        if (f7 > 1.0f) {
            f7 = 1.0f;
        }
    ...
    public void onUpdate() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            for (int j = 0; j < 5; ++j) {
                ...
                ((WorldServer)this.worldObj).getEntityTracker().sendToAllTrackingEntity((Entity)this, (Packet)new S04PacketEntityEquipment(this.getEntityId(), j, itemstack1));
                if (itemstack != null) {
                    this.attributeMap.removeAttributeModifiers(itemstack.getAttributeModifiers());
                }
                if (itemstack1 != null) {
        ...
        if (f > 0.0025000002f) {
            ...
            f1 = (float)MathHelper.atan2((double)d1, (double)d0) * 180.0f / (float)Math.PI - 90.0f;
        }
    ...
    protected float updateDistance(float p_110146_1_, float p_110146_2_) {
        boolean flag;
        float f = MathHelper.wrapAngleTo180_float((float)(p_110146_1_ - this.renderYawOffset));
        this.renderYawOffset += f * 0.3f;
        float f1 = MathHelper.wrapAngleTo180_float((float)(this.rotationYaw - this.renderYawOffset));
    ...
    public void onLivingUpdate() {
        ...
        if (Math.abs((double)this.motionX) < 0.005) {
            this.motionX = 0.0;
        }
        if (Math.abs((double)this.motionY) < 0.005) {
            this.motionY = 0.0;
        }
        if (Math.abs((double)this.motionZ) < 0.005) {
            this.motionZ = 0.0;
        }
    ...
    protected void collideWithNearbyEntities() {
        List list = this.worldObj.getEntitiesInAABBexcluding((Entity)this, this.getEntityBoundingBox().expand((double)0.2f, 0.0, (double)0.2f), Predicates.and((Predicate)EntitySelectors.NOT_SPECTATING, (Predicate)new /* Unavailable Anonymous Inner Class!! */));
        if (!list.isEmpty()) {
    ...
    protected void collideWithEntity(Entity entityIn) {
        entityIn.applyEntityCollision((Entity)this);
    }
    ...
    public void onItemPickup(Entity p_71001_1_, int p_71001_2_) {
        if (!p_71001_1_.isDead && !this.worldObj.isRemote) {
            ...
            if (p_71001_1_ instanceof EntityItem) {
                entitytracker.sendToAllTrackingEntity(p_71001_1_, (Packet)new S0DPacketCollectItem(p_71001_1_.getEntityId(), this.getEntityId()));
            }
