...
extends Entity {
    ...
    public void onUpdate() {
        if (this.getEntityItem() == null) {
            ...
            if (flag || this.ticksExisted % 25 == 0) {
                if (this.worldObj.getBlockState(new BlockPos((Entity)this)).getBlock().getMaterial() == Material.lava) {
                    this.motionY = 0.2f;
        ...
        if (other.isEntityAlive() && this.isEntityAlive()) {
            ...
            if (this.delayBeforeCanPickup != Short.MAX_VALUE && other.delayBeforeCanPickup != Short.MAX_VALUE) {
                if (this.age != Short.MIN_VALUE && other.age != Short.MIN_VALUE) {
                    ...
                    if (itemstack1.hasTagCompound() && !itemstack1.getTagCompound().equals((Object)itemstack.getTagCompound())) {
                        return false;
                    }
                    ...
                    other.delayBeforeCanPickup = Math.max((int)other.delayBeforeCanPickup, (int)this.delayBeforeCanPickup);
                    other.age = Math.min((int)other.age, (int)this.age);
    ...
    public boolean handleWaterMovement() {
        if (this.worldObj.handleMaterialAcceleration(this.getEntityBoundingBox(), Material.water, (Entity)this)) {
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        if (this.getEntityItem() != null) {
            tagCompound.setTag("Item", (NBTBase)this.getEntityItem().writeToNBT(new NBTTagCompound()));
        }
    }
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.setEntityItemStack(ItemStack.loadItemStackFromNBT((NBTTagCompound)nbttagcompound));
        if (this.getEntityItem() == null) {
            this.setDead();
        }
    }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn) {
        if (!this.worldObj.isRemote) {
            ...
            if (this.delayBeforeCanPickup == 0 && (this.owner == null || 6000 - this.age <= 200 || this.owner.equals((Object)entityIn.getName())) && entityIn.inventory.addItemStackToInventory(itemstack)) {
                EntityPlayer entityplayer;
                if (itemstack.getItem() == Item.getItemFromBlock((Block)Blocks.log)) {
                    entityIn.triggerAchievement((StatBase)AchievementList.mineWood);
                }
                if (itemstack.getItem() == Item.getItemFromBlock((Block)Blocks.log2)) {
                    entityIn.triggerAchievement((StatBase)AchievementList.mineWood);
                }
                ...
                entityIn.onItemPickup((Entity)this, i);
    ...
    public String getName() {
        return this.hasCustomName() ? this.getCustomNameTag() : StatCollector.translateToLocal((String)("item." + this.getEntityItem().getUnlocalizedName()));
    }
    ...
    public void setEntityItemStack(ItemStack stack) {
        this.getDataWatcher().updateObject(10, (Object)stack);
