...
extends Entity {
    ...
    public void onUpdate() {
        ...
        double d9 = Math.sqrt((double)(this.motionX * this.motionX + this.motionZ * this.motionZ));
        if (d9 > 0.2975) {
            double d2 = Math.cos((double)((double)this.rotationYaw * Math.PI / 180.0));
            double d4 = Math.sin((double)((double)this.rotationYaw * Math.PI / 180.0));
            int k = 0;
        ...
        if (this.worldObj.isRemote && this.isBoatEmpty) {
            if (this.boatPosRotationIncrements > 0) {
                ...
                double d22 = MathHelper.wrapAngleTo180_double((double)(this.boatYaw - (double)this.rotationYaw));
            ...
            if ((d11 = Math.sqrt((double)(this.motionX * this.motionX + this.motionZ * this.motionZ))) > 0.35) {
                double d14 = 0.35 / d11;
                this.motionX *= d14;
                this.motionZ *= d14;
                d11 = 0.35;
            ...
            for (int i1 = 0; i1 < 4; ++i1) {
                int l1 = MathHelper.floor_double((double)(this.posX + ((double)(i1 % 2) - 0.5) * 0.8));
                int i2 = MathHelper.floor_double((double)(this.posZ + ((double)(i1 / 2) - 0.5) * 0.8));
                for (int j2 = 0; j2 < 2; ++j2) {
                    int l = MathHelper.floor_double((double)this.posY) + j2;
                ...
                if (!this.worldObj.isRemote && !this.isDead) {
                    ...
                    if (this.worldObj.getGameRules().getBoolean("doEntityDrops")) {
                        for (int j1 = 0; j1 < 3; ++j1) {
                            this.dropItemWithOffset(Item.getItemFromBlock((Block)Blocks.planks), 1, 0.0f);
                        }
            ...
            if (d18 * d18 + d21 * d21 > 0.001) {
                d15 = (float)(MathHelper.atan2((double)d21, (double)d18) * 180.0 / Math.PI);
            }
            if ((d23 = MathHelper.wrapAngleTo180_double((double)(d15 - (double)this.rotationYaw))) > 20.0) {
                d23 = 20.0;
            }
            if (d23 < -20.0) {
                d23 = -20.0;
            ...
            if (!this.worldObj.isRemote) {
                List list = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.getEntityBoundingBox().expand((double)0.2f, 0.0, (double)0.2f));
    ...
    public void updateRiderPosition() {
        if (this.riddenByEntity != null) {
            double d0 = Math.cos((double)((double)this.rotationYaw * Math.PI / 180.0)) * 0.4;
            double d1 = Math.sin((double)((double)this.rotationYaw * Math.PI / 180.0)) * 0.4;
    ...
    public boolean interactFirst(EntityPlayer playerIn) {
        ...
        if (!this.worldObj.isRemote) {
            playerIn.mountEntity((Entity)this);
        }
        return true;
    }
    ...
    protected void updateFallState(double y, boolean onGroundIn, Block blockIn, BlockPos pos) {
        ...
        } else if (this.worldObj.getBlockState(new BlockPos((Entity)this).down()).getBlock().getMaterial() != Material.water && y < 0.0) {
            this.fallDistance = (float)((double)this.fallDistance - y);
        }
    }

    public void setDamageTaken(float p_70266_1_) {
        this.dataWatcher.updateObject(19, (Object)Float.valueOf((float)p_70266_1_));
    }
