...
extends EntityHanging {
    ...
    protected void entityInit() {
        ...
        this.getDataWatcher().addObject(9, (Object)0);
    }
    ...
    private void removeFrameFromMap(ItemStack p_110131_1_) {
        if (p_110131_1_ != null) {
            if (p_110131_1_.getItem() == Items.filled_map) {
                ...
                mapdata.mapDecorations.remove((Object)("frame-" + this.getEntityId()));
            }
    ...
    private void setDisplayedItemWithUpdate(ItemStack p_174864_1_, boolean p_174864_2_) {
        ...
        this.getDataWatcher().updateObject(8, (Object)p_174864_1_);
    ...
    private void func_174865_a(int p_174865_1_, boolean p_174865_2_) {
        this.getDataWatcher().updateObject(9, (Object)((byte)(p_174865_1_ % 8)));
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        if (this.getDisplayedItem() != null) {
            tagCompound.setTag("Item", (NBTBase)this.getDisplayedItem().writeToNBT(new NBTTagCompound()));
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        if (nbttagcompound != null && !nbttagcompound.hasNoTags()) {
            this.setDisplayedItemWithUpdate(ItemStack.loadItemStackFromNBT((NBTTagCompound)nbttagcompound), false);
