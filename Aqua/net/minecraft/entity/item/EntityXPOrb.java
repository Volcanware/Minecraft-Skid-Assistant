...
extends Entity {
    ...
    public void onUpdate() {
        ...
        if (this.xpTargetColor < this.xpColor - 20 + this.getEntityId() % 100) {
            if (this.closestPlayer == null || this.closestPlayer.getDistanceSqToEntity((Entity)this) > d0 * d0) {
                this.closestPlayer = this.worldObj.getClosestPlayerToEntity((Entity)this, d0);
            }
        ...
        if (this.closestPlayer != null && (d5 = 1.0 - (d4 = Math.sqrt((double)((d1 = (this.closestPlayer.posX - this.posX) / d0) * d1 + (d2 = (this.closestPlayer.posY + (double)this.closestPlayer.getEyeHeight() - this.posY) / d0) * d2 + (d3 = (this.closestPlayer.posZ - this.posZ) / d0) * d3)))) > 0.0) {
            d5 *= d5;
    ...
    public boolean handleWaterMovement() {
        return this.worldObj.handleMaterialAcceleration(this.getEntityBoundingBox(), Material.water, (Entity)this);
    }
