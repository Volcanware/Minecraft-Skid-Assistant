...
extends EntityMinecart {
    ...
    protected void func_180460_a(BlockPos p_180460_1_, IBlockState p_180460_2_) {
        ...
        if (d0 > 1.0E-4 && this.motionX * this.motionX + this.motionZ * this.motionZ > 0.001) {
            d0 = MathHelper.sqrt_double((double)d0);
            this.pushX /= d0;
            this.pushZ /= d0;
    ...
    public IBlockState getDefaultDisplayTile() {
        return (this.isMinecartPowered() ? Blocks.lit_furnace : Blocks.furnace).getDefaultState().withProperty((IProperty)BlockFurnace.FACING, (Comparable)EnumFacing.NORTH);
    }
}
