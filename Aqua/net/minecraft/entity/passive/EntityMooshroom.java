    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (itemstack != null && itemstack.getItem() == Items.shears && this.getGrowingAge() >= 0) {
            ...
            if (!this.worldObj.isRemote) {
                ...
                for (int i = 0; i < 5; ++i) {
                    this.worldObj.spawnEntityInWorld((Entity)new EntityItem(this.worldObj, this.posX, this.posY + (double)this.height, this.posZ, new ItemStack((Block)Blocks.red_mushroom)));
                }
