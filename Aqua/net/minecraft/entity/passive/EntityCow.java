...
extends EntityAnimal {
    public EntityCow(World worldIn) {
        ...
        this.tasks.addTask(1, (EntityAIBase)new EntityAIPanic((EntityCreature)this, 2.0));
        this.tasks.addTask(2, (EntityAIBase)new EntityAIMate((EntityAnimal)this, 1.0));
        this.tasks.addTask(3, (EntityAIBase)new EntityAITempt((EntityCreature)this, 1.25, Items.wheat, false));
        this.tasks.addTask(4, (EntityAIBase)new EntityAIFollowParent((EntityAnimal)this, 1.25));
