...
implements IInvBasic {
    private static final Predicate<Entity> horseBreedingSelector = new /* Unavailable Anonymous Inner Class!! */;
    private static final IAttribute horseJumpStrength = new RangedAttribute((IAttribute)null, "horse.jumpStrength", 0.7, 0.0, 2.0).setDescription("Jump Strength").setShouldWatch(true);
    ...
    public EntityHorse(World worldIn) {
        ...
        this.tasks.addTask(1, (EntityAIBase)new EntityAIPanic((EntityCreature)this, 1.2));
        this.tasks.addTask(1, (EntityAIBase)new EntityAIRunAroundLikeCrazy(this, 1.2));
        this.tasks.addTask(2, (EntityAIBase)new EntityAIMate((EntityAnimal)this, 1.0));
        this.tasks.addTask(4, (EntityAIBase)new EntityAIFollowParent((EntityAnimal)this, 1.0));
        this.tasks.addTask(6, (EntityAIBase)new EntityAIWander((EntityCreature)this, 0.7));
    ...
    protected void entityInit() {
        ...
        this.dataWatcher.addObject(21, (Object)String.valueOf((Object)""));
        this.dataWatcher.addObject(22, (Object)0);
    }

    public void setHorseType(int type) {
        this.dataWatcher.updateObject(19, (Object)((byte)type));
    ...
    public void setHorseVariant(int variant) {
        this.dataWatcher.updateObject(20, (Object)variant);
        this.resetTexturePrefix();
    }
    ...
    public String getName() {
        ...
        switch (i) {
            default: {
                return StatCollector.translateToLocal((String)"entity.horse.name");
            }
            case 1: {
                return StatCollector.translateToLocal((String)"entity.donkey.name");
            }
            case 2: {
                return StatCollector.translateToLocal((String)"entity.mule.name");
            }
            case 3: {
                return StatCollector.translateToLocal((String)"entity.zombiehorse.name");
            }
            case 4: 
        }
        return StatCollector.translateToLocal((String)"entity.skeletonhorse.name");
    }
    ...
    private void setHorseWatchableBoolean(int p_110208_1_, boolean p_110208_2_) {
        ...
        if (p_110208_2_) {
            this.dataWatcher.updateObject(16, (Object)(i | p_110208_1_));
        } else {
            this.dataWatcher.updateObject(16, (Object)(i & ~p_110208_1_));
        }
    }
    ...
    public void setOwnerId(String id) {
        this.dataWatcher.updateObject(21, (Object)id);
    }
    ...
    public void setHorseArmorStack(ItemStack itemStackIn) {
        this.dataWatcher.updateObject(22, (Object)this.getHorseArmorIndex(itemStackIn));
        this.resetTexturePrefix();
    }
    ...
    public int increaseTemper(int p_110198_1_) {
        int i = MathHelper.clamp_int((int)(this.getTemper() + p_110198_1_), (int)0, (int)this.getMaxTemper());
        this.setTemper(i);
        return i;
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        return this.riddenByEntity != null && this.riddenByEntity.equals((Object)entity) ? false : super.attackEntityFrom(source, amount);
    }
    ...
    public boolean prepareChunkForSpawn() {
        ...
        int j = MathHelper.floor_double((double)this.posZ);
    ...
    public void dropChests() {
        if (!this.worldObj.isRemote && this.isChested()) {
            this.dropItem(Item.getItemFromBlock((Block)Blocks.chest), 1);
            this.setChested(false);
        }
    }
    ...
    public void fall(float distance, float damageMultiplier) {
        ...
        if ((i = MathHelper.ceiling_float_int((float)((distance * 0.5f - 3.0f) * damageMultiplier))) > 0) {
            Block block;
    ...
    private void initHorseChest() {
        ...
        if (animalchest != null) {
            animalchest.removeInventoryChangeListener((IInvBasic)this);
            int i = Math.min((int)animalchest.getSizeInventory(), (int)this.horseChest.getSizeInventory());
            for (int j = 0; j < i; ++j) {
        ...
        this.horseChest.addInventoryChangeListener((IInvBasic)this);
        ...
        if (itemstack != null) {
            ...
            if (!flag && !this.isUndead()) {
                ...
                if (itemstack.getItem() == Items.wheat) {
                    ...
                    j = 30;
                    k = 3;
                } else if (Block.getBlockFromItem((Item)itemstack.getItem()) == Blocks.hay_block) {
                    f = 20.0f;
                    j = 180;
            ...
            if (!flag && this.canCarryChest() && !this.isChested() && itemstack.getItem() == Item.getItemFromBlock((Block)Blocks.chest)) {
    ...
    public void onLivingUpdate() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (!this.isEatingHaystack() && this.riddenByEntity == null && this.rand.nextInt(300) == 0 && this.worldObj.getBlockState(new BlockPos(MathHelper.floor_double((double)this.posX), MathHelper.floor_double((double)this.posY) - 1, MathHelper.floor_double((double)this.posZ))).getBlock() == Blocks.grass) {
            ...
            if (this.isBreeding() && !this.isAdultHorse() && !this.isEatingHaystack() && (entityhorse = this.getClosestHorse((Entity)this, 16.0)) != null && this.getDistanceSqToEntity((Entity)entityhorse) > 4.0) {
    ...
    public void dropChestItems() {
        this.dropItemsInChest((Entity)this, this.horseChest);
        this.dropChests();
    }
    ...
    public void moveEntityWithHeading(float strafe, float forward) {
        if (this.riddenByEntity != null && this.riddenByEntity instanceof EntityLivingBase && this.isHorseSaddled()) {
            ...
            if (this.jumpPower > 0.0f && !this.isHorseJumping() && this.onGround) {
                ...
                if (forward > 0.0f) {
                    float f = MathHelper.sin((float)(this.rotationYaw * (float)Math.PI / 180.0f));
                    float f1 = MathHelper.cos((float)(this.rotationYaw * (float)Math.PI / 180.0f));
            ...
            float f2 = MathHelper.sqrt_double((double)(d1 * d1 + d0 * d0)) * 4.0f;
            if (f2 > 1.0f) {
                f2 = 1.0f;
            }
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        if (tagCompund.hasKey("OwnerUUID", 8)) {
            ...
            s = PreYggdrasilConverter.getStringUUIDFromName((String)s1);
        }
        if (s.length() > 0) {
            this.setOwnerId(s);
        }
        ...
        if (this.isChested()) {
            ...
            for (int i = 0; i < nbttaglist.tagCount(); ++i) {
                ...
                this.horseChest.setInventorySlotContents(j, ItemStack.loadItemStackFromNBT((NBTTagCompound)nbttagcompound));
            }
        }
        if (tagCompund.hasKey("ArmorItem", 10) && (itemstack = ItemStack.loadItemStackFromNBT((NBTTagCompound)tagCompund.getCompoundTag("ArmorItem"))) != null && EntityHorse.isArmorItem(itemstack.getItem())) {
            this.horseChest.setInventorySlotContents(1, itemstack);
        }
        if (tagCompund.hasKey("SaddleItem", 10)) {
            ItemStack itemstack1 = ItemStack.loadItemStackFromNBT((NBTTagCompound)tagCompund.getCompoundTag("SaddleItem"));
    ...
    public boolean replaceItemInInventory(int inventorySlot, ItemStack itemStackIn) {
        ...
        if (inventorySlot == 499 && this.canCarryChest()) {
            ...
            if (itemStackIn != null && itemStackIn.getItem() == Item.getItemFromBlock((Block)Blocks.chest) && !this.isChested()) {
                this.setChested(true);
                this.initHorseChest();
                return true;
            }
