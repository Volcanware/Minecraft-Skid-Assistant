...
implements IEntityOwnable {
    ...
    public void setTamed(boolean tamed) {
        ...
        if (tamed) {
            this.dataWatcher.updateObject(16, (Object)((byte)(b0 | 4)));
        } else {
            this.dataWatcher.updateObject(16, (Object)((byte)(b0 & 0xFFFFFFFB)));
        }
        this.setupTamedAI();
    }
    ...
    public void setOwnerId(String ownerUuid) {
        this.dataWatcher.updateObject(17, (Object)ownerUuid);
    }

    public EntityLivingBase getOwner() {
        try {
            UUID uuid = UUID.fromString((String)this.getOwnerId());
