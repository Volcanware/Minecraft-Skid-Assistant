...
extends EntityAnimal {
    private final InventoryCrafting inventoryCrafting = new InventoryCrafting((Container)new /* Unavailable Anonymous Inner Class!! */, 2, 1);
    ...
    public EntitySheep(World worldIn) {
        ...
        this.tasks.addTask(3, (EntityAIBase)new EntityAITempt((EntityCreature)this, 1.1, Items.wheat, false));
    ...
    protected void dropFewItems(boolean wasRecentlyHit, int lootingModifier) {
        if (!this.getSheared()) {
            this.entityDropItem(new ItemStack(Item.getItemFromBlock((Block)Blocks.wool), 1, this.getFleeceColor().getMetadata()), 0.0f);
        }
    ...
    protected Item getDropItem() {
        return Item.getItemFromBlock((Block)Blocks.wool);
    }
    ...
    public float getHeadRotationAngleX(float p_70890_1_) {
        if (this.sheepTimer > 4 && this.sheepTimer <= 36) {
            ...
            return 0.62831855f + 0.2199115f * MathHelper.sin((float)(f * 28.7f));
        }
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (itemstack != null && itemstack.getItem() == Items.shears && !this.getSheared() && !this.isChild()) {
            if (!this.worldObj.isRemote) {
                ...
                for (int j = 0; j < i; ++j) {
                    EntityItem entityitem = this.entityDropItem(new ItemStack(Item.getItemFromBlock((Block)Blocks.wool), 1, this.getFleeceColor().getMetadata()), 1.0f);
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.setFleeceColor(EnumDyeColor.byMetadata((int)tagCompund.getByte("Color")));
    }
    ...
    public EnumDyeColor getFleeceColor() {
        return EnumDyeColor.byMetadata((int)(this.dataWatcher.getWatchableObjectByte(16) & 0xF));
    }

    public void setFleeceColor(EnumDyeColor color) {
        byte b0 = this.dataWatcher.getWatchableObjectByte(16);
        this.dataWatcher.updateObject(16, (Object)((byte)(b0 & 0xF0 | color.getMetadata() & 0xF)));
    }
    ...
    private EnumDyeColor getDyeColorMixFromParents(EntityAnimal father, EntityAnimal mother) {
        ...
        return EnumDyeColor.byDyeDamage((int)k);
    }
