...
extends EntityAmbientCreature {
    ...
    protected void updateAITasks() {
        ...
        if (this.getIsBatHanging()) {
            ...
            this.motionX += (Math.signum((double)d0) * 0.5 - this.motionX) * (double)0.1f;
            this.motionY += (Math.signum((double)d1) * (double)0.7f - this.motionY) * (double)0.1f;
            this.motionZ += (Math.signum((double)d2) * 0.5 - this.motionZ) * (double)0.1f;
            float f = (float)(MathHelper.atan2((double)this.motionZ, (double)this.motionX) * 180.0 / Math.PI) - 90.0f;
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.dataWatcher.updateObject(16, (Object)tagCompund.getByte("BatFlags"));
    }
