...
extends PathNavigate {
    ...
    protected void pathFollow() {
        ...
        int i = 6;
        if (vec3.squareDistanceTo(this.currentPath.getVectorFromIndex((Entity)this.theEntity, this.currentPath.getCurrentPathIndex())) < (double)f) {
            this.currentPath.incrementPathIndex();
        }
        for (int j = Math.min((int)(this.currentPath.getCurrentPathIndex() + i), (int)(this.currentPath.getCurrentPathLength() - 1)); j > this.currentPath.getCurrentPathIndex(); --j) {
