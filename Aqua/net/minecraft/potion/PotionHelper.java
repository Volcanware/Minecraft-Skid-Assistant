...
public class PotionHelper {
    ...
    public static int calcPotionLiquidColor(Collection<PotionEffect> p_77911_0_) {
        ...
        return Config.isCustomColors() ? CustomColors.getPotionColor((int)0, (int)i) : i;
    }
    ...
    public static int getLiquidColor(int dataValue, boolean bypassCache) {
        Integer integer = IntegerCache.getInteger((int)dataValue);
        if (!bypassCache) {
            if (DATAVALUE_COLORS.containsKey((Object)integer)) {
                return (Integer)DATAVALUE_COLORS.get((Object)integer);
            }
            int i = PotionHelper.calcPotionLiquidColor(PotionHelper.getPotionEffects(integer, false));
            DATAVALUE_COLORS.put((Object)integer, (Object)i);
            return i;
        }
    ...
    public static List<PotionEffect> getPotionEffects(int p_77917_0_, boolean p_77917_1_) {
        ...
        for (Potion potion : Potion.potionTypes) {
            int i;
            String s;
            if (potion == null || potion.isUsable() && !p_77917_1_ || (s = (String)potionRequirements.get((Object)potion.getId())) == null || (i = PotionHelper.parsePotionEffects(s, 0, s.length(), p_77917_0_)) <= 0) continue;
            int j = 0;
            String s1 = (String)potionAmplifiers.get((Object)potion.getId());
            ...
            if (potion.isInstant()) {
                ...
                i = 1200 * (i * 3 + (i - 1) * 2);
                i >>= j;
                i = (int)Math.round((double)((double)i * potion.getEffectiveness()));
                if ((p_77917_0_ & 0x4000) != 0) {
                    i = (int)Math.round((double)((double)i * 0.75 + 0.5));
                }
            }
            if (list == null) {
    ...
    static {
        potionRequirements.put((Object)Potion.regeneration.getId(), (Object)"0 & !1 & !2 & !3 & 0+6");
        potionRequirements.put((Object)Potion.moveSpeed.getId(), (Object)"!0 & 1 & !2 & !3 & 1+6");
        potionRequirements.put((Object)Potion.fireResistance.getId(), (Object)"0 & 1 & !2 & !3 & 0+6");
        potionRequirements.put((Object)Potion.heal.getId(), (Object)"0 & !1 & 2 & !3");
        potionRequirements.put((Object)Potion.poison.getId(), (Object)"!0 & !1 & 2 & !3 & 2+6");
        potionRequirements.put((Object)Potion.weakness.getId(), (Object)"!0 & !1 & !2 & 3 & 3+6");
        potionRequirements.put((Object)Potion.harm.getId(), (Object)"!0 & !1 & 2 & 3");
        potionRequirements.put((Object)Potion.moveSlowdown.getId(), (Object)"!0 & 1 & !2 & 3 & 3+6");
        potionRequirements.put((Object)Potion.damageBoost.getId(), (Object)"0 & !1 & !2 & 3 & 3+6");
        potionRequirements.put((Object)Potion.nightVision.getId(), (Object)"!0 & 1 & 2 & !3 & 2+6");
        potionRequirements.put((Object)Potion.invisibility.getId(), (Object)"!0 & 1 & 2 & 3 & 2+6");
        potionRequirements.put((Object)Potion.waterBreathing.getId(), (Object)"0 & !1 & 2 & 3 & 2+6");
        potionRequirements.put((Object)Potion.jump.getId(), (Object)"0 & 1 & !2 & 3 & 3+6");
        potionAmplifiers.put((Object)Potion.moveSpeed.getId(), (Object)"5");
        potionAmplifiers.put((Object)Potion.digSpeed.getId(), (Object)"5");
        potionAmplifiers.put((Object)Potion.damageBoost.getId(), (Object)"5");
        potionAmplifiers.put((Object)Potion.regeneration.getId(), (Object)"5");
        potionAmplifiers.put((Object)Potion.harm.getId(), (Object)"5");
        potionAmplifiers.put((Object)Potion.heal.getId(), (Object)"5");
        potionAmplifiers.put((Object)Potion.resistance.getId(), (Object)"5");
        potionAmplifiers.put((Object)Potion.poison.getId(), (Object)"5");
        potionAmplifiers.put((Object)Potion.jump.getId(), (Object)"5");
    }
}
