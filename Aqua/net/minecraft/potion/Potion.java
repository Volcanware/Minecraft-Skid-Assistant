...
public class Potion {
    ...
    protected Potion(int potionID, ResourceLocation location, boolean badEffect, int potionColor) {
        ...
        field_180150_I.put((Object)location, (Object)this);
    ...
    public static Potion getPotionFromResourceLocation(String location) {
        return (Potion)field_180150_I.get((Object)new ResourceLocation(location));
    }
        ...
        if (!(this.id == Potion.heal.id && !entityLivingBaseIn.isEntityUndead() || this.id == Potion.harm.id && entityLivingBaseIn.isEntityUndead())) {
            if (this.id == Potion.harm.id && !entityLivingBaseIn.isEntityUndead() || this.id == Potion.heal.id && entityLivingBaseIn.isEntityUndead()) {
                ...
                if (p_180793_1_ == null) {
                    ...
                    entityLivingBaseIn.attackEntityFrom(DamageSource.causeIndirectMagicDamage((Entity)p_180793_1_, (Entity)p_180793_2_), (float)j);
                }
            }
        } else {
    ...
    public static String getDurationString(PotionEffect effect) {
        ...
        return StringUtils.ticksToElapsedTime((int)i);
    }
    ...
    public Potion registerPotionAttributeModifier(IAttribute p_111184_1_, String p_111184_2_, double p_111184_3_, int p_111184_5_) {
        AttributeModifier attributemodifier = new AttributeModifier(UUID.fromString((String)p_111184_2_), this.getName(), p_111184_3_, p_111184_5_);
        this.attributeModifierMap.put((Object)p_111184_1_, (Object)attributemodifier);
        return this;
    }
    ...
    public void removeAttributesModifiersFromEntity(EntityLivingBase entityLivingBaseIn, BaseAttributeMap p_111187_2_, int amplifier) {
        for (Map.Entry entry : this.attributeModifierMap.entrySet()) {
