...
extends Enchantment {
    ...
    public int calcModifierDamage(int level, DamageSource source) {
        ...
        return this.protectionType == 0 ? MathHelper.floor_float((float)(f * 0.75f)) : (this.protectionType == 1 && source.isFireDamage() ? MathHelper.floor_float((float)(f * 1.25f)) : (this.protectionType == 2 && source == DamageSource.fall ? MathHelper.floor_float((float)(f * 2.5f)) : (this.protectionType == 3 && source.isExplosion() ? MathHelper.floor_float((float)(f * 1.5f)) : (this.protectionType == 4 && source.isProjectile() ? MathHelper.floor_float((float)(f * 1.5f)) : 0))));
    }
    ...
    public static int getFireTimeForEntity(Entity p_92093_0_, int p_92093_1_) {
        int i = EnchantmentHelper.getMaxEnchantmentLevel((int)Enchantment.fireProtection.effectId, (ItemStack[])p_92093_0_.getInventory());
        if (i > 0) {
            p_92093_1_ -= MathHelper.floor_float((float)((float)p_92093_1_ * (float)i * 0.15f));
        }
        return p_92093_1_;
    }

    public static double func_92092_a(Entity p_92092_0_, double p_92092_1_) {
        int i = EnchantmentHelper.getMaxEnchantmentLevel((int)Enchantment.blastProtection.effectId, (ItemStack[])p_92092_0_.getInventory());
        if (i > 0) {
            p_92092_1_ -= (double)MathHelper.floor_double((double)(p_92092_1_ * (double)((float)i * 0.15f)));
        }
        return p_92092_1_;
    }
}
