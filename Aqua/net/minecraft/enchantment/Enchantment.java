...
public abstract class Enchantment {
    ...
    protected Enchantment(int enchID, ResourceLocation enchName, int enchWeight, EnumEnchantmentType enchType) {
        ...
        locationEnchantments.put((Object)enchName, (Object)this);
    }

    public static Enchantment getEnchantmentByLocation(String location) {
        return (Enchantment)locationEnchantments.get((Object)new ResourceLocation(location));
    }
    ...
    public String getTranslatedName(int level) {
        String s = StatCollector.translateToLocal((String)this.getName());
        return s + " " + StatCollector.translateToLocal((String)("enchantment.level." + level));
    }
    ...
    static {
        ...
        for (Enchantment enchantment : enchantmentsList) {
            ...
            list.add((Object)enchantment);
        }
        enchantmentsBookList = (Enchantment[])list.toArray((Object[])new Enchantment[list.size()]);
    }
}
