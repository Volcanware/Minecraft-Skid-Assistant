...
public class RealmsScreen {
    ...
    public static void blit(int p_blit_0_, int p_blit_1_, float p_blit_2_, float p_blit_3_, int p_blit_4_, int p_blit_5_, int p_blit_6_, int p_blit_7_, float p_blit_8_, float p_blit_9_) {
        Gui.drawScaledCustomSizeModalRect((int)p_blit_0_, (int)p_blit_1_, (float)p_blit_2_, (float)p_blit_3_, (int)p_blit_4_, (int)p_blit_5_, (int)p_blit_6_, (int)p_blit_7_, (float)p_blit_8_, (float)p_blit_9_);
    }
    ...
    public static void blit(int p_blit_0_, int p_blit_1_, float p_blit_2_, float p_blit_3_, int p_blit_4_, int p_blit_5_, float p_blit_6_, float p_blit_7_) {
        Gui.drawModalRectWithCustomSizedTexture((int)p_blit_0_, (int)p_blit_1_, (float)p_blit_2_, (float)p_blit_3_, (int)p_blit_4_, (int)p_blit_5_, (float)p_blit_6_, (float)p_blit_7_);
    }
    ...
    public static void bindFace(String p_bindFace_0_, String p_bindFace_1_) {
        ResourceLocation resourcelocation = AbstractClientPlayer.getLocationSkin((String)p_bindFace_1_);
        if (resourcelocation == null) {
            resourcelocation = DefaultPlayerSkin.getDefaultSkin((UUID)UUIDTypeAdapter.fromString((String)p_bindFace_0_));
        }
        AbstractClientPlayer.getDownloadImageSkin((ResourceLocation)resourcelocation, (String)p_bindFace_1_);
    ...
    public static String getLocalizedString(String p_getLocalizedString_0_) {
        return I18n.format((String)p_getLocalizedString_0_, (Object[])new Object[0]);
    }

    public static String getLocalizedString(String p_getLocalizedString_0_, Object ... p_getLocalizedString_1_) {
        return I18n.format((String)p_getLocalizedString_0_, (Object[])p_getLocalizedString_1_);
    }
