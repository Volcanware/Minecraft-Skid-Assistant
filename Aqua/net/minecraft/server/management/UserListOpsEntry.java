...
extends UserListEntry<GameProfile> {
    ...
    public UserListOpsEntry(JsonObject p_i1150_1_) {
        super((Object)UserListOpsEntry.constructProfile(p_i1150_1_), p_i1150_1_);
    ...
    protected void onSerialization(JsonObject data) {
        if (this.getValue() != null) {
            ...
            data.addProperty("level", (Number)Integer.valueOf((int)this.permissionLevel));
            data.addProperty("bypassesPlayerLimit", Boolean.valueOf((boolean)this.bypassesPlayerLimit));
        }
    }
