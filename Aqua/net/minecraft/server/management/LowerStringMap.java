...
implements Map<String, V> {
    ...
    public boolean containsKey(Object p_containsKey_1_) {
        return this.internalMap.containsKey((Object)p_containsKey_1_.toString().toLowerCase());
    }
    ...
    public V get(Object p_get_1_) {
        return (V)this.internalMap.get((Object)p_get_1_.toString().toLowerCase());
    }

    public V put(String p_put_1_, V p_put_2_) {
        return (V)this.internalMap.put((Object)p_put_1_.toLowerCase(), p_put_2_);
    }

    public V remove(Object p_remove_1_) {
        return (V)this.internalMap.remove((Object)p_remove_1_.toString().toLowerCase());
    }

    public void putAll(Map<? extends String, ? extends V> p_putAll_1_) {
        for (Map.Entry entry : p_putAll_1_.entrySet()) {
