...
public class ItemInWorldManager {
    ...
    public void updateBlockRemoving() {
        ...
        if (this.receivedFinishDiggingPacket) {
            ...
            if (block.getMaterial() == Material.air) {
                ...
                float f = block.getPlayerRelativeBlockHardness((EntityPlayer)this.thisPlayerMP, this.thisPlayerMP.worldObj, this.field_180241_i) * (float)(i + 1);
                int j = (int)(f * 10.0f);
            ...
            if (block1.getMaterial() == Material.air) {
                ...
                float f1 = block1.getPlayerRelativeBlockHardness((EntityPlayer)this.thisPlayerMP, this.thisPlayerMP.worldObj, this.field_180241_i) * (float)(k + 1);
                int l = (int)(f1 * 10.0f);
    ...
    public void blockRemoving(BlockPos pos) {
        if (pos.equals((Object)this.field_180240_f)) {
            ...
            Block block = this.theWorld.getBlockState(pos).getBlock();
            if (block.getMaterial() != Material.air) {
                float f = block.getPlayerRelativeBlockHardness((EntityPlayer)this.thisPlayerMP, this.thisPlayerMP.worldObj, pos) * (float)(i + 1);
                if (f >= 0.7f) {
                    this.isDestroyingBlock = false;
    ...
    public boolean tryHarvestBlock(BlockPos pos) {
        ...
        this.theWorld.playAuxSFXAtEntity((EntityPlayer)this.thisPlayerMP, 2001, pos, Block.getStateId((IBlockState)iblockstate));
