...
IPlayerUsage {
    ...
    private final PlayerUsageSnooper usageSnooper = new PlayerUsageSnooper("server", (IPlayerUsage)this, MinecraftServer.getCurrentTimeMillis());
    ...
    protected void convertMapIfNeeded(String worldNameIn) {
        if (this.getActiveAnvilConverter().isOldMapFormat(worldNameIn)) {
            ...
            this.getActiveAnvilConverter().convertMapFormat(worldNameIn, (IProgressUpdate)new /* Unavailable Anonymous Inner Class!! */);
        }
    }
    ...
    public void tick() {
        ...
        if (i - this.nanoTimeSinceStatusRefresh >= 5000000000L) {
            ...
            int j = MathHelper.getRandomIntegerInRange((Random)this.random, (int)0, (int)(this.getCurrentPlayerCount() - agameprofile.length));
            ...
            this.statusResponse.getPlayerCountData().setPlayers((GameProfile[])agameprofile);
        }
        ...
        for (int j = 0; j < this.worldServers.length; ++j) {
            ...
            if (j == 0 || this.getAllowNether()) {
                ...
                try {
                    ...
                    CrashReport crashreport = CrashReport.makeCrashReport((Throwable)throwable1, (String)"Exception ticking world");
                ...
                try {
                    ...
                    CrashReport crashreport1 = CrashReport.makeCrashReport((Throwable)throwable, (String)"Exception ticking world entities");
    ...
    public CrashReport addServerInfoToCrashReport(CrashReport report) {
        report.getCategory().addCrashSectionCallable("Profiler Position", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        if (this.serverConfigManager != null) {
            report.getCategory().addCrashSectionCallable("Player Count", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        }
        return report;
    }
    ...
    public List<String> getTabCompletions(ICommandSender sender, String input, BlockPos pos) {
        ...
        if (input.startsWith("/")) {
            boolean flag = !(input = input.substring(1)).contains((CharSequence)" ");
        ...
        for (String s1 : this.serverConfigManager.getAllUsernames()) {
            if (!CommandBase.doesStringStartWith((String)s, (String)s1)) continue;
            list.add((Object)s1);
        }
        return list;
    }
    ...
    public void addServerStatsToSnooper(PlayerUsageSnooper playerSnooper) {
        playerSnooper.addClientStat("whitelist_enabled", (Object)false);
        playerSnooper.addClientStat("whitelist_count", (Object)0);
        if (this.serverConfigManager != null) {
            playerSnooper.addClientStat("players_current", (Object)this.getCurrentPlayerCount());
            playerSnooper.addClientStat("players_max", (Object)this.getMaxPlayers());
            playerSnooper.addClientStat("players_seen", (Object)this.serverConfigManager.getAvailablePlayerDat().length);
        }
        playerSnooper.addClientStat("uses_auth", (Object)this.onlineMode);
        playerSnooper.addClientStat("gui_state", (Object)(this.getGuiEnabled() ? "enabled" : "disabled"));
        ...
        playerSnooper.addClientStat("avg_tick_ms", (Object)((int)(MathHelper.average((long[])this.tickTimeArray) * 1.0E-6)));
        int i = 0;
        if (this.worldServers != null) {
            for (int j = 0; j < this.worldServers.length; ++j) {
                ...
                playerSnooper.addClientStat("world[" + i + "][dimension]", (Object)worldserver.provider.getDimensionId());
                ...
                playerSnooper.addClientStat("world[" + i + "][hardcore]", (Object)worldinfo.isHardcoreModeEnabled());
                playerSnooper.addClientStat("world[" + i + "][generator_name]", (Object)worldinfo.getTerrainType().getWorldTypeName());
                playerSnooper.addClientStat("world[" + i + "][generator_version]", (Object)worldinfo.getTerrainType().getGeneratorVersion());
                playerSnooper.addClientStat("world[" + i + "][height]", (Object)this.buildLimit);
                playerSnooper.addClientStat("world[" + i + "][chunks_loaded]", (Object)worldserver.getChunkProvider().getLoadedChunkCount());
                ++i;
            }
        }
        playerSnooper.addClientStat("worlds", (Object)i);
    }

    public void addServerTypeToSnooper(PlayerUsageSnooper playerSnooper) {
        playerSnooper.addStatToSnooper("singleplayer", (Object)this.isSinglePlayer());
        playerSnooper.addStatToSnooper("server_brand", (Object)this.getServerModName());
        playerSnooper.addStatToSnooper("gui_supported", (Object)(GraphicsEnvironment.isHeadless() ? "headless" : "supported"));
        playerSnooper.addStatToSnooper("dedicated", (Object)this.isDedicatedServer());
    }
    ...
    public <V> ListenableFuture<V> callFromMainThread(Callable<V> callable) {
        ...
        if (!this.isCallingFromMinecraftThread() && !this.isServerStopped()) {
            ...
            Queue<FutureTask<?>> queue = this.futureTaskQueue;
            synchronized (queue) {
                this.futureTaskQueue.add((Object)listenablefuturetask);
    ...
    public ListenableFuture<Object> addScheduledTask(Runnable runnableToSchedule) {
        ...
        return this.callFromMainThread(Executors.callable((Runnable)runnableToSchedule));
    }
    ...
    static /* synthetic */ ServerConfigurationManager access$100(MinecraftServer x0) {
