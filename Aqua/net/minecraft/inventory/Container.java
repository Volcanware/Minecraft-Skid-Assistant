...
public abstract class Container {
    ...
    protected Slot addSlotToContainer(Slot slotIn) {
        ...
        this.inventorySlots.add((Object)slotIn);
        this.inventoryItemStacks.add((Object)null);
        return slotIn;
    }

    public void onCraftGuiOpened(ICrafting listener) {
        if (this.crafters.contains((Object)listener)) {
            throw new IllegalArgumentException("Listener already listening");
        }
        this.crafters.add((Object)listener);
        listener.updateCraftingInventory(this, this.getInventory());
        this.detectAndSendChanges();
    }

    public void removeCraftingFromCrafters(ICrafting listeners) {
        this.crafters.remove((Object)listeners);
    }

    public List<ItemStack> getInventory() {
        ArrayList list = Lists.newArrayList();
        for (int i = 0; i < this.inventorySlots.size(); ++i) {
            list.add((Object)((Slot)this.inventorySlots.get(i)).getStack());
        }
        return list;
    }
        ...
        if (mode == 5) {
            ...
            if ((i != 1 || this.dragEvent != 2) && i != this.dragEvent) {
                ...
                if (slot != null && Container.canAddItemToSlot(slot, inventoryplayer.getItemStack(), true) && slot.isItemValid(inventoryplayer.getItemStack()) && inventoryplayer.getItemStack().stackSize > this.dragSlots.size() && this.canDragIntoSlot(slot)) {
                    this.dragSlots.add((Object)slot);
                }
                ...
                if (slot7 != null) {
                    ...
                    if (itemstack9 == null) {
                        ...
                        if (itemstack10 == null) {
                            ...
                            if (itemstack9.getItem() == itemstack10.getItem() && itemstack9.getMetadata() == itemstack10.getMetadata() && ItemStack.areItemStackTagsEqual((ItemStack)itemstack9, (ItemStack)itemstack10)) {
                                int i2;
                        ...
                        } else if (itemstack9.getItem() == itemstack10.getItem() && itemstack10.getMaxStackSize() > 1 && (!itemstack9.getHasSubtypes() || itemstack9.getMetadata() == itemstack10.getMetadata()) && ItemStack.areItemStackTagsEqual((ItemStack)itemstack9, (ItemStack)itemstack10) && (l1 = itemstack9.stackSize) > 0 && l1 + itemstack10.stackSize <= itemstack10.getMaxStackSize()) {
            ...
            if (!(itemstack4 == null || slot2 != null && slot2.getHasStack() && slot2.canTakeStack(playerIn))) {
                ...
                for (int l2 = 0; l2 < 2; ++l2) {
                    for (int i3 = i1; i3 >= 0 && i3 < this.inventorySlots.size() && itemstack4.stackSize < itemstack4.getMaxStackSize(); i3 += j1) {
                        ...
                        int l = Math.min((int)(itemstack4.getMaxStackSize() - itemstack4.stackSize), (int)slot8.getStack().stackSize);
    ...
    public boolean getCanCraft(EntityPlayer p_75129_1_) {
        return !this.playerList.contains((Object)p_75129_1_);
    }

    public void setCanCraft(EntityPlayer p_75128_1_, boolean p_75128_2_) {
        if (p_75128_2_) {
            this.playerList.remove((Object)p_75128_1_);
        } else {
            this.playerList.add((Object)p_75128_1_);
        }
    }
    ...
    protected boolean mergeItemStack(ItemStack stack, int startIndex, int endIndex, boolean reverseDirection) {
        ...
        if (stack.isStackable()) {
            while (stack.stackSize > 0 && (!reverseDirection && i < endIndex || reverseDirection && i >= startIndex)) {
                ...
                if (itemstack != null && itemstack.getItem() == stack.getItem() && (!stack.getHasSubtypes() || stack.getMetadata() == itemstack.getMetadata()) && ItemStack.areItemStackTagsEqual((ItemStack)stack, (ItemStack)itemstack)) {
    ...
    public static boolean canAddItemToSlot(Slot slotIn, ItemStack stack, boolean stackSizeMatters) {
        ...
        if (slotIn != null && slotIn.getHasStack() && stack != null && stack.isItemEqual(slotIn.getStack()) && ItemStack.areItemStackTagsEqual((ItemStack)slotIn.getStack(), (ItemStack)stack)) {
    ...
    public static void computeStackSize(Set<Slot> p_94525_0_, int p_94525_1_, ItemStack p_94525_2_, int p_94525_3_) {
        switch (p_94525_1_) {
            case 0: {
                p_94525_2_.stackSize = MathHelper.floor_float((float)((float)p_94525_2_.stackSize / (float)p_94525_0_.size()));
                break;
            }
            case 1: {
    ...
    public static int calcRedstoneFromInventory(IInventory inv) {
        ...
        for (int j = 0; j < inv.getSizeInventory(); ++j) {
            ...
            f += (float)itemstack.stackSize / (float)Math.min((int)inv.getInventoryStackLimit(), (int)itemstack.getMaxStackSize());
            ++i;
        }
        return MathHelper.floor_float((float)((f /= (float)inv.getSizeInventory()) * 14.0f)) + (i > 0 ? 1 : 0);
    }
}
