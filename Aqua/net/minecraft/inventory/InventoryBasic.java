...
implements IInventory {
    ...
    public ItemStack func_174894_a(ItemStack stack) {
        ...
        for (int i = 0; i < this.slotsCount; ++i) {
            ...
            if (!ItemStack.areItemsEqual((ItemStack)itemstack1, (ItemStack)itemstack) || (k = Math.min((int)itemstack.stackSize, (int)((j = Math.min((int)this.getInventoryStackLimit(), (int)itemstack1.getMaxStackSize())) - itemstack1.stackSize))) <= 0) continue;
