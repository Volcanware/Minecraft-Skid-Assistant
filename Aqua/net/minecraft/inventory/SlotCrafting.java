...
extends Slot {
    ...
    public ItemStack decrStackSize(int amount) {
        if (this.getHasStack()) {
            this.amountCrafted += Math.min((int)amount, (int)this.getStack().stackSize);
        }
    ...
    protected void onCrafting(ItemStack stack) {
        ...
        if (stack.getItem() == Item.getItemFromBlock((Block)Blocks.crafting_table)) {
        ...
        if (stack.getItem() == Item.getItemFromBlock((Block)Blocks.furnace)) {
        ...
        if (stack.getItem() == Item.getItemFromBlock((Block)Blocks.enchanting_table)) {
            this.thePlayer.triggerAchievement((StatBase)AchievementList.enchantments);
        }
        if (stack.getItem() == Item.getItemFromBlock((Block)Blocks.bookshelf)) {
