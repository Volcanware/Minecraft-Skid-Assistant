...
extends Container {
    public IInventory tableInventory = new /* Unavailable Anonymous Inner Class!! */;
    ...
    public ContainerEnchantment(InventoryPlayer playerInv, World worldIn, BlockPos pos) {
        ...
        for (int i = 0; i < 3; ++i) {
            for (int j = 0; j < 9; ++j) {
                this.addSlotToContainer(new Slot((IInventory)playerInv, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
            }
        }
        for (int k = 0; k < 9; ++k) {
            this.addSlotToContainer(new Slot((IInventory)playerInv, k, 8 + k * 18, 142));
        }
    }

    public void onCraftGuiOpened(ICrafting listener) {
        super.onCraftGuiOpened(listener);
        listener.sendProgressBarUpdate((Container)this, 0, this.enchantLevels[0]);
        listener.sendProgressBarUpdate((Container)this, 1, this.enchantLevels[1]);
        listener.sendProgressBarUpdate((Container)this, 2, this.enchantLevels[2]);
        listener.sendProgressBarUpdate((Container)this, 3, this.xpSeed & 0xFFFFFFF0);
        listener.sendProgressBarUpdate((Container)this, 4, this.enchantmentIds[0]);
        listener.sendProgressBarUpdate((Container)this, 5, this.enchantmentIds[1]);
        listener.sendProgressBarUpdate((Container)this, 6, this.enchantmentIds[2]);
    }
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < this.crafters.size(); ++i) {
            ...
            icrafting.sendProgressBarUpdate((Container)this, 3, this.xpSeed & 0xFFFFFFF0);
            icrafting.sendProgressBarUpdate((Container)this, 4, this.enchantmentIds[0]);
            icrafting.sendProgressBarUpdate((Container)this, 5, this.enchantmentIds[1]);
            icrafting.sendProgressBarUpdate((Container)this, 6, this.enchantmentIds[2]);
        }
    }
            ...
            if (itemstack != null && itemstack.isItemEnchantable()) {
                if (!this.worldPointer.isRemote) {
                    ...
                    for (int i1 = 0; i1 < 3; ++i1) {
                        this.enchantLevels[i1] = EnchantmentHelper.calcItemStackEnchantability((Random)this.rand, (int)i1, (int)l, (ItemStack)itemstack);
    ...
    private List<EnchantmentData> func_178148_a(ItemStack stack, int p_178148_2_, int p_178148_3_) {
        ...
        List list = EnchantmentHelper.buildEnchantmentList((Random)this.rand, (ItemStack)stack, (int)p_178148_3_);
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            } else if (itemstack1.getItem() == Items.dye && EnumDyeColor.byDyeDamage((int)itemstack1.getMetadata()) == EnumDyeColor.BLUE) {
