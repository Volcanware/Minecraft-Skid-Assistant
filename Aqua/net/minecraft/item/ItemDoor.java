...
extends Item {
    ...
    public static void placeDoor(World worldIn, BlockPos pos, EnumFacing facing, Block door) {
        ...
        IBlockState iblockstate = door.getDefaultState().withProperty((IProperty)BlockDoor.FACING, (Comparable)facing).withProperty((IProperty)BlockDoor.HINGE, (Comparable)(flag2 ? BlockDoor.EnumHingePosition.RIGHT : BlockDoor.EnumHingePosition.LEFT));
