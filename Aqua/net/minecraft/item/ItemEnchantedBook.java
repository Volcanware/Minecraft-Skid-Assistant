...
extends Item {
    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
        ...
        if (nbttaglist != null) {
            for (int i = 0; i < nbttaglist.tagCount(); ++i) {
                ...
                tooltip.add((Object)Enchantment.getEnchantmentById((int)j).getTranslatedName((int)k));
            }
        }
    }
    ...
    public void getAll(Enchantment enchantment, List<ItemStack> list) {
        for (int i = enchantment.getMinLevel(); i <= enchantment.getMaxLevel(); ++i) {
            list.add((Object)this.getEnchantedItemStack(new EnchantmentData(enchantment, i)));
        }
    }
    ...
    public WeightedRandomChestContent getRandom(Random rand, int minChance, int maxChance, int weight) {
        ...
        EnchantmentHelper.addRandomEnchantment((Random)rand, (ItemStack)itemstack, (int)30);
