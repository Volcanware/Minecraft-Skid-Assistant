...
extends Item {
    ...
    public float getStrVsBlock(ItemStack stack, Block state) {
        return this.effectiveBlocks.contains((Object)state) ? this.efficiencyOnProperMaterial : 1.0f;
    }
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(itemModifierUUID, "Tool modifier", (double)this.damageVsEntity, 0));
        return multimap;
    }
}
