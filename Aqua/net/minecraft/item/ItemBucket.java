    ...
    public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn) {
        ...
        if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (flag) {
                ...
                if (material == Material.water && (Integer)iblockstate.getValue((IProperty)BlockLiquid.LEVEL) == 0) {
                ...
                if (material == Material.lava && (Integer)iblockstate.getValue((IProperty)BlockLiquid.LEVEL) == 0) {
                    worldIn.setBlockToAir(blockpos);
                    playerIn.triggerAchievement(StatList.objectUseStats[Item.getIdFromItem((Item)this)]);
