...
extends ItemBlock {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        if (block == this.block && (i = ((Integer)iblockstate.getValue((IProperty)BlockSnow.LAYERS)).intValue()) <= 7 && (axisalignedbb = this.block.getCollisionBoundingBox(worldIn, blockpos, iblockstate1 = iblockstate.withProperty((IProperty)BlockSnow.LAYERS, (Comparable)Integer.valueOf((int)(i + 1))))) != null && worldIn.checkNoEntityCollision(axisalignedbb) && worldIn.setBlockState(blockpos, iblockstate1, 2)) {
