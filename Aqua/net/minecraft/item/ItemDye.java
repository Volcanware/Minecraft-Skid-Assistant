...
extends Item {
    ...
    public String getUnlocalizedName(ItemStack stack) {
        ...
        return super.getUnlocalizedName() + "." + EnumDyeColor.byDyeDamage((int)i).getUnlocalizedName();
    }
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        EnumDyeColor enumdyecolor = EnumDyeColor.byDyeDamage((int)stack.getMetadata());
        ...
        } else if (enumdyecolor == EnumDyeColor.BROWN && (block = (iblockstate = worldIn.getBlockState(pos)).getBlock()) == Blocks.log && iblockstate.getValue((IProperty)BlockPlanks.VARIANT) == BlockPlanks.EnumType.JUNGLE) {
    ...
    public static boolean applyBonemeal(ItemStack stack, World worldIn, BlockPos target) {
        ...
        if (iblockstate.getBlock() instanceof IGrowable && (igrowable = (IGrowable)iblockstate.getBlock()).canGrow(worldIn, target, iblockstate, worldIn.isRemote)) {
            if (!worldIn.isRemote) {
