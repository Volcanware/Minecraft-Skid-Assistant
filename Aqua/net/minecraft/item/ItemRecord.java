...
extends Item {
    ...
    protected ItemRecord(String name) {
        ...
        RECORDS.put((Object)("records." + name), (Object)this);
    }
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        if (iblockstate.getBlock() == Blocks.jukebox && !((Boolean)iblockstate.getValue((IProperty)BlockJukebox.HAS_RECORD)).booleanValue()) {
            ...
            worldIn.playAuxSFXAtEntity((EntityPlayer)null, 1005, pos, Item.getIdFromItem((Item)this));
            --stack.stackSize;
    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
        tooltip.add((Object)this.getRecordNameLocal());
    }

    public String getRecordNameLocal() {
        return StatCollector.translateToLocal((String)("item.record." + this.recordName + ".desc"));
    }
    ...
    public static ItemRecord getRecord(String name) {
        return (ItemRecord)((Object)RECORDS.get((Object)name));
    }
}
