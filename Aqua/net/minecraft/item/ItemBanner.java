...
extends ItemBlock {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        if (side == EnumFacing.UP) {
            ...
            worldIn.setBlockState(pos, Blocks.standing_banner.getDefaultState().withProperty((IProperty)BlockStandingSign.ROTATION, (Comparable)Integer.valueOf((int)i)), 3);
        } else {
    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
        ...
        if (nbttagcompound != null && nbttagcompound.hasKey("Patterns")) {
            ...
            for (int i = 0; i < nbttaglist.tagCount() && i < 6; ++i) {
                ...
                EnumDyeColor enumdyecolor = EnumDyeColor.byDyeDamage((int)nbttagcompound1.getInteger("Color"));
                TileEntityBanner.EnumBannerPattern tileentitybanner$enumbannerpattern = TileEntityBanner.EnumBannerPattern.getPatternByID((String)nbttagcompound1.getString("Pattern"));
                if (tileentitybanner$enumbannerpattern == null) continue;
                tooltip.add((Object)StatCollector.translateToLocal((String)("item.banner." + tileentitybanner$enumbannerpattern.getPatternName() + "." + enumdyecolor.getUnlocalizedName())));
            }
        }
    }
    ...
    public void getSubItems(Item itemIn, CreativeTabs tab, List<ItemStack> subItems) {
        for (EnumDyeColor enumdyecolor : EnumDyeColor.values()) {
            ...
            TileEntityBanner.setBaseColorAndPatterns((NBTTagCompound)nbttagcompound, (int)enumdyecolor.getDyeDamage(), (NBTTagList)null);
    ...
    private EnumDyeColor getBaseColor(ItemStack stack) {
        ...
        enumdyecolor = nbttagcompound != null && nbttagcompound.hasKey("Base") ? EnumDyeColor.byDyeDamage((int)nbttagcompound.getInteger("Base")) : EnumDyeColor.byDyeDamage((int)stack.getMetadata());
        return enumdyecolor;
    }
}
