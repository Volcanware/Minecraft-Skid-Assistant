    ...
    public ItemStack getCraftingResult(InventoryCrafting inv) {
        ...
        for (int k = 0; k < inv.getSizeInventory(); ++k) {
            ...
            if (itemstack1.getItem() instanceof ItemArmor) {
                ...
                i = (int)((float)i + Math.max((float)f, (float)Math.max((float)f1, (float)f2)) * 255.0f);
            ...
            float[] afloat = EntitySheep.getDyeRgb((EnumDyeColor)EnumDyeColor.byDyeDamage((int)itemstack1.getMetadata()));
            int l1 = (int)(afloat[0] * 255.0f);
            int i2 = (int)(afloat[1] * 255.0f);
            int j2 = (int)(afloat[2] * 255.0f);
            i += Math.max((int)l1, (int)Math.max((int)i2, (int)j2));
            aint[0] = aint[0] + l1;
            aint[1] = aint[1] + i2;
            aint[2] = aint[2] + j2;
            ++j;
        ...
        float f4 = Math.max((int)i1, (int)Math.max((int)j1, (int)k1));
