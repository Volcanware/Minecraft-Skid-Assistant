...
public class FurnaceRecipes {
    ...
    private FurnaceRecipes() {
        ...
        this.addSmeltingRecipeForBlock((Block)Blocks.sand, new ItemStack(Blocks.glass), 0.1f);
        ...
        this.addSmeltingRecipeForBlock((Block)Blocks.cactus, new ItemStack(Items.dye, 1, EnumDyeColor.GREEN.getDyeDamage()), 0.2f);
    ...
    public void addSmeltingRecipeForBlock(Block input, ItemStack stack, float experience) {
        this.addSmelting(Item.getItemFromBlock((Block)input), stack, experience);
    }
    ...
    public void addSmeltingRecipe(ItemStack input, ItemStack stack, float experience) {
        this.smeltingList.put((Object)input, (Object)stack);
        this.experienceList.put((Object)stack, (Object)Float.valueOf((float)experience));
    }

    public ItemStack getSmeltingResult(ItemStack stack) {
        for (Map.Entry entry : this.smeltingList.entrySet()) {
            if (!this.compareItemStacks(stack, (ItemStack)entry.getKey())) continue;
