...
public class Item {
    ...
    protected static final UUID itemModifierUUID = UUID.fromString((String)"CB3F55D3-645C-4F38-A497-9C13A33DB5CF");
    ...
    public static int getIdFromItem(Item itemIn) {
        return itemIn == null ? 0 : itemRegistry.getIDForObject((Object)itemIn);
    }
    ...
    public static Item getItemFromBlock(Block blockIn) {
        return (Item)BLOCK_TO_ITEM.get((Object)blockIn);
    }

    public static Item getByNameOrId(String id) {
        Item item = (Item)itemRegistry.getObject((Object)new ResourceLocation(id));
        if (item == null) {
            try {
                return Item.getItemById(Integer.parseInt((String)id));
            }
    ...
    public String getUnlocalizedNameInefficiently(ItemStack stack) {
        ...
        return s == null ? "" : StatCollector.translateToLocal((String)s);
    }
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        return ("" + StatCollector.translateToLocal((String)(this.getUnlocalizedNameInefficiently(stack) + ".name"))).trim();
    }
    ...
    public static void registerItems() {
        Item.registerItemBlock(Blocks.stone, (Item)new ItemMultiTexture(Blocks.stone, Blocks.stone, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("stone"));
        Item.registerItemBlock((Block)Blocks.grass, (Item)new ItemColored((Block)Blocks.grass, false));
        Item.registerItemBlock(Blocks.dirt, (Item)new ItemMultiTexture(Blocks.dirt, Blocks.dirt, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("dirt"));
        Item.registerItemBlock(Blocks.cobblestone);
        Item.registerItemBlock(Blocks.planks, (Item)new ItemMultiTexture(Blocks.planks, Blocks.planks, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("wood"));
        Item.registerItemBlock(Blocks.sapling, (Item)new ItemMultiTexture(Blocks.sapling, Blocks.sapling, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("sapling"));
        Item.registerItemBlock(Blocks.bedrock);
        Item.registerItemBlock((Block)Blocks.sand, (Item)new ItemMultiTexture((Block)Blocks.sand, (Block)Blocks.sand, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("sand"));
        ...
        Item.registerItemBlock(Blocks.log, (Item)new ItemMultiTexture(Blocks.log, Blocks.log, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("log"));
        Item.registerItemBlock(Blocks.log2, (Item)new ItemMultiTexture(Blocks.log2, Blocks.log2, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("log"));
        Item.registerItemBlock((Block)Blocks.leaves, (Item)new ItemLeaves(Blocks.leaves).setUnlocalizedName("leaves"));
        Item.registerItemBlock((Block)Blocks.leaves2, (Item)new ItemLeaves(Blocks.leaves2).setUnlocalizedName("leaves"));
        Item.registerItemBlock(Blocks.sponge, (Item)new ItemMultiTexture(Blocks.sponge, Blocks.sponge, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("sponge"));
        ...
        Item.registerItemBlock(Blocks.sandstone, (Item)new ItemMultiTexture(Blocks.sandstone, Blocks.sandstone, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("sandStone"));
        ...
        Item.registerItemBlock((Block)Blocks.sticky_piston, (Item)new ItemPiston((Block)Blocks.sticky_piston));
        Item.registerItemBlock(Blocks.web);
        Item.registerItemBlock((Block)Blocks.tallgrass, (Item)new ItemColored((Block)Blocks.tallgrass, true).setSubtypeNames(new String[]{"shrub", "grass", "fern"}));
        Item.registerItemBlock((Block)Blocks.deadbush);
        Item.registerItemBlock((Block)Blocks.piston, (Item)new ItemPiston((Block)Blocks.piston));
        Item.registerItemBlock(Blocks.wool, (Item)new ItemCloth(Blocks.wool).setUnlocalizedName("cloth"));
        Item.registerItemBlock((Block)Blocks.yellow_flower, (Item)new ItemMultiTexture((Block)Blocks.yellow_flower, (Block)Blocks.yellow_flower, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("flower"));
        Item.registerItemBlock((Block)Blocks.red_flower, (Item)new ItemMultiTexture((Block)Blocks.red_flower, (Block)Blocks.red_flower, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("rose"));
        Item.registerItemBlock((Block)Blocks.brown_mushroom);
        Item.registerItemBlock((Block)Blocks.red_mushroom);
        Item.registerItemBlock(Blocks.gold_block);
        Item.registerItemBlock(Blocks.iron_block);
        Item.registerItemBlock((Block)Blocks.stone_slab, (Item)new ItemSlab((Block)Blocks.stone_slab, Blocks.stone_slab, Blocks.double_stone_slab).setUnlocalizedName("stoneSlab"));
        ...
        Item.registerItemBlock((Block)Blocks.chest);
        ...
        Item.registerItemBlock(Blocks.snow_layer, (Item)new ItemSnow(Blocks.snow_layer));
        Item.registerItemBlock(Blocks.ice);
        Item.registerItemBlock(Blocks.snow);
        Item.registerItemBlock((Block)Blocks.cactus);
        ...
        Item.registerItemBlock(Blocks.monster_egg, (Item)new ItemMultiTexture(Blocks.monster_egg, Blocks.monster_egg, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("monsterStoneEgg"));
        Item.registerItemBlock(Blocks.stonebrick, (Item)new ItemMultiTexture(Blocks.stonebrick, Blocks.stonebrick, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("stonebricksmooth"));
        ...
        Item.registerItemBlock(Blocks.vine, (Item)new ItemColored(Blocks.vine, false));
        ...
        Item.registerItemBlock((Block)Blocks.mycelium);
        Item.registerItemBlock(Blocks.waterlily, (Item)new ItemLilyPad(Blocks.waterlily));
        ...
        Item.registerItemBlock((Block)Blocks.wooden_slab, (Item)new ItemSlab((Block)Blocks.wooden_slab, Blocks.wooden_slab, Blocks.double_wooden_slab).setUnlocalizedName("woodSlab"));
        ...
        Item.registerItemBlock((Block)Blocks.tripwire_hook);
        ...
        Item.registerItemBlock((Block)Blocks.beacon);
        Item.registerItemBlock(Blocks.cobblestone_wall, (Item)new ItemMultiTexture(Blocks.cobblestone_wall, Blocks.cobblestone_wall, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("cobbleWall"));
        Item.registerItemBlock(Blocks.wooden_button);
        Item.registerItemBlock(Blocks.anvil, (Item)new ItemAnvilBlock(Blocks.anvil).setUnlocalizedName("anvil"));
        ...
        Item.registerItemBlock((Block)Blocks.daylight_detector);
        Item.registerItemBlock(Blocks.redstone_block);
        Item.registerItemBlock(Blocks.quartz_ore);
        Item.registerItemBlock((Block)Blocks.hopper);
        Item.registerItemBlock(Blocks.quartz_block, (Item)new ItemMultiTexture(Blocks.quartz_block, Blocks.quartz_block, new String[]{"default", "chiseled", "lines"}).setUnlocalizedName("quartzBlock"));
        ...
        Item.registerItemBlock(Blocks.stained_hardened_clay, (Item)new ItemCloth(Blocks.stained_hardened_clay).setUnlocalizedName("clayHardenedStained"));
        Item.registerItemBlock(Blocks.barrier);
        Item.registerItemBlock(Blocks.iron_trapdoor);
        Item.registerItemBlock(Blocks.hay_block);
        Item.registerItemBlock(Blocks.carpet, (Item)new ItemCloth(Blocks.carpet).setUnlocalizedName("woolCarpet"));
        ...
        Item.registerItemBlock((Block)Blocks.double_plant, (Item)new ItemDoublePlant((Block)Blocks.double_plant, (Block)Blocks.double_plant, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("doublePlant"));
        Item.registerItemBlock((Block)Blocks.stained_glass, (Item)new ItemCloth((Block)Blocks.stained_glass).setUnlocalizedName("stainedGlass"));
        Item.registerItemBlock((Block)Blocks.stained_glass_pane, (Item)new ItemCloth((Block)Blocks.stained_glass_pane).setUnlocalizedName("stainedGlassPane"));
        Item.registerItemBlock(Blocks.prismarine, (Item)new ItemMultiTexture(Blocks.prismarine, Blocks.prismarine, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("prismarine"));
        Item.registerItemBlock(Blocks.sea_lantern);
        Item.registerItemBlock(Blocks.red_sandstone, (Item)new ItemMultiTexture(Blocks.red_sandstone, Blocks.red_sandstone, (Function)new /* Unavailable Anonymous Inner Class!! */).setUnlocalizedName("redSandStone"));
        Item.registerItemBlock(Blocks.red_sandstone_stairs);
        Item.registerItemBlock((Block)Blocks.stone_slab2, (Item)new ItemSlab((Block)Blocks.stone_slab2, Blocks.stone_slab2, Blocks.double_stone_slab2).setUnlocalizedName("stoneSlab2"));
        ...
        Item.registerItem(326, "water_bucket", new ItemBucket((Block)Blocks.flowing_water).setUnlocalizedName("bucketWater").setContainerItem(item));
        Item.registerItem(327, "lava_bucket", new ItemBucket((Block)Blocks.flowing_lava).setUnlocalizedName("bucketLava").setContainerItem(item));
        ...
        Item.registerItem(338, "reeds", new ItemReed((Block)Blocks.reeds).setUnlocalizedName("reeds").setCreativeTab(CreativeTabs.tabMaterials));
        ...
        Item.registerItem(356, "repeater", new ItemReed((Block)Blocks.unpowered_repeater).setUnlocalizedName("diode").setCreativeTab(CreativeTabs.tabRedstone));
        ...
        Item.registerItem(380, "cauldron", new ItemReed((Block)Blocks.cauldron).setUnlocalizedName("cauldron").setCreativeTab(CreativeTabs.tabBrewing));
        ...
        Item.registerItem(404, "comparator", new ItemReed((Block)Blocks.unpowered_comparator).setUnlocalizedName("comparator").setCreativeTab(CreativeTabs.tabRedstone));
    ...
    private static void registerItemBlock(Block blockIn) {
        Item.registerItemBlock(blockIn, (Item)new ItemBlock(blockIn));
    }

    protected static void registerItemBlock(Block blockIn, Item itemIn) {
        Item.registerItem(Block.getIdFromBlock((Block)blockIn), (ResourceLocation)Block.blockRegistry.getNameForObject((Object)blockIn), itemIn);
        BLOCK_TO_ITEM.put((Object)blockIn, (Object)itemIn);
    }
    ...
    private static void registerItem(int id, ResourceLocation textualID, Item itemIn) {
        itemRegistry.register(id, (Object)textualID, (Object)itemIn);
    }
}
