    ...
    public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn) {
        ...
        if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (worldIn.getBlockState(blockpos).getBlock().getMaterial() == Material.water) {
                ...
                if (!playerIn.inventory.addItemStackToInventory(new ItemStack((Item)Items.potionitem))) {
                    playerIn.dropPlayerItemWithRandomChoice(new ItemStack((Item)Items.potionitem, 1, 0), false);
                }
            }
        }
        return itemStackIn;
