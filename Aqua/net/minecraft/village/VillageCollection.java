...
extends WorldSavedData {
    ...
    public void addToVillagerPositionList(BlockPos pos) {
        if (this.villagerPositionsList.size() <= 64 && !this.positionInList(pos)) {
            this.villagerPositionsList.add((Object)pos);
        }
    }
    ...
    private void addNewDoorsToVillageOrCreateVillage() {
        for (int i = 0; i < this.newDoors.size(); ++i) {
            ...
            if (village == null) {
                ...
                this.villageList.add((Object)village);
                this.markDirty();
            }
    ...
    private void addToNewDoorsList(BlockPos doorBlock) {
        int j;
        EnumFacing enumfacing = BlockDoor.getFacing((IBlockAccess)this.worldObj, (BlockPos)doorBlock);
        ...
        if (i != (j = this.countBlocksCanSeeSky(doorBlock, enumfacing1, i + 1))) {
            this.newDoors.add((Object)new VillageDoorInfo(doorBlock, i < j ? enumfacing : enumfacing1, this.tickCounter));
        }
    }
