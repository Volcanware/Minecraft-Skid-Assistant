...
public class VillageSiege {
    ...
    private boolean func_75529_b() {
        ...
        while (true) {
            ...
            for (int i = 0; i < 10; ++i) {
                ...
                this.field_75532_g = blockpos.getX() + (int)((double)(MathHelper.cos((float)f1) * f) * 0.9);
                this.field_75538_h = blockpos.getY();
                this.field_75539_i = blockpos.getZ() + (int)((double)(MathHelper.sin((float)f1) * f) * 0.9);
                flag = false;
    ...
    private Vec3 func_179867_a(BlockPos p_179867_1_) {
        for (int i = 0; i < 10; ++i) {
            ...
            if (!this.theVillage.func_179866_a(blockpos) || !SpawnerAnimals.canCreatureTypeSpawnAtLocation((EntityLiving.SpawnPlacementType)EntityLiving.SpawnPlacementType.ON_GROUND, (World)this.worldObj, (BlockPos)blockpos)) continue;
