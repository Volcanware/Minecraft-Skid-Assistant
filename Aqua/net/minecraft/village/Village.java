...
public class Village {
    ...
    private boolean func_179861_a(BlockPos p_179861_1_, BlockPos p_179861_2_) {
        if (!World.doesBlockHaveSolidTopSurface((IBlockAccess)this.worldObj, (BlockPos)p_179861_2_.down())) {
            return false;
        }
    ...
    public boolean func_179866_a(BlockPos pos) {
        return this.center.distanceSq((Vec3i)pos) < (double)(this.villageRadius * this.villageRadius);
    }
    ...
    public VillageDoorInfo getExistedDoor(BlockPos doorBlock) {
        if (this.center.distanceSq((Vec3i)doorBlock) > (double)(this.villageRadius * this.villageRadius)) {
            return null;
        }
        for (VillageDoorInfo villagedoorinfo : this.villageDoorInfoList) {
            if (villagedoorinfo.getDoorBlockPos().getX() != doorBlock.getX() || villagedoorinfo.getDoorBlockPos().getZ() != doorBlock.getZ() || Math.abs((int)(villagedoorinfo.getDoorBlockPos().getY() - doorBlock.getY())) > 1) continue;
            return villagedoorinfo;
        }
        return null;
    }
    ...
    public void addVillageDoorInfo(VillageDoorInfo doorInfo) {
        this.villageDoorInfoList.add((Object)doorInfo);
    ...
    public void addOrRenewAgressor(EntityLivingBase entitylivingbaseIn) {
        ...
        this.villageAgressors.add((Object)new VillageAggressor(this, entitylivingbaseIn, this.tickCounter));
    }
    ...
    public EntityPlayer getNearestTargetPlayer(EntityLivingBase villageDefender) {
        ...
        for (String s : this.playerReputation.keySet()) {
            ...
            if (!this.isPlayerReputationTooLow(s) || (entityplayer1 = this.worldObj.getPlayerEntityByName(s)) == null || !((d1 = entityplayer1.getDistanceSqToEntity((Entity)villageDefender)) <= d0)) continue;
            entityplayer = entityplayer1;
            d0 = d1;
        }
        return entityplayer;
    ...
    private void removeDeadAndOldAgressors() {
        ...
        while (iterator.hasNext()) {
            ...
            if (village$villageaggressor.agressor.isEntityAlive() && Math.abs((int)(this.tickCounter - village$villageaggressor.agressionTime)) <= 300) continue;
            iterator.remove();
        }
    }
    ...
    private void removeDeadAndOutOfRangeDoors() {
        ...
        while (iterator.hasNext()) {
            ...
            if (this.isWoodDoor(villagedoorinfo.getDoorBlockPos()) && Math.abs((int)(this.tickCounter - villagedoorinfo.getInsidePosY())) <= 1200) continue;
    ...
    private void updateVillageRadiusAndCenter() {
        ...
        if (i == 0) {
            ...
            int j = 0;
            for (VillageDoorInfo villagedoorinfo : this.villageDoorInfoList) {
                j = Math.max((int)villagedoorinfo.getDistanceToDoorBlockSq(this.center), (int)j);
            }
            this.villageRadius = Math.max((int)32, (int)((int)Math.sqrt((double)j) + 1));
        }
    }

    public int getReputationForPlayer(String p_82684_1_) {
        Integer integer = (Integer)this.playerReputation.get((Object)p_82684_1_);
        return integer != null ? integer : 0;
    }

    public int setReputationForPlayer(String p_82688_1_, int p_82688_2_) {
        int i = this.getReputationForPlayer(p_82688_1_);
        int j = MathHelper.clamp_int((int)(i + p_82688_2_), (int)-30, (int)10);
        this.playerReputation.put((Object)p_82688_1_, (Object)j);
        return j;
    }
    ...
    public void readVillageDataFromNBT(NBTTagCompound compound) {
        ...
        for (int i = 0; i < nbttaglist.tagCount(); ++i) {
            ...
            this.villageDoorInfoList.add((Object)villagedoorinfo);
        }
        ...
        for (int j = 0; j < nbttaglist1.tagCount(); ++j) {
            ...
            if (nbttagcompound1.hasKey("UUID")) {
                ...
                GameProfile gameprofile = playerprofilecache.getProfileByUUID(UUID.fromString((String)nbttagcompound1.getString("UUID")));
                if (gameprofile == null) continue;
                this.playerReputation.put((Object)gameprofile.getName(), (Object)nbttagcompound1.getInteger("S"));
                continue;
            }
            this.playerReputation.put((Object)nbttagcompound1.getString("Name"), (Object)nbttagcompound1.getInteger("S"));
        }
    }
    ...
    public void writeVillageDataToNBT(NBTTagCompound compound) {
        ...
        for (String s : this.playerReputation.keySet()) {
            ...
            nbttagcompound1.setInteger("S", ((Integer)this.playerReputation.get((Object)s)).intValue());
