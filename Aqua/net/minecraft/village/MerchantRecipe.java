...
public class MerchantRecipe {
    ...
    public void readFromTags(NBTTagCompound tagCompound) {
        ...
        this.itemToBuy = ItemStack.loadItemStackFromNBT((NBTTagCompound)nbttagcompound);
        NBTTagCompound nbttagcompound1 = tagCompound.getCompoundTag("sell");
        this.itemToSell = ItemStack.loadItemStackFromNBT((NBTTagCompound)nbttagcompound1);
        if (tagCompound.hasKey("buyB", 10)) {
            this.secondItemToBuy = ItemStack.loadItemStackFromNBT((NBTTagCompound)tagCompound.getCompoundTag("buyB"));
        }
