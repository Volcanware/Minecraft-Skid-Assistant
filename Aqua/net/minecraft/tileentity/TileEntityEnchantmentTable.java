...
IInteractionObject {
    ...
    public void update() {
        ...
        EntityPlayer entityplayer = this.worldObj.getClosestPlayer((double)((float)this.pos.getX() + 0.5f), (double)((float)this.pos.getY() + 0.5f), (double)((float)this.pos.getZ() + 0.5f), 3.0);
        if (entityplayer != null) {
            double d0 = entityplayer.posX - (double)((float)this.pos.getX() + 0.5f);
            double d1 = entityplayer.posZ - (double)((float)this.pos.getZ() + 0.5f);
            this.field_145924_q = (float)MathHelper.atan2((double)d1, (double)d0);
        ...
        this.bookSpread = MathHelper.clamp_float((float)this.bookSpread, (float)0.0f, (float)1.0f);
        ++this.tickCount;
        this.pageFlipPrev = this.pageFlip;
        float f = (this.field_145932_k - this.pageFlip) * 0.4f;
        float f3 = 0.2f;
        f = MathHelper.clamp_float((float)f, (float)(-f3), (float)f3);
