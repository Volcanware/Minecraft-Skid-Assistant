...
public abstract class TileEntity {
    ...
    private static void addMapping(Class<? extends TileEntity> cl, String id) {
        if (nameToClassMap.containsKey((Object)id)) {
            throw new IllegalArgumentException("Duplicate id: " + id);
        }
        nameToClassMap.put((Object)id, cl);
        classToNameMap.put(cl, (Object)id);
    }
    ...
    public void writeToNBT(NBTTagCompound compound) {
        String s = (String)classToNameMap.get((Object)this.getClass());
        if (s == null) {
    ...
    public static TileEntity createAndLoadEntity(NBTTagCompound nbt) {
        ...
        try {
            Class oclass = (Class)nameToClassMap.get((Object)nbt.getString("id"));
            if (oclass != null) {
    ...
    public void addInfoToCrashReport(CrashReportCategory reportCategory) {
        reportCategory.addCrashSectionCallable("Name", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        if (this.worldObj != null) {
            CrashReportCategory.addBlockInfo((CrashReportCategory)reportCategory, (BlockPos)this.pos, (Block)this.getBlockType(), (int)this.getBlockMetadata());
            reportCategory.addCrashSectionCallable("Actual block type", (Callable)new /* Unavailable Anonymous Inner Class!! */);
            reportCategory.addCrashSectionCallable("Actual block data value", (Callable)new /* Unavailable Anonymous Inner Class!! */);
        }
    }
