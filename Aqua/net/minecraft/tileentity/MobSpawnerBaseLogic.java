...
public abstract class MobSpawnerBaseLogic {
    ...
    private String getEntityNameToSpawn() {
        if (this.getRandomEntity() == null) {
            if (this.mobID != null && this.mobID.equals((Object)"Minecart")) {
                this.mobID = "MinecartRideable";
            }
            return this.mobID;
        }
        return WeightedRandomMinecart.access$000((WeightedRandomMinecart)this.getRandomEntity());
    }
        ...
        if (this.isActivated()) {
            ...
            if (this.getSpawnerWorld().isRemote) {
                ...
                for (int i = 0; i < this.spawnCount; ++i) {
                    Entity entity = EntityList.createEntityByName((String)this.getEntityNameToSpawn(), (World)this.getSpawnerWorld());
                    if (entity == null) {
                        return;
                    }
    ...
    private Entity spawnNewEntity(Entity entityIn, boolean spawn) {
        if (this.getRandomEntity() != null) {
            ...
            for (String s : WeightedRandomMinecart.access$100((WeightedRandomMinecart)this.getRandomEntity()).getKeySet()) {
                NBTBase nbtbase = WeightedRandomMinecart.access$100((WeightedRandomMinecart)this.getRandomEntity()).getTag(s);
            ...
            while (nbttagcompound.hasKey("Riding", 10)) {
                ...
                Entity entity1 = EntityList.createEntityByName((String)nbttagcompound2.getString("id"), (World)entityIn.worldObj);
                if (entity1 != null) {
    ...
    private void resetTimer() {
        ...
        if (this.minecartToSpawn.size() > 0) {
            this.setRandomEntity((WeightedRandomMinecart)WeightedRandom.getRandomItem((Random)this.getSpawnerWorld().rand, this.minecartToSpawn));
        }
        this.func_98267_a(1);
    }
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        if (nbt.hasKey("SpawnPotentials", 9)) {
            ...
            for (int i = 0; i < nbttaglist.tagCount(); ++i) {
                this.minecartToSpawn.add((Object)new WeightedRandomMinecart(this, nbttaglist.getCompoundTagAt(i)));
            }
        }
    ...
    public void writeToNBT(NBTTagCompound nbt) {
        ...
        if (!StringUtils.isNullOrEmpty((String)s)) {
            ...
            if (this.getRandomEntity() != null) {
                nbt.setTag("SpawnData", WeightedRandomMinecart.access$100((WeightedRandomMinecart)this.getRandomEntity()).copy());
            }
            if (this.getRandomEntity() != null || this.minecartToSpawn.size() > 0) {
                ...
                if (this.minecartToSpawn.size() > 0) {
                    ...
                    nbttaglist.appendTag((NBTBase)this.getRandomEntity().toNBT());
                }
    ...
    public Entity func_180612_a(World worldIn) {
        Entity entity;
        if (this.cachedEntity == null && (entity = EntityList.createEntityByName((String)this.getEntityNameToSpawn(), (World)worldIn)) != null) {
