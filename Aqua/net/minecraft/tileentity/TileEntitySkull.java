...
extends TileEntity {
    ...
    public void writeToNBT(NBTTagCompound compound) {
        ...
        if (this.playerProfile != null) {
            ...
            NBTUtil.writeGameProfile((NBTTagCompound)nbttagcompound, (GameProfile)this.playerProfile);
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        if (this.skullType == 3) {
            ...
            if (compound.hasKey("Owner", 10)) {
                this.playerProfile = NBTUtil.readGameProfileFromNBT((NBTTagCompound)compound.getCompoundTag("Owner"));
            } else if (compound.hasKey("ExtraType", 8) && !StringUtils.isNullOrEmpty((String)(s = compound.getString("ExtraType")))) {
    ...
    public static GameProfile updateGameprofile(GameProfile input) {
        if (input != null && !StringUtils.isNullOrEmpty((String)input.getName())) {
