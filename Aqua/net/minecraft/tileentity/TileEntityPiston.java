...
implements ITickable {
    ...
    private void launchWithSlimeBlock(float p_145863_1_, float p_145863_2_) {
        ...
        if (axisalignedbb != null && !(list = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)null, axisalignedbb)).isEmpty()) {
            this.field_174933_k.addAll((Collection)list);
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        this.pistonState = Block.getBlockById((int)compound.getInteger("blockId")).getStateFromMeta(compound.getInteger("blockData"));
        this.pistonFacing = EnumFacing.getFront((int)compound.getInteger("facing"));
    ...
    public void writeToNBT(NBTTagCompound compound) {
        ...
        compound.setInteger("blockId", Block.getIdFromBlock((Block)this.pistonState.getBlock()));
