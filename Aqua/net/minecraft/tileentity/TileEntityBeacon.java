...
IInventory {
    ...
    private void addEffectsToPlayers() {
        if (this.isComplete && this.levels > 0 && !this.worldObj.isRemote && this.primaryEffect > 0) {
            ...
            int k = this.pos.getY();
            int l = this.pos.getZ();
            AxisAlignedBB axisalignedbb = new AxisAlignedBB((double)j, (double)k, (double)l, (double)(j + 1), (double)(k + 1), (double)(l + 1)).expand(d0, d0, d0).addCoord(0.0, (double)this.worldObj.getHeight(), 0.0);
    ...
    private void updateSegmentColors() {
        ...
        BeamSegment tileentitybeacon$beamsegment = new BeamSegment(EntitySheep.getDyeRgb((EnumDyeColor)EnumDyeColor.WHITE));
        this.beamSegments.add((Object)tileentitybeacon$beamsegment);
        boolean flag = true;
        ...
        for (int i1 = k + 1; i1 < 256; ++i1) {
            ...
            if (iblockstate.getBlock() == Blocks.stained_glass) {
                afloat = EntitySheep.getDyeRgb((EnumDyeColor)((EnumDyeColor)iblockstate.getValue((IProperty)BlockStainedGlass.COLOR)));
            } else {
                ...
                afloat = EntitySheep.getDyeRgb((EnumDyeColor)((EnumDyeColor)iblockstate.getValue((IProperty)BlockStainedGlassPane.COLOR)));
            }
            if (!flag) {
            ...
            if (Arrays.equals((float[])afloat, (float[])tileentitybeacon$beamsegment.getColors())) {
                tileentitybeacon$beamsegment.incrementHeight();
            } else {
        ...
        if (!this.worldObj.isRemote && this.levels == 4 && i < this.levels) {
            for (EntityPlayer entityplayer : this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, new AxisAlignedBB((double)j, (double)k, (double)l, (double)j, (double)(k - 4), (double)l).expand(10.0, 5.0, 10.0))) {
