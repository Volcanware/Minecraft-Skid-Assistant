...
ISidedInventory {
    ...
    public void setInventorySlotContents(int index, ItemStack stack) {
        boolean flag = stack != null && stack.isItemEqual(this.furnaceItemStacks[index]) && ItemStack.areItemStackTagsEqual((ItemStack)stack, (ItemStack)this.furnaceItemStacks[index]);
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        for (int i = 0; i < nbttaglist.tagCount(); ++i) {
            ...
            this.furnaceItemStacks[j] = ItemStack.loadItemStackFromNBT((NBTTagCompound)nbttagcompound);
        }
    ...
    public void update() {
        ...
        if (!this.worldObj.isRemote) {
            if (this.isBurning() || this.furnaceItemStacks[1] != null && this.furnaceItemStacks[0] != null) {
                ...
                this.cookTime = MathHelper.clamp_int((int)(this.cookTime - 2), (int)0, (int)this.totalCookTime);
            }
            if (flag != this.isBurning()) {
                flag1 = true;
                BlockFurnace.setState((boolean)this.isBurning(), (World)this.worldObj, (BlockPos)this.pos);
            }
        }
        if (flag1) {
            this.markDirty();
    ...
    public void smeltItem() {
        if (this.canSmelt()) {
            ...
            if (this.furnaceItemStacks[0].getItem() == Item.getItemFromBlock((Block)Blocks.sponge) && this.furnaceItemStacks[0].getMetadata() == 1 && this.furnaceItemStacks[1] != null && this.furnaceItemStacks[1].getItem() == Items.bucket) {
    ...
    public static int getItemBurnTime(ItemStack p_145952_0_) {
        ...
        return item instanceof ItemTool && ((ItemTool)item).getToolMaterialName().equals((Object)"WOOD") ? 200 : (item instanceof ItemSword && ((ItemSword)item).getToolMaterialName().equals((Object)"WOOD") ? 200 : (item instanceof ItemHoe && ((ItemHoe)item).getMaterialName().equals((Object)"WOOD") ? 200 : (item == Items.stick ? 100 : (item == Items.coal ? 1600 : (item == Items.lava_bucket ? 20000 : (item == Item.getItemFromBlock((Block)Blocks.sapling) ? 100 : (item == Items.blaze_rod ? 2400 : 0)))))));
    }
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) {
        return index == 2 ? false : (index != 1 ? true : TileEntityFurnace.isItemFuel(stack) || SlotFurnaceFuel.isBucket((ItemStack)stack));
    }
