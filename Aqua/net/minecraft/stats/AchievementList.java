...
public class AchievementList {
    ...
    static {
        ...
        snipeSkeleton = new Achievement("achievement.snipeSkeleton", "snipeSkeleton", 7, 0, (Item)Items.bow, killEnemy).setSpecial().registerStat();
        ...
        potion = new Achievement("achievement.potion", "potion", 2, 8, (Item)Items.potionitem, blazeRod).registerStat();
        ...
        fullBeacon = new Achievement("achievement.fullBeacon", "fullBeacon", 7, 8, (Block)Blocks.beacon, killWither).setSpecial().registerStat();
        exploreAllBiomes = new Achievement("achievement.exploreAllBiomes", "exploreAllBiomes", 4, 8, (Item)Items.diamond_boots, theEnd).func_150953_b(JsonSerializableSet.class).setSpecial().registerStat();
