...
public class StatList {
    ...
    private static void initCraftableStats() {
        ...
        for (IRecipe irecipe : CraftingManager.getInstance().getRecipeList()) {
            ...
            set.add((Object)irecipe.getRecipeOutput().getItem());
        }
        for (ItemStack itemstack : FurnaceRecipes.instance().getSmeltingList().values()) {
            set.add((Object)itemstack.getItem());
        }
        for (Item item : set) {
            ...
            if (s == null) continue;
            StatList.objectCraftStats[i] = new StatCrafting("stat.craftItem.", s, (IChatComponent)new ChatComponentTranslation("stat.craftItem", new Object[]{new ItemStack(item).getChatComponent()}), item).registerStat();
        }
    ...
    private static void initMiningStats() {
        for (Block block : Block.blockRegistry) {
            ...
            StatList.mineBlockStatArray[i] = new StatCrafting("stat.mineBlock.", s, (IChatComponent)new ChatComponentTranslation("stat.mineBlock", new Object[]{new ItemStack(block).getChatComponent()}), item).registerStat();
            objectMineStats.add((Object)((StatCrafting)mineBlockStatArray[i]));
        }
    ...
    private static void initStats() {
        for (Item item : Item.itemRegistry) {
            ...
            String s = StatList.func_180204_a(item);
            if (s == null) continue;
            StatList.objectUseStats[i] = new StatCrafting("stat.useItem.", s, (IChatComponent)new ChatComponentTranslation("stat.useItem", new Object[]{new ItemStack(item).getChatComponent()}), item).registerStat();
            if (item instanceof ItemBlock) continue;
            itemStats.add((Object)((StatCrafting)objectUseStats[i]));
        }
    ...
    private static void initItemDepleteStats() {
        for (Item item : Item.itemRegistry) {
            ...
            StatList.objectBreakStats[i] = new StatCrafting("stat.breakItem.", s, (IChatComponent)new ChatComponentTranslation("stat.breakItem", new Object[]{new ItemStack(item).getChatComponent()}), item).registerStat();
        }
        StatList.replaceAllSimilarBlocks(objectBreakStats);
    }

    private static String func_180204_a(Item p_180204_0_) {
        ResourceLocation resourcelocation = (ResourceLocation)Item.itemRegistry.getNameForObject((Object)p_180204_0_);
        return resourcelocation != null ? resourcelocation.toString().replace(':', '.') : null;
    }

    private static void replaceAllSimilarBlocks(StatBase[] p_75924_0_) {
        StatList.mergeStatBases(p_75924_0_, (Block)Blocks.water, (Block)Blocks.flowing_water);
        StatList.mergeStatBases(p_75924_0_, (Block)Blocks.lava, (Block)Blocks.flowing_lava);
        ...
        StatList.mergeStatBases(p_75924_0_, (Block)Blocks.powered_repeater, (Block)Blocks.unpowered_repeater);
        StatList.mergeStatBases(p_75924_0_, (Block)Blocks.powered_comparator, (Block)Blocks.unpowered_comparator);
        ...
        StatList.mergeStatBases(p_75924_0_, (Block)Blocks.double_stone_slab, (Block)Blocks.stone_slab);
        StatList.mergeStatBases(p_75924_0_, (Block)Blocks.double_wooden_slab, (Block)Blocks.wooden_slab);
        StatList.mergeStatBases(p_75924_0_, (Block)Blocks.double_stone_slab2, (Block)Blocks.stone_slab2);
        StatList.mergeStatBases(p_75924_0_, (Block)Blocks.grass, Blocks.dirt);
    ...
    private static void mergeStatBases(StatBase[] statBaseIn, Block p_151180_1_, Block p_151180_2_) {
        int i = Block.getIdFromBlock((Block)p_151180_1_);
        int j = Block.getIdFromBlock((Block)p_151180_2_);
        if (statBaseIn[i] != null && statBaseIn[j] == null) {
            statBaseIn[j] = statBaseIn[i];
        } else {
            allStats.remove((Object)statBaseIn[i]);
            objectMineStats.remove((Object)statBaseIn[i]);
            generalStats.remove((Object)statBaseIn[i]);
            statBaseIn[i] = statBaseIn[j];
        }
    }

    public static StatBase getStatKillEntity(EntityList.EntityEggInfo eggInfo) {
        String s = EntityList.getStringFromID((int)eggInfo.spawnedID);
    ...
    public static StatBase getOneShotStat(String p_151177_0_) {
        return (StatBase)oneShotStats.get((Object)p_151177_0_);
    }
}
