...
public class ModelSprite {
    ...
    public void render(Tessellator tessellator, float scale) {
        GlStateManager.translate((float)(this.posX * scale), (float)(this.posY * scale), (float)(this.posZ * scale));
        float f = this.minU;
        float f1 = this.maxU;
        float f2 = this.minV;
        float f3 = this.maxV;
    ...
    public static void renderItemIn2D(Tessellator tess, float minU, float minV, float maxU, float maxV, int sizeX, int sizeY, float width, float texWidth, float texHeight) {
        ...
        float f = maxU - minU;
        float f1 = maxV - minV;
        double d0 = MathHelper.abs((float)f) * (texWidth / 16.0f);
        double d1 = MathHelper.abs((float)f1) * (texHeight / 16.0f);
