...
implements IRandomEntity {
    ...
    public int getId() {
        return Config.getRandom((BlockPos)this.tileEntity.getPos(), (int)this.tileEntity.getBlockMetadata());
    }
    ...
    public String getName() {
        String s = TileEntityUtils.getTileEntityName((TileEntity)this.tileEntity);
        return s;
    }
