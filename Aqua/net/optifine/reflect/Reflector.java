...
public class Reflector {
    ...
    public static ReflectorField EntityVillager_careerId = new ReflectorField((IFieldLocator)new FieldLocatorTypes(EntityVillager.class, new Class[0], Integer.TYPE, new Class[]{Integer.TYPE, Boolean.TYPE, Boolean.TYPE, InventoryBasic.class}, "EntityVillager.careerId"));
    public static ReflectorField EntityVillager_careerLevel = new ReflectorField((IFieldLocator)new FieldLocatorTypes(EntityVillager.class, new Class[]{Integer.TYPE}, Integer.TYPE, new Class[]{Boolean.TYPE, Boolean.TYPE, InventoryBasic.class}, "EntityVillager.careerLevel"));
    ...
    private static void dbgCall(boolean isStatic, String callType, ReflectorMethod refMethod, Object[] params, Object retVal) {
        ...
        Log.dbg((String)(callType + s2 + " " + s + "." + s1 + "(" + ArrayUtils.arrayToString((Object[])params) + ") => " + retVal));
    }
    ...
    private static void dbgCallVoid(boolean isStatic, String callType, ReflectorMethod refMethod, Object[] params) {
        ...
        Log.dbg((String)(callType + s2 + " " + s + "." + s1 + "(" + ArrayUtils.arrayToString((Object[])params) + ")"));
    }
    ...
    private static void dbgFieldValue(boolean isStatic, String accessType, ReflectorField refField, Object val) {
        ...
        Log.dbg((String)(accessType + s2 + " " + s + "." + s1 + " => " + val));
    }
    ...
    private static void handleException(Throwable e, Object obj, ReflectorMethod refMethod, Object[] params) {
        if (e instanceof InvocationTargetException) {
            ...
            Log.warn((String)"*** Exception outside of method ***");
            Log.warn((String)("Method deactivated: " + refMethod.getTargetMethod()));
            refMethod.deactivate();
            if (e instanceof IllegalArgumentException) {
                Log.warn((String)"*** IllegalArgumentException ***");
                Log.warn((String)("Method: " + refMethod.getTargetMethod()));
                Log.warn((String)("Object: " + obj));
                Log.warn((String)("Parameter classes: " + ArrayUtils.arrayToString((Object[])Reflector.getClasses(params))));
                Log.warn((String)("Parameters: " + ArrayUtils.arrayToString((Object[])params)));
            }
            Log.warn((String)"", (Throwable)e);
        }
    }
    ...
    private static void handleException(Throwable e, ReflectorConstructor refConstr, Object[] params) {
        if (e instanceof InvocationTargetException) {
            ...
            Log.warn((String)"*** Exception outside of constructor ***");
            Log.warn((String)("Constructor deactivated: " + refConstr.getTargetConstructor()));
            refConstr.deactivate();
            if (e instanceof IllegalArgumentException) {
                Log.warn((String)"*** IllegalArgumentException ***");
                Log.warn((String)("Constructor: " + refConstr.getTargetConstructor()));
                Log.warn((String)("Parameter classes: " + ArrayUtils.arrayToString((Object[])Reflector.getClasses(params))));
                Log.warn((String)("Parameters: " + ArrayUtils.arrayToString((Object[])params)));
            }
            Log.warn((String)"", (Throwable)e);
    ...
    private static boolean registerResolvable(String str) {
        1 iresolvable = new /* Unavailable Anonymous Inner Class!! */;
        ReflectorResolver.register((IResolvable)iresolvable);
        return true;
    }
