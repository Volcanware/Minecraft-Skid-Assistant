...
extends Thread {
    ...
    private static Charset ASCII = Charset.forName((String)"ASCII");
    ...
    private void connect() throws IOException {
        ...
        socket.connect((SocketAddress)new InetSocketAddress(s, i), 5000);
    ...
    private void writeRequest(HttpRequest req, OutputStream out) throws IOException {
        ...
        Map map = req.getHeaders();
        for (String s : map.keySet()) {
            String s1 = (String)req.getHeaders().get((Object)s);
