...
implements IParameters {
    ...
    public ExpressionType[] getParameterTypes(IExpression[] arguments) {
        ...
        list.addAll((Collection)Arrays.asList((Object[])this.first));
        for (int i1 = 0; i1 < k; ++i1) {
            list.addAll((Collection)Arrays.asList((Object[])this.repeat));
        }
        list.addAll((Collection)Arrays.asList((Object[])this.last));
        ExpressionType[] aexpressiontype = (ExpressionType[])list.toArray((Object[])new ExpressionType[list.size()]);
