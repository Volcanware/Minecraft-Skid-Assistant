...
public class CustomLoadingScreens {
    ...
    private static Pair<CustomLoadingScreen[], Integer> parseScreens() {
        ...
        Properties properties = ResUtils.readProperties((String)s5, (String)"CustomLoadingScreens");
        int k = ainteger[0];
        ...
        for (int j1 = 0; j1 < ainteger.length; ++j1) {
            ...
            acustomloadingscreen[integer.intValue() - k] = CustomLoadingScreen.parseScreen((String)s4, (int)integer, (Properties)properties);
        }
        return new ImmutablePair((Object)acustomloadingscreen, (Object)k);
    }

    public static void warn(String str) {
        Config.warn((String)("CustomLoadingScreen: " + str));
    }

    public static void dbg(String str) {
        Config.dbg((String)("CustomLoadingScreen: " + str));
    }
}
