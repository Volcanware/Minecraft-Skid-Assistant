...
public class CustomPanoramaProperties {
    ...
    public CustomPanoramaProperties(String path, Properties props) {
        ...
        this.overlay1Top = ConnectedParser.parseColor4((String)props.getProperty("overlay1.top"), (int)-2130706433);
        this.overlay1Bottom = ConnectedParser.parseColor4((String)props.getProperty("overlay1.bottom"), (int)0xFFFFFF);
        this.overlay2Top = ConnectedParser.parseColor4((String)props.getProperty("overlay2.top"), (int)0);
        this.overlay2Bottom = ConnectedParser.parseColor4((String)props.getProperty("overlay2.bottom"), (int)Integer.MIN_VALUE);
    }
