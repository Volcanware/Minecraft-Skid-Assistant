...
extends ModelAdapter {
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart) {
        ...
        return modelPart.equals((Object)"head") ? modelhumanoidhead.skeletonHead : (modelPart.equals((Object)"head2") ? (!Reflector.ModelHumanoidHead_head.exists() ? null : (ModelRenderer)Reflector.getFieldValue((Object)modelhumanoidhead, (ReflectorField)Reflector.ModelHumanoidHead_head)) : null);
    }
    ...
    public IEntityRenderer makeEntityRender(ModelBase modelBase, float shadowSize) {
        ...
        if (!Reflector.TileEntitySkullRenderer_humanoidHead.exists()) {
            Config.warn((String)"Field not found: TileEntitySkullRenderer.humanoidHead");
            return null;
        }
        Reflector.setFieldValue((Object)tileentityspecialrenderer, (ReflectorField)Reflector.TileEntitySkullRenderer_humanoidHead, (Object)modelBase);
