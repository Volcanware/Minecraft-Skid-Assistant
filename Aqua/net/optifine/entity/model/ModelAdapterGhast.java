...
extends ModelAdapter {
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart) {
        ...
        if (modelPart.equals((Object)"body")) {
            return (ModelRenderer)Reflector.getFieldValue((Object)modelghast, (ReflectorField)Reflector.ModelGhast_body);
        }
        String s = "tentacle";
        if (modelPart.startsWith(s)) {
            ModelRenderer[] amodelrenderer = (ModelRenderer[])Reflector.getFieldValue((Object)modelghast, (ReflectorField)Reflector.ModelGhast_tentacles);
