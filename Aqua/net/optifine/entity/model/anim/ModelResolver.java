...
implements IModelResolver {
    ...
    public ModelRenderer getModelRenderer(String name) {
        ...
        if (this.thisModelRenderer != null && name.equals((Object)"this")) {
            return this.thisModelRenderer;
        }
        if (this.partModelRenderer != null && name.equals((Object)"part")) {
        ...
        for (int i = 0; i < this.customModelRenderers.length; ++i) {
            ...
            if (name.equals((Object)modelrenderer1.getId())) {
    ...
    public ModelVariableFloat getModelVariable(String name) {
        ...
        ModelVariableType modelvariabletype = ModelVariableType.parse((String)s1);
