...
extends ModelAdapter {
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart) {
        ...
        if (modelPart.equals((Object)"core")) {
            return (ModelRenderer)Reflector.getFieldValue((Object)modelmagmacube, (ReflectorField)Reflector.ModelMagmaCube_core);
        }
        String s = "segment";
        if (modelPart.startsWith(s)) {
            ModelRenderer[] amodelrenderer = (ModelRenderer[])Reflector.getFieldValue((Object)modelmagmacube, (ReflectorField)Reflector.ModelMagmaCube_segments);
