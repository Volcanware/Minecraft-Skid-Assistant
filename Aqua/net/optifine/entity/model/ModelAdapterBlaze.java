...
extends ModelAdapter {
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart) {
        ...
        if (modelPart.equals((Object)"head")) {
            return (ModelRenderer)Reflector.getFieldValue((Object)modelblaze, (ReflectorField)Reflector.ModelBlaze_blazeHead);
        }
        String s = "stick";
        if (modelPart.startsWith(s)) {
            ModelRenderer[] amodelrenderer = (ModelRenderer[])Reflector.getFieldValue((Object)modelblaze, (ReflectorField)Reflector.ModelBlaze_blazeSticks);
