...
extends ModelAdapter {
    ...
    public IEntityRenderer makeEntityRender(ModelBase modelBase, float shadowSize) {
        ...
        if (!Reflector.TileEntityChestRenderer_simpleChest.exists()) {
            Config.warn((String)"Field not found: TileEntityChestRenderer.simpleChest");
            return null;
        }
        Reflector.setFieldValue((Object)tileentityspecialrenderer, (ReflectorField)Reflector.TileEntityChestRenderer_simpleChest, (Object)modelBase);
