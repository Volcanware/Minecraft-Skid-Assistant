...
extends ClippingHelper {
    ...
    private void normalizePlane(float[] plane) {
        float f = MathHelper.sqrt_float((float)(plane[0] * plane[0] + plane[1] * plane[1] + plane[2] * plane[2]));
        plane[0] = plane[0] / f;
        plane[1] = plane[1] / f;
        plane[2] = plane[2] / f;
        plane[3] = plane[3] / f;
    ...
    public void init() {
        ...
        System.arraycopy((Object)Shaders.faProjection, (int)0, (Object)afloat, (int)0, (int)16);
        System.arraycopy((Object)Shaders.faModelView, (int)0, (Object)afloat1, (int)0, (int)16);
        SMath.multiplyMat4xMat4((float[])afloat2, (float[])afloat1, (float[])afloat);
