...
extends GuiScreenOF {
    ...
    private TooltipManager tooltipManager = new TooltipManager((GuiScreen)this, (TooltipProvider)new TooltipProviderShaderOptions());
    ...
    public GuiShaderOptions(GuiScreen guiscreen, GameSettings gamesettings, String screenName) {
        ...
        if (screenName != null) {
            this.screenText = Shaders.translate((String)("screen." + screenName), (String)screenName);
        }
    }

    public void initGui() {
        this.title = I18n.format((String)"of.options.shaderOptionsTitle", (Object[])new Object[0]);
        int i = 100;
        int j = 0;
        int k = 30;
        int l = 20;
        int i1 = 120;
        int j1 = 20;
        int k1 = Shaders.getShaderPackColumns((String)this.screenName, (int)2);
        ShaderOption[] ashaderoption = Shaders.getShaderPackOptions((String)this.screenName);
        if (ashaderoption != null) {
            int l1 = MathHelper.ceiling_double_int((double)((double)ashaderoption.length / 9.0));
            if (k1 < l1) {
                k1 = l1;
            }
            for (int i2 = 0; i2 < ashaderoption.length; ++i2) {
                ...
                int j2 = i2 % k1;
                int k2 = i2 / k1;
                int l2 = Math.min((int)(width / k1), (int)200);
                j = (width - l2 * k1) / 2;
                int i3 = j2 * l2 + 5 + j;
                int j3 = k + k2 * l;
                int k3 = l2 - 10;
                String s = GuiShaderOptions.getButtonText(shaderoption, k3);
                Object guibuttonshaderoption = Shaders.isShaderPackOptionSlider((String)shaderoption.getName()) ? new GuiSliderShaderOption(i + i2, i3, j3, k3, j1, shaderoption, s) : new GuiButtonShaderOption(i + i2, i3, j3, k3, j1, shaderoption, s);
                guibuttonshaderoption.enabled = shaderoption.isEnabled();
                this.buttonList.add(guibuttonshaderoption);
            }
        }
        this.buttonList.add((Object)new GuiButton(201, width / 2 - i1 - 20, height / 6 + 168 + 11, i1, j1, I18n.format((String)"controls.reset", (Object[])new Object[0])));
        this.buttonList.add((Object)new GuiButton(200, width / 2 + 20, height / 6 + 168 + 11, i1, j1, I18n.format((String)"gui.done", (Object[])new Object[0])));
    }
