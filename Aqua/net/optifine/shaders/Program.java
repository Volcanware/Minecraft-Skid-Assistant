...
public class Program {
    ...
    public void resetConfiguration() {
        ...
        if (this.drawBuffersBuffer == null) {
            this.drawBuffersBuffer = Shaders.nextIntBuffer((int)8);
        }
    }
    ...
    public void copyFrom(Program p) {
        ...
        System.arraycopy((Object)p.getBuffersFlip(), (int)0, (Object)this.buffersFlip, (int)0, (int)this.buffersFlip.length);
        ...
        System.arraycopy((Object)p.getToggleColorTextures(), (int)0, (Object)this.toggleColorTextures, (int)0, (int)this.toggleColorTextures.length);
    }
