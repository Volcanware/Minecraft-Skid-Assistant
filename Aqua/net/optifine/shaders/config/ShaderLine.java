...
public class ShaderLine {
    ...
    public boolean isUniform(String name) {
        return this.isUniform() && name.equals((Object)this.name);
    }
    ...
    public boolean isAttribute(String name) {
        return this.isAttribute() && name.equals((Object)this.name);
    }
    ...
    public boolean isProperty(String name) {
        return this.isProperty() && name.equals((Object)this.name);
    }

    public boolean isProperty(String name, String value) {
        return this.isProperty(name) && value.equals((Object)this.value);
    }

    public boolean isConstInt(String name) {
        return this.isConstInt() && name.equals((Object)this.name);
    }
    ...
    public boolean isConstFloat(String name) {
        return this.isConstFloat() && name.equals((Object)this.name);
    }

    public boolean isConstBool(String name) {
        return this.isConstBool() && name.equals((Object)this.name);
    }

    public boolean isExtension(String name) {
        return this.isExtension() && name.equals((Object)this.name);
    }
    ...
    public Vector4f getValueVec4() {
        ...
        s = StrUtils.removePrefix((String)s, (String)"vec4");
        String[] astring = Config.tokenize((String)(s = StrUtils.trim((String)s, (String)" ()")), (String)", ");
        if (astring.length != 4) {
            return null;
        }
        ...
        for (int i = 0; i < astring.length; ++i) {
            String s1 = astring[i];
            float f = Config.parseFloat((String)(s1 = StrUtils.removeSuffix((String)s1, (String[])new String[]{"F", "f"})), (float)Float.MAX_VALUE);
    ...
    public boolean getValueBool() {
        ...
        if (!s.equals((Object)"true") && !s.equals((Object)"false")) {
