...
public class VillagerProfession {
    ...
    public boolean matches(int prof, int car) {
        return this.profession != prof ? false : this.careers == null || Config.equalsOne((int)car, (int[])this.careers);
    }

    private boolean hasCareer(int car) {
        return this.careers == null ? false : Config.equalsOne((int)car, (int[])this.careers);
    }
    ...
    public boolean addCareer(int car) {
        ...
        this.careers = Config.addIntToArray((int[])this.careers, (int)car);
        return true;
    }
    ...
    public String toString() {
        return this.careers == null ? "" + this.profession : "" + this.profession + ":" + Config.arrayToString((int[])this.careers);
    }
}
