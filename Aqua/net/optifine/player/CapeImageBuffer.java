...
extends ImageBufferDownload {
    ...
    public BufferedImage parseUserSkin(BufferedImage imageRaw) {
        BufferedImage bufferedimage = CapeUtils.parseCape((BufferedImage)imageRaw);
        this.elytraOfCape = CapeUtils.isElytraCape((BufferedImage)imageRaw, (BufferedImage)bufferedimage);
