...
import dev.rise.module.impl.other.Disabler;
...
public class ViaMCP implements InstanceAccess {
    ...
    public int getVersion() {
       final String ip = Rise.ip;
        if (ip != null && this.getModule(Disabler.class).isEnabled() && this.getBoolean(Disabler.class, "Hypixel") && (ip.contains("hypixel.net") && !ip.contains("ruhypixel.net") || ip.contains("2606:4700::6810:4e15")))
            return 756;
        return version;
    }
