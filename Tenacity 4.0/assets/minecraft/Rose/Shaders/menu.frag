...
void main() {
    const vec3 c1 = vec3(140.0/255.0, 0.0/255.0, 17.0/255.0);
    const vec3 c2 = vec3(173.0/255.0, 0.0/255.0, 101.4/255.0);
    const vec3 c3 = vec3(0.4, 0.0, 0.0);
    const vec3 c4 = vec3(164.0/255.0, 1.0/255.0, 174.4/255.0);
