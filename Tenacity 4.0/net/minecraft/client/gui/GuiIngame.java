...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        BlurModule blurModule = (BlurModule) Tenacity.INSTANCE.getModuleCollection().get(BlurModule.class);
        ...
        if (scoreobjective1 != null && Tenacity.INSTANCE.isToggled(ScoreboardMod.class))
        {
