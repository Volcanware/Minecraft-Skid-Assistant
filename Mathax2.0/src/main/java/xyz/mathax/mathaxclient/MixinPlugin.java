...
import xyz.mathax.mathaxclient.asm.Asm;
...
public class MixinPlugin implements IMixinConfigPlugin {
    private static final String mixinPackage = "xyz.mathax.mathaxclient.mixin";
    ...
    public void onLoad(String mixinPackage) {
        ...
        } catch (NoSuchFieldException | IllegalAccessException | InstantiationException exception) {
