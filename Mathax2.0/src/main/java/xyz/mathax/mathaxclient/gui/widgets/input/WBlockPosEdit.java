...
import static xyz.mathax.mathaxclient.utils.Utils.canUpdate;
    ...
    public void init() {
        ...
        if (canUpdate()) {
            ...
            click.action = () -> {
                ...
                ChatUtils.info(string);
                //Modules.get().get(Marker.class).info(string);
