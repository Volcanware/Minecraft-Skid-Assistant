package xyz.mathax.mathaxclient.gui.prompts;
...
public class YesNoPrompt {
    ...
    private YesNoPrompt(Theme theme, Screen parent) {
        this.theme = theme;
        this.parent = parent;
    }
    ...
    public static YesNoPrompt create(Theme theme, Screen parent) {
    ...
    public void show() {
        ...
        if (Config.get().dontShowAgainPrompts.contains(id)) {
            return;
        }
    ...
    private class PromptScreen extends WindowScreen {
        public PromptScreen(Theme theme) {
