package xyz.mathax.mathaxclient.gui.renderer.packer;
...
public class TexturePacker {
    ...
    public GuiTexture add(Identifier identifier) {
        try {
            InputStream in = mc.getResourceManager().getResource(identifier).get().getInputStream();
