...
import xyz.mathax.mathaxclient.settings.StorageBlockListSetting;
...
public class StorageBlockListSettingScreen extends LeftRightListSettingScreen<BlockEntityType<?>> {
    public StorageBlockListSettingScreen(Theme theme, Setting<List<BlockEntityType<?>>> setting) {
    ...
    protected WWidget getValueWidget(BlockEntityType<?> value) {
        ...
        if (value == BlockEntityType.FURNACE) {
            item = Items.FURNACE;
        } else if (value == BlockEntityType.CHEST) {
            item = Items.CHEST;
        } else if (value == BlockEntityType.TRAPPED_CHEST) {
            item = Items.TRAPPED_CHEST;
        } else if (value == BlockEntityType.ENDER_CHEST) {
            item = Items.ENDER_CHEST;
        } else if (value == BlockEntityType.DISPENSER) {
            item = Items.DISPENSER;
        } else if (value == BlockEntityType.DROPPER) {
            item = Items.DROPPER;
        } else if (value == BlockEntityType.HOPPER) {
            item = Items.HOPPER;
        } else if (value == BlockEntityType.SHULKER_BOX) {
            item = Items.SHULKER_BOX;
        } else if (value == BlockEntityType.BARREL) {
            item = Items.BARREL;
        } else if (value == BlockEntityType.SMOKER) {
            item = Items.SMOKER;
        } else if (value == BlockEntityType.BLAST_FURNACE) {
