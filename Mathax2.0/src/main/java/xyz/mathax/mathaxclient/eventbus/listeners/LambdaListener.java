package xyz.mathax.mathaxclient.eventbus.listeners;
...
public class LambdaListener implements IListener {
    ...
    public LambdaListener(Factory factory, Class<?> klass, Object object, Method method) {
        ...
        try {
            ...
            if (isJava1dot8) {
                boolean isLookupConstructorAccessible = lookupConstructor.isAccessible();
                lookupConstructor.setAccessible(true);
                lookup = lookupConstructor.newInstance(klass);
                lookupConstructor.setAccessible(isLookupConstructorAccessible);
            } else {
