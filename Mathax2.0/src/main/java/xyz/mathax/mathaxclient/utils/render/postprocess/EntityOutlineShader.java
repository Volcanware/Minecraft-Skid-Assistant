...
public class EntityOutlineShader extends EntityShader {
    ...
    protected void setUniforms() {
        shader.set("u_Width", esp.outlineWidthSetting.get());
        shader.set("u_FillOpacity", esp.fillOpacitySetting.get());
        shader.set("u_ShapeMode", esp.shapeModeSetting.get().ordinal());
        shader.set("u_GlowMultiplier", esp.glowMultiplierSetting.get());
    }
}