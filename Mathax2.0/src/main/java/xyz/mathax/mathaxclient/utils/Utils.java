package xyz.mathax.mathaxclient.utils;
...
import xyz.mathax.mathaxclient.utils.world.BlockEntityIterator;
import xyz.mathax.mathaxclient.utils.world.ChunkIterator;
...
import xyz.mathax.mathaxclient.mixin.*;
...
public class Utils {
            ...
            if (nbt2.contains("Items")) {
                ...
                for (int i = 0; i < nbt3.size(); i++) {
                    ...
                    if (slot >= 0 && slot < items.length) {
                        items[slot] = ItemStack.fromNbt(nbt3.getCompound(i));
                    }
                }
            }
        }
    ...
    public static String nameToCommand(String name) {
