...
public class Color implements ICopyable<Color>, ISerializable<Color> {
    public static final Color MATHAX = new Color(230, 75, 100);
    public static final Color MATHAX_BACKGROUND = new Color(30, 30, 45);
    ...
    public static final Color PURPLE = new Color(0, 50, 50);
    ...
    @Override
    public Color fromJson(JSONObject json) {
