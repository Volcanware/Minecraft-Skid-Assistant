...
public class Mesh {
    ...
    public void begin() {
        ...
        if (rendering3D) {
            Vec3d camera = MatHax.mc.gameRenderer.getCamera().getPos();
    ...
    public void growIfNeeded() {
        ...
        if (indicesCount * 4 >= indices.capacity()) {
            ...
            if (newSize % drawMode.indicesCount != 0) {
                newSize += newSize % (drawMode.indicesCount * 4);
            }
    ...
    public void beginRender(MatrixStack matrixStack) {
        GL.saveState();
        ...
        if (rendering3D) {
            ...
            Vec3d cameraPos = MatHax.mc.gameRenderer.getCamera().getPos();
            matrixStack1.translate(0, -cameraPos.y, 0);
        }
