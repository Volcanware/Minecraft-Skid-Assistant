...
public class BlockItemPackets1_13 extends viaversion.viabackwards.api.rewriters.ItemRewriter<Protocol1_12_2To1_13> {
    ...
    public BlockItemPackets1_13(Protocol1_12_2To1_13 protocol) {
        super(protocol, null);
        extraNbtTag = "VB|Protocol1_12_2To1_13|2";
    }
                ...
                if (oldId == null) {
                    if (!newId.startsWith("viaversion:legacy/")) {
                        ...
                        if (ViaBackwards.getConfig().addCustomEnchantsToLore()) {
                            ...
                            name = "§7" + Character.toUpperCase(name.charAt(0)) + name.substring(1).toLowerCase(Locale.ROOT);
