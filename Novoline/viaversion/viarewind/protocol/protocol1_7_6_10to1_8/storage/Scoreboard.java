...
public class Scoreboard extends StoredObject {
	...
	public Optional<String> getTeam(String player) {
		for(Map.Entry<String, List<String>> entry : teams.entrySet())
			if(entry.getValue().contains(player)) return Optional.of(entry.getKey());
	...
	public void setColorIndependentSidebar(String colorIndependentSidebar) { this.colorIndependentSidebar = colorIndependentSidebar; }
	public String getColorIndependentSidebar() { return colorIndependentSidebar; }
	public HashMap<Byte, String> getColorDependentSidebar() { return colorDependentSidebar; }
