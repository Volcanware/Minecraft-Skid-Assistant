...
import viaversion.viarewind.protocol.protocol1_8to1_9.util.RelativeMoveUtil;
...
import static viaversion.viarewind.protocol.protocol1_8to1_9.Protocol1_8TO1_9.VALID_ATTRIBUTES;

public class EntityPackets {

	public static void register(Protocol protocol) {
		//Entity Velocity
		protocol.registerIncoming(State.PLAY, 0x10, 26, new ServerboundVehicleMove_18TO19());
		...
		protocol.registerOutgoing(State.PLAY, 0x29, 0x18, new PacketRemapper() {
			...
			public void registerMap() {
				...
				create(packetWrapper -> packetWrapper.write(Type.BOOLEAN, true));
				handler(packetWrapper -> {
					int entityId = packetWrapper.get(Type.VAR_INT, 0);
					Entity1_10Types.EntityType type = packetWrapper.user().get(EntityTracker.class).getClientEntityTypes().get(entityId);
					if (type == Entity1_10Types.EntityType.BOAT) {
	...
	private static final class ServerboundVehicleMove_18TO19 extends PacketRemapper {
