...
import viaversion.viarewind.protocol.protocol1_8to1_9.storage.*;
    ...
    public static void register(Protocol protocol) {
            ...
            public void registerMap() {
                ...
                handler(packetWrapper -> {
					...
					if (pos.getConfirmId() != -1) {
						if (pos.getPosX() == x && pos.getPosY() == y && pos.getPosZ() == z && pos.getYaw() == yaw && pos
								.getPitch() == pitch) {
        ...
        protocol.registerIncoming(State.PLAY, 0x1C, 0x08, new PacketRemapper() {
            ...
            public void registerMap() {
                map(Type.POSITION);
                map(Type.BYTE, Type.VAR_INT);
                handler(packetWrapper -> packetWrapper.read(Type.ITEM));
        ...
        protocol.registerIncoming(State.PLAY, 0x1A, 0x0A, new PacketRemapper() {
            ...
            public void registerMap() {
                create(packetWrapper -> {
					packetWrapper.cancel();
					PacketWrapper delayedPacket = new PacketWrapper(0x1A, null, packetWrapper.user());
        ...
        protocol.registerIncoming(State.PLAY, 0x01, 0x14, new PacketRemapper() {
            ...
            public void registerMap() {
                map(Type.STRING);
                create(packetWrapper -> packetWrapper.write(Type.BOOLEAN, false));
        ...
        protocol.registerIncoming(State.PLAY, 0x04, 0x15, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                map(Type.BOOLEAN);
                map(Type.UNSIGNED_BYTE);
                create(packetWrapper -> packetWrapper.write(Type.VAR_INT, 1));
                handler(packetWrapper -> {
