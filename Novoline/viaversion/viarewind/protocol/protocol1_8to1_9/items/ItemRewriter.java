...
import viaversion.viarewind.utils.Enchantments;
...
import static viaversion.viaversion.protocols.protocol1_9to1_8.ItemRewriter.potionNameFromDamage;
...
public class ItemRewriter {
	...
	static {
		ENTTIY_NAME_TO_ID = viaversion.viaversion.protocols.protocol1_9to1_8.ItemRewriter.ENTTIY_NAME_TO_ID;
		ENTTIY_ID_TO_NAME = viaversion.viaversion.protocols.protocol1_9to1_8.ItemRewriter.ENTTIY_ID_TO_NAME;
		POTION_NAME_TO_ID = viaversion.viaversion.protocols.protocol1_9to1_8.ItemRewriter.POTION_NAME_TO_ID;
		POTION_ID_TO_NAME = viaversion.viaversion.protocols.protocol1_9to1_8.ItemRewriter.POTION_ID_TO_NAME;
	...
	public static Item toClient(Item item) {
		...
		if(viaVersionTag.size() == 2 && (short) viaVersionTag.get("id").getValue() == item.getIdentifier() && (short) viaVersionTag
				.get("data").getValue() == item.getData()) {
