...
public abstract class ConfigurationNodeWalker {
    ...
    /**
     * A {@link ninja.leaping.configurate.util.ConfigurationNodeWalker} that implements a breadth-first traversal over
     * the configuration.
     *
     * <p>See <a href="https://en.wikipedia.org/wiki/Breadth-first_search">here</a> for more
     * info.
     */
    public static final ninja.leaping.configurate.util.ConfigurationNodeWalker BREADTH_FIRST = new ninja.leaping.configurate.util.ConfigurationNodeWalker() {

        @NonNull
        @Override
        public <T extends ConfigurationNode> Iterator<ConfigurationNodeWalker.VisitedNode<T>> walkWithPath(@NonNull T start) {
            return new BreadthFirstIterator<>(start);
        }
    };

    /**
     * A {@link ninja.leaping.configurate.util.ConfigurationNodeWalker} that implements a depth-first pre-order traversal over
     * the configuration.
     *
     * <p>See <a href="https://en.wikipedia.org/wiki/Depth-first_search">here</a> for more
     * info.
     */
    public static final ninja.leaping.configurate.util.ConfigurationNodeWalker DEPTH_FIRST_PRE_ORDER = new ninja.leaping.configurate.util.ConfigurationNodeWalker() {
    ...
    /**
     * A {@link ninja.leaping.configurate.util.ConfigurationNodeWalker} that implements a depth-first post-order traversal over
     * the configuration.
     *
     * <p>See <a href="https://en.wikipedia.org/wiki/Depth-first_search">here</a> for more
     * info.
     */
    public static final ninja.leaping.configurate.util.ConfigurationNodeWalker DEPTH_FIRST_POST_ORDER = new ninja.leaping.configurate.util.ConfigurationNodeWalker() {
