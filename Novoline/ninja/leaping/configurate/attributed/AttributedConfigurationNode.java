...
public interface AttributedConfigurationNode extends ConfigurationNode {
    ...
    @NonNull
    @Override
    AttributedConfigurationNode setValue(@Nullable Object value);

    @NonNull
    @Override
    AttributedConfigurationNode mergeValuesFrom(@NonNull ConfigurationNode other);
    ...
    @NonNull
    @Override
    AttributedConfigurationNode getNode(@NonNull Object... path);
