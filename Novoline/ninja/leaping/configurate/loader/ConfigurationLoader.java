...
public interface ConfigurationLoader<NodeType extends ConfigurationNode> {
     ...
     */
    @NotNull ConfigurationOptions getDefaultOptions();
     ...
     * @throws IOException if any sort of error occurs with reading or parsing the configuration
     */
    @NotNull NodeType load(@NotNull ConfigurationOptions options) throws IOException;
     ...
     */
    void save(@NotNull ConfigurationNode node) throws IOException;
     ...
     * @return The appropriate node type
     */
    @NotNull NodeType createEmptyNode(@NotNull ConfigurationOptions options);
