    ...
    private void func_175422_a(EntityPlayer p_175422_1_, int p_175422_2_) {
        ...
        if (itemstack == null || (this.disabledSlots & 1 << p_175422_2_ + 8) == 0) {
            if (itemstack != null || (this.disabledSlots & 1 << p_175422_2_ + 16) == 0) {
                ...
                if (p_175422_1_.abilities.isCreative() && (itemstack == null || itemstack.getItem() == Item.getItemFromBlock(Blocks.air)) && itemstack1 != null) {
        ...
        if (this.worldObj.isRemote) {
            ...
            if (source.isExplosion()) {
                ...
                if (!flag1 && !flag) {
                    ...
                    if (source.getEntity() instanceof EntityPlayer && !((EntityPlayer) source.getEntity()).abilities.isAllowEdit()) {
                        return false;
