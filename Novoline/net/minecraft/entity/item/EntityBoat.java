...
public class EntityBoat extends Entity {
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (this.isEntityInvulnerable(source)) {
            ...
            if (this.riddenByEntity != null && this.riddenByEntity == source.getEntity() && source instanceof EntityDamageSourceIndirect) {
                ...
                boolean flag = source.getEntity() instanceof EntityPlayer && ((EntityPlayer) source.getEntity()).abilities.isCreative();
    ...
    public void onUpdate() {
        ...
        if (d9 > 0.2975D) {
            double d2 = MathHelper.cos((double) this.rotationYaw * Math.PI / 180.0D);
            double d4 = MathHelper.sin((double) this.rotationYaw * Math.PI / 180.0D);
    ...
    public void updateRiderPosition() {
        if (this.riddenByEntity != null) {
            double d0 = MathHelper.cos((double) this.rotationYaw * Math.PI / 180.0D) * 0.4D;
            double d1 = MathHelper.sin((double) this.rotationYaw * Math.PI / 180.0D) * 0.4D;
...
/*    @Override
    public void moveEntity(double x, double y, double z) {
        final BoatMoveEvent event = new BoatMoveEvent(x, y, z);
