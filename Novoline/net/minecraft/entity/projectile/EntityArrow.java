...
public class EntityArrow extends Entity implements IProjectile {
    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            if (movingobjectposition != null && movingobjectposition.entityHit instanceof EntityPlayer) {
                ...
                if (entityplayer.abilities.isDisabledDamage() || this.shootingEntity instanceof EntityPlayer && !((EntityPlayer) this.shootingEntity).canAttackPlayer(entityplayer)) {
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn) {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0) {
            boolean flag = this.canBePickedUp == 1 || this.canBePickedUp == 2 && entityIn.abilities.isCreative();
