...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
    ...
    public void onDeath(DamageSource cause) {
        ...
        if (entityLivingBase != null) {
            final EntityList.EntityEggInfo info = EntityList.entityEggs.get(EntityList.getEntityID(entityLivingBase));

            if (info != null) {
                this.triggerAchievement(info.field_151513_e);
            }
    ...
    private void sendTileEntityUpdate(TileEntity tileEntity) {
        if (tileEntity != null) {
            final Packet packet = tileEntity.getDescriptionPacket();
