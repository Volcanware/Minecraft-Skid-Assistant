...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public EntityPlayer(World worldIn, GameProfile gameProfileIn) {
        super(worldIn);
        this.setEntityUniqueID(getUUID(gameProfileIn));
    ...
    public void onUpdate() {
        ...
        int i = 29999999;
        double d3 = clamp_double(this.posX, -2.9999999E7D, 2.9999999E7D);
        double d4 = clamp_double(this.posZ, -2.9999999E7D, 2.9999999E7D);
    ...
    public void onLivingUpdate() {
        ...
        float f = sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ);
    ...
    public void onDeath(DamageSource cause) {
        ...
        if (cause != null) {
            this.motionX = -cos((this.attackedAtYaw + this.rotationYaw) * (float) Math.PI / 180.0F) * 0.1F;
            this.motionZ = -sin((this.attackedAtYaw + this.rotationYaw) * (float) Math.PI / 180.0F) * 0.1F;
        } else {
    ...
    public EntityItem dropItem(ItemStack droppedItem, boolean dropAround, boolean traceItem) {
        if (droppedItem == null) {
            ...
            if (dropAround) {
                ...
                entityitem.motionX = -sin(f1) * f;
                entityitem.motionZ = cos(f1) * f;
                entityitem.motionY = 0.20000000298023224D;
            } else {
                float f2 = 0.3F;
                entityitem.motionX = -sin(this.rotationYaw / 180.0F * (float) Math.PI) * cos(this.rotationPitch / 180.0F * (float) Math.PI) * f2;
                entityitem.motionZ = cos(this.rotationYaw / 180.0F * (float) Math.PI) * cos(this.rotationPitch / 180.0F * (float) Math.PI) * f2;
                entityitem.motionY = -sin(this.rotationPitch / 180.0F * (float) Math.PI) * f2 + 0.1F;
                float f3 = this.rand.nextFloat() * (float) Math.PI * 2.0F;
                f2 = 0.02F * this.rand.nextFloat();
                entityitem.motionX += cos(f3) * (double) f2;
                entityitem.motionY += (this.rand.nextFloat() - this.rand.nextFloat()) * 0.1F;
                entityitem.motionZ += sin(f3) * (double) f2;
            }
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.abilities.readCapabilitiesFromNBT(tagCompund);
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        this.abilities.writeCapabilitiesToNBT(tagCompound);
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (this.isEntityInvulnerable(source)) {
            return false;
        } else if (this.abilities.isDisabledDamage() && !source.canHarmInCreative()) {
            return false;
        } else {
            this.entityAge = 0;
            ...
            if (!p_70998_1_.interactFirst(this)) {
                if (itemstack != null && p_70998_1_ instanceof EntityLivingBase) {
                    ...
                    if (itemstack.interactWithEntity(this, (EntityLivingBase) p_70998_1_)) {
                        if (itemstack.stackSize <= 0 && !this.abilities.isCreative()) {
                ...
                if (itemstack != null && itemstack == this.getCurrentEquippedItem()) {
                    if (itemstack.stackSize <= 0 && !this.abilities.isCreative()) {
                        this.destroyCurrentEquippedItem();
                    } else if (itemstack.stackSize < itemstack1.stackSize && this.abilities.isCreative()) {
        ...
        if (targetEntity.canAttackWithItem()) {
            if (!targetEntity.hitByEntity(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag2) {
                        if (i > 0) {
                            targetEntity.addVelocity(-sin(this.rotationYaw * (float) Math.PI / 180.0F) * (float) i * 0.5F, 0.1D, cos(this.rotationYaw * (float) Math.PI / 180.0F) * (float) i * 0.5F);
                            this.motionX *= 0.6D;
                            this.motionZ *= 0.6D;
    ...
    public void addComponentMessage(IChatComponent chatComponent) {
    }
    ...
    public void addMovementStat(double p_71000_1_, double p_71000_3_, double p_71000_5_) {
        if (this.ridingEntity == null) {
            if (this.isInsideOfMaterial(Material.water)) {
                int i = Math.round(sqrt_double(p_71000_1_ * p_71000_1_ + p_71000_3_ * p_71000_3_ + p_71000_5_ * p_71000_5_) * 100.0F);
                ...
                int j = Math.round(sqrt_double(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_) * 100.0F);
                ...
                int k = Math.round(sqrt_double(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_) * 100.0F);
                ...
                int l = Math.round(sqrt_double(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_) * 100.0F);
    ...
    private void addMountedMovementStat(double p_71015_1_, double p_71015_3_, double p_71015_5_) {
        if (this.ridingEntity != null) {
            int i = Math.round(sqrt_double(p_71015_1_ * p_71015_1_ + p_71015_3_ * p_71015_3_ + p_71015_5_ * p_71015_5_) * 100.0F);
            ...
            if (i > 0) {
                if (this.ridingEntity instanceof EntityMinecart) {
                    ...
                    } else if (this.startMinecartRidingCoordinate.distanceSq(floor_double(this.posX), floor_double(this.posY), floor_double(this.posZ)) >= 1000000.0D) {
    ...
    public void addExhaustion(float p_71020_1_) {
        if (!this.abilities.isDisabledDamage()) {
            if (!this.worldObj.isRemote) {
    ...
    public boolean canEat(boolean ignoreHunger) {
        return (ignoreHunger || this.foodStats.needFood()) && !this.abilities.isDisabledDamage();
    }
    ...
    /**
     * Gets a players UUID given their GameProfile
     */
