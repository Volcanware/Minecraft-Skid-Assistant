...
public class EntityZombie extends EntityMob {
    ...
    protected void startConversion(int ticks) {
        ...
        this.addPotionEffect(new PotionEffect(Potion.damageBoost.getId(), ticks, Math.min(this.worldObj.getDifficulty().getDifficultyId() - 1, 0)));
    ...
    protected void convertToVillager() {
        ...
        entityvillager.addPotionEffect(new PotionEffect(Potion.confusion.getId(), 200, 0));
