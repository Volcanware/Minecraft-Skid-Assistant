...
public class EntitySlime extends EntityLiving implements IMob {
    ...
    static class AISlimeAttack extends EntityAIBase {
        ...
        public boolean shouldExecute() {
            ...
            return entitylivingbase != null && entitylivingbase.isEntityAlive() && (!(entitylivingbase instanceof EntityPlayer) || !((EntityPlayer) entitylivingbase).abilities.isDisabledDamage());
        }
        ...
        public boolean continueExecuting() {
            EntityLivingBase entitylivingbase = this.slime.getAttackTarget();
            return entitylivingbase != null && entitylivingbase.isEntityAlive() && (!(entitylivingbase instanceof EntityPlayer) || !((EntityPlayer) entitylivingbase).abilities.isDisabledDamage()) && --this.field_179465_b > 0;
        }
