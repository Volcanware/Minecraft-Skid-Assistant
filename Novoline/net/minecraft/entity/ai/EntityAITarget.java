        ...
        if (entitylivingbase == null) {
            ...
            if (team != null && team1 == team) {
                ...
                if (this.taskOwner.getDistanceSqToEntity(entitylivingbase) > d0 * d0) {
                    ...
                    return !(entitylivingbase instanceof EntityPlayer) || !((EntityPlayer) entitylivingbase).abilities.isDisabledDamage();
                }
            }
        }
    }
    ...
    public static boolean isSuitableTarget(EntityLiving attacker, EntityLivingBase target, boolean includeInvincibles, boolean checkSight) {
        if (target == null) {
            ...
            if (team != null && team1 == team) {
                ...
                } else if (target instanceof EntityPlayer && !includeInvincibles && ((EntityPlayer) target).abilities.isDisabledDamage()) {
                    return false;
                }
