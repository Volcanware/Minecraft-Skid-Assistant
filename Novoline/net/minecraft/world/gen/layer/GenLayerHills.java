...
public class GenLayerHills extends GenLayer {
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight) {
        ...
        final int[] aint1 = this.field_151628_d.getInts(areaX - 1, areaY - 1, areaWidth + 2, areaHeight + 2);
        ...
        for (int i = 0; i < areaHeight; ++i) {
            for (int j = 0; j < areaWidth; ++j) {
                ...
                final int l = aint1[j + 1 + (i + 1) * (areaWidth + 2)];
                ...
                if (k != 0 && l >= 2 && (l - 2) % 29 == 1 && k < 128) {
                    ...
                    if (i1 == k) {
                        ...
                        final int k1 = aint[j + 1 + 1 + (i + 1) * (areaWidth + 2)];
                        final int l1 = aint[j + 1 - 1 + (i + 1) * (areaWidth + 2)];
