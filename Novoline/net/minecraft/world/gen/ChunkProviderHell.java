...
public class ChunkProviderHell implements IChunkProvider {
        ...
        for (int j1 = 0; j1 < i; ++j1) {
            for (int k1 = 0; k1 < i; ++k1) {
                for (int l1 = 0; l1 < 16; ++l1) {
                    double d0 = 0.125D;
                    int i4 = (j1 * i1 + k1) * l;
                    double d1 = this.noiseField[i4 + l1];
                    int i5 = (j1 * i1 + k1 + 1) * l;
                    double d2 = this.noiseField[i5 + l1];
                    int i6 = ((j1 + 1) * i1 + k1) * l;
                    double d3 = this.noiseField[i6 + l1];
                    int i7 = ((j1 + 1) * i1 + k1 + 1) * l;
                    double d4 = this.noiseField[i7 + l1];
                    double d5 = (this.noiseField[i4 + l1 + 1] - d1) * d0;
                    double d6 = (this.noiseField[i5 + l1 + 1] - d2) * d0;
                    double d7 = (this.noiseField[i6 + l1 + 1] - d3) * d0;
                    double d8 = (this.noiseField[i7 + l1 + 1] - d4) * d0;
    ...
    private double[] initializeNoiseField(double[] p_73164_1_, int p_73164_2_, int p_73164_3_, int p_73164_4_, int p_73164_5_, int p_73164_6_, int p_73164_7_) {
        ...
        for (int j = 0; j < p_73164_6_; ++j) {
            adouble[j] = MathHelper.cos((double) j * Math.PI * 6.0D / (double) p_73164_6_) * 2.0D;
            double d2 = j;
