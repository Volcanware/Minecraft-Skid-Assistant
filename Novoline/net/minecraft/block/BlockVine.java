...
public class BlockVine extends Block {
                ...
                if (enumfacing1 == EnumFacing.UP && pos.getY() < 255 && worldIn.isAirBlock(blockpos1)) {
                    ...
                    if (!flag) {
                        ...
                        if (block1.blockMaterial == Material.air) {
                            ...
                            final boolean flag1 = state.getValue(getPropertyFor(enumfacing2));
                            final boolean flag2 = state.getValue(getPropertyFor(enumfacing4));
                    ...
                    if (pos.getY() > 1) {
                        ...
                        if (block.blockMaterial == Material.air) {
                            ...
                            for (Object enumfacing5 : EnumFacing.Plane.HORIZONTAL) {
                                final PropertyBool propertybool = getPropertyFor((EnumFacing) enumfacing5);
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        final IBlockState iblockstate = this.getDefaultState().withProperty(UP, Boolean.FALSE).withProperty(NORTH, Boolean.FALSE).withProperty(EAST, Boolean.FALSE).withProperty(SOUTH, Boolean.FALSE).withProperty(WEST, Boolean.FALSE);
