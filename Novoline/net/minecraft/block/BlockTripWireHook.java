...
public class BlockTripWireHook extends Block {
    ...
    public void func_176260_a(World worldIn, BlockPos pos, IBlockState hookState, boolean p_176260_4_, boolean p_176260_5_, int p_176260_6_, IBlockState p_176260_7_) {
        ...
        final boolean flag = hookState.getValue(ATTACHED);
        final boolean flag1 = hookState.getValue(POWERED);
        ...
        for (int j = 1; j < 42; ++j) {
            ...
            if (iblockstate.getBlock() != Blocks.tripwire && j != p_176260_6_) {
                ...
                final boolean flag5 = !iblockstate.getValue(BlockTripWire.DISARMED);
                final boolean flag6 = iblockstate.getValue(BlockTripWire.POWERED);
                final boolean flag7 = iblockstate.getValue(BlockTripWire.SUSPENDED);
                flag3 &= flag7 == flag2;
                flag4 |= flag5 && flag6;
        ...
        flag3 = flag3 & i > 1;
        flag4 = flag4 & flag3;
        final IBlockState iblockstate1 = this.getDefaultState().withProperty(ATTACHED, flag3).withProperty(POWERED, flag4);
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        final boolean flag = state.getValue(ATTACHED);
        final boolean flag1 = state.getValue(POWERED);
