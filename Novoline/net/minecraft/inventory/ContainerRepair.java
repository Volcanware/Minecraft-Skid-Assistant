...
public class ContainerRepair extends Container {
    ...
    public ContainerRepair(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, EntityPlayer player) {
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47) {
            ...
            public boolean canTakeStack(EntityPlayer playerIn) {
                return (playerIn.abilities.isCreative() || playerIn.experienceLevel >= ContainerRepair.this.maximumCost) && ContainerRepair.this.maximumCost > 0 && this.getHasStack();
            }
            ...
            public void onPickupFromSlot(EntityPlayer playerIn, ItemStack stack) {
                ...
                if (!playerIn.abilities.isCreative() && !worldIn.isRemote && iblockstate.getBlock() == Blocks.anvil && playerIn.getRNG().nextFloat() < 0.12F) {
    ...
    public void updateRepairOutput() {
        ...
        if (itemstack == null) {
            ...
            if (itemstack2 != null) {
                ...
                if (itemstack1.isItemStackDamageable() && itemstack1.getItem().getIsRepairable(itemstack, itemstack2)) {
                    ...
                    for (l4 = 0; j4 > 0 && l4 < itemstack2.stackSize; ++l4) {
                        final int j5 = itemstack1.getItemDamage() - j4;
                    ...
                    if (itemstack1.isItemStackDamageable() && !flag) {
                        final int k2 = itemstack.getMaxDamage() - itemstack.getItemDamage();
                        final int l2 = itemstack2.getMaxDamage() - itemstack2.getItemDamage();
                        final int i3 = l2 + itemstack1.getMaxDamage() * 12 / 100;
                        final int j3 = k2 + i3;
                    ...
                    for (int i5 : map1.keySet()) {
                        ...
                        if (enchantment != null) {
                            final int k5 = map.getOrDefault(i5, 0);
                            int l3 = map1.get(i5);
                            final int i6;
                            ...
                            if (this.thePlayer.abilities.isCreative() || itemstack.getItem() == Items.enchanted_book) {
                                flag1 = true;
                            }
            ...
            if (this.maximumCost >= 40 && !this.thePlayer.abilities.isCreative()) {
                itemstack1 = null;
            }
