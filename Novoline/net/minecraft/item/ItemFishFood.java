...
public class ItemFishFood extends ItemFood {
    ...
    protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player) {
        ...
        if (itemfishfood$fishtype == ItemFishFood.FishType.PUFFERFISH) {
            player.addPotionEffect(new PotionEffect(Potion.poison.getId(), 1200, 3));
            player.addPotionEffect(new PotionEffect(Potion.hunger.getId(), 300, 2));
            player.addPotionEffect(new PotionEffect(Potion.confusion.getId(), 300, 1));
        }
