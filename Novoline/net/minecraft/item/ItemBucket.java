    ...
    public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn) {
        ...
        if (movingobjectposition != null) {
            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (flag) {
                    if (!playerIn.canPlayerEdit(blockpos.offset(movingobjectposition.facing), movingobjectposition.facing, itemStackIn)) {
                        return itemStackIn;
                    }
                    ...
                    BlockPos blockpos1 = blockpos.offset(movingobjectposition.facing);

                    if (!playerIn.canPlayerEdit(blockpos1, movingobjectposition.facing, itemStackIn)) {
                        return itemStackIn;
                    }

                    if (this.tryPlaceContainedLiquid(worldIn, blockpos1) && !playerIn.abilities.isCreative()) {
                        playerIn.triggerAchievement(StatList.objectUseStats[Item.getIdFromItem(this)]);
                        return new ItemStack(Items.bucket);
                    }
                }
