...
public class ChatController {
    ...
    public boolean func_175990_d(String p_175990_1_) {
        if (!this.field_175998_i.containsKey(p_175990_1_)) {
            ...
            final ChatController.ChatChannelListener chatcontroller$chatchannellistener = this.field_175998_i.get(p_175990_1_);
    ...
    public ChatController.EnumChannelState func_175989_e(String p_175989_1_) {
        if (!this.field_175998_i.containsKey(p_175989_1_)) {
            ...
            final ChatController.ChatChannelListener chatcontroller$chatchannellistener = this.field_175998_i.get(p_175989_1_);
    ...
    public boolean func_175984_n() {
        if (this.field_153011_i != ChatController.ChatState.Uninitialized) {
            ...
            if (ErrorCode.failed(errorcode)) {
                ...
                final HashSet<ChatTokenizationOption> hashset = new HashSet<>();
    ...
    protected boolean func_175987_a(String p_175987_1_, boolean p_175987_2_) {
        if (this.field_153011_i != ChatController.ChatState.Initialized) {
            ...
            final ChatController.ChatChannelListener chatcontroller$chatchannellistener = new ChatController.ChatChannelListener(p_175987_1_);
    ...
    public boolean func_175991_l(String p_175991_1_) {
        if (this.field_153011_i != ChatController.ChatState.Initialized) {
            ...
            final ChatController.ChatChannelListener chatcontroller$chatchannellistener = this.field_175998_i.get(p_175991_1_);
    ...
    public boolean func_175986_a(String p_175986_1_, String p_175986_2_) {
        if (this.field_153011_i != ChatController.ChatState.Initialized) {
            ...
            final ChatController.ChatChannelListener chatcontroller$chatchannellistener = this.field_175998_i.get(p_175986_1_);
    ...
    public class ChatChannelListener implements IChatChannelListener {
        ...
        public void func_176032_a(String p_176032_1_) {
            if (ChatController.this.field_175995_l == ChatController.EnumEmoticonMode.None) {
                ...
                if (!this.field_176042_f.isEmpty()) {
                    final ListIterator<ChatTokenizedMessage> listiterator1 = this.field_176042_f.listIterator();

                    while (listiterator1.hasNext()) {
                        final ChatTokenizedMessage chattokenizedmessage = listiterator1.next();
        ...
        public void chatChannelMembershipCallback(String p_chatChannelMembershipCallback_1_,
                                                  ChatEvent p_chatChannelMembershipCallback_2_,
                                                  ChatChannelInfo p_chatChannelMembershipCallback_3_) {
        ...
        public void chatChannelUserChangeCallback(String p_chatChannelUserChangeCallback_1_,
            ...
            for (ChatUserInfo info : p_chatChannelUserChangeCallback_3_) {
                final int j = this.field_176044_d.indexOf(info);
            ...
            for (ChatUserInfo userInfo : p_chatChannelUserChangeCallback_4_) {
                final int i1 = this.field_176044_d.indexOf(userInfo);

                if (i1 >= 0) {
                    this.field_176044_d.remove(i1);
                }

                this.field_176044_d.add(userInfo);
            }

            for (ChatUserInfo chatUserInfo : p_chatChannelUserChangeCallback_2_) {
