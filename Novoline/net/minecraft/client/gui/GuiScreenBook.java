...
public class GuiScreenBook extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            if (this.field_175386_A == null) {
                ...
                final int k1 = Math.min(128 / this.fontRendererObj.getHeight(), this.field_175386_A.size());
    ...
    public IChatComponent func_175385_b(int p_175385_1_, int p_175385_2_) {
        if (this.field_175386_A == null) {
            ...
            if (i >= 0 && j >= 0) {
                final int k = Math.min(128 / this.fontRendererObj.getHeight(), this.field_175386_A.size());

                if (i <= 116 && j < this.mc.fontRendererObj.getHeight() * k + k) {
                    final int l = j / this.mc.fontRendererObj.getHeight();
    ...
    static class NextPageButton extends GuiButton {
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                ...
                this.drawTexturedModalRect((int) this.xPosition,(int)  this.yPosition, i, j, 23, 13);
            }
        }
