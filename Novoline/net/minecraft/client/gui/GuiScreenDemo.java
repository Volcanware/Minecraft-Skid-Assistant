        ...
        switch (button.id) {
            case 1:
                ...
                try {
                    ...
                    final Object object = aClass.getMethod("getDesktop", new Class[0]).invoke(null);

                    aClass.getMethod("browse", new Class[]{URI.class}).invoke(object, new URI("http://www.minecraft.net/store?source=demo"));
