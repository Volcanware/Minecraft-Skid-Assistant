...
public class ModelHorse extends ModelBase {
    ...
    public void render(Entity entity, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        final float f1 = entityhorse.getHorseSize();
        ...
        if (!flag) {
            GlStateManager.popMatrix();
            GlStateManager.pushMatrix();
            final float f2 = 0.5F + f1 * f1 * 0.5F;
    ...
    public void setLivingAnimations(EntityLivingBase entityLivingBase, float p_78086_2_, float p_78086_3_, float partialTickTime) {
        super.setLivingAnimations(entityLivingBase, p_78086_2_, p_78086_3_, partialTickTime);
        final float f = this.updateHorseRotation(entityLivingBase.prevRenderYawOffset, entityLivingBase.renderYawOffset, partialTickTime);
        final float f1 = this.updateHorseRotation(entityLivingBase.prevRotationYawHead, entityLivingBase.rotationYawHead, partialTickTime);
        final float f2 = entityLivingBase.prevRotationPitch + (entityLivingBase.rotationPitch - entityLivingBase.prevRotationPitch) * partialTickTime;
        float f3 = f1 - f;
        ...
        final float f5 = entityhorse.getGrassEatingAmount(partialTickTime);
        final float f6 = entityhorse.getRearingAmount(partialTickTime);
        final float f7 = 1.0F - f6;
        final float f8 = entityhorse.getMouthOpennessAngle(partialTickTime);
        ...
        final float f9 = (float) entityLivingBase.ticksExisted + partialTickTime;
        final float f10 = MathHelper.cos(p_78086_2_ * 0.6662F + (float) Math.PI);
        final float f11 = f10 * 0.8F * p_78086_3_;
        ...
        final float f15 = 0.2617994F * f6;
        final float f16 = MathHelper.cos(f9 * 0.6F + (float) Math.PI);
        ...
        final float f17 = (-1.0471976F + f16) * f6 + f11 * f7;
        final float f18 = (-1.0471976F + -f16) * f6 + -f11 * f7;
