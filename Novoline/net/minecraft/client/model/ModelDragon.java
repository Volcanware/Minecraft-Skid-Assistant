...
public class ModelDragon extends ModelBase {
    ...
    public void render(Entity entity, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        this.jaw.rotateAngleX = (float) (MathHelper.sin(f * (float) Math.PI * 2.0F) + 1.0D) * 0.2F;
        float f1 = (float) (MathHelper.sin((double) (f * (float) Math.PI * 2.0F - 1.0F)) + 1.0D);
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            final float f9 = MathHelper.cos((float) i * 0.45F + f8) * 0.15F;
            final float v = (float) (Math.PI / 180.0F);
            this.spine.rotateAngleY = this.updateRotations(adouble1[0] - adouble[0]) * v * f5;
            this.spine.rotateAngleX = f9 + (float) (adouble1[1] - adouble[1]) * v * f5 * 5.0F;
            this.spine.rotateAngleZ = -this.updateRotations(adouble1[0] - (double) f7) * v * f5;
            ...
            final float cos = MathHelper.cos(this.spine.rotateAngleX);
            f3 = (float) ((double) f3 - MathHelper.cos(this.spine.rotateAngleY) * cos * 10.0D);
            f4 = (float) ((double) f4 - MathHelper.sin(this.spine.rotateAngleY) * cos * 10.0D);
        ...
        final float v = (float) Math.PI / 180.0F;
        this.head.rotateAngleY = this.updateRotations(adouble2[0] - adouble[0]) * v * 1.0F;
        this.head.rotateAngleZ = -this.updateRotations(adouble2[0] - (double) f7) * v * 1.0F;
        ...
        for (int j = 0; j < 2; ++j) {
            ...
            this.wing.rotateAngleX = 0.125F - MathHelper.cos(f11) * 0.2F;
        ...
        float f10 = -MathHelper.sin(f * (float) Math.PI * 2.0F) * 0.0F;
