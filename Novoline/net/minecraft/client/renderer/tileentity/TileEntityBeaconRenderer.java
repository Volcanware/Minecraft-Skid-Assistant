    ...
    public void renderTileEntityAt(TileEntityBeacon te, double x, double y, double z, float partialTicks, int destroyStage) {
        ...
        if (f > 0.0F) {
            ...
            for (TileEntityBeacon.BeamSegment beamSegment : list) {
                ...
                double d4 = 0.5D + MathHelper.cos(d2 + 2.356194490192345D) * 0.2D;
                double d5 = 0.5D + MathHelper.sin(d2 + 2.356194490192345D) * 0.2D;
                double d6 = 0.5D + MathHelper.cos(d2 + Math.PI / 4D) * 0.2D;
                double d7 = 0.5D + MathHelper.sin(d2 + Math.PI / 4D) * 0.2D;
                double d8 = 0.5D + MathHelper.cos(d2 + 3.9269908169872414D) * 0.2D;
                double d9 = 0.5D + MathHelper.sin(d2 + 3.9269908169872414D) * 0.2D;
                double d10 = 0.5D + MathHelper.cos(d2 + 5.497787143782138D) * 0.2D;
                double d11 = 0.5D + MathHelper.sin(d2 + 5.497787143782138D) * 0.2D;
                double d14 = -1.0D + d1;
                double d15 = (double) ((float) beamSegment.getHeight() * f) * 2.5D + d14;
                ...
                double d12 = -1.0D + d1;
                double d13 = (double) ((float) beamSegment.getHeight() * f) + d12;
                worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
