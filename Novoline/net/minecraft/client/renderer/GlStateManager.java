...
public class GlStateManager {
    ...
    public static void disableLighting(boolean disabled) {
        if (disabled) {
            lightingState.setDisabled();
        }
    }
    ...
    private static GlStateManager.TexGenCoord texGenCoord(GlStateManager.TexGen texGen) {
        switch (GlStateManager.GlStateManager$1.field_179175_a[texGen.ordinal()]) { // @off
            case 1:
    ...
    public static void clearDepth(double depth) {
        if (depth != clearState.field_179205_a) {
            if (Minecraft.getInstance().getCurrentServerData() == null && depth != clearState.magicConstant && Minecraft.getInstance().player != null || depth == clearState.magicConstant) {
                return;
            }
