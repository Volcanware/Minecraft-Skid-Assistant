...
public class RenderDragon extends RenderLiving<EntityDragon> {
     ...
     */
    public void renderModel(EntityDragon entityLivingBase, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        if (entityLivingBase.deathTicks > 0) {
            float f = (float) entityLivingBase.deathTicks / 200.0F;
