...
public class BlockModelRenderer {
            ...
            if (!list.isEmpty()) {
                ...
                if (!p_renderModelAmbientOcclusion_7_ || p_renderModelAmbientOcclusion_3_.shouldSideBeRendered(p_renderModelAmbientOcclusion_1_, blockpos, enumfacing)) {
                    if (XRay.isEnabled && XRay.showESP()) {
                        Block block = Minecraft.getInstance().world.getBlockState(p_renderModelAmbientOcclusion_5_).getBlock();
                        ...
                        if (block instanceof BlockOre || block instanceof BlockRedstoneOre) {
                            ...
                            if (Minecraft.getInstance().player.getDistance(x, z) <= XRay.getDistance()) {
    ...
    public boolean renderModelStandard(IBlockAccess p_renderModelStandard_1_,
    ...
    public static class AmbientOcclusionFace {
        ...
        private int getVertexBrightness(int p_178203_1_,
                                        int p_178203_2_,
                                        int p_178203_3_,
                                        int p_178203_4_,
                                        float p_178203_5_,
    ...
    public enum EnumNeighborInfo {
        ...
        EnumNeighborInfo(String p_i6_3_,
                         int p_i6_4_,
                         EnumFacing[] p_i6_5_,
                         float p_i6_6_,
                         boolean p_i6_7_,
