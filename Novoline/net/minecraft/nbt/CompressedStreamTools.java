...
public class CompressedStreamTools {
    ...
    private static NBTBase func_152455_a(DataInput dataInput, int p_152455_1_, NBTSizeTracker p_152455_2_) throws IOException {
        ...
        if (b == 0) {
            ...
            try {
                nbtbase.read(dataInput, p_152455_1_, p_152455_2_);
                return nbtbase;
