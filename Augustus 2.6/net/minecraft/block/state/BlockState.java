...
public class BlockState
{
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add("block", Block.blockRegistry.getNameForObject(this.block)).add("properties", Iterables.transform((Iterable<IProperty>)this.properties, (Function<? super IProperty, ?>)BlockState.GET_NAME_FUNC)).toString();
    }
