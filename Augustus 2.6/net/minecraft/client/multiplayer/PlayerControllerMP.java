...
public class PlayerControllerMP implements MM
{
    ...
    public boolean onPlayerDamageBlock(final BlockPos posBlock, final EnumFacing directionFacing) {
        ...
        if (PlayerControllerMP.mm.fastBreak.isToggled() && this.curBlockDamageMP >= 0.0f) {
            if (PlayerControllerMP.mm.fastBreak.instant.getBoolean()) {
    ...
    public void syncCurrentPlayItem() {
        ...
        if (PlayerControllerMP.mm.newScaffold.isToggled() && PlayerControllerMP.mm.newScaffold.silentMode.getSelected().equals("Spoof")) {
            i = PlayerControllerMP.mm.newScaffold.getSlotID();
        }
        if (PlayerControllerMP.mm.scaffoldWalk.isToggled() && PlayerControllerMP.mm.scaffoldWalk.silentMode.getSelected().equals("Spoof")) {
            i = PlayerControllerMP.mm.scaffoldWalk.getSlotID();
        }
