...
public class OpenGlHelper
{
    ...
    public static void initializeTextures() {
        ...
        try {
            final List<CentralProcessor.PhysicalProcessor> aprocessor = new SystemInfo().getHardware().getProcessor().getPhysicalProcessors();
            OpenGlHelper.field_183030_aa = String.format("%dx %s", aprocessor.size(), aprocessor.get(0)).replaceAll("\\s+", " ");
        }
        catch (Throwable t) {}
    }
