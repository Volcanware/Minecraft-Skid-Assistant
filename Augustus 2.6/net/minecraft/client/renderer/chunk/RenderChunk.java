    ...
    public void rebuildChunk(final float x, final float y, final float z, final ChunkCompileTaskGenerator generator) {
        ...
        if (!regionrendercache.extendedLevelsInChunkCache()) {
            ...
            while (iterator.hasNext()) {
                ...
                final EventRenderChunk eventRenderChunk = new EventRenderChunk(new BlockPos(blockposm.getX(), blockposm.getY(), blockposm.getZ()), iblockstate);
                EventHandler.call(eventRenderChunk);
