...
public class FinalizableReferenceQueue implements Closeable
{
    ...
    private static final String FINALIZER_CLASS_NAME = "me.gong.mcleaks.util.google.common.base.internal.Finalizer";
    ...
    static class SystemLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            ...
            if (systemLoader != null) {
                try {
                    return systemLoader.loadClass("me.gong.mcleaks.util.google.common.base.internal.Finalizer");
                }
    ...
    static class DecoupledLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            try {
                ...
                return finalizerLoader.loadClass("me.gong.mcleaks.util.google.common.base.internal.Finalizer");
            }
            catch (Exception e) {
        ...
        URL getBaseUrl() throws IOException {
            final String finalizerPath = "me.gong.mcleaks.util.google.common.base.internal.Finalizer".replace('.', '/') + ".class";
    ...
    static class DirectLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            try {
                return Class.forName("me.gong.mcleaks.util.google.common.base.internal.Finalizer");
            }
