...
package me.gong.mcleaks.util.google.common.base.internal;
...
public class Finalizer implements Runnable
{
    ...
    private static final String FINALIZABLE_REFERENCE = "me.gong.mcleaks.util.google.common.base.FinalizableReference";
    ...
    public static void startFinalizer(final Class<?> finalizableReferenceClass, final ReferenceQueue<Object> queue, final PhantomReference<Object> frqReference) {
        if (!finalizableReferenceClass.getName().equals("me.gong.mcleaks.util.google.common.base.FinalizableReference")) {
