...
import me.gong.mcleaks.util.google.common.collect.AbstractSequentialIterator;
import me.gong.mcleaks.util.google.common.util.concurrent.SettableFuture;
import java.lang.ref.Reference;
import java.util.concurrent.Future;
import me.gong.mcleaks.util.google.common.util.concurrent.Uninterruptibles;
...
import me.gong.mcleaks.util.google.common.util.concurrent.ExecutionError;
...
import me.gong.mcleaks.util.google.common.base.Ticker;
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V>
    {
        ...
        public ListenableFuture<V> loadFuture(final K key, final CacheLoader<? super K, V> loader) {
            try {
                ...
                return Futures.transform(newValue2, (me.gong.mcleaks.util.google.common.base.Function<? super V, ? extends V>)new me.gong.mcleaks.util.google.common.base.Function<V, V>() {
                    @Override
