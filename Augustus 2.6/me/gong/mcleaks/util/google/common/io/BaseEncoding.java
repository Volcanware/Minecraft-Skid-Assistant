    ...
    private static final class Alphabet extends CharMatcher
    {
        ...
        private boolean hasLowerCase() {
            for (final char c : this.chars) {
                if (me.gong.mcleaks.util.google.common.base.Ascii.isLowerCase(c)) {
                    return true;
                }
            }
            return false;
        ...
        private boolean hasUpperCase() {
            for (final char c : this.chars) {
                if (me.gong.mcleaks.util.google.common.base.Ascii.isUpperCase(c)) {
                    return true;
                }
            }
            return false;
        ...
        Alphabet upperCase() {
            ...
            for (int i = 0; i < this.chars.length; ++i) {
                upperCased[i] = me.gong.mcleaks.util.google.common.base.Ascii.toUpperCase(this.chars[i]);
            }
        ...
        Alphabet lowerCase() {
            ...
            for (int i = 0; i < this.chars.length; ++i) {
                lowerCased[i] = me.gong.mcleaks.util.google.common.base.Ascii.toLowerCase(this.chars[i]);
            }
