...
public final class Sets
{
    ...
    public static <E> SetView<E> union(final Set<? extends E> set1, final Set<? extends E> set2) {
        ...
        return new SetView<E>() {
            ...
            public Stream<E> stream() {
                return Stream.concat((Stream<? extends E>)set1.stream(), (Stream<? extends E>)set2minus1.stream());
            }
            
            @Override
            public Stream<E> parallelStream() {
                return Stream.concat((Stream<? extends E>)set1.parallelStream(), (Stream<? extends E>)set2minus1.parallelStream());
            }
    ...
    public static <E> SetView<E> intersection(final Set<E> set1, final Set<?> set2) {
        ...
        return new SetView<E>() {
            ...
            @Override
            public Stream<E> stream() {
                return (Stream<E>)set1.stream().filter(inSet2);
            }
            
            @Override
            public Stream<E> parallelStream() {
                return (Stream<E>)set1.parallelStream().filter(inSet2);
            }
    ...
    public static <E> SetView<E> difference(final Set<E> set1, final Set<?> set2) {
        ...
        return new SetView<E>() {
            ...
            @Override
            public Stream<E> stream() {
                return (Stream<E>)set1.stream().filter(notInSet2);
            }
            
            @Override
            public Stream<E> parallelStream() {
                return (Stream<E>)set1.parallelStream().filter(notInSet2);
            }
