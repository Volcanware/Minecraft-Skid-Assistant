...
public final class Tables
{
    ...
    @Beta
    public static <R, C, V> Table<R, C, V> newCustomTable(final Map<R, Map<C, V>> backingMap, final me.gong.mcleaks.util.google.common.base.Supplier<? extends Map<C, V>> factory) {
