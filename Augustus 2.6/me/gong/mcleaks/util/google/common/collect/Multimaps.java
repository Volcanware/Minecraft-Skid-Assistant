...
public final class Multimaps
{
    ...
    public static <K, V> Multimap<K, V> newMultimap(final Map<K, Collection<V>> map, final me.gong.mcleaks.util.google.common.base.Supplier<? extends Collection<V>> factory) {
        return new CustomMultimap<K, V>(map, factory);
    }
    
    public static <K, V> ListMultimap<K, V> newListMultimap(final Map<K, Collection<V>> map, final me.gong.mcleaks.util.google.common.base.Supplier<? extends List<V>> factory) {
        return new CustomListMultimap<K, V>(map, factory);
    }
    
    public static <K, V> SetMultimap<K, V> newSetMultimap(final Map<K, Collection<V>> map, final me.gong.mcleaks.util.google.common.base.Supplier<? extends Set<V>> factory) {
        return new CustomSetMultimap<K, V>(map, factory);
    }
    
    public static <K, V> SortedSetMultimap<K, V> newSortedSetMultimap(final Map<K, Collection<V>> map, final me.gong.mcleaks.util.google.common.base.Supplier<? extends SortedSet<V>> factory) {
    ...
    public static <K, V1, V2> Multimap<K, V2> transformValues(final Multimap<K, V1> fromMultimap, final me.gong.mcleaks.util.google.common.base.Function<? super V1, V2> function) {
    ...
    public static <K, V1, V2> ListMultimap<K, V2> transformValues(final ListMultimap<K, V1> fromMultimap, final me.gong.mcleaks.util.google.common.base.Function<? super V1, V2> function) {
        Preconditions.checkNotNull(function);
        final Maps.EntryTransformer<K, V1, V2> transformer = Maps.asEntryTransformer(function);
        return transformEntries(fromMultimap, transformer);
    }
    ...
    public static <K, V> ImmutableListMultimap<K, V> index(final Iterable<V> values, final me.gong.mcleaks.util.google.common.base.Function<? super V, K> keyFunction) {
        return index(values.iterator(), keyFunction);
    }
    
    public static <K, V> ImmutableListMultimap<K, V> index(final Iterator<V> values, final me.gong.mcleaks.util.google.common.base.Function<? super V, K> keyFunction) {
        Preconditions.checkNotNull(keyFunction);
    ...
    {
        transient me.gong.mcleaks.util.google.common.base.Supplier<? extends Collection<V>> factory;
        @GwtIncompatible
        private static final long serialVersionUID = 0L;
        
        CustomMultimap(final Map<K, Collection<V>> map, final me.gong.mcleaks.util.google.common.base.Supplier<? extends Collection<V>> factory) {
            super(map);
        ...
        private void readObject(final ObjectInputStream stream) throws IOException, ClassNotFoundException {
            ...
            this.factory = (me.gong.mcleaks.util.google.common.base.Supplier<? extends Collection<V>>)stream.readObject();
    ...
    {
        transient me.gong.mcleaks.util.google.common.base.Supplier<? extends List<V>> factory;
        @GwtIncompatible
        private static final long serialVersionUID = 0L;
        
        CustomListMultimap(final Map<K, Collection<V>> map, final me.gong.mcleaks.util.google.common.base.Supplier<? extends List<V>> factory) {
            super(map);
            this.factory = Preconditions.checkNotNull(factory);
        }
        ...
        private void readObject(final ObjectInputStream stream) throws IOException, ClassNotFoundException {
            stream.defaultReadObject();
            this.factory = (me.gong.mcleaks.util.google.common.base.Supplier<? extends List<V>>)stream.readObject();
            final Map<K, Collection<V>> map = (Map<K, Collection<V>>)stream.readObject();
            this.setMap(map);
        }
    }
    ...
    {
        transient me.gong.mcleaks.util.google.common.base.Supplier<? extends Set<V>> factory;
        @GwtIncompatible
        private static final long serialVersionUID = 0L;
        
        CustomSetMultimap(final Map<K, Collection<V>> map, final me.gong.mcleaks.util.google.common.base.Supplier<? extends Set<V>> factory) {
            super(map);
            this.factory = Preconditions.checkNotNull(factory);
        }
        ...
        private void readObject(final ObjectInputStream stream) throws IOException, ClassNotFoundException {
            stream.defaultReadObject();
            this.factory = (me.gong.mcleaks.util.google.common.base.Supplier<? extends Set<V>>)stream.readObject();
            final Map<K, Collection<V>> map = (Map<K, Collection<V>>)stream.readObject();
            this.setMap(map);
        }
    }
    ...
    {
        transient me.gong.mcleaks.util.google.common.base.Supplier<? extends SortedSet<V>> factory;
        transient Comparator<? super V> valueComparator;
        @GwtIncompatible
        private static final long serialVersionUID = 0L;
        
        CustomSortedSetMultimap(final Map<K, Collection<V>> map, final me.gong.mcleaks.util.google.common.base.Supplier<? extends SortedSet<V>> factory) {
            super(map);
            this.factory = Preconditions.checkNotNull(factory);
        ...
        private void readObject(final ObjectInputStream stream) throws IOException, ClassNotFoundException {
            stream.defaultReadObject();
            this.factory = (me.gong.mcleaks.util.google.common.base.Supplier<? extends SortedSet<V>>)stream.readObject();
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable
    {
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            if (result == null) {
                final Map<Object, Object> unmodifiableMap = Collections.unmodifiableMap((Map<?, ?>)Maps.transformValues((Map<? extends K, Collection<V>>)this.delegate.asMap(), (me.gong.mcleaks.util.google.common.base.Function<? super Collection<V>, ? extends V>)new me.gong.mcleaks.util.google.common.base.Function<Collection<V>, Collection<V>>() {
                    @Override
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2>
    {
        ...
        Collection<V2> transform(final K key, final Collection<V1> values) {
            final me.gong.mcleaks.util.google.common.base.Function<? super V1, V2> function = Maps.asValueToValueFunction(this.transformer, key);
            if (values instanceof List) {
                return (Collection<V2>)Lists.transform((List<Object>)(List)values, (me.gong.mcleaks.util.google.common.base.Function<? super Object, ?>)function);
            }
        ...
        Iterator<Map.Entry<K, V2>> entryIterator() {
            return Iterators.transform(this.fromMultimap.entries().iterator(), (me.gong.mcleaks.util.google.common.base.Function<? super Map.Entry<K, V1>, ? extends Map.Entry<K, V2>>)Maps.asEntryToEntryFunction((Maps.EntryTransformer<? super Object, ? super Object, V2>)this.transformer));
        }
        ...
        Collection<V2> createValues() {
            return Collections2.transform(this.fromMultimap.entries(), (me.gong.mcleaks.util.google.common.base.Function<? super Map.Entry<K, V1>, V2>)Maps.asEntryToValueFunction((Maps.EntryTransformer<? super Object, ? super Object, T>)this.transformer));
        }
    }
    ...
    private static final class TransformedEntriesListMultimap<K, V1, V2> extends TransformedEntriesMultimap<K, V1, V2> implements ListMultimap<K, V2>
    {
        ...
        List<V2> transform(final K key, final Collection<V1> values) {
            return Lists.transform((List<Object>)(List)values, (me.gong.mcleaks.util.google.common.base.Function<? super Object, ? extends V2>)Maps.asValueToValueFunction((Maps.EntryTransformer<? super K, ? super F, ? extends T>)this.transformer, key));
        }
    ...
    static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>>
    {
        ...
        class EntrySet extends Maps.EntrySet<K, Collection<V>>
        {
            ...
            public Iterator<Map.Entry<K, Collection<V>>> iterator() {
                return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), (me.gong.mcleaks.util.google.common.base.Function<? super K, Collection<V>>)new me.gong.mcleaks.util.google.common.base.Function<K, Collection<V>>() {
                    @Override
