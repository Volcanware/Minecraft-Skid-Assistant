    ...
    class RowMap extends Maps.ViewCachingAbstractMap<R, Map<C, V>>
    {
        ...
        class EntrySet extends TableSet<Map.Entry<R, Map<C, V>>>
        {
            ...
            public Iterator<Map.Entry<R, Map<C, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.backingMap.keySet(), (me.gong.mcleaks.util.google.common.base.Function<? super R, Map<C, V>>)new me.gong.mcleaks.util.google.common.base.Function<R, Map<C, V>>() {
                    @Override
    ...
    private class ColumnMap extends Maps.ViewCachingAbstractMap<C, Map<R, V>>
    {
        ...
        class ColumnMapEntrySet extends TableSet<Map.Entry<C, Map<R, V>>>
        {
            ...
            public Iterator<Map.Entry<C, Map<R, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.columnKeySet(), (me.gong.mcleaks.util.google.common.base.Function<? super C, Map<R, V>>)new me.gong.mcleaks.util.google.common.base.Function<C, Map<R, V>>() {
                    @Override
