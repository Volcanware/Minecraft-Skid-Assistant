...
class MapMakerInternalMap<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable
{
    ...
    static final class StrongKeyWeakValueEntry<K, V> extends AbstractStrongKeyEntry<K, V, StrongKeyWeakValueEntry<K, V>> implements WeakValueEntry<K, V, StrongKeyWeakValueEntry<K, V>>
    {
        ...
        void setValue(final V value, final ReferenceQueue<V> queueForValues) {
            ...
            //     4: astore_3        /* previous */
            //     5: aload_0         /* this */
            //     6: new             Lme/gong/mcleaks/util/google/common/collect/MapMakerInternalMap$WeakValueReferenceImpl;
            //     9: dup            
            //    10: aload_2         /* queueForValues */
            //    11: aload_1         /* value */
            //    12: aload_0         /* this */
            //    13: invokespecial   me/gong/mcleaks/util/google/common/collect/MapMakerInternalMap$WeakValueReferenceImpl.<init>:(Ljava/lang/ref/ReferenceQueue;Ljava/lang/Object;Lme/gong/mcleaks/util/google/common/collect/MapMakerInternalMap$InternalEntry;)V
            //    16: putfield        me/gong/mcleaks/util/google/common/collect/MapMakerInternalMap$StrongKeyWeakValueEntry.valueReference:Lme/gong/mcleaks/util/google/common/collect/MapMakerInternalMap$WeakValueReference;
            //    19: aload_3         /* previous */
            //    20: invokeinterface me/gong/mcleaks/util/google/common/collect/MapMakerInternalMap$WeakValueReference.clear:()V
            //    25: return         
            //    Signature:
    ...
    static final class WeakKeyWeakValueEntry<K, V> extends AbstractWeakKeyEntry<K, V, WeakKeyWeakValueEntry<K, V>> implements WeakValueEntry<K, V, WeakKeyWeakValueEntry<K, V>>
    {
        ...
        void setValue(final V value, final ReferenceQueue<V> queueForValues) {
            ...
            //    12: aload_0         /* this */
            //    13: invokespecial   me/gong/mcleaks/util/google/common/collect/MapMakerInternalMap$WeakValueReferenceImpl.<init>:(Ljava/lang/ref/ReferenceQueue;Ljava/lang/Object;Lme/gong/mcleaks/util/google/common/collect/MapMakerInternalMap$InternalEntry;)V
            //    16: putfield        me/gong/mcleaks/util/google/common/collect/MapMakerInternalMap$WeakKeyWeakValueEntry.valueReference:Lme/gong/mcleaks/util/google/common/collect/MapMakerInternalMap$WeakValueReference;
            //    19: aload_3         /* previous */
            //    20: invokeinterface me/gong/mcleaks/util/google/common/collect/MapMakerInternalMap$WeakValueReference.clear:()V
            //    25: return         
            //    Signature:
