...
public final class Iterables
{
    ...
    public static <T> Iterable<T> filter(final Iterable<?> unfiltered, final Class<T> desiredType) {
        ...
        return new FluentIterable<T>() {
            ...
            public void forEach(final Consumer<? super T> action) {
                Preconditions.checkNotNull(action);
                final Class<? super T> val$desiredType;
                unfiltered.forEach(o -> {
                    val$desiredType = desiredType;
                    if (val$desiredType.isInstance(o)) {
                        action.accept(val$desiredType.cast(o));
                    }
                });
            }
    ...
    public static <F, T> Iterable<T> transform(final Iterable<F> fromIterable, final me.gong.mcleaks.util.google.common.base.Function<? super F, ? extends T> function) {
        Preconditions.checkNotNull(fromIterable);
        Preconditions.checkNotNull(function);
        return new FluentIterable<T>() {
            @Override
            public Iterator<T> iterator() {
                return Iterators.transform(fromIterable.iterator(), (me.gong.mcleaks.util.google.common.base.Function<? super Object, ? extends T>)function);
            }
    ...
    public static <T> Iterable<T> mergeSorted(final Iterable<? extends Iterable<? extends T>> iterables, final Comparator<? super T> comparator) {
        ...
        final Iterable<T> iterable = new FluentIterable<T>() {
            @Override
            public Iterator<T> iterator() {
                return (Iterator<T>)Iterators.mergeSorted(Iterables.transform((Iterable<Object>)iterables, (me.gong.mcleaks.util.google.common.base.Function<? super Object, ? extends Iterator<?>>)Iterables.toIterator()), (Comparator<? super Object>)comparator);
            }
        };
        return new UnmodifiableIterable<T>((Iterable)iterable);
    }
    
    static <T> me.gong.mcleaks.util.google.common.base.Function<Iterable<? extends T>, Iterator<? extends T>> toIterator() {
        return new me.gong.mcleaks.util.google.common.base.Function<Iterable<? extends T>, Iterator<? extends T>>() {
            @Override
