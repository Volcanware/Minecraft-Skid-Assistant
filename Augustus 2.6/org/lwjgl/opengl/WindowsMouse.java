...
final class WindowsMouse
{
    ...
    public void poll(final IntBuffer coord_buffer, final ByteBuffer buttons) {
    ...
    public void handleMouseMoved(final int x, final int y, final long millis, final boolean should_center) {
