                ...
                if (addressRetrieved) {
                    if (this.data.resourcePackUrl != null && this.data.resourcePackHash != null) {
                        try {
                            ...
                            Futures.addCallback((ListenableFuture)Realms.downloadResourcePack(this.data.resourcePackUrl, this.data.resourcePackHash), (FutureCallback)new FutureCallback<Object>() {
                                @Override
