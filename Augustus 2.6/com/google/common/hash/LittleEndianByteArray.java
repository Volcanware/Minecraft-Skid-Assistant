...
final class LittleEndianByteArray
{
    ...
    private enum UnsafeByteArray implements LittleEndianBytes
    {
        ...
        private static /* synthetic */ UnsafeByteArray[] $values() {
            return new UnsafeByteArray[] { UnsafeByteArray.UNSAFE_LITTLE_ENDIAN, UnsafeByteArray.UNSAFE_BIG_ENDIAN };
        }
    ...
    private enum JavaLittleEndianBytes implements LittleEndianBytes
    {
        ...
        private static /* synthetic */ JavaLittleEndianBytes[] $values() {
            return new JavaLittleEndianBytes[] { JavaLittleEndianBytes.INSTANCE };
        }
