...
public final class Lists
{
    ...
    public static <E> CopyOnWriteArrayList<E> newCopyOnWriteArrayList(final Iterable<? extends E> elements) {
        final Collection<? extends E> elementsCollection = (Collection<? extends E>)((elements instanceof Collection) ? ((Collection)elements) : newArrayList((Iterable<?>)elements));
    ...
    public static <T> List<T> reverse(final List<T> list) {
        if (list instanceof ImmutableList) {
            final List<T> result;
            final List<?> reversed = result = (List<T>)((ImmutableList)list).reverse();
            return result;
        }
