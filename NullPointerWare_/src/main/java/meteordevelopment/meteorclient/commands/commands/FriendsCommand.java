            ...
            .then(argument("player", PlayerListEntryArgumentType.create())
                .executes(context -> {
                    ...
                    if (Friends.get().add(friend)) {
                        ChatUtils.addMessage(friend.hashCode(), Formatting.GRAY, "Added (highlight)%s (default)to friends.".formatted(friend.getName()));
                    }
            ...
            .then(argument("friend", FriendArgumentType.create())
                .executes(context -> {
                    ...
                    if (Friends.get().remove(friend)) {
                        ChatUtils.addMessage(friend.hashCode(), Formatting.GRAY, "Removed (highlight)%s (default)from friends.".formatted(friend.getName()));
                    }
