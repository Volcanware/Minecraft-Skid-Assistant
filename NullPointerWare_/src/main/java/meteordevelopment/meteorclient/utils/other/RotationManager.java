...
import meteordevelopment.meteorclient.events.game.AttackEvent;
import meteordevelopment.meteorclient.events.game.ItemUseEvent;
...
public class RotationManager {
    ...
    @EventHandler(priority = EventPriority.LOWEST)
    private void onSendMovementPacketPre(SendMovementPacketsEvent event) {
    ...
    @EventHandler(priority = EventPriority.HIGHEST)
    private void onSendMovementPacketPost(final SendMovementPacketsEvent.Post event) {
