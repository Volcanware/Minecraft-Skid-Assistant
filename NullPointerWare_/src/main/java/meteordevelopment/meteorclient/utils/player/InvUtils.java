...
import static meteordevelopment.meteorclient.utils.player.PlayerUtils.hasEffect;
...
public final class InvUtils {
    ...
    public static List<Integer> findList(Predicate<ItemStack> isGood, int start, int end) {
