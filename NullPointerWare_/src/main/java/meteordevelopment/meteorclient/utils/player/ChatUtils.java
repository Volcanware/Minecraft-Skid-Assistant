...
public final class ChatUtils {
    ...
    public static void init() {
        PREFIX = Text.empty()
            ...
            .append("[")
            .append(Text.literal("NullWare").setStyle(Style.EMPTY.withColor(TextColor.fromRgb(MeteorClient.ADDON.color.getPacked()))))
            .append("] ");
    }
    ...
    public static void info(String message, Object... args) {
        addMessage(Formatting.GRAY, message, args);
    }

    public static void infoPrefix(String prefix, String message, Object... args) {
        addMessage(0, prefix, Formatting.LIGHT_PURPLE, Formatting.GRAY, message, args);
    }

    // Warning

    public static void warning(String message, Object... args) {
        addMessage(Formatting.YELLOW, message, args);
    }

    public static void warningPrefix(String prefix, String message, Object... args) {
        addMessage(0, prefix, Formatting.LIGHT_PURPLE, Formatting.YELLOW, message, args);
    }

    // Error

    public static void error(String message, Object... args) {
        addMessage(Formatting.RED, message, args);
    }

    public static void errorPrefix(String prefix, String message, Object... args) {
        addMessage(0, prefix, Formatting.LIGHT_PURPLE, Formatting.RED, message, args);
    }
    ...
    public static void addMessage(String prefix, Text message) {
        addMessage(0, prefix, Formatting.AQUA, message);
    }

    public static void addMessage(Formatting color, String message, Object... args) {
        addMessage(0, null, null, color, message, args);
    }

    public static void addMessage(int id, Formatting color, String message, Object... args) {
        addMessage(id, null, null, color, message, args);
    }

    public static void addMessage(int id, @Nullable String prefixTitle, @Nullable Formatting prefixColor, Formatting messageColor, String messageContent, Object... args) {
        MutableText message = formatMsg(String.format(messageContent, args), messageColor);
        addMessage(id, prefixTitle, prefixColor, message);
    }

    public static void addMessage(int id, @Nullable String prefixTitle, @Nullable Formatting prefixColor, String messageContent, Formatting messageColor) {
        MutableText message = formatMsg(messageContent, messageColor);
        addMessage(id, prefixTitle, prefixColor, message);
    }

    public static void addMessage(int id, @Nullable String prefixTitle, @Nullable Formatting prefixColor, Text msg) {
