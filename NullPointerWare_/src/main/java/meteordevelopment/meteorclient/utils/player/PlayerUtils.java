...
public final class PlayerUtils {
    ...
    public static boolean hasFlyUtilities () {
        assert mc.player != null;
        return mc.player.getAbilities().flying || Modules.get().isActive(Flight.class) || mc.player.hasStatusEffect(StatusEffects.LEVITATION);
    }
    ...
    public static LivingEntity findNearestEntity(PlayerEntity toPlayer, double range, boolean seeOnly) {
