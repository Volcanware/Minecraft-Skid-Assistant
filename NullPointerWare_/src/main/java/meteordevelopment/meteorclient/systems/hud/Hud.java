...
public class Hud extends System<Hud> implements Iterable<HudElement> {
    public static final HudGroup GROUP = new HudGroup("NullPointerWare");
    ...
    public void init() {
        ...
        register(TimerPowerHud.INFO);
        register(TimerPowerHudBar.INFO);
        register(VulcanSecondsHud.INFO);
