...
public class Disabler extends SpeedMode {
    public Disabler() {
        super(SpeedModes.Disabler);
    }

    @Override
    public void onMove(PlayerMoveEvent event) {

        if (!Modules.get().isActive(meteordevelopment.meteorclient.systems.modules.misc.Disabler.class) || Modules.get().isActive(Flight.class))
            return;
