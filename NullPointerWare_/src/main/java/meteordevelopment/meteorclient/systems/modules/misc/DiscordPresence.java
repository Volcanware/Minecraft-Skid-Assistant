...
public final class DiscordPresence extends Module {
    ...
    public DiscordPresence() {
        super(Categories.Misc, "discord-presence", "Displays NullPointerWare as your presence on Discord.");
    ...
    public void onActivate() {
        DiscordIPC.start(1175241198894588058L, null);
        ...
        rpc.setLargeImage("blacklagoon-rpc", largeText);
    ...
    private enum SmallImage {
        MineGame("yourheartismarineblue", "lagoon"),
        Snail("srdyxntdes491", "Nullable");
