...
public final class AirPlace extends Module {
    ...
    private void onTick(final TickEvent.Post event){
        ...
        if (mc.options.useKey.isPressed()) {
            BlockUtils.place(((BlockHitResult) hitResult).getBlockPos(), Hand.MAIN_HAND, mc.player.getInventory().selectedSlot, BlockUtils.RotationPacket.None, 0, true, true, false);
        }
    }
