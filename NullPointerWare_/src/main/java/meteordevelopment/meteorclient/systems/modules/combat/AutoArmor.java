...
public final class AutoArmor extends Module {
    ...
    private void onPreTick(final TickEvent.Pre event) {
        ...
        if (inInv.get() && mc.currentScreen == null)
            return;
    ...
    private int getScore(ItemStack itemStack) {
        ...
        score += itemStack.getItem() instanceof ArmorItem ? (int) ((ArmorItem) itemStack.getItem()).getToughness() : 0;
