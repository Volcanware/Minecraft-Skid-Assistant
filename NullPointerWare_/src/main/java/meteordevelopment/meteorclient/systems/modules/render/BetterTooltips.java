...
public final class BetterTooltips extends Module {
    ...
    @EventHandler
    private void appendTooltip(final ItemStackTooltipEvent event) {
        // Status effects
    ...
    @EventHandler
    private void getTooltipData(final TooltipDataEvent event) {
        // Container preview
    ...
    @EventHandler
    private void onSectionVisible(final SectionVisibleEvent event) {
