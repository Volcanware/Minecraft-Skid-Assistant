...
public final class SelfWeb extends Module {
    ...
    private void placeWeb() {
        ...
        BlockUtils.place(mc.player.getBlockPos(), web, rotate.get() ? BlockUtils.RotationPacket.Vanilla : BlockUtils.RotationPacket.None, 0, false);

        if (doubles.get()) {
            BlockUtils.place(mc.player.getBlockPos().add(0, 1, 0), web, rotate.get() ? BlockUtils.RotationPacket.Vanilla : BlockUtils.RotationPacket.None, 0, false);
        }
