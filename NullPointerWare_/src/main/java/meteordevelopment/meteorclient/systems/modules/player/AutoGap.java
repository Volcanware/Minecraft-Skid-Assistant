...
public final class AutoGap extends Module {
    private static final Class<? extends Module>[] AURAS = new Class[] { Aura.class, CrystalAura.class, AnchorAura.class, BedAura.class };
    ...
    @EventHandler
    private void onItemUseCrosshairTarget(final ItemUseCrosshairTargetEvent event) {
