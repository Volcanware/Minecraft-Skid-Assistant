...
public final class HighwayBuilder extends Module {
    ...
    private enum State {
        ...
        MineEnderChests {
            ...
            protected void tick(HighwayBuilder b) {
                ...
                if (blockState.getBlock() == Blocks.ENDER_CHEST) {
                    ...
                    BlockUtils.place(pos.getMcPos(), Hand.MAIN_HAND, slot, BlockUtils.RotationPacket.Vanilla, 0, true, true, false);
                }
            }
        };
        ...
        protected void place(HighwayBuilder b, MBPIterator it, int slot, State nextState) {
            ...
            for (MBlockPos pos : it) {
                if (BlockUtils.place(pos.getMcPos(), Hand.MAIN_HAND, slot, b.rotation.get().place ? BlockUtils.RotationPacket.Vanilla : BlockUtils.RotationPacket.None, 0, true, true, true)) {
                    placed = true;
                    b.blocksPlaced++;
                    break;
                }
